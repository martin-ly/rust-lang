...
**日期**: 2026-07-24  **扫描**: 1842 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1430（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 561375
**阈值**: 0.5  **命中对**: 523（同目录 523 / 跨目录 0）
...
| 0.818 | 0.818 | 0.5 | 5 | Y | `crates/c03_control_fn/docs/tier_04_rust_194_updates/README.md`(21) | `crates/c11_macro_system_proc/docs/tier_04_rust_194_updates/README.md`(21) |
...
| 0.818 | 0.818 | 0.5 | 5 | Y | `crates/c05_threads/docs/tier_04_rust_194_updates/README.md`(22) | `crates/c11_macro_system_proc/docs/tier_04_rust_194_updates/README.md`(21) |
...
| 0.818 | 0.818 | 0.5 | 5 | Y | `crates/c07_process/docs/tier_04_rust_194_updates/README.md`(21) | `crates/c11_macro_system_proc/docs/tier_04_rust_194_updates/README.md`(21) |
...
| 0.818 | 0.818 | 0.5 | 5 | Y | `crates/c10_networks/docs/tier_04_rust_194_updates/README.md`(21) | `crates/c11_macro_system_proc/docs/tier_04_rust_194_updates/README.md`(21) |
...
| 0.767 | 0.767 | 0.25 | 9 | Y | `docs/05_practice/14_project_13_database_engine.md`(108) | `docs/05_practice/13_project_12_wasm_app.md`(113) |
...
- JSON: `reports/CONTENT_OVERLAP_V2_2026-07-24.json`
