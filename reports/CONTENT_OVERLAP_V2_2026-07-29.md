...
**日期**: 2026-07-29  **扫描**: 1901 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1486（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 600881
**阈值**: 0.5  **命中对**: 496（同目录 496 / 跨目录 0）
...
|:---:|:---:|:---:|:---:|:---:|:---|:---|
| 1.0 | 0.74 | 1.0 | 60 | Y | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(240) | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(171) |
