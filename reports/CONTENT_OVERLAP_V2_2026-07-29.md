...
**日期**: 2026-07-29  **扫描**: 1882 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1467（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 588388
**阈值**: 0.5  **命中对**: 614（同目录 614 / 跨目录 0）
...
|:---:|:---:|:---:|:---:|:---:|:---|:---|
| 1.0 | 0.74 | 1.0 | 45 | Y | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(171) | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(240) |
| 1.0 | 0.74 | 1.0 | 15 | Y | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(240) | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(171) |
...
| 0.818 | 0.818 | 0.5 | 5 | Y | `crates/c01_ownership_borrow_scope/docs/tier_04_rust_194_updates/README.md`(22) | `crates/c04_generic/docs/tier_04_rust_194_updates/README.md`(22) |
...
- JSON: `reports/CONTENT_OVERLAP_V2_2026-07-29.json`
