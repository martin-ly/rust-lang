...
**日期**: 2026-07-29  **扫描**: 1910 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1495（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 606281
...
| 0.742 | 0.742 | 0.333 | 8 | Y | `docs/05_practice/09_project_08_cache_system.md`(121) | `docs/05_practice/10_project_09_log_parser.md`(116) |
