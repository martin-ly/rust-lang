...
**日期**: 2026-07-29  **扫描**: 1909 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1494（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 604660
...
| 0.767 | 0.767 | 0.25 | 7 | Y | `docs/05_practice/14_project_13_database_engine.md`(108) | `docs/05_practice/13_project_12_wasm_app.md`(113) |
...
| 0.742 | 0.742 | 0.333 | 8 | Y | `docs/05_practice/10_project_09_log_parser.md`(116) | `docs/05_practice/11_project_10_data_pipeline.md`(120) |
