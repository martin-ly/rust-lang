...
**日期**: 2026-07-15  **总关系数**: 7134  **核心 50 实体关系数**: 1940  **核心实体数**: 50

## 1. 全局 ex:RelationAnnotation 占比

- `ex:RelationAnnotation` 数量: 5194
- 全局通用谓词占比: **72.81%**
- 核心 50 周边通用谓词占比: **0.00%**
...
| 谓词 | 计数 | 占比（核心） |
|:---|---:|---:|
| `ex:dependsOn` | 1315 | 67.78% |
| `ex:entails` | 497 | 25.62% |
| `ex:equivalentTo` | 57 | 2.94% |
| `ex:refines` | 47 | 2.42% |
| `ex:mutexWith` | 8 | 0.41% |
| `ex:instanceOf` | 6 | 0.31% |
| `ex:counterExample` | 5 | 0.26% |
| `ex:appliesTo` | 3 | 0.15% |
| `ex:enables` | 2 | 0.10% |
