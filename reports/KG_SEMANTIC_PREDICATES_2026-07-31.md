...
| `l1` | 52 | 1515 | 67 | 4.42% |
| `l2` | 41 | 1202 | 44 | 3.66% |
| `async` | 16 | 545 | 18 | 3.30% |
| `unsafe` | 10 | 394 | 11 | 2.79% |
| `formal` | 98 | 1893 | 80 | 4.23% |
| `l5` | 27 | 699 | 22 | 3.15% |
| `l6_concept` | 125 | 2288 | 134 | 5.86% |
| `l7` | 73 | 1375 | 73 | 5.31% |
| `l3_rem` | 43 | 946 | 47 | 4.97% |
| `meta_navigation` | 29 | 3485 | 63 | 1.81% |
| `ecosystem` | 151 | 2621 | 136 | 5.19% |
| `future` | 73 | 1375 | 73 | 5.31% |
| `rustc_internals` | 17 | 309 | 5 | 1.62% |
| `framework` | 24 | 585 | 29 | 4.96% |
...
| 谓词 | 修改前 | 修改后 | Δ |
|:---|---:|---:|---:|
| `ex:relatedTo` | 0 | 6979 | +6979 |
| `ex:dependsOn` | 0 | 1011 | +1011 |
| `ex:entails` | 0 | 920 | +920 |
| `ex:RelationAnnotation` | 9584 | 674 | -8910 |
