...
**日期**: 2026-07-29  **总关系数**: 9187  **核心 50 实体关系数**: 2588  **核心实体数**: 50
...
| 谓词 | 计数 | 占比（核心） |
|:---|---:|---:|
| `ex:dependsOn` | 1021 | 39.45% |
| `ex:hasPart` | 619 | 23.92% |
| `ex:entails` | 385 | 14.88% |
| `ex:relatedTo` | 285 | 11.01% |
| `ex:refines` | 138 | 5.33% |
| `ex:partOf` | 109 | 4.21% |
| `ex:appliesTo` | 31 | 1.20% |
...
- JSON: `reports/KG_RELATION_PRECISION_2026-07-29.json`
