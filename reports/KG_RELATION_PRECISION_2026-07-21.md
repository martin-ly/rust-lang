...
**日期**: 2026-07-21  **总关系数**: 8410  **核心 50 实体关系数**: 2470  **核心实体数**: 50
...
| 谓词 | 计数 | 占比（核心） |
|:---|---:|---:|
| `ex:dependsOn` | 969 | 39.23% |
| `ex:hasPart` | 568 | 23.00% |
| `ex:entails` | 379 | 15.34% |
| `ex:relatedTo` | 276 | 11.17% |
| `ex:refines` | 138 | 5.59% |
| `ex:partOf` | 109 | 4.41% |
| `ex:appliesTo` | 31 | 1.26% |
...
- JSON: `reports/KG_RELATION_PRECISION_2026-07-21.json`
