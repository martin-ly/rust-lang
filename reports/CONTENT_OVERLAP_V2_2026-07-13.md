...
**日期**: 2026-07-13  **扫描**: 1945 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1450（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 567420
**阈值**: 0.5  **命中对**: 583（同目录 571 / 跨目录 12）
