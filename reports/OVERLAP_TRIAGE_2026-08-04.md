...
**来源**: `reports/CONTENT_OVERLAP_V2_2026-08-04.json`  **总对数**: 481
...
| REVIEWED | 370 | 已批量复核确认非重复（stub/模板系列/同领域术语共现，白名单） |
| REVIEW | 2 | 人工复核 |
...
| 0.733 | `docs/05_practice/06_project_05_text_statistics.md` | `docs/05_practice/04_project_03_calculator.md` |
...
| 0.719 | `docs/05_practice/07_project_06_concurrent_downloader.md` | `docs/05_practice/10_project_09_log_parser.md` |
| 0.719 | `docs/05_practice/07_project_06_concurrent_downloader.md` | `docs/05_practice/11_project_10_data_pipeline.md` |
