...
**日期**: 2026-07-14  **扫描**: 1947 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1452（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 574858
**阈值**: 0.5  **命中对**: 570（同目录 560 / 跨目录 10）
