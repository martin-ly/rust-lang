...
| `unsafe` | 12 | 441 | 24 | 5.44% |
| `formal` | 115 | 1984 | 81 | 4.08% |
| `l5` | 27 | 734 | 22 | 3.00% |
| `l6_concept` | 175 | 3002 | 170 | 5.66% |
| `l7` | 74 | 1496 | 94 | 6.28% |
| `l3_rem` | 44 | 944 | 45 | 4.77% |
| `meta_navigation` | 30 | 3607 | 63 | 1.75% |
| `ecosystem` | 204 | 3342 | 172 | 5.15% |
| `future` | 75 | 1508 | 94 | 6.23% |
...
| 谓词 | 修改前 | 修改后 | Δ |
|:---|---:|---:|---:|
| `ex:relatedTo` | 0 | 7232 | +7232 |
| `ex:entails` | 0 | 1224 | +1224 |
| `ex:dependsOn` | 0 | 1153 | +1153 |
| `ex:RelationAnnotation` | 10621 | 793 | -9828 |
...
⚠️ 处理批次内仍有 954 条通用谓词（低于阈值 0 条），需进一步处理。

## 6. 机器可读

- JSON: `reports/KG_SEMANTIC_PREDICATES_2026-08-05.json`
