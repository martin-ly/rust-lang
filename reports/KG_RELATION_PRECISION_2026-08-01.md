...
**日期**: 2026-08-01  **总关系数**: 10134  **核心 50 实体关系数**: 2768  **核心实体数**: 50
...
| 谓词 | 计数 | 占比（核心） |
|:---|---:|---:|
| `ex:dependsOn` | 1139 | 41.15% |
| `ex:hasPart` | 626 | 22.62% |
| `ex:entails` | 436 | 15.75% |
| `ex:relatedTo` | 255 | 9.21% |
| `ex:refines` | 140 | 5.06% |
| `ex:partOf` | 105 | 3.79% |
| `ex:appliesTo` | 31 | 1.12% |
| `ex:equivalentTo` | 18 | 0.65% |
| `ex:mutexWith` | 7 | 0.25% |
| `ex:instanceOf` | 6 | 0.22% |
| `ex:enables` | 3 | 0.11% |
...
- JSON: `reports/KG_RELATION_PRECISION_2026-08-01.json`
