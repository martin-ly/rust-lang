...
| `formal` | 104 | 1946 | 81 | 4.16% |
| `l5` | 27 | 717 | 22 | 3.07% |
| `l6_concept` | 158 | 2713 | 154 | 5.68% |
| `l7` | 74 | 1489 | 94 | 6.31% |
| `l3_rem` | 44 | 936 | 45 | 4.81% |
| `meta_navigation` | 30 | 3572 | 63 | 1.76% |
| `ecosystem` | 186 | 3050 | 156 | 5.11% |
...
| 谓词 | 修改前 | 修改后 | Δ |
|:---|---:|---:|---:|
| `ex:relatedTo` | 0 | 7028 | +7028 |
| `ex:entails` | 0 | 1166 | +1166 |
| `ex:dependsOn` | 0 | 1089 | +1089 |
| `ex:RelationAnnotation` | 10266 | 762 | -9504 |
...
⚠️ 处理批次内仍有 922 条通用谓词（低于阈值 0 条），需进一步处理。
