...
| `l1` | 54 | 1574 | 67 | 4.26% |
| `l2` | 44 | 1298 | 46 | 3.54% |
| `async` | 16 | 567 | 18 | 3.17% |
| `unsafe` | 11 | 410 | 12 | 2.93% |
| `formal` | 102 | 1924 | 79 | 4.11% |
| `l5` | 27 | 712 | 22 | 3.09% |
| `l6_concept` | 148 | 2604 | 152 | 5.84% |
| `l7` | 75 | 1495 | 95 | 6.35% |
| `l3_rem` | 44 | 934 | 45 | 4.82% |
| `meta_navigation` | 30 | 3564 | 63 | 1.77% |
| `ecosystem` | 175 | 2940 | 154 | 5.24% |
| `future` | 76 | 1507 | 95 | 6.30% |
| `rustc_internals` | 17 | 309 | 5 | 1.62% |
| `framework` | 24 | 603 | 50 | 8.29% |
...
| 谓词 | 修改前 | 修改后 | Δ |
|:---|---:|---:|---:|
| `ex:relatedTo` | 0 | 6943 | +6943 |
| `ex:entails` | 0 | 1148 | +1148 |
| `ex:dependsOn` | 0 | 1072 | +1072 |
| `ex:RelationAnnotation` | 10125 | 741 | -9384 |
...
⚠️ 处理批次内仍有 903 条通用谓词（低于阈值 0 条），需进一步处理。
