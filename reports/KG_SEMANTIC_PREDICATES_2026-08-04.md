...
| `unsafe` | 12 | 418 | 12 | 2.87% |
| `formal` | 104 | 1942 | 79 | 4.07% |
| `l5` | 27 | 715 | 22 | 3.08% |
| `l6_concept` | 154 | 2660 | 154 | 5.79% |
| `l7` | 74 | 1489 | 94 | 6.31% |
| `l3_rem` | 44 | 936 | 45 | 4.81% |
| `meta_navigation` | 30 | 3568 | 63 | 1.77% |
| `ecosystem` | 182 | 2997 | 156 | 5.21% |
| `future` | 75 | 1501 | 94 | 6.26% |
| `rustc_internals` | 17 | 309 | 5 | 1.62% |
| `framework` | 24 | 604 | 50 | 8.28% |
...
| 谓词 | 修改前 | 修改后 | Δ |
|:---|---:|---:|---:|
| `ex:relatedTo` | 0 | 6994 | +6994 |
| `ex:entails` | 0 | 1155 | +1155 |
| `ex:dependsOn` | 0 | 1078 | +1078 |
| `ex:RelationAnnotation` | 10192 | 744 | -9448 |
...
⚠️ 处理批次内仍有 905 条通用谓词（低于阈值 0 条），需进一步处理。
