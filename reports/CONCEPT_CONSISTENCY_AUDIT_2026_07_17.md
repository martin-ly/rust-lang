...
> 生成时间: 2026-07-17T21:20:38.886483
...
| 概念 | 提取次数 | 涉及文件数 |
|:---|:---|:---|
| RPITIT-RTN-TAIT-定义 | 464 | 46 |
| unsafe-UB | 454 | 124 |
| effects-system-定义 | 353 | 39 |
| 所有权-Move语义 | 259 | 94 |
| Pin-自引用 | 235 | 68 |
| const-trait-impl-定义 | 177 | 33 |
...
| 变型-定义 | 102 | 22 |
| 内部可变性-运行时检查 | 101 | 32 |
| async-Future-状态机 | 96 | 39 |
| 生命周期-子类型-outlives | 92 | 27 |
| let-chains-守卫 | 88 | 35 |
| const-trait-impl-效果 | 85 | 19 |
| RPITIT-RTN-TAIT-捕获 | 80 | 24 |
| GAT-async-生命周期 | 78 | 17 |
| unsafe-extern-块 | 76 | 14 |
| unsafe-extern-safe | 74 | 16 |
| 变型-规则 | 71 | 14 |
| 所有权-唯一所有权 | 70 | 36 |
| GAT-async-边界 | 69 | 19 |
| let-chains-链式 | 64 | 8 |
