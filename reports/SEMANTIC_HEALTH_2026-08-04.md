...
| 维度 | 权重 | 得分 | 关键证据 |
|---|:---:|:---:|:---|
| 元数据一致性 | 30% | 97.2 | flagged 22/773（D1互斥/D2脱节/D3重声明/D4版本/D5 nightly/D6套话） |
| 拓扑实质度 | 25% | 100.0 | 定义套话率 0.0 / 关系塌缩 0.749 / 跳出 0.0 / 死端 0 / 判定定量 0.906 |
| 去重健康 | 20% | 100.0 | 重叠命中 481，可处理（MERGE+DOCS_INTERNAL） 0 |
...
**总分**: 99.1 = 0.30×97.2 + 0.25×100.0 + 0.20×100.0 + 0.25×100.0
