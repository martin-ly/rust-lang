...
> 生成: 2026-07-17 · 扫描 concept/ 活跃 md: **521**（排除 archive/SUMMARY/README）
...
| 维度 | 命中页 | 覆盖率 |
|:---|---:|---:|
| P0 官方（doc.rust-lang.org / rust-lang.github.io / rustc-dev-guide / ferrocene） | 516 | 99.0% |
| P1 学术/形式化（RustBelt/arxiv/acm/ieee/springer/aeneas …） | 466 | 89.4% |
| P2 社区/生态（verus/creusot/docs.rs/crates.io/blog.rust-lang.org …） | 434 | 83.3% |
| **任一权威（P0∪P1∪P2）** | **521** | **100.0%** |
| 无任何国际权威引用（缺口） | 0 | 0.0% |
