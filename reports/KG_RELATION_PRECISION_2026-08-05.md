...
**日期**: 2026-08-05  **总关系数**: 10621  **核心 50 实体关系数**: 2799  **核心实体数**: 50
...
| 谓词 | 计数 | 占比（核心） |
|:---|---:|---:|
| `ex:dependsOn` | 1149 | 41.05% |
| `ex:hasPart` | 640 | 22.87% |
| `ex:entails` | 442 | 15.79% |
| `ex:relatedTo` | 256 | 9.15% |
| `ex:refines` | 140 | 5.00% |
| `ex:partOf` | 105 | 3.75% |
...
- JSON: `reports/KG_RELATION_PRECISION_2026-08-05.json`
