...
**日期**: 2026-08-04  **总关系数**: 10192  **核心 50 实体关系数**: 2769  **核心实体数**: 50
...
| 谓词 | 计数 | 占比（核心） |
|:---|---:|---:|
| `ex:dependsOn` | 1137 | 41.06% |
| `ex:hasPart` | 624 | 22.54% |
| `ex:entails` | 440 | 15.89% |
| `ex:relatedTo` | 256 | 9.25% |
| `ex:refines` | 140 | 5.06% |
| `ex:partOf` | 105 | 3.79% |
...
- JSON: `reports/KG_RELATION_PRECISION_2026-08-04.json`
