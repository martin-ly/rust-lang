...
**日期**: 2026-07-16  **扫描**: 1966 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1452（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 565719
**阈值**: 0.5  **命中对**: 638（同目录 636 / 跨目录 2）
...
| 0.818 | 0.818 | 0.5 | 5 | Y | `crates/c05_threads/docs/tier_04_rust_194_updates/README.md`(22) | `crates/c10_networks/docs/tier_04_rust_194_updates/README.md`(21) |
...
- JSON: `reports/CONTENT_OVERLAP_V2_2026-07-16.json`
