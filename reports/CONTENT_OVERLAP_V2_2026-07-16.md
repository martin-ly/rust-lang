...
**日期**: 2026-07-16  **扫描**: 1946 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1432（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 551390
**阈值**: 0.5  **命中对**: 549（同目录 542 / 跨目录 7）
