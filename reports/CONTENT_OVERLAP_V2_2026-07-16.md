...
**日期**: 2026-07-16  **扫描**: 1965 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1451（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 565384
**阈值**: 0.5  **命中对**: 621（同目录 619 / 跨目录 2）
