...
| 维度 | 命中页 | 覆盖率 |
|:---|---:|---:|
| P0 官方（doc.rust-lang.org / rust-lang.github.io / rustc-dev-guide / ferrocene） | 450 | 97.8% |
...
|:---|---:|---:|---:|---:|---:|
| L0 | 60 | 58 | 96.7% | 59 | 98.3% |
| L1 | 55 | 55 | 100.0% | 55 | 100.0% |
| L2 | 38 | 38 | 100.0% | 38 | 100.0% |
| L3 | 57 | 55 | 96.5% | 57 | 100.0% |
| L4 | 53 | 53 | 100.0% | 53 | 100.0% |
| L5 | 19 | 19 | 100.0% | 19 | 100.0% |
| L6 | 115 | 111 | 96.5% | 115 | 100.0% |
| L7 | 60 | 58 | 96.7% | 59 | 98.3% |
| L? | 3 | 3 | 100.0% | 3 | 100.0% |

## 核心缺口（L1-L4 且 无 P0 官方国际权威）

共 **2** 页。下表为前 60（按层级、页长降序，优先补权威来源小节）。

| 层级 | 文件 | 行数 |
|:---|:---|---:|
| L3 | `concept/03_advanced/02_process_ipc/10_modern_process_libraries.md` | 230 |
| L3 | `concept/03_advanced/02_process_ipc/08_process_performance_engineering.md` | 213 |
