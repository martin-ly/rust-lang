...
**日期**: 2026-07-30  **扫描**: 1918 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1503（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 606687
**阈值**: 0.5  **命中对**: 522（同目录 522 / 跨目录 0）
...
|:---:|:---:|:---:|:---:|:---:|:---|:---|
| 1.0 | 0.745 | 1.0 | 48 | Y | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(249) | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(180) |
| 1.0 | 0.745 | 1.0 | 14 | Y | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(180) | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(249) |
...
- JSON: `reports/CONTENT_OVERLAP_V2_2026-07-30.json`
