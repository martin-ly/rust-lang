...
**日期**: 2026-07-17  **扫描**: 1968 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1454（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 566904
**阈值**: 0.5  **命中对**: 651（同目录 649 / 跨目录 2）
...
| 0.759 | 0.759 | 0.0 | 5 | Y | `knowledge/04_expert/miri/README.md`(79) | `knowledge/06_ecosystem/deployment/README.md`(73) |
...
- JSON: `reports/CONTENT_OVERLAP_V2_2026-07-17.json`
