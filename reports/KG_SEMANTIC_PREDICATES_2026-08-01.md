...
| `l1` | 54 | 1574 | 67 | 4.26% |
| `l2` | 44 | 1283 | 46 | 3.59% |
| `async` | 16 | 572 | 18 | 3.15% |
| `unsafe` | 11 | 411 | 12 | 2.92% |
| `formal` | 101 | 1962 | 80 | 4.08% |
| `l5` | 27 | 717 | 22 | 3.07% |
| `l6_concept` | 147 | 2616 | 152 | 5.81% |
| `l7` | 75 | 1448 | 95 | 6.56% |
| `l3_rem` | 44 | 930 | 45 | 4.84% |
| `meta_navigation` | 30 | 3561 | 63 | 1.77% |
| `ecosystem` | 173 | 2951 | 154 | 5.22% |
| `future` | 76 | 1460 | 95 | 6.51% |
| `rustc_internals` | 17 | 312 | 5 | 1.60% |
...
| 谓词 | 修改前 | 修改后 | Δ |
|:---|---:|---:|---:|
| `ex:relatedTo` | 0 | 6879 | +6879 |
| `ex:entails` | 0 | 1170 | +1170 |
| `ex:dependsOn` | 0 | 1121 | +1121 |
| `ex:RelationAnnotation` | 10134 | 742 | -9392 |
...
⚠️ 处理批次内仍有 904 条通用谓词（低于阈值 0 条），需进一步处理。

## 6. 机器可读

- JSON: `reports/KG_SEMANTIC_PREDICATES_2026-08-01.json`