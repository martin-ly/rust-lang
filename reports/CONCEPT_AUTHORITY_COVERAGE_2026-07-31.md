...
> 生成: 2026-07-31 · 扫描 concept/ 活跃 md: **578**（排除 archive/SUMMARY/README）
...
| 维度 | 命中页 | 覆盖率 |
|:---|---:|---:|
| P0 官方（doc.rust-lang.org / rust-lang.github.io / rustc-dev-guide / ferrocene） | 573 | 99.1% |
| P1 学术/形式化（RustBelt/arxiv/acm/ieee/springer/aeneas …） | 540 | 93.4% |
| P2 社区/生态（verus/creusot/docs.rs/crates.io/blog.rust-lang.org …） | 504 | 87.2% |
| **任一权威（P0∪P1∪P2）** | **578** | **100.0%** |
| 无任何国际权威引用（缺口） | 0 | 0.0% |

## 内容页口径覆盖率（排除 00_meta 工具页 / quiz / placeholders / sources 索引）

> 内容页 **485** 页。00_meta 为知识库内部工具/导航/审计页，非 Rust 概念内容，其权威基线为 P0 官方文档；P1/P2 学术生态来源对其不适用，故单列口径。
