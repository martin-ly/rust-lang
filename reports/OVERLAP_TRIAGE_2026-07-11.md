...
**来源**: `reports/CONTENT_OVERLAP_V2_2026-07-11.json`  **总对数**: 572

| 分类 | 数量 | 处置 |
|---|:---:|:---|
| MERGE | 5 | 应合并近克隆（留一删余或 stub 化） |
| DOCS_INTERNAL | 49 | docs/ 内同主题互抄（合并或互链） |
| SERIES | 27 | 保留但标注为版本系列/分章（白名单） |
| REVIEW | 491 | 人工复核 |
...
| sim | 文件1 | 文件2 |
|:---:|:---|:---|
| 1.0 | `crates/c01_ownership_borrow_scope/docs/c01_ownership/quick_reference.md` | `crates/c01_ownership_borrow_scope/docs/tier_03_references/04_drop_and_raii_reference.md` |
| 1.0 | `crates/c03_control_fn/docs/mind_map.md` | `crates/c03_control_fn/docs/multidimensional_matrix.md` |
...
| 0.727 | `crates/c09_design_pattern/docs/c09_comprehensive_enhancement_report_2025_10_19.md` | `crates/c09_design_pattern/docs/tier_01_foundations/02_navigation.md` |
| 0.727 | `crates/c09_design_pattern/docs/enhancement_summary_2025_10_19.md` | `crates/c09_design_pattern/docs/tier_01_foundations/02_navigation.md` |
...
| 0.571 | `crates/c07_process/docs/c07_process_completion_summary_2025_10_19.md` | `crates/c07_process/docs/tier_01_foundations/02_navigation.md` |
...
| 0.84 | `concept/07_future/03_preview_features/31_safety_tags_preview.md` | `concept/04_formal/02_separation_logic/33_safety_tags_in_formal.md` |
| 0.84 | `concept/04_formal/02_separation_logic/33_safety_tags_in_formal.md` | `concept/07_future/03_preview_features/31_safety_tags_preview.md` |
...
- JSON: `reports/OVERLAP_TRIAGE_2026-07-11.json`
