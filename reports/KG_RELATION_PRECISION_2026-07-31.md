...
**日期**: 2026-07-31  **总关系数**: 9584  **核心 50 实体关系数**: 2646  **核心实体数**: 50
...
| 谓词 | 计数 | 占比（核心） |
|:---|---:|---:|
| `ex:dependsOn` | 1066 | 40.29% |
| `ex:hasPart` | 622 | 23.51% |
| `ex:entails` | 392 | 14.81% |
| `ex:relatedTo` | 286 | 10.81% |
| `ex:refines` | 140 | 5.29% |
| `ex:partOf` | 109 | 4.12% |
| `ex:appliesTo` | 31 | 1.17% |
