...
**日期**: 2026-07-31  **总关系数**: 9773  **核心 50 实体关系数**: 2685  **核心实体数**: 50
...
| 谓词 | 计数 | 占比（核心） |
|:---|---:|---:|
| `ex:dependsOn` | 1104 | 41.12% |
| `ex:hasPart` | 622 | 23.17% |
| `ex:entails` | 392 | 14.60% |
| `ex:relatedTo` | 285 | 10.61% |
| `ex:refines` | 142 | 5.29% |
| `ex:partOf` | 109 | 4.06% |
| `ex:appliesTo` | 31 | 1.15% |
