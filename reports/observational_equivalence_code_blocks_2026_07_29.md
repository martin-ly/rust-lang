...
- compile_fail: ok=913 unexpected_pass=1 wrong_code=0
...
| 文件 | 行 | 分类 | 状态 | 错误摘要 |
|---|---:|---|---|---|
| `concept/04_formal/11_computational_models/04_mathematical_functions_of_computation.md` | 214 | candidate | fail | error[E0507]: cannot move out of `x`, a captured variable in an `Fn` closure<br>error: aborting due to 1 previous error |
