...
**日期**: 2026-08-04  **总关系数**: 10522  **核心 50 实体关系数**: 2793  **核心实体数**: 50
...
| 谓词 | 计数 | 占比（核心） |
|:---|---:|---:|
| `ex:dependsOn` | 1143 | 40.92% |
| `ex:hasPart` | 640 | 22.91% |
| `ex:entails` | 442 | 15.83% |
| `ex:relatedTo` | 256 | 9.17% |
| `ex:refines` | 140 | 5.01% |
| `ex:partOf` | 105 | 3.76% |
| `ex:appliesTo` | 31 | 1.11% |
| `ex:equivalentTo` | 18 | 0.64% |
| `ex:mutexWith` | 7 | 0.25% |
| `ex:instanceOf` | 6 | 0.21% |
| `ex:enables` | 3 | 0.11% |
| `ex:counterExample` | 2 | 0.07% |
...
- JSON: `reports/KG_RELATION_PRECISION_BASELINE_2026_08_04.json`
