...
**实体数**: 539  **关系数**: 8396 → 7510
**改动数**: 5200

## 目标

将 `ex:relatedTo` 占比从 81.1% 降到 <50%。
精化后：`ex:relatedTo` = 1637 / 7510 = **21.8%**
...
| 谓词 | 前 | 后 | Δ |
|:---|---:|---:|---:|
| ex:hasPart | 0 | 3226 | +3226 |
| ex:relatedTo | 6806 | 1637 | -5169 |
| ex:dependsOn | 834 | 1423 | +589 |
| ex:entails | 756 | 1108 | +352 |
| ex:refines | 0 | 85 | +85 |
...
- `ex:relatedTo` 占比：81.1% → 21.8%
- `ex:relatedTo` 数量：6806 → 1637 (Δ -5169)
...
| R0-dedup | removed redundant relatedTo | ex:SemanticModelAtlas | ex:relatedTo | ex:AlgebraicEffectsAndEffectHandlersFromFreeMonadsToRustKeywordEffects | (ex:SemanticModelAtlas,ex:AlgebraicEffectsAndEffectHandlersFromFreeMonadsToRustKeywordEffects) 已存在 dependsOn/entails，删除冗余 relatedTo |
| R0-dedup | removed redundant relatedTo | ex:SemanticModelAtlas | ex:relatedTo | ex:ProcessCalculiForRustCSPCCSAndThePiCalculus | (ex:SemanticModelAtlas,ex:ProcessCalculiForRustCSPCCSAndThePiCalculus) 已存在 dependsOn/entails，删除冗余 relatedTo |
...
| R0-dedup | removed redundant relatedTo | ex:LetElseEarlyReturnOnPatternMismatch | ex:relatedTo | ex:LetChainsAndIfLetGuards | (ex:LetElseEarlyReturnOnPatternMismatch,ex:LetChainsAndIfLetGuards) 已存在 dependsOn/entails，删除冗余 relatedTo |
| R0-dedup | removed redundant relatedTo | ex:LetElseEarlyReturnOnPatternMismatch | ex:relatedTo | ex:Patterns | (ex:LetElseEarlyReturnOnPatternMismatch,ex:Patterns) 已存在 dependsOn/entails，删除冗余 relatedTo |
...
| R0-dedup | removed redundant relatedTo | ex:NegativeImpls | ex:relatedTo | ex:SendAndSyncAutoTraitsAsCompileTimeConcurrencyContracts | (ex:NegativeImpls,ex:SendAndSyncAutoTraitsAsCompileTimeConcurrencyContracts) 已存在 dependsOn/entails，删除冗余 relatedTo |
| R0-dedup | removed redundant relatedTo | ex:NegativeImpls | ex:relatedTo | ex:PinAndUnpin | (ex:NegativeImpls,ex:PinAndUnpin) 已存在 dependsOn/entails，删除冗余 relatedTo |
| R0-dedup | removed redundant relatedTo | ex:AssociatedTypeDefaults | ex:relatedTo | ex:Traits_00traits | (ex:AssociatedTypeDefaults,ex:Traits_00traits) 已存在 dependsOn/entails，删除冗余 relatedTo |
| R0-dedup | removed redundant relatedTo | ex:AssociatedTypeDefaults | ex:relatedTo | ex:SpecializationPreview | (ex:AssociatedTypeDefaults,ex:SpecializationPreview) 已存在 dependsOn/entails，删除冗余 relatedTo |
...
- JSON: `reports/KG_RELATION_REFINEMENT_2026-07-16.json`