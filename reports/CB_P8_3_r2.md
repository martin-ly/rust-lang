...
| `concept/06_ecosystem/14_enterprise_architecture/14_data_intensive_patterns.md` | 229 | candidate | fail | error: lifetime may not live long enough<br>error: aborting due to 1 previous error |
| `concept/04_formal/11_computational_models/07_type_theory_and_rust.md` | 333 | compile_fail | cf_wrong_code | error: aborting due to 1 previous error |
| `concept/04_formal/11_computational_models/07_type_theory_and_rust.md` | 350 | compile_fail | cf_wrong_code | error: aborting due to 1 previous error |
