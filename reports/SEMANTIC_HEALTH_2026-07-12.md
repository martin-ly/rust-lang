...
**日期**: 2026-07-12  **语义健康总分**: **76.8 / 100**  **等级**: **WARN** (OK≥85 / WARN≥60 / FAIL<60)
...
| 拓扑实质度 | 25% | 90.6 | 定义套话率 0.011 / 关系塌缩 0.833 / 跳出 0.166 / 死端 0 / 判定定量 0.578 |
| 去重健康 | 20% | 84.6 | 重叠命中 570，可处理（MERGE+DOCS_INTERNAL） 54 |
...
**总分**: 76.8 = 0.30×49.2 + 0.25×90.6 + 0.20×84.6 + 0.25×90
