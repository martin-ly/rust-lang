...
**日期**: 2026-07-11  **扫描**: 1899 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1409（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 521254
**阈值**: 0.5  **命中对**: 572（同目录 560 / 跨目录 12）
...
| 0.84 | 0.84 | 0.75 | 31 | Y | `concept/07_future/03_preview_features/31_safety_tags_preview.md`(157) | `concept/04_formal/02_separation_logic/33_safety_tags_in_formal.md`(178) |
| 0.84 | 0.84 | 0.75 | 14 | Y | `concept/04_formal/02_separation_logic/33_safety_tags_in_formal.md`(178) | `concept/07_future/03_preview_features/31_safety_tags_preview.md`(157) |
