...
**纳入索引**: 1411（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 525029
**阈值**: 0.45  **命中对**: 662（同目录 648 / 跨目录 14）
...
| 1.0 | 0.357 | 1.0 | 5 | Y | `crates/c10_networks/docs/rust_190_examples_collection.md`(857) | `crates/c10_networks/docs/rust_190_examples_part2.md`(857) |
...
| 0.84 | 0.84 | 0.75 | 38 | Y | `concept/04_formal/02_separation_logic/33_safety_tags_in_formal.md`(178) | `concept/07_future/03_preview_features/31_safety_tags_preview.md`(157) |
| 0.84 | 0.84 | 0.75 | 7 | Y | `concept/07_future/03_preview_features/31_safety_tags_preview.md`(157) | `concept/04_formal/02_separation_logic/33_safety_tags_in_formal.md`(178) |
...
| 0.794 | 0.794 | 0.0 | 13 | Y | `knowledge/04_expert/README.md`(114) | `knowledge/06_ecosystem/README.md`(140) |
...
| 0.759 | 0.759 | 0.0 | 8 | Y | `knowledge/04_expert/academic/README.md`(79) | `knowledge/04_expert/miri/README.md`(79) |
| 0.759 | 0.759 | 0.0 | 8 | Y | `knowledge/04_expert/miri/README.md`(79) | `knowledge/06_ecosystem/deployment/README.md`(73) |
