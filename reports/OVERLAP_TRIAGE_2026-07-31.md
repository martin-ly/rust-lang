...
**来源**: `reports/CONTENT_OVERLAP_V2_2026-07-31.json`  **总对数**: 511

| 分类 | 数量 | 处置 |
|---|:---:|:---|
| MERGE | 0 | 应合并近克隆（留一删余或 stub 化） |
| DOCS_INTERNAL | 0 | docs/ 内同主题互抄（合并或互链） |
| SERIES | 127 | 保留但标注为版本系列/分章（白名单） |
| REVIEWED | 384 | 已批量复核确认非重复（stub/模板系列/同领域术语共现，白名单） |
| REVIEW | 0 | 人工复核 |
...
| 0.727 | `crates/c01_ownership_borrow_scope/docs/04_multidimensional_matrix.md` | `crates/c01_ownership_borrow_scope/docs/07_role_based_navigation.md` |
...
- JSON: `reports/OVERLAP_TRIAGE_2026-07-31.json`
