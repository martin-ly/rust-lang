...
- compile_fail: ok=1110 unexpected_pass=0 wrong_code=4
...
| `concept/06_ecosystem/16_algorithm_patterns/19_parallel_and_gpu_algorithms.md` | 380 | compile_fail | cf_wrong_code | error[E0599]: no method named `into_par_iter` found for struct `std::ops::Range<Idx>` in the current scope<br>error: aborting due to 2 prev |
