...
**日期**: 2026-07-12  **扫描**: 1899 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1407（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 531842
**阈值**: 0.5  **命中对**: 570（同目录 558 / 跨目录 12）
...
| 0.949 | 0.949 | 0.0 | 13 | Y | `docs/research_notes/software_design_theory/01_design_patterns_formal/01_creational/README.md`(140) | `docs/research_notes/software_design_theory/01_design_patterns_formal/02_structural/README.md`(145) |
| 0.949 | 0.949 | 0.0 | 13 | Y | `docs/research_notes/software_design_theory/01_design_patterns_formal/01_creational/README.md`(140) | `docs/research_notes/software_design_theory/01_design_patterns_formal/03_behavioral/README.md`(153) |
...
| 0.871 | 0.871 | 0.5 | 31 | Y | `concept/07_future/03_preview_features/33_autoverus_preview.md`(173) | `concept/04_formal/04_model_checking/24_autoverus.md`(184) |
| 0.871 | 0.871 | 0.5 | 7 | Y | `concept/04_formal/04_model_checking/24_autoverus.md`(184) | `concept/07_future/03_preview_features/33_autoverus_preview.md`(173) |
...
| 0.818 | 0.818 | 0.5 | 6 | Y | `crates/c07_process/docs/view01.md`(15) | `crates/c07_process/docs/view04.md`(15) |
| 0.818 | 0.818 | 0.5 | 6 | Y | `crates/c07_process/docs/view02.md`(15) | `crates/c07_process/docs/view04.md`(15) |
...
| 0.75 | 0.75 | 0.0 | 10 | Y | `docs/research_notes/software_design_theory/02_workflow/README.md`(120) | `docs/research_notes/software_design_theory/05_distributed/README.md`(135) |
