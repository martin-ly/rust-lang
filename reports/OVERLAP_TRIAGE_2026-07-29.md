...
**来源**: `reports/CONTENT_OVERLAP_V2_2026-07-29.json`  **总对数**: 614
...
| REVIEWED | 487 | 已批量复核确认非重复（stub/模板系列/同领域术语共现，白名单） |
| REVIEW | 0 | 人工复核 |
...
| 0.818 | `crates/c01_ownership_borrow_scope/docs/tier_04_rust_194_updates/README.md` | `crates/c04_generic/docs/tier_04_rust_194_updates/README.md` |
...
- JSON: `reports/OVERLAP_TRIAGE_2026-07-29.json`
