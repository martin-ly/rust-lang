...
**日期**: 2026-08-07  **扫描**: 2134 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1713（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 769312
**阈值**: 0.5  **命中对**: 595（同目录 595 / 跨目录 0）
...
|:---:|:---:|:---:|:---:|:---:|:---|:---|
| 1.0 | 0.348 | 1.0 | 36 | Y | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(358) | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(277) |
| 1.0 | 0.348 | 1.0 | 28 | Y | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(277) | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(358) |
...
| 0.806 | 0.806 | 0.2 | 10 | Y | `docs/05_practice/08_project_07_chat_server.md`(115) | `docs/05_practice/12_project_11_web_server.md`(113) |
...
| 0.75 | 0.75 | 0.4 | 5 | Y | `crates/c05_threads/docs/tier_01_foundations/02_navigation.md`(22) | `crates/c05_threads/docs/tier_01_foundations/04_faq.md`(22) |
| 0.75 | 0.75 | 0.4 | 5 | Y | `crates/c05_threads/docs/tier_01_foundations/03_glossary.md`(22) | `crates/c05_threads/docs/tier_01_foundations/04_faq.md`(22) |
...
| 0.719 | 0.719 | 0.2 | 9 | Y | `docs/05_practice/04_project_03_calculator.md`(116) | `docs/05_practice/12_project_11_web_server.md`(113) |
| 0.719 | 0.719 | 0.333 | 9 | Y | `docs/05_practice/04_project_03_calculator.md`(116) | `docs/05_practice/15_project_14_async_runtime.md`(118) |
| 0.719 | 0.719 | 0.25 | 9 | Y | `docs/05_practice/04_project_03_calculator.md`(116) | `docs/05_practice/16_project_15_distributed_system.md`(115) |
...
- JSON: `reports/CONTENT_OVERLAP_V2_2026-08-07.json`
