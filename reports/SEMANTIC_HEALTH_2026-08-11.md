...
**日期**: 2026-08-11  **语义健康总分**: **100.0 / 100**  **等级**: **OK** (OK≥85 / WARN≥60 / FAIL<60)

> 与 `kb_quality_dashboard.md`（数量型：⟹/mermaid/代码块计数）互补；本仪表盘衡量语义质量（一致性/闭环/交叉/唯一/KG 完整）。

| 维度 | 权重 | 得分 | 关键证据 |
|---|:---:|:---:|:---|
| 元数据一致性 | 30% | 100.0 | flagged 0/823（D1互斥/D2脱节/D3重声明/D4版本/D5 nightly/D6套话） |
| 拓扑实质度 | 25% | 100.0 | 定义套话率 0.0 / 关系塌缩 0.749 / 跳出 0.0 / 死端 0 / 判定定量 0.906 |
| 去重健康 | 20% | 100.0 | 重叠命中 595，可处理（MERGE+DOCS_INTERNAL） 0 |
...
**总分**: 100.0 = 0.30×100.0 + 0.25×100.0 + 0.20×100.0 + 0.25×100.0
...
- JSON: `reports/SEMANTIC_HEALTH_2026-08-11.json`
