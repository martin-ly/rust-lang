...
**日期**: 2026-07-15  **扫描**: 1943 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1437（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 561727
**阈值**: 0.5  **命中对**: 564（同目录 554 / 跨目录 10）
