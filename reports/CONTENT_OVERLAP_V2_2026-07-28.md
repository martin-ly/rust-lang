...
**日期**: 2026-07-28  **扫描**: 1847 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1435（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 567642
**阈值**: 0.5  **命中对**: 500（同目录 500 / 跨目录 0）
...
| 0.733 | 0.733 | 0.333 | 8 | Y | `docs/05_practice/09_project_08_cache_system.md`(121) | `docs/05_practice/06_project_05_text_statistics.md`(108) |
