...
**日期**: 2026-08-04  **扫描**: 2084 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1664（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 738996
**阈值**: 0.5  **命中对**: 481（同目录 481 / 跨目录 0）
...
|:---:|:---:|:---:|:---:|:---:|:---|:---|
| 1.0 | 0.348 | 1.0 | 49 | Y | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(277) | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(358) |
| 1.0 | 0.348 | 1.0 | 16 | Y | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(358) | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(277) |
...
| 0.793 | 0.793 | 0.25 | 9 | Y | `docs/05_practice/06_project_05_text_statistics.md`(108) | `docs/05_practice/13_project_12_wasm_app.md`(113) |
...
| 0.75 | 0.75 | 0.0 | 13 | Y | `docs/12_research_notes/08_software_design_theory/02_workflow/README.md`(120) | `docs/12_research_notes/08_software_design_theory/07_distributed/README.md`(135) |
...
| 0.733 | 0.733 | 0.333 | 5 | Y | `docs/05_practice/06_project_05_text_statistics.md`(108) | `docs/05_practice/04_project_03_calculator.md`(116) |
...
| 0.719 | 0.719 | 0.333 | 9 | Y | `docs/05_practice/07_project_06_concurrent_downloader.md`(136) | `docs/05_practice/09_project_08_cache_system.md`(121) |
| 0.719 | 0.719 | 0.333 | 9 | Y | `docs/05_practice/07_project_06_concurrent_downloader.md`(136) | `docs/05_practice/10_project_09_log_parser.md`(116) |
| 0.719 | 0.719 | 0.333 | 9 | Y | `docs/05_practice/07_project_06_concurrent_downloader.md`(136) | `docs/05_practice/11_project_10_data_pipeline.md`(120) |
