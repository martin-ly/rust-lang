...
**日期**: 2026-08-04  **扫描**: 2048 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1630（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 702910
**阈值**: 0.5  **命中对**: 487（同目录 487 / 跨目录 0）
...
|:---:|:---:|:---:|:---:|:---:|:---|:---|
| 1.0 | 0.354 | 1.0 | 45 | Y | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(260) | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(343) |
| 1.0 | 0.354 | 1.0 | 15 | Y | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(343) | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(260) |
...
| 0.821 | 0.821 | 0.333 | 6 | Y | `docs/05_practice/14_project_13_database_engine.md`(108) | `docs/05_practice/06_project_05_text_statistics.md`(108) |
...
| 0.793 | 0.793 | 0.25 | 6 | Y | `docs/05_practice/13_project_12_wasm_app.md`(113) | `docs/05_practice/06_project_05_text_statistics.md`(108) |
...
| 0.742 | 0.742 | 0.333 | 5 | Y | `docs/05_practice/09_project_08_cache_system.md`(121) | `docs/05_practice/04_project_03_calculator.md`(116) |
| 0.742 | 0.742 | 0.333 | 5 | Y | `docs/05_practice/10_project_09_log_parser.md`(116) | `docs/05_practice/04_project_03_calculator.md`(116) |
| 0.742 | 0.742 | 0.333 | 5 | Y | `docs/05_practice/11_project_10_data_pipeline.md`(120) | `docs/05_practice/04_project_03_calculator.md`(116) |
...
| 0.733 | 0.733 | 0.333 | 5 | Y | `docs/05_practice/09_project_08_cache_system.md`(121) | `docs/05_practice/06_project_05_text_statistics.md`(108) |
| 0.733 | 0.733 | 0.333 | 5 | Y | `docs/05_practice/10_project_09_log_parser.md`(116) | `docs/05_practice/06_project_05_text_statistics.md`(108) |
| 0.733 | 0.733 | 0.333 | 5 | Y | `docs/05_practice/11_project_10_data_pipeline.md`(120) | `docs/05_practice/06_project_05_text_statistics.md`(108) |
| 0.727 | 0.727 | 0.0 | 5 | Y | `crates/c01_ownership_borrow_scope/docs/01_concept_relationship_network.md`(15) | `crates/c01_ownership_borrow_scope/docs/07_role_based_navigation.md`(15) |
| 0.727 | 0.727 | 0.0 | 5 | Y | `crates/c01_ownership_borrow_scope/docs/01_concept_relationship_network.md`(15) | `crates/c01_ownership_borrow_scope/docs/tier_01_foundations/03_glossary.md`(22) |
| 0.727 | 0.727 | 0.0 | 5 | Y | `crates/c01_ownership_borrow_scope/docs/03_mind_map.md`(15) | `crates/c01_ownership_borrow_scope/docs/07_role_based_navigation.md`(15) |
| 0.727 | 0.727 | 0.0 | 5 | Y | `crates/c01_ownership_borrow_scope/docs/03_mind_map.md`(15) | `crates/c01_ownership_borrow_scope/docs/tier_01_foundations/03_glossary.md`(22) |
| 0.727 | 0.727 | 0.0 | 5 | Y | `crates/c01_ownership_borrow_scope/docs/04_multidimensional_matrix.md`(15) | `crates/c01_ownership_borrow_scope/docs/07_role_based_navigation.md`(15) |
| 0.727 | 0.727 | 0.0 | 5 | Y | `crates/c01_ownership_borrow_scope/docs/04_multidimensional_matrix.md`(15) | `crates/c01_ownership_borrow_scope/docs/tier_01_foundations/03_glossary.md`(22) |
| 0.727 | 0.727 | 0.0 | 5 | Y | `crates/c01_ownership_borrow_scope/docs/07_role_based_navigation.md`(15) | `crates/c01_ownership_borrow_scope/docs/15_visualization_index.md`(15) |
| 0.727 | 0.727 | 0.0 | 5 | Y | `crates/c01_ownership_borrow_scope/docs/15_visualization_index.md`(15) | `crates/c01_ownership_borrow_scope/docs/tier_01_foundations/03_glossary.md`(22) |
| 0.727 | 0.727 | 0.25 | 5 | Y | `crates/c06_async/docs/tier_01_foundations/05_glommio_quick_start.md`(25) | `crates/c06_async/docs/tier_03_references/01_async_language_features_reference.md`(26) |
| 0.719 | 0.719 | 0.333 | 9 | Y | `docs/05_practice/04_project_03_calculator.md`(116) | `docs/05_practice/05_project_04_password_generator.md`(115) |
| 0.719 | 0.719 | 0.333 | 9 | Y | `docs/05_practice/04_project_03_calculator.md`(116) | `docs/05_practice/07_project_06_concurrent_downloader.md`(136) |
| 0.719 | 0.719 | 0.333 | 9 | Y | `docs/05_practice/08_project_07_chat_server.md`(115) | `docs/05_practice/09_project_08_cache_system.md`(121) |
| 0.719 | 0.719 | 0.333 | 9 | Y | `docs/05_practice/08_project_07_chat_server.md`(115) | `docs/05_practice/10_project_09_log_parser.md`(116) |
| 0.719 | 0.719 | 0.333 | 9 | Y | `docs/05_practice/08_project_07_chat_server.md`(115) | `docs/05_practice/11_project_10_data_pipeline.md`(120) |
| 0.719 | 0.719 | 0.2 | 9 | Y | `docs/05_practice/09_project_08_cache_system.md`(121) | `docs/05_practice/12_project_11_web_server.md`(113) |
| 0.719 | 0.719 | 0.333 | 9 | Y | `docs/05_practice/09_project_08_cache_system.md`(121) | `docs/05_practice/15_project_14_async_runtime.md`(118) |
| 0.719 | 0.719 | 0.25 | 9 | Y | `docs/05_practice/09_project_08_cache_system.md`(121) | `docs/05_practice/16_project_15_distributed_system.md`(115) |
| 0.719 | 0.719 | 0.2 | 9 | Y | `docs/05_practice/10_project_09_log_parser.md`(116) | `docs/05_practice/12_project_11_web_server.md`(113) |

## 机器可读

- JSON: `reports/CONTENT_OVERLAP_V2_2026-08-04.json`
