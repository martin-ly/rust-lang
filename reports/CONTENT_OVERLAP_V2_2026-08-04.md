...
**纳入索引**: 1714（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 766172
**阈值**: 0.5  **命中对**: 616（同目录 616 / 跨目录 0）
...
|:---:|:---:|:---:|:---:|:---:|:---|:---|
| 1.0 | 0.348 | 1.0 | 64 | Y | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(277) | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(358) |
