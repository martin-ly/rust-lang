...
**日期**: 2026-07-31  **扫描**: 1993 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1576（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 655507
**阈值**: 0.5  **命中对**: 518（同目录 518 / 跨目录 0）
...
| 1.0 | 0.745 | 1.0 | 28 | Y | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(260) | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(191) |
