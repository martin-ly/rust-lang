...
**日期**: 2026-07-31  **扫描**: 1986 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1569（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 650622
**阈值**: 0.5  **命中对**: 475（同目录 475 / 跨目录 0）
...
|:---:|:---:|:---:|:---:|:---:|:---|:---|
| 1.0 | 0.302 | 1.0 | 66 | Y | `concept/07_future/00_version_tracking/feature_domain_matrix_197.md`(305) | `concept/07_future/00_version_tracking/feature_domain_matrix_198.md`(219) |
| 1.0 | 0.745 | 1.0 | 61 | Y | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(260) | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(191) |
...
| 0.846 | 0.846 | 0.5 | 5 | Y | `crates/c08_algorithms/docs/tier_01_foundations/01_project_overview.md`(22) | `crates/c08_algorithms/docs/tier_01_foundations/02_navigation.md`(22) |
