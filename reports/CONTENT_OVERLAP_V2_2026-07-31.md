...
**日期**: 2026-07-31  **扫描**: 1983 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1566（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 646791
**阈值**: 0.5  **命中对**: 474（同目录 474 / 跨目录 0）
...
|:---:|:---:|:---:|:---:|:---:|:---|:---|
| 1.0 | 0.745 | 1.0 | 48 | Y | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(260) | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(191) |
| 1.0 | 0.745 | 1.0 | 16 | Y | `concept/07_future/00_version_tracking/rust_1_99_preview.md`(191) | `concept/07_future/00_version_tracking/rust_1_100_preview.md`(260) |
...
| 0.75 | 0.75 | 0.0 | 11 | Y | `docs/12_research_notes/08_software_design_theory/07_distributed/README.md`(135) | `docs/12_research_notes/08_software_design_theory/02_workflow/README.md`(120) |
...
| 0.733 | 0.733 | 0.333 | 8 | Y | `docs/05_practice/06_project_05_text_statistics.md`(108) | `docs/05_practice/04_project_03_calculator.md`(116) |
