...
**来源**: `reports/CONTENT_OVERLAP_V2_2026-07-12.json`  **总对数**: 575

| 分类 | 数量 | 处置 |
|---|:---:|:---|
| MERGE | 5 | 应合并近克隆（留一删余或 stub 化） |
| DOCS_INTERNAL | 49 | docs/ 内同主题互抄（合并或互链） |
| SERIES | 20 | 保留但标注为版本系列/分章（白名单） |
| REVIEW | 501 | 人工复核 |
...
| 0.902 | `concept/04_formal/04_model_checking/24_autoverus.md` | `concept/07_future/03_preview_features/33_autoverus_preview.md` |
...
| 0.521 | `concept/07_future/00_version_tracking/rust_1_95_stabilized.md` | `docs/02_reference/quick_reference/02_rust_195_features_cheatsheet.md` |
| 0.521 | `docs/02_reference/quick_reference/02_rust_195_features_cheatsheet.md` | `concept/07_future/00_version_tracking/rust_1_95_stabilized.md` |
