...
**来源**: `reports/CONTENT_OVERLAP_V2_2026-07-12.json`  **总对数**: 588

| 分类 | 数量 | 处置 |
|---|:---:|:---|
| MERGE | 0 | 应合并近克隆（留一删余或 stub 化） |
| DOCS_INTERNAL | 0 | docs/ 内同主题互抄（合并或互链） |
| SERIES | 128 | 保留但标注为版本系列/分章（白名单） |
| REVIEWED | 460 | 已批量复核确认非重复（stub/模板系列/同领域术语共现，白名单） |
| REVIEW | 0 | 人工复核 |
...
| 0.818 | `crates/c01_ownership_borrow_scope/docs/rust_194_updates/README.md` | `crates/c03_control_fn/docs/rust_194_updates/README.md` |
| 0.818 | `crates/c01_ownership_borrow_scope/docs/rust_194_updates/README.md` | `crates/c06_async/docs/rust_194_updates/README.md` |
| 0.818 | `crates/c01_ownership_borrow_scope/docs/rust_194_updates/README.md` | `crates/c07_process/docs/rust_194_updates/README.md` |
...
| 0.818 | `crates/c04_generic/docs/rust_194_updates/README.md` | `crates/c07_process/docs/rust_194_updates/README.md` |
| 0.818 | `crates/c04_generic/docs/rust_194_updates/README.md` | `crates/c08_algorithms/docs/rust_194_updates/README.md` |
| 0.818 | `crates/c05_threads/docs/rust_194_updates/README.md` | `crates/c06_async/docs/rust_194_updates/README.md` |
| 0.818 | `crates/c05_threads/docs/rust_194_updates/README.md` | `crates/c07_process/docs/rust_194_updates/README.md` |
...
| 0.818 | `crates/c06_async/docs/rust_194_updates/README.md` | `crates/c07_process/docs/rust_194_updates/README.md` |
