...
**日期**: 2026-07-30  **总关系数**: 9272  **核心 50 实体关系数**: 2603  **核心实体数**: 50
...
| 谓词 | 计数 | 占比（核心） |
|:---|---:|---:|
| `ex:dependsOn` | 1027 | 39.45% |
| `ex:hasPart` | 621 | 23.86% |
| `ex:entails` | 387 | 14.87% |
| `ex:relatedTo` | 288 | 11.06% |
| `ex:refines` | 140 | 5.38% |
| `ex:partOf` | 109 | 4.19% |
...
- JSON: `reports/KG_RELATION_PRECISION_2026-07-30.json`
