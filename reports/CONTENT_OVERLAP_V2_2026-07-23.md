...
**日期**: 2026-07-23  **扫描**: 1841 文件（concept/knowledge/docs/content/crates，排除 archive/book/target）
**纳入索引**: 1429（已剔除真 stub/空关键词）  **候选对(共享>=5词)**: 559427
**阈值**: 0.5  **命中对**: 515（同目录 515 / 跨目录 0）
...
- JSON: `reports/CONTENT_OVERLAP_V2_2026-07-23.json`
