...
| 维度 | 权重 | 得分 | 关键证据 |
|---|:---:|:---:|:---|
| 元数据一致性 | 30% | 99.8 | flagged 1/520（D1互斥/D2脱节/D3重声明/D4版本/D5 nightly/D6套话） |
| 拓扑实质度 | 25% | 98.4 | 定义套话率 0.0 / 关系塌缩 0.749 / 跳出 0.032 / 死端 0 / 判定定量 1.0 |
| 去重健康 | 20% | 100.0 | 重叠命中 564，可处理（MERGE+DOCS_INTERNAL） 0 |
...
**总分**: 99.5 = 0.30×99.8 + 0.25×98.4 + 0.20×100.0 + 0.25×100.0
