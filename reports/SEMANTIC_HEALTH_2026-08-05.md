...
**日期**: 2026-08-05  **语义健康总分**: **99.1 / 100**  **等级**: **OK** (OK≥85 / WARN≥60 / FAIL<60)

> 与 `kb_quality_dashboard.md`（数量型：⟹/mermaid/代码块计数）互补；本仪表盘衡量语义质量（一致性/闭环/交叉/唯一/KG 完整）。

| 维度 | 权重 | 得分 | 关键证据 |
|---|:---:|:---:|:---|
| 元数据一致性 | 30% | 97.0 | flagged 25/823（D1互斥/D2脱节/D3重声明/D4版本/D5 nightly/D6套话） |
...
**总分**: 99.1 = 0.30×97.0 + 0.25×100.0 + 0.20×100.0 + 0.25×100.0
...
- JSON: `reports/SEMANTIC_HEALTH_2026-08-05.json`
