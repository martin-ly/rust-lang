...
# 只推需要<=15个来源的文件
below_30.sort(key=lambda x: int(0.30 * x[3]) + 1 - x[2])
target = [(p, int(0.30 * d) + 1 - a) for p, r, a, d in below_30 if int(0.30 * d) + 1 - a <= 15]
print(f"Files to push to 30% (need <=15 sources): {len(target)}")
