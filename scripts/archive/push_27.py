...
below_25.sort(key=lambda x: int(0.27 * x[3]) + 1 - x[2])
target = [(p, int(0.27 * d) + 1 - a) for p, r, a, d in below_25 if int(0.27 * d) + 1 - a <= 25]
print(f"Files to push to 27% (need <=25 sources): {len(target)}")
