...
>
> **来源**: [TRPL — Foreword](https://doc.rust-lang.org/book/foreword.html) · [Rust Reference](https://doc.rust-lang.org/reference/) · [Brown University — Concepts in Rust Programming](https://cel.cs.brown.edu/crp/) · [Oxide: The Essence of Rust](https://arxiv.org/abs/1903.00982)
> **前置概念**: N/A
---
...
|:---|:---|:---|
| **Move 语义** | 非 `Copy` 类型按所有权转移 | use-after-free、双重释放 |
