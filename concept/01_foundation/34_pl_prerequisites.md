...
>
> **来源**: [TRPL — Foreword](https://doc.rust-lang.org/book/foreword.html) · [Rust Reference](https://doc.rust-lang.org/reference/) · [Brown University — Concepts in Rust Programming](https://cel.cs.brown.edu/crp/) · [Oxide: The Essence of Rust](https://arxiv.org/abs/1903.00982) · [Itanium C++ ABI](https://itanium-cxx-abi.github.io/cxx-abi/abi.html)
> **前置概念**: N/A
---
...
> **下一步**: 如果你已理解以上概念，请继续阅读 [所有权（Ownership）系统](01_ownership.md)。如果你在阅读所有权时感到困惑，返回本文对应章节寻找根源解释。
...
> **推荐阅读顺序**: 完成本节 → [所有权](01_ownership.md) → [类型系统（Type System）](04_type_system.md)
>
