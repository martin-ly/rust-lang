...
> **[TRPL: Ch4.1]** Ownership is a set of rules that govern how a Rust program manages memory.
...
> **[RustBelt: POPL 2018]** Rust's ownership system can be understood as an **affine type system** in which each resource is owned by exactly one pointer at any given time.
...
| **论断** | **来源** | **可信度** |
|:---|:---|:---|
| 所有权是 Rust 最核心的特性 | [TRPL 3rd Ed: Ch4.1] · [Brown Book: Ch4] | ✅ |
