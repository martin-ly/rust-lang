...
> **Summary**: Rust 语法中运算符与各类符号的速查参考，包括可重载运算符对应的 trait、路径/泛型/trait bound/宏/注释/括号等上下文中的符号含义。
>
> **受众**: [初学者] / [中级]
> **Bloom 层级**: 记忆 → 理解
