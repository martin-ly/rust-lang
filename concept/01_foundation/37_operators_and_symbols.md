...
> **Summary**: Rust 语法中运算符与各类符号的速查参考，包括可重载运算符对应的 trait、路径/泛型/trait bound/宏/注释/括号等上下文中的符号含义。 Quick reference of Rust operators and symbols, including overloadable traits and meanings in paths, generics, trait bounds, macros, comments, and brackets.
>
> **受众**: [初学者] / [中级]
> **Bloom 层级**: 记忆 → 理解
...
| `expr[..]` / `expr[a..]` / `expr[..b]` / `expr[a..b]` | 使用 range 类型的切片索引 |
...
| [Traits](../01_foundation/04_type_system.md) | 多数运算符通过 trait 重载 |
| [Generics](../02_intermediate/02_generics.md) | `<>`、`:`、`where` 用于泛型约束 |
