...
> **后置概念**: [Smart Pointers](../../02_intermediate/02_memory_management/12_smart_pointers.md) · [Performance](../../06_ecosystem/15_performance_optimization.md)
...
- [Smart Pointers](../../02_intermediate/02_memory_management/12_smart_pointers.md) — 智能指针（Smart Pointer）与容器适配
