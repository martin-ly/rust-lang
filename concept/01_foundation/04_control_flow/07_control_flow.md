...
> **后置概念**: [Generics](../../02_intermediate/01_generics/02_generics.md) · [Async](../../03_advanced/02_async.md)
...
> **关联章节**: [Error Handling Basics](../08_error_handling/32_error_handling_basics.md) · [Async Control Flow](../../03_advanced/02_async.md)
...
> **关联章节**: [Async](../../03_advanced/02_async.md) · [Closures](../00_start/15_closure_basics.md) · [Error Handling](../08_error_handling/32_error_handling_basics.md)
...
> **关联章节**: [Borrowing](../01_ownership_borrow_lifetime/02_borrowing.md) · [Lifetimes](../01_ownership_borrow_lifetime/03_lifetimes.md) · [Formal Type Theory](../../04_formal/02_type_theory.md)
...
> **关联章节**: [Error Handling Basics](../08_error_handling/32_error_handling_basics.md) · [Async Control Flow](../../03_advanced/02_async.md) · [Panic and Abort](../08_error_handling/13_panic_and_abort.md)
