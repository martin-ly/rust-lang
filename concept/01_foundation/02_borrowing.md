...
| **Pin 与自引用** | [`../03_advanced/04_pin_unpin.md`](../03_advanced/04_pin_unpin.md) | 自引用结构的借用检查器边界 |
| **Unsafe Rust** | [`../03_advanced/02_unsafe_rust.md`](../03_advanced/02_unsafe_rust.md) | `UnsafeCell`、裸指针突破借用规则 |
| **C++ 对比** | [`../05_comparative/cpp_comparison.md`](../05_comparative/cpp_comparison.md) | `const T&`/`T&` vs `&T`/`&mut T` |
