...
> **[来源: Rust Reference: NLL]** T4 — 非词法生命周期基于控制流图的精确存活期分析 ([RFC 2094](https://rust-lang.github.io/rfcs//2094-nll.html))。 ✅
...
> **[来源: Rust Reference: NLL]** "NLL: 实际使用期有效" — 非词法生命周期基于数据流分析 ([RFC 2094](https://rust-lang.github.io/rfcs//2094-nll.html))。 ✅
