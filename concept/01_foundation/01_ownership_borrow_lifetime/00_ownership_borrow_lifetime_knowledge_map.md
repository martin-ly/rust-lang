...
「核心层知识图谱」部分按所有权系统、借用系统与生命周期系统的顺序逐层展开。
...
「概念关系矩阵」部分包含核心概念相互依赖 与 特性影响矩阵 两条主线，本节依次说明。
...
本节围绕「学习路径」展开，依次讨论初学者路径（0–3 个月）、进阶路径（3–12 个月）与专家路径（1 年+）。
...
本节从认知路径、定理链、反向推理与反命题切入，剖析「认知路径与推理骨架」的核心内容。
