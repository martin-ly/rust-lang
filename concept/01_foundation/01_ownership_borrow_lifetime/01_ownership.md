...
> **[Ralf Jung, "The Meaning of Memory Safety", PLArch 2021](https://plv.mpi-sws.org/semantics-of-memory-safety/)** 内存安全的精确定义：程序不会出现「指向已释放内存的指针被解引用（Reference）」或「对同一内存的非原子并发写」。 ✅
