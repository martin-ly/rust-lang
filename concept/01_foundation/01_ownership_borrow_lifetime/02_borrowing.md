...
> **相关链接**：完整借用分析见 §8.4；字符串与文本权威页见 [09_strings_and_text.md](../../06_strings_and_text/09_strings_and_text.md)。
...
> **相关链接**：完整交互分析见 §8.2；类型系统中的 trait 机制见 [04_type_system.md](../../02_type_system/04_type_system.md)。
...
> **相关链接**：完整语义差异见 §8.3； coercion 与类型转换见 [14_coercion_and_casting.md](../../02_type_system/14_coercion_and_casting.md)。
...
> **相关链接**：完整模式分析见 §8.1；字符串处理见 [09_strings_and_text.md](../../06_strings_and_text/09_strings_and_text.md)。
...
> **相关链接**：运行时 panic 边界见 [13_panic_and_abort.md](../../08_error_handling/13_panic_and_abort.md)；`Send`/`Sync` 与内部可变性见 [01_ownership.md](../01_ownership.md) §11.5。
...
> **相关链接**：与 match guards 的穷尽性差异见 [04_type_system.md](../../02_type_system/04_type_system.md)；HM 类型推断背景见 [04_type_system.md](../../02_type_system/04_type_system.md) §12.4。
