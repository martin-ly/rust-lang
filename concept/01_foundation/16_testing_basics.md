...
# 测试基础：从单元测试到集成测试
> **EN**: Testing
> **Summary**: - [测试基础：从单元测试到集成测试](#测试基础从单元测试到集成测试) - [📑 目录](#-目录) - [一、核心概念](#一核心概念) - [1.1 Rust 测试文化](#11-rust-测试文化) - [1.2 测试types全景](#12-测试types全景) - [1.3 测试的组织](#13-测试的组织) - [二、技术细节](#二技术细节) - [2.1 单元测试](#21-单元测试) - [2.2 集成测试](#22-集成测试) - [2.3 文档测试](#23-文档测试) - [三、测试模式矩阵](#三测试模式矩阵) - [四、反命题与边界分析](#四反命题与边界分析) - [4.1
