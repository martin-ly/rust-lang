...
- [Advanced Generics](../02_intermediate/02_generics.md) — 泛型（Generics）与生命周期参数共同构成参数化多态
...
**跨层映射**: 本章节 APIT/RPIT 语义 ↔ [`./04_type_system.md`](04_type_system.md) §11 "类型系统（Type System）前沿" · [`../02_intermediate/02_generics.md`](../02_intermediate/02_generics.md) §4.1 "泛型参数推断"
...
> **交叉链接**: [L1 类型系统（Type System）: ADT 与 Union 对比](04_type_system.md) · [L3 unsafe: union 字段访问](../03_advanced/03_unsafe.md) · [L3 unsafe: ManuallyDrop](../03_advanced/03_unsafe.md)
