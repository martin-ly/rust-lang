...
> **前置概念**: [Ownership](./01_ownership.md) · [Borrowing](./02_borrowing.md) · [Lifetime](./03_lifetime.md)
> **后置概念**: [Unsafe Rust](../03_advanced/01_unsafe_rust.md) · [Formal Methods](../04_formal/01_linear_logic.md)
...
> [PLDI 2025 — Tree Borrows](https://plv.mpi-sws.org/rustbelt/ghostcell/) ·
...
> **Bloom 层级**: 分析 → 应用
> [来源: [PLDI 2025 — Ralf Jung et al., "Tree Borrows"](https://plv.mpi-sws.org/rustbelt/ghostcell/)]（一级来源，学术论文）
...
> [来源: [PLDI 2025 — Tree Borrows](https://plv.mpi-sws.org/rustbelt/ghostcell/)]（一级来源）
...
> **与类型系统的关联**: 详见 [`04_type_system.md` §11.7](../01_foundation/04_type_system.md) 对名义类型与结构类型的完整分析——其中 §11.7.10 专门论证了引用构造的结构本质与目标类型名义约束的交互关系。
...
| [PLDI 2025 — Tree Borrows](https://plv.mpi-sws.org/rustbelt/ghostcell/) | ✅ 一级 | 树形借用模型学术论文 |
