...
> **跨层回溯**: [智能指针（Smart Pointer）](../02_intermediate/02_memory_management/12_smart_pointers.md) · [内部可变性](../02_intermediate/02_memory_management/08_interior_mutability.md)
