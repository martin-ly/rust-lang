...
> **前置依赖**: [FFI Advanced](09_ffi_advanced.md) · [Attributes and Macros](../01_foundation/09_macros_basics/12_attributes_and_macros.md) · [Smart Pointers](../02_intermediate/02_memory_management/12_smart_pointers.md) · [Terminology Glossary](../00_meta/terminology_glossary.md)
> **后置概念**: [Unsafe Rust](03_unsafe.md) · [Preludes](../01_foundation/07_modules_and_items/35_preludes.md) · [Rust vs C++](../05_comparative/01_rust_vs_cpp.md)
