...
> **Summary**: - [Rust FFI：与外部代码的安全边界](#rust-ffi与外部代码的安全边界) - [📑 目录](#-目录) - [一、核心概念](#一核心概念) - [1.1 FFI 的基本模型](#11-ffi-的基本模型) - [1.2 ABI 与调用约定](#12-abi-与调用约定) - [1.3 types映射与布局兼容](#13-types映射与布局兼容) - [二、技术细节](#二技术细节) - [2.1 extern 块的完整语法](#21-extern-块的完整语法) - [2.2 不透明types与封装](#22-不透明types与封装) - [2.3 回调与闭包传递](#23-回调与闭包传递) -
