...
| Trait 与泛型 | 能解释 `Send`/`Sync` 为何是 auto trait，并为泛型 Future 写出正确约束 | 回到 [L2 Traits](../02_intermediate/00_traits/01_traits.md) · [L2 泛型](../02_intermediate/01_generics/01_generics.md) |
| 内存管理 | 能说明 `Arc`/`Mutex` 与 `Pin` 的所有权语义 | 回到 [L2 内存管理](../02_intermediate/02_memory_management/01_memory_management.md) |
