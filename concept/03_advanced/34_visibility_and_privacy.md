...
> **双维定位**: S×App — 规范应用
> **前置依赖**: [Modules and Paths](../01_foundation/07_modules_and_items/11_modules_and_paths.md) · [Names, Scopes and Resolution](../04_formal/40_names_and_resolution.md)
> **后置概念**: [API Naming Conventions](../02_intermediate/05_modules_and_visibility/22_api_naming_conventions.md) · [Cargo SemVer Checks](../07_future/46_cargo_semver_checks_preview.md) · [Safety Boundaries](../05_comparative/04_safety_boundaries.md)
...
| 概念 | 关系 |
|:---|:---|
| [Modules and Paths](../01_foundation/07_modules_and_items/11_modules_and_paths.md) | 可见性基于模块层次结构 |
