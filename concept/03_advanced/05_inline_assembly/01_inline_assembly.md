...
- [内联汇编 (Inline Assembly)](#内联汇编-inline-assembly)
  ...
  - [一、核心概念](#一核心概念)
    ...
    - [1.5 Label 操作数](#15-label-操作数)
    - [1.6 模板修饰符（Template Modifiers）](#16-模板修饰符template-modifiers)
    - [1.7 `clobber_abi`：按调用约定声明寄存器破坏](#17-clobber_abi按调用约定声明寄存器破坏)
  - [二、平台差异矩阵](#二平台差异矩阵)
  ...
  - [四、安全边界与常见陷阱](#四安全边界与常见陷阱)
    ...
    - [4.3 `#[unsafe(naked)]` 与 `naked_asm!` 的规则](#43-unsafenaked-与-naked_asm-的规则)
  - [五、来源与延伸阅读](#五来源与延伸阅读)
  - [权威来源索引](#权威来源索引)
  - [嵌入式测验](#嵌入式测验)
