...
> **交叉链接**: 内存序模型见 [../02_intermediate/00_traits/01_traits.md](../02_intermediate/00_traits/01_traits.md) §5.4（`Atomic*` 与内存序）；unsafe 边界见 [../03_advanced/03_unsafe.md](03_unsafe.md) §2（`UnsafeCell` 与内部可变性）。
