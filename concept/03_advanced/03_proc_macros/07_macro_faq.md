...
本文档汇总了 Rust 宏（Macro）系统中的常见问题和解答。
...
「宏基础问题」部分按 Q1: 声明宏 vs. 过程宏，何时使用哪个？、Q2: 宏与函数的区别是什么？与Q3: 宏会影响性能吗？的顺序逐层展开。
...
本节将「声明宏问题」分解为若干主题： Q4: 如何调试声明宏？、Q5: 声明宏的卫生性如何工作？与Q6: 如何处理宏的多个分支？。
...
「过程宏问题」涉及 Q7: 如何开始写第一个过程宏？、Q8: syn 和 quote 是必须的吗？、Q9: 如何测试过程宏？与Q10: 过程宏可以读取文件吗？，本节逐一说明其要点。
...
本节围绕「工程实践问题」展开，依次讨论 Q11: 如何组织宏项目结构？、Q12: 宏的错误消息如何优化？与Q13: 如何发布宏库？。
...
本节围绕「故障排查问题」展开，依次讨论 Q14: "recursion limit reached" 错误如何…、Q15: "cannot find macro" 错误如何解决？与Q16: 为什么宏展开后有编译错误？。
...
理解「高级话题」需要把握 Q17: 如何构建 DSL？、Q18: 宏可以生成宏吗？与Q19: 如何实现零成本抽象？，本节依次展开。
...
> 下面程序运行时（Runtime） `c` 最终为 2（副作用发生了两次）。
