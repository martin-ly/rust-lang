...
> **[Haskell GHC User Guide: Parallelism and Concurrency](https://downloads.haskell.org/ghc/latest/docs/users_guide/parallel.html)** Haskell 通过 `Par` monad 和 STM (`TVar`) 实现并发，纯函数隔离消除数据竞争，STM 有形式化语义基础。 ✅
