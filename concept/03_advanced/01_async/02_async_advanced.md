...
> **交叉链接**: `Stream` 的异步惰性求值与 1.3 形式化定义 中 Future 的惰性语义一致；`Sink` 的线性状态机与 [../04_formal/03_ownership_formal.md](../../04_formal/01_ownership_logic/02_ownership_formal.md) §5.2 的线性类型资源管理形成对偶。
