...
### 测验 1：《04_formal_09_operational_semantics_archived.md》是一份归档文件。归档文件在知识体系中有什么作用？（理解层）

**题目**: 《04_formal_09_operational_semantics_archived.md》是一份归档文件。归档文件在知识体系中有什么作用？
