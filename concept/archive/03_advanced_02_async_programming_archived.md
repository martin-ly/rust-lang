...
>
> ```text
> 异步（Async）编程安全 ⟸ Future 状态机变换
> ```

## 嵌入式测验（Embedded Quiz）

### 测验 1：《03_advanced_02_async_programming_archived.md》是一份归档文件。归档文件在知识体系中有什么作用？（理解层）

**题目**: 《03_advanced_02_async_programming_archived.md》是一份归档文件。归档文件在知识体系中有什么作用？
