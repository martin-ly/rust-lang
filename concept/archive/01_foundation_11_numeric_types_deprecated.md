...
- [Rust 数值类型与运算](#rust-数值类型与运算)
  ...
  - [嵌入式测验（Embedded Quiz）](#嵌入式测验embedded-quiz)
    - [测验 1：《Rust 数值类型与运算》是一份归档文件。归档文件在知识体系中有什么作用？（理解层）](#测验-1rust-数值类型与运算是一份归档文件归档文件在知识体系中有什么作用理解层)
...
### 测验 1：《Rust 数值类型与运算》是一份归档文件。归档文件在知识体系中有什么作用？（理解层）

**题目**: 《Rust 数值类型与运算》是一份归档文件。归档文件在知识体系中有什么作用？
