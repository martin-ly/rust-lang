...
>
> ```text
> 零成本安全 ⟸ 单态化（Monomorphization）语义保持
> ```

## 嵌入式测验（Embedded Quiz）

### 测验 1：《03_advanced_08_zero_cost_abstractions_archived.md》是一份归档文件。归档文件在知识体系中有什么作用？（理解层）

**题目**: 《03_advanced_08_zero_cost_abstractions_archived.md》是一份归档文件。归档文件在知识体系中有什么作用？
