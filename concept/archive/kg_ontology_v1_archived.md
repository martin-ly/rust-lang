...
- [Rust 知识体系知识图谱本体规范（Knowledge Graph Ontology）](#rust-知识体系知识图谱本体规范knowledge-graph-ontology)
  ...
  - [嵌入式测验（Embedded Quiz）](#嵌入式测验embedded-quiz)
    - [测验 1：本文档《Rust 知识体系知识图谱本体规范（Knowledge Graph Ontology）》在 Rust 知识体系中属于哪一层级的元数据？（理解层）](#测验-1本文档rust-知识体系知识图谱本体规范knowledge-graph-ontology在-rust-知识体系中属于哪一层级的元数据理解层)
    - [测验 2：《Rust 知识体系知识图谱本体规范（Knowledge Graph Ontology）》的主要用途是什么？（理解层）](#测验-2rust-知识体系知识图谱本体规范knowledge-graph-ontology的主要用途是什么理解层)
...
### 测验 1：本文档《Rust 知识体系知识图谱本体规范（Knowledge Graph Ontology）》在 Rust 知识体系中属于哪一层级的元数据？（理解层）

**题目**: 本文档《Rust 知识体系知识图谱本体规范（Knowledge Graph Ontology）》在 Rust 知识体系中属于哪一层级的元数据？
...
### 测验 2：《Rust 知识体系知识图谱本体规范（Knowledge Graph Ontology）》的主要用途是什么？（理解层）

**题目**: 《Rust 知识体系知识图谱本体规范（Knowledge Graph Ontology）》的主要用途是什么？
