...
- [L0 元信息层索引（Meta Layer Index）](00.md)
  - [概念一致性（Coherence）检查清单（Concept Consistency Audit Checklist）](LINK_PLACEHOLDER)
...
- [L1 基础概念](01_foundation/README.md)
  ...
  - [变量模型：从通用 PL 视角看 Rust 的所有权（Ownership）](LINK_PLACEHOLDER)
...
- [L2 进阶概念](02_intermediate/README.md)
  ...
  - [`assert_matches!`：模式匹配（Pattern Matching）断言的形式化语义](LINK_PLACEHOLDER)
  ...
  - [智能指针（Smart Pointer）：堆内存管理与共享语义](LINK_PLACEHOLDER)
  ...
  - [生命周期（Lifetimes）高级主题：从 HRTB 到自引用类型](LINK_PLACEHOLDER)
...
- [L3 高级概念](03_advanced/README.md)
  ...
  - [过程宏（Procedural Macro）：编译期代码生成的元编程工具](LINK_PLACEHOLDER)
  - [NLL 与 Polonius：借用（Borrowing）检查器的演进](LINK_PLACEHOLDER)
...
- [L4 形式化理论](04_formal/README.md)
  ...
  - [类型推断（Type Inference）：Hindley-Milner 算法与 Rust 的工业实现](LINK_PLACEHOLDER)
