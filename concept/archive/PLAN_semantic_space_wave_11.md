...
|:---|:---|:---|:---|:---|:---|
| 表征空间边界 | 编译器强制 | 程序员自律 | 类型系统（Type System） | GC 简化 | VM 抽象 |
...
- `03_advanced/02_unsafe/03_unsafe.md`：§X 标注 "此处为表征空间 §2 的逃逸舱口"
...
### 测验 1：《Wave 11 计划：Rust 表征空间与语义边界全面梳理》是一份归档文件。归档文件在知识体系中有什么作用？（理解层）

**题目**: 《Wave 11 计划：Rust 表征空间与语义边界全面梳理》是一份归档文件。归档文件在知识体系中有什么作用？
