...
> **Bloom 层级**: 理解
> **状态**: 已归档（内容已迁移至主文件）
> **归档声明**: 本文件内容已合并至 [`10_numerics.md`](../01_foundation/02_type_system/10_numerics.md)。
> 原文件保留用于历史追溯。请勿独立编辑本文件。
> **归档原因**: 与 `10_numerics.md` 内容高度重叠（>85%），且 `10` 版本结构更完整、边界测试覆盖更广。
> **状态**: 已归档（2026-05-30 重复文件清理）
> **本节关键术语**: 数值运算 (Numeric Operations) · 饱和运算 (Saturating) · 包装运算 (Wrapping) ·  checked 运算 · 类型提升 (Promotion) — [完整对照表](../00_meta/01_terminology/terminology_glossary.md)
>
