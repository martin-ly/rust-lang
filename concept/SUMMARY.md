...
- [L1 基础概念](01_foundation/README.md)
  ...
  - [副作用与纯度：从引用透明到 Rust 的所有权（Ownership）效果](01_foundation/21_effects_and_purity.md)
  ...
  - [测验：所有权、借用（Borrowing）与生命周期（Lifetimes）（试点）](01_foundation/33_quiz_ownership_borrowing.md)
...
- [L2 进阶概念](02_intermediate/README.md)
  ...
  - [生命周期（Lifetimes）高级主题：从 HRTB 到自引用类型](02_intermediate/18_lifetimes_advanced.md)
  ...
  - [异常安全：C++ 与 Rust 的错误处理哲学](02_intermediate/27_exception_safety_rust_cpp.md)
...
- [L4 形式化理论](04_formal/README.md)
  ...
  - [Borrow Checking Decidability（借用检查可判定性）](04_formal/28_borrow_checking_decidability.md)
