...
- [L1 基础概念](01_foundation/README.md)
  - [编程语言理论基础（PL Prerequisites）](01_foundation/34_pl_prerequisites.md)
  ...
  - [Lifetimes 高级主题](01_foundation/30_lifetimes_advanced.md)
  - [Type System Basics（类型系统基础）](01_foundation/04_type_system.md)
  - [Never Type (`!`)：底类型与穷尽性](01_foundation/31_never_type.md)
  - [引用（Reference）语义：自动解引用、Deref 强制与类型转换](01_foundation/05_reference_semantics.md)
  ...
  - [Rust 错误处理（Error Handling）基础](01_foundation/32_error_handling_basics.md)
  - [数值类型与运算：从整数到浮点的完整图景](01_foundation/10_numerics.md)
  - [模块（Module）系统与路径：Rust 的代码组织哲学](01_foundation/11_modules_and_paths.md)
  ...
  - [字符串与编码：Rust 的文本处理类型系统（Type System）](01_foundation/18_strings_and_encoding.md)
  - [值语义 vs 引用（Reference）语义：从 C++、Java、Python 到 Rust](01_foundation/19_value_vs_reference_semantics.md)
  - [变量模型：从通用 PL 视角看 Rust 的所有权（Ownership）](01_foundation/20_variable_model.md)
  ...
  - [Move 语义：C++ 与 Rust 的资源转移模型](01_foundation/23_move_semantics.md)
  - [测验：所有权（Ownership）、借用（Borrowing）与生命周期（Lifetimes）（试点）](01_foundation/33_quiz_ownership_borrowing.md)
  - [测验：类型系统（Type System）（试点扩展）](01_foundation/24_quiz_type_system.md)
  - [测验：错误处理（Error Handling）（试点扩展）](01_foundation/25_quiz_error_handling.md)
  - [测验：模块（Module）系统与测试（L1 试点扩展）](01_foundation/26_quiz_modules_testing.md)
  - [测验：闭包（Closures）与迭代器（L1 试点扩展）](01_foundation/27_quiz_closures_iterators.md)
...
- [L2 进阶概念](02_intermediate/README.md)
  ...
  - [`assert_matches!`：模式匹配（Pattern Matching）断言的形式化语义](02_intermediate/05_assert_matches.md)
  ...
  - [内部可变性：编译期规则的运行时（Runtime）逃逸](02_intermediate/08_interior_mutability.md)
  ...
  - [智能指针（Smart Pointer）：堆内存管理与共享语义](02_intermediate/12_smart_pointers.md)
  ...
  - [Rust 迭代器（Iterator）模式](02_intermediate/15_iterator_patterns.md)
  - [宏（Macro）模式：编译期代码生成的工程实践](02_intermediate/17_macro_patterns.md)
  ...
  - [测验：Trait 与泛型（Generics）（试点扩展）](02_intermediate/23_quiz_traits_and_generics.md)
  ...
  - [C 预处理器 vs Rust 宏（Macro）：从文本替换到语法树](02_intermediate/26_c_preprocessor_vs_rust_macros.md)
  - [异常安全：C++ 与 Rust 的错误处理（Error Handling）哲学](02_intermediate/27_exception_safety_rust_cpp.md)
  - [构造与初始化：C++ 的构造函数 vs Rust 的结构体（Struct）字面量](02_intermediate/28_construction_and_initialization.md)
  - [友元 vs 模块（Module）可见性：C++ 的 `friend` 与 Rust 的隐私边界](02_intermediate/29_friend_vs_module_privacy.md)
