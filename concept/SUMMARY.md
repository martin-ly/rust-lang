...
- [L0 元信息](00_meta/README.md)
  ...
  - [概念一致性（Coherence）检查清单（Concept Consistency Audit Checklist）](LINK_PLACEHOLDER_1)
...
- [L1 基础概念](01_foundation/README.md)
  ...
  - [引用（Reference）语义：自动解引用、Deref 强制与类型转换](LINK_PLACEHOLDER_2)
  - [零成本抽象（Zero-Cost Abstraction）：Rust 的性能哲学](LINK_PLACEHOLDER_3)
  ...
  - [字符串与编码：Rust 的文本处理类型系统（Type System）](LINK_PLACEHOLDER_8)
  - [变量模型：从通用 PL 视角看 Rust 的所有权（Ownership）](LINK_PLACEHOLDER_9)
  ...
  - [测验：所有权、借用（Borrowing）与生命周期（Lifetimes）（试点）](LINK_PLACEHOLDER_10)
...
- [L2 进阶概念](02_intermediate/README.md)
  ...
  - [`assert_matches!`：模式匹配（Pattern Matching）断言的形式化语义](LINK_PLACEHOLDER_11)
  ...
  - [内部可变性：编译期规则的运行时（Runtime）逃逸](LINK_PLACEHOLDER_12)
  ...
  - [智能指针（Smart Pointer）：堆内存管理与共享语义](LINK_PLACEHOLDER_13)
  ...
  - [Rust 迭代器（Iterator）模式](LINK_PLACEHOLDER_14)
  - [迭代器模式：Rust 的惰性计算与零成本抽象](02_intermediate/16_iterator_patterns.md)
  - [宏（Macro）模式：编译期代码生成的工程实践](LINK_PLACEHOLDER_15)
  ...
  - [测验：Trait 与泛型（Generics）（试点扩展）](LINK_PLACEHOLDER_16)
...
- [L3 高级概念](03_advanced/README.md)
  ...
  - [异步（Async）模式：从 Future 到生产级并发](LINK_PLACEHOLDER_17)
  ...
  - [过程宏（Procedural Macro）：编译期代码生成的元编程工具](LINK_PLACEHOLDER_18)
  ...
  - [原子操作（Atomic Operations）与内存序：无锁并发的精确控制](LINK_PLACEHOLDER_19)
...
- [L4 形式化理论](04_formal/README.md)
  ...
  - [类型推断（Type Inference）：Hindley-Milner 算法与 Rust 的工业实现](LINK_PLACEHOLDER_20)
...
- [L7 前沿趋势](07_future/README.md)
  ...
  - [Rust for Linux ：操作系统内核中的内存安全（Memory Safety）](LINK_PLACEHOLDER_21)
  ...
  - [Open Enums 概念预研：从 `#[non_exhaustive]` 到可扩展枚举（Enum）](LINK_PLACEHOLDER_22)
