...
- v1.1 (2026-05-26): 权威内容对齐：补充 Hayroll (PLDI 2026) — C 宏与条件编译的模块化翻译，符号执行驱动配置覆盖，翻译器无关设计 [来源: Web Authority Alignment Batch 14]
...
| **宏翻译层** | 分类宏、标注宏展开节点、重建 Rust 宏/函数 | 通过源码标注与翻译器输出交互，无需侵入式修改 |
