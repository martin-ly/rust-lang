...
> **后置概念**: [Application Domains](../06_data_and_distributed/04_application_domains.md) · [Toolchain](../00_toolchain/01_toolchain.md)
...
- [L6: Core Crates（核心库谱系）](../02_core_crates/03_core_crates.md) —— 传统功能域分类视角
- [L6: Application Domains](../06_data_and_distributed/04_application_domains.md) —— 工程落地场景
