> **内容分级**: [综述级]
> **本节关键术语**: rustc_driver · rustc_interface · `run_compiler` · Callbacks · `rustc_private` · Stable MIR · `rustc_public` · Compiler Session — [完整对照表](../../00_meta/01_terminology/01_terminology_glossary.md)
>
...
> **后置概念**: [Compiler Infrastructure](05_compiler_infrastructure.md) · [Compiler Diagnostics and UI Tests](11_compiler_diagnostics_and_ui_tests.md)（待补）
...
>
> [Rustc Dev Guide — rustc_driver and rustc_interface](https://rustc-dev-guide.rust-lang.org/)(<https://rustc-dev-guide.rust-lang.org/rustc-driver/intro.html>)
...
>
> [Rustc Dev Guide — rustc_interface](https://rustc-dev-guide.rust-lang.org/)(<https://rustc-dev-guide.rust-lang.org/rustc-driver/intro.html#rustc_interface>)
