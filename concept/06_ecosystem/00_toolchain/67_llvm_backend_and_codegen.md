> **内容分级**: [综述级]
> **本节关键术语**: LLVM · Codegen · LLVM IR · Codegen Unit · Monomorphization · Target Spec · LTO · `rustc_codegen_llvm` · `rustc_codegen_ssa` — [完整对照表](../../00_meta/01_terminology/terminology_glossary.md)
>
...
> [Rustc Dev Guide — What is LLVM?](https://web.archive.org/web/*/https://rustc-dev-guide.rust-lang.org/backend/backend.html)(<https://rustc-dev-guide.rust-lang.org/backend/codegen.html#what-is-llvm>)
...
>
> [Rustc Dev Guide — Code generation — Codegen units](https://web.archive.org/web/*/https://rustc-dev-guide.rust-lang.org/backend/mono.html)(<https://rustc-dev-guide.rust-lang.org/backend/codegen.html#what-is-llvm>)
...
> [Rustc Dev Guide — Code generation — LTO](https://web.archive.org/web/*/https://rustc-dev-guide.rust-lang.org/backend/mono.html)(<https://rustc-dev-guide.rust-lang.org/backend/codegen.html#what-is-llvm>)
