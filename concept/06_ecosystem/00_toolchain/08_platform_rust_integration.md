...
> **前置概念**: [Cross Compilation](../05_systems_and_embedded/02_cross_compilation.md) · [Embedded Systems](../05_systems_and_embedded/03_embedded_systems.md) · [Unsafe Rust](../../03_advanced/02_unsafe/01_unsafe.md) · [FFI](../../03_advanced/04_ffi/01_rust_ffi.md) · [安全边界](../../05_comparative/03_domain_comparisons/01_safety_boundaries.md)
> **后置概念**: [Industrial Case Studies](../11_domain_applications/14_industrial_case_studies.md) · [OS Kernel](../05_systems_and_embedded/05_os_kernel.md)
>
