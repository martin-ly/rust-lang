...
> **后置概念**: [Cloud Native](../04_web_and_networking/24_cloud_native.md) · [Security Practices](../07_security_and_cryptography/19_security_practices.md)
...
- [Cloud Native](../04_web_and_networking/24_cloud_native.md) — 云原生部署
- [Security Practices](../07_security_and_cryptography/19_security_practices.md) — 安全开发实践
- [Testing Strategies](../09_testing_and_quality/12_testing_strategies.md) — 测试策略
