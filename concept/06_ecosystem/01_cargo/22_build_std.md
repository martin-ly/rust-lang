...
> **前置概念**: [Rust 嵌入式系统开发](../05_systems_and_embedded/03_embedded_systems.md) · [Cargo 配置与环境变量](18_cargo_configuration.md) · [所有权（Ownership）系统](../../01_foundation/01_ownership_borrow_lifetime/01_ownership.md)
> **后置概念**: [交叉编译](../05_systems_and_embedded/02_cross_compilation.md) · [unsafe Rust](../../03_advanced/02_unsafe/01_unsafe.md)
...
- [交叉编译](../05_systems_and_embedded/02_cross_compilation.md)
- [Cargo 配置与环境变量](18_cargo_configuration.md)
- [所有权（Ownership）系统](../../01_foundation/01_ownership_borrow_lifetime/01_ownership.md)
- [泛型（Generics）与 Trait Bounds](../../02_intermediate/01_generics/01_generics.md)
