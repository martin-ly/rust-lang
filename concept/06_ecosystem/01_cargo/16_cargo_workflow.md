...
> **内容分级**: [综述级]
> **本节关键术语**: Package Layout · `Cargo.toml` · `Cargo.lock` · Workspace · Target Directory — [完整对照表](../../00_meta/01_terminology/01_terminology_glossary.md)
>
> **EN**: Cargo Workflow
...
> **前置概念**: [Cargo Getting Started](15_cargo_getting_started.md) · [Modules and Paths](../../01_foundation/07_modules_and_items/01_modules_and_paths.md)
> **后置概念**: [Cargo Guide Practices](17_cargo_guide_practices.md) · [Cargo Workspaces](14_cargo_workspaces.md) · [Cargo Dependency Resolution](06_cargo_dependency_resolution.md)
...
详见 [Cargo Workspaces](14_cargo_workspaces.md)。
...
工作流脚本中拆分修改逻辑时，容易让两个可变借用（Mutable Borrow）同时存活。
