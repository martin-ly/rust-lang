...
> **定位**: 补充 `10_cargo_manifest_reference.md` 未涉及的 target、rust-version、pkgid 等子主题。
> **前置概念**: [Cargo Manifest Reference](10_cargo_manifest_reference.md) · [Cargo Workflow](16_cargo_workflow.md)
> **后置概念**: [Cargo Commands Reference](19_cargo_commands_reference.md) · [Cargo Build Scripts](05_cargo_build_scripts.md)
...
详见 [Cargo Workspaces](14_cargo_workspaces.md) 与 [Cargo Build Scripts](05_cargo_build_scripts.md)。
