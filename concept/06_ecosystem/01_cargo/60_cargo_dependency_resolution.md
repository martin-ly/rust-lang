...
> **权威来源对齐变更日志**: 2026-06-23 更新，对齐 Rust 1.84.0+ / RFC 3537 / Cargo resolver v3 & MSRV-aware resolver；2026-06-26 新增第九章可运行实践 `examples/resolver_v3_practice/` [P2 Deep Content Sprint](../../00_meta/02_sources/international_authority_index.md)
