...
> **前置概念**: [Toolchain](../00_toolchain/01_toolchain.md) · [Rust Installation](../../00_meta/04_navigation/08_learning_mvp_path.md)
> **后置概念**: [Cargo Workflow](16_cargo_workflow.md) · [Cargo Dependency Resolution](06_cargo_dependency_resolution.md) · [Cargo Manifest Reference](10_cargo_manifest_reference.md)
...
| Workspace | 多 crate | 见 [Cargo Workspaces](14_cargo_workspaces.md) | 大型项目、monorepo |
...
首次构建后 Cargo 会生成 `Cargo.lock`，记录解析出的精确版本。对于二进制项目，应将 `Cargo.lock` 提交到版本控制；对于纯库项目，通常不提交。详见 [Cargo Workflow](16_cargo_workflow.md)。
...
- Cargo Script 详情见 [Cargo Script](01_cargo_script.md)。
- 多 crate 管理见 [Cargo Workspaces](14_cargo_workspaces.md)。
...
入门阶段最常见的编译错误：变量尚未声明就被引用（Reference）。
