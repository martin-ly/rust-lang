...
> **定理链**: 见“五、定理链”
> **前置概念**: [Cargo Workspaces](14_cargo_workspaces.md) · [Cargo Dependency Resolution](06_cargo_dependency_resolution.md)
...
- **feature unification 与 `public = true` 的最小可运行演示**：[`crates/c17_resolver_v3_public_demo`](../../../crates/c17_resolver_v3_public_demo/)，配套概念说明见 [Resolver v3 与 `public = true` 的 feature unification 演示](03_resolver_v3_public_feature_unification.md)。
