...
> **前置概念**: [Cargo Registries and Publishing](08_cargo_registries_and_publishing.md) · [Cargo Authentication and Cache](09_cargo_authentication_and_cache.md) · [Cargo Configuration](18_cargo_configuration.md)
> **后置概念**: [Cargo Commands Reference](19_cargo_commands_reference.md) · [Security Practices](../07_security_and_cryptography/01_security_practices.md)
...
registry 解析器等返回引用（Reference）的函数，若返回引用可能来自多个入参，必须显式标注生命周期（Lifetimes）。
