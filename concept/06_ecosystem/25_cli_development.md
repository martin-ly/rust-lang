...
> **Summary**: - [Rust CLI 开发生态](#rust-cli-开发生态) - [📑 目录](#-目录) - [一、核心概念](#一核心概念) - [1.1 CLI 设计原则](#11-cli-设计原则) - [1.2 参数解析](#12-参数解析) - [二、关键 crate](#二关键-crate) - [2.1 clap](#21-clap) - [2.2 交互与输出](#22-交互与输出) - [2.3 配置管理](#23-配置管理) - [三、打包与分发](#三打包与分发) - [3.1 单一二进制](#31-单一二进制) - [3.2 安装方式](#32-安装方式) - [3.3 Shel
>
> **受众**: [进阶]
