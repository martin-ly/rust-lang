...
- [API Design Patterns（API 设计模式）](#api-design-patternsapi-设计模式)
  ...
  - [一、权威定义（Definition）](#一权威定义definition)
    ...
    - [1.2 GraphQL：查询语言与运行时（Runtime）](LINK_PLACEHOLDER)
  ...
  - [五、GraphQL API 设计](#五graphql-api-设计)
    - [5.1 Schema 与类型系统（Type System）](LINK_PLACEHOLDER)
  ...
  - [嵌入式测验（Embedded Quiz）](#嵌入式测验embedded-quiz)
    ...
    - [测验 5：Rust API 的"零成本抽象（Zero-Cost Abstraction）"原则如何体现在集合 API 设计中？（理解层）](LINK_PLACEHOLDER)
  - [认知路径](#认知路径)
    - [核心推理链](#核心推理链)
    - [反命题与边界](#反命题与边界)
