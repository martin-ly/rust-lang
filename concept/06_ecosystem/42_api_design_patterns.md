...
> [错误处理](../01_foundation/10_error_handling_basics.md) ·
...
> GraphQL 是一种用于 API 的**查询语言**和**运行时**，由 Facebook（Meta）于 2015 年开源。
...
| **API 延迟预算** | P99 < 200ms | 网络物理限制 | CDN、缓存、异步处理 |
