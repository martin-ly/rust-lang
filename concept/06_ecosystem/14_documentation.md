...
> **EN**: Testing
> **Summary**: - [文档生态：rustdoc、文档测试与 API 文档规范](#文档生态rustdoc文档测试与-api-文档规范) - [📑 目录](#-目录) - [一、核心概念](#一核心概念) - [1.1 rustdoc：compiler集成的文档生成器](#11-rustdoccompiler集成的文档生成器) - [1.2 文档测试（Doc Tests）](#12-文档测试doc-tests) - [1.3 文档作为types系统的一部分](#13-文档作为types系统的一部分) - [二、技术细节](#二技术细节) - [2.1 文档注释语法](#21-文档注释语法) - [2.2 Intra-doc Links](#2
