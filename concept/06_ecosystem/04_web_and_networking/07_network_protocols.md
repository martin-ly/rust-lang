...
> **前置概念**: [Async/Await](../../03_advanced/01_async/01_async.md) · [Ownership](../../01_foundation/01_ownership_borrow_lifetime/01_ownership.md) · [Unsafe](../../03_advanced/02_unsafe/01_unsafe.md)
> **后置概念**: [Stream Processing Ecosystem](../06_data_and_distributed/03_stream_processing_ecosystem.md) · [Distributed Systems](01_distributed_systems.md)
>
...
> 本节选编自 `crates/c10_networks/docs/10_rust_190_modern_network_technologies_2025.md`，
...
> 本节选编自 `crates/c10_networks/docs/02_http3_quic_guide.md`，
> 作为 canonical 网络协议概念页的工程实践补充。
...
> 来源：`crates/c10_networks/docs/03_one_page_summary.md`
