...
> [Stream Processing Semantics](../../03_advanced/06_low_level_patterns/05_stream_processing_semantics.md) ·
> [事件驱动架构](../03_design_patterns/06_event_driven_architecture.md)
> **后置延伸**: [CQRS & Event Sourcing](../03_design_patterns/07_cqrs_event_sourcing.md) ·
> [流处理生态](../06_data_and_distributed/03_stream_processing_ecosystem.md)
>
...
- [事件驱动架构](../03_design_patterns/06_event_driven_architecture.md) — 发布-订阅、消息队列、Reactive Streams
- [CQRS & Event Sourcing](../03_design_patterns/07_cqrs_event_sourcing.md) — 事件流、投影处理器
- [流处理生态](../06_data_and_distributed/03_stream_processing_ecosystem.md) — timely/differential dataflow、Materialize
- [架构设计模式](../03_design_patterns/08_architecture_patterns.md) — 分层/六边形/洋葱/整洁架构
- [Stream Processing Semantics](../../03_advanced/06_low_level_patterns/05_stream_processing_semantics.md) — 流处理语义学
- [Async/Await](../../03_advanced/01_async/01_async.md) — 异步编程基础
- [并发编程](../../03_advanced/00_concurrency/01_concurrency.md) — Send/Sync、线程安全
- [范型矩阵](../../05_comparative/00_paradigms/01_paradigm_matrix.md) — 多语言范式对比
