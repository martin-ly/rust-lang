...
> [事件驱动架构](../03_design_patterns/32_event_driven_architecture.md)
> **后置延伸**: [CQRS & Event Sourcing](../03_design_patterns/33_cqrs_event_sourcing.md) ·
> [流处理生态](../06_data_and_distributed/36_stream_processing_ecosystem.md)
>
...
| **时间模型** | 离散异步（Async） | 连续 + 离散 | 离散传播 | 离散异步 |
...
- [流处理生态](../06_data_and_distributed/36_stream_processing_ecosystem.md) — timely/differential dataflow、Materialize
- [架构设计模式](../03_design_patterns/35_architecture_patterns.md) — 分层/六边形/洋葱/整洁架构
...
> **认知路径**: 从 Rust 核心语言特性出发，经由 **Reactive Programming & FRP（响应式编程与函数式响应编程）** 的生态/前沿实践，通向系统化工程能力与未来语言演进方向。
...
> **过渡**: 掌握 Reactive Programming & FRP（响应式编程与函数式响应编程） 的基础概念后，建议通过实际案例与源码阅读加深理解，建立从理论到实践的桥梁。
> **过渡**: 在工程实践中应用 Reactive Programming & FRP（响应式编程与函数式响应编程） 时，务必评估生态成熟度、社区支持与长期维护风险，避免过度依赖实验性技术。
> **过渡**: Reactive Programming & FRP（响应式编程与函数式响应编程） 反映了 Rust 生态系统的演进趋势与语言设计哲学，理解这些趋势有助于预判未来发展方向并做出前瞻性技术决策。

### 反命题与边界

> **反命题**: "Reactive Programming & FRP（响应式编程与函数式响应编程） 是万能解决方案，适用于所有场景" —— 错误。任何技术选择都有权衡，需根据具体需求、团队能力与项目约束综合评估。
