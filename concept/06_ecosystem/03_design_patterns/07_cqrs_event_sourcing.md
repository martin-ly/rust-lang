...
**Summary**: Design patterns for separating read and write models and reconstructing state from immutable events in Rust distributed systems.
...
> `concept/06_ecosystem/03_design_patterns/` 中不再保留完整正文，以避免双权威页冲突。
