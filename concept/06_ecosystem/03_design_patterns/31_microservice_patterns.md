...
> **后置概念**: [事件驱动架构](32_event_driven_architecture.md) · [云原生](../04_web_and_networking/24_cloud_native.md)
>
...
- [分布式系统](../04_web_and_networking/18_distributed_systems.md) — gRPC、Raft、Actor 模型
- [云原生](../04_web_and_networking/24_cloud_native.md) — 容器化、Kubernetes、可观测性
- [系统设计原则](05_system_design_principles.md) — 安全-性能-可维护性帕累托前沿
- [Async](../../03_advanced/01_async/02_async.md) — async/await、并发模型
