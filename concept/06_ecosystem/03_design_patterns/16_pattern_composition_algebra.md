...
> **前置概念**: [Patterns](01_patterns.md) · [Concurrency Patterns](../../03_advanced/00_concurrency/03_concurrency_patterns.md) · [Async Patterns](../../03_advanced/01_async/03_async_patterns.md) · [Type System](../../01_foundation/02_type_system/01_type_system.md) · [Paradigm Matrix](../../05_comparative/00_paradigms/01_paradigm_matrix.md)
> **后置概念**: [Distributed Systems](../04_web_and_networking/01_distributed_systems.md) · [System Design Principles](03_system_design_principles.md)
