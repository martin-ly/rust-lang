...
- [L5 Rust vs Go](../../05_comparative/01_systems_languages/02_rust_vs_go.md) —— 并发模型惯用法对比
- [L7 版本跟踪](../../07_future/00_version_tracking/05_rust_version_tracking.md) —— 1.95/1.96 新惯用法来源
