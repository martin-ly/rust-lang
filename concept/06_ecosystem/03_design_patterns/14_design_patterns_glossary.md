...
> **文档定位**: 设计模式核心术语快速参考
> **项目状态**: ✅ 活跃维护
> **相关文档**: [Design Patterns](01_patterns.md) · [Pattern Implementation Comparison](09_pattern_implementation_comparison.md) · [Pattern Selection Best Practices](10_pattern_selection_best_practices.md) · [Architecture Patterns](08_architecture_patterns.md) · [Engineering and Production Patterns](13_engineering_and_production_patterns.md) · [Frontier Research and Innovative Patterns](12_frontier_research_and_innovative_patterns.md) · [Algorithm Engineering Practice](../11_domain_applications/08_algorithm_engineering_practice.md)
...
|:---|:---|:---|:---|
| **创建型** | Singleton | `OnceLock` / `LazyLock` | [Design Patterns](01_patterns.md) |
| | Factory | `match` + enum / `dyn Trait` | [Design Patterns](01_patterns.md) |
| | Abstract Factory | trait 组合 + 注册表 | [Design Patterns](01_patterns.md) |
| | Builder | Typestate / 消费型链式调用 | [Pattern Implementation Comparison](09_pattern_implementation_comparison.md) |
| | Prototype | `Clone` trait | [Design Patterns](01_patterns.md) |
...
| | Memento | `Clone` + 序列化快照 | [Design Patterns](01_patterns.md) |
| | Interpreter | 递归下降 / enum AST | [Design Patterns](01_patterns.md) |
