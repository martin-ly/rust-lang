...
> **前置概念**: [Toolchain](../00_toolchain/01_toolchain.md) · [FFI](../../03_advanced/04_ffi/05_rust_ffi.md) · [Type System](../../01_foundation/02_type_system/04_type_system.md)
> **后置概念**: [WASI](../05_systems_and_embedded/08_wasi.md)
...
- [Application Domains](../06_data_and_distributed/04_application_domains.md) — 应用领域分析
