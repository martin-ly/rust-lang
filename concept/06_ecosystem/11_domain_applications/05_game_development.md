...
> **受众**: [进阶]
> **Bloom 层级**: L3-L4
> **权威来源**: 本文件为 `concept/` 权威页。Rust 游戏开发（Game Development）主题统一收敛于本页；原同目录 `06_game_development.md` 已于 2026-07-12 合并至本页并改为重定向 stub。
...
> [Performance](../10_performance/01_performance_optimization.md)
> **后置概念**: [WebAssembly](03_webassembly.md) ·
> [ECS](../06_data_and_distributed/01_application_domains.md)
>
...
- [WebAssembly](03_webassembly.md) — WebAssembly
- [Design Patterns](../03_design_patterns/01_patterns.md) — 设计模式
