...
[wgpu](https://github.com/gfx-rs/wgpu) 是 [WebGPU 规范（W3C）](https://www.w3.org/TR/webgpu/) 的 Rust 原生实现：同一份 Rust 代码通过不同后端跑在 Vulkan、Metal、DX12、OpenGL 与浏览器 WebGPU 之上。其设计要点：
