...
- **里程碑线**：从 2020 年 Miguel Ojeda 的 RFC，到 v5.15 编译器/核心模块（Module）基础设施、v6.1 首个 Rust 驱动（Android Binder）、v6.8 扩展到网络与块设备子系统——内核社区采用“新驱动优先 Rust”的渐进策略。
...
> [Boos et al., "Theseus: an Experiment in Operating System Structure and State Management", OSDI 2020](https://www.usenix.org/conference/osdi20/presentation/boos) ✅
...
```rust,ignore
#![no_std]
// 仅作概念展示：需实验特性门 allocator_api（每日构建版工具链）
