...
> **关键洞察**: WASI 的能力安全模型与 Rust 的所有权模型存在深层同构——二者都通过**资源唯一标识 + 显式转移**来消除隐式全局访问。这是 Rust 成为 Wasm 生态首选语言的深层原因。[WASI Docs](https://wasi.dev/); [Rust Ownership Model](https://doc.rust-lang.org/reference/introduction.html) <!-- link: known-broken --> ✅
...
> **[Capability-Based Security Research](https://www.cl.cam.ac.uk/research/security/capabilities/); [Dennis & Van Horn, CACM 1966](https://doi.org/10.1145/365230.365252); [Rust Ownership Model](https://doc.rust-lang.org/reference/introduction.html) <!-- link: known-broken -->** 能力安全模型基于操作系统安全研究的经典文献。✅
---
