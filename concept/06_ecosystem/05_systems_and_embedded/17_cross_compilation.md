...
> **前置概念**: [Toolchain](../00_toolchain/01_toolchain.md) · [Type System](../../01_foundation/02_type_system/04_type_system.md)
> **后置概念**: [WASI](08_wasi.md) · [WebAssembly](../11_domain_applications/11_webassembly.md)
...
- [WebAssembly](../11_domain_applications/11_webassembly.md) — WebAssembly 生态
