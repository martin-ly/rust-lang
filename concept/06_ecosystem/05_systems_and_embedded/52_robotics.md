...
> [性能优化](../10_performance/15_performance_optimization.md) ·
> [机器学习生态](../11_domain_applications/46_machine_learning_ecosystem.md) ·
> [形式化验证工具](../08_formal_verification/74_formal_verification_tools.md)
>
> **来源**:
>
...
- [网络协议](../04_web_and_networking/38_network_protocols.md) — UDP/TCP、序列化、gRPC/QUIC
- [操作系统内核](39_os_kernel.md) — 调度器、中断、内存管理
- [性能优化](../10_performance/15_performance_optimization.md) — SIMD、缓存、零拷贝
...
- [机器学习生态](../11_domain_applications/46_machine_learning_ecosystem.md) — 感知算法、神经网络推理
- [形式化验证工具](../08_formal_verification/74_formal_verification_tools.md) — 模型检查、定理证明、Kani
- [分布式共识](../06_data_and_distributed/50_distributed_consensus.md) — 多机器人协同、一致性（Coherence）
