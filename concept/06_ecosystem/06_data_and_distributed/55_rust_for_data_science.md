...
- [性能优化](../10_performance/15_performance_optimization.md) — SIMD、缓存、内存布局
- [WebAssembly](../11_domain_applications/11_webassembly.md) — 浏览器内数据分析、跨平台部署
- [云原生](../04_web_and_networking/24_cloud_native.md) — 容器化数据服务、对象存储
