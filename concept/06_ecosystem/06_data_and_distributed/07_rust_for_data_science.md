...
- [机器学习生态](../11_domain_applications/13_machine_learning_ecosystem.md) — candle、burn、tch-rs、linfa
- [性能优化](../10_performance/01_performance_optimization.md) — SIMD、缓存、内存布局
- [WebAssembly](../11_domain_applications/03_webassembly.md) — 浏览器内数据分析、跨平台部署
- [云原生](../04_web_and_networking/02_cloud_native.md) — 容器化数据服务、对象存储
- [并发编程](../../03_advanced/00_concurrency/01_concurrency.md) — Send/Sync、Rayon 并行
- [类型系统（Type System）](../../01_foundation/02_type_system/01_type_system.md) — 泛型（Generics）、Trait、零成本抽象（Zero-Cost Abstraction）
- [量子计算](../11_domain_applications/16_quantum_computing_rust.md) — 量子模拟、量子机器学习
