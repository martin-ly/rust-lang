...
> **前置概念**: [Stream Processing Ecosystem](36_stream_processing_ecosystem.md) · [Ownership](../../01_foundation/01_ownership_borrow_lifetime/01_ownership.md) · [Concurrency](../../03_advanced/00_concurrency/01_concurrency.md)
> **后置概念**: [Distributed Systems](../04_web_and_networking/18_distributed_systems.md) · [Formal Methods](../../04_formal/04_model_checking/05_verification_toolchain.md)
>
