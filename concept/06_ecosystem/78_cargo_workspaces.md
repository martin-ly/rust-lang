...
> 详见 [Cargo Dependency Resolution](60_cargo_dependency_resolution.md) 中“Resolver 版本差异”一节。
...
| 概念 | 关系 |
|:---|:---|
| [Cargo Dependency Resolution](60_cargo_dependency_resolution.md) | workspace 共享一个 `Cargo.lock` 和 resolver |
