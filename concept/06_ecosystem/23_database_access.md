...
>
> **来源**: [Diesel](https://docs.rs/diesel/) · [SQLx](https://docs.rs/sqlx/) · [tokio-postgres](https://docs.rs/tokio-postgres/) · [TRPL](https://doc.rust-lang.org/book/title-page.html)
---
...
`sqlx` 是异步、编译期检查 SQL 语法（通过宏查询数据库 schema），无 ORM。`diesel` 是类型安全 ORM，编译期生成查询，支持迁移，但学习曲线更陡。
</details>
