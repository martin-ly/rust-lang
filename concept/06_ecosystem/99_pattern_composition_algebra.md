...
- [模式组合代数：统一坐标系与结构化关联](#模式组合代数统一坐标系与结构化关联)
  ...
  - [二、模式统一坐标系](#二模式统一坐标系)
  - [三、模式关系代数](#三模式关系代数)
    - [3.1 组合 (⊗) 的规则](#31-组合--的规则)
    - [3.2 冲突 (⊘) 的典型场景](#32-冲突--的典型场景)
    - [3.3 替代 (⇄) 的决策维度](#33-替代--的决策维度)
  - [四、组合案例分析](#四组合案例分析)
    ...
    - [4.2 Singleton vs 依赖注入](#42-singleton-vs-依赖注入)
      - [问题定义](#问题定义-1)
      - [Singleton 的 Rust 表达与风险](#singleton-的-rust-表达与风险)
      - [依赖注入的 Rust 表达](#依赖注入的-rust-表达)
  ...
  - [六、反命题与边界分析](#六反命题与边界分析)
    - [6.1 反命题 1："模式组合越多越好"](#61-反命题-1模式组合越多越好)
    - [6.2 反命题 2："Singleton 在 Rust 中已被消除"](#62-反命题-2singleton-在-rust-中已被消除)
    - [6.3 反命题 3："Pipeline + Iterator 总是零成本"](#63-反命题-3pipeline--iterator-总是零成本)
    - [6.4 边界条件](#64-边界条件)
  - [七、来源与延伸阅读](#七来源与延伸阅读)
