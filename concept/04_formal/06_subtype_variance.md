...
>
> **EN**: Type System
> **Summary**: - [子types与变型：Rust types系统中的协变、逆变与不变](#子types与变型rust-types系统中的协变逆变与不变) - [📑 目录](#-目录) - [一、核心概念](#一核心概念) - [1.1 子types关系：'static 是 'a 的子types](#11-子types关系static-是-a-的子types) - [1.2 变型三态：协变、逆变、不变](#12-变型三态协变逆变不变) - [1.3 Rust 中的变型规则](#13-rust-中的变型规则) - [二、技术细节](#二技术细节) - [2.1 lifetimes位置的变型推导](#21-lifetimes位置的变型推导) - [2.2 结构体与枚举的变型](#
