...
- [指称语义与领域理论](#指称语义与领域理论)
  ...
  - [十、边界测试：指称语义的编译错误](#十边界测试指称语义的编译错误)
    ...
    - [2.2 所有权（Ownership）即线性性](LINK_PLACEHOLDER)
    - [2.3 生命周期（Lifetimes）即区域](LINK_PLACEHOLDER)
  ...
  - [权威来源索引](#权威来源索引)
    ...
    - [10.4 边界测试：`unsafe` 代码的语义鸿沟（运行时（Runtime） UB）](LINK_PLACEHOLDER)
...
| 指称语义与领域理论 正确用法 ⟹ 常见陷阱 | 忽略边界条件 | 编译错误或运行时 bug | 高 |
