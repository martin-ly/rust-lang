...
> **跨层映射**: 本文件定理 ↔ [`00_meta/inter_layer_map.md`](../../00_meta/04_navigation/inter_layer_map.md) §4.1 "内存安全（Memory Safety）完备性" · §5.2 "定理一致性检查"
...
> **扩展映射**:
>
> - **L3 Unsafe**: [`../03_advanced/02_unsafe/03_unsafe.md`](../../03_advanced/02_unsafe/03_unsafe.md) §3 "Unsafe 抽象边界" ↔ C1 边界层。unsafe 代码的安全契约需在 Iris 中手动建模，RustBelt 提供方法论但不自动化验证 (Source: [Wikipedia — Type Theory](https://en.wikipedia.org/wiki/Type_theory))
...
| Unsafe | [`../03_advanced/02_unsafe/03_unsafe.md`](../../03_advanced/02_unsafe/03_unsafe.md) | 验证边界 · C1 边界层 · L3 Unsafe 映射 |
...
> **相关谓词映射**: [own(τ) / shr(κ, ℓ) 完整映射](../../00_meta/02_sources/rustbelt_predicate_map.md) · [标准库谓词规范](../../00_meta/02_sources/rustbelt_predicate_map.md#五谓词组合与-rust-代码对应)
