...
> **前置依赖**: [Traits](../../02_intermediate/00_traits/01_traits.md) · [Macros Advanced](../../03_advanced/03_proc_macros/01_macros.md) · [Design Patterns](../../06_ecosystem/03_design_patterns/01_patterns.md) · [Pattern Implementation Comparison](../../06_ecosystem/03_design_patterns/09_pattern_implementation_comparison.md)
> **后置概念**: [Frontier Research and Innovative Patterns](../../06_ecosystem/03_design_patterns/12_frontier_research_and_innovative_patterns.md) · [Pattern Composition Algebra](12_pattern_composition_algebra.md)
