...
> **跨层映射**: 本文件 Const Generics 形式化 ↔ [`../02_intermediate/01_generics/02_generics.md`](../../02_intermediate/01_generics/02_generics.md) §5.7 "Const Generics 进阶用法" · [`../07_future/05_rust_version_tracking.md`](../../07_future/05_rust_version_tracking.md) §3.3 "`_` 推断 const generics"
