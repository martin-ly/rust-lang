...
> **后置概念**:
> [Ownership Formalization](../01_ownership_logic/03_ownership_formal.md) · [RustBelt](../02_separation_logic/04_rustbelt.md)
...
> **跨层映射**: 本文件定理 ↔ [`00_meta/inter_layer_map.md`](../../00_meta/04_navigation/inter_layer_map.md) §3.1 "L1-L4 形式化映射" · §4.2 "类型系统（Type System）一致性（Coherence）"
...
**L1 映射**: [`../01_foundation/02_type_system/04_type_system.md`](../../01_foundation/02_type_system/04_type_system.md) §1
...
[`../01_foundation/02_type_system/04_type_system.md`](../../01_foundation/02_type_system/04_type_system.md) §2 ADT 代数语义 ·
...
**L2-L4 映射**: [`../02_intermediate/01_generics/02_generics.md`](../../02_intermediate/01_generics/02_generics.md)
§4.1 System F · 本节 L2
...
|:---|:---|:---|:---|
| L1: λ→ 简单类型 | [`../01_foundation/02_type_system/04_type_system.md`](../../01_foundation/02_type_system/04_type_system.md) §4.5 T3 | **精确** | L1 的 T3 类型安全定理依赖 L4 的 λ→ 基础 |
| T5: HM 推断完备性 | `../01_foundation/02_type_system/04_type_system.md` §4.4 T2 | **精确** | L1 T2（类型推断（Type Inference）完备性）是 T5 的工程实例 |
| T1: 进展+保持=类型安全 | [`../01_foundation/02_type_system/04_type_system.md`](../../01_foundation/02_type_system/04_type_system.md) §4.5 T3 | **精确** | L1 T3 是 T1 在 Rust 中的受限形式 |
...
| T3: 约束可满足性 | [`../02_intermediate/01_generics/02_generics.md`](../../02_intermediate/01_generics/02_generics.md) §4.4 | **精确** | L2 约束多态是 T3 的工程语法 |
| C2: 高阶类型/GATs | [`../02_intermediate/01_generics/02_generics.md`](../../02_intermediate/01_generics/02_generics.md) §2.3 | **精确** | L2 GATs 是 C2 的 Rust 语法 |
...
> **[来源: [RFC 3762](https://github.com/rust-lang/rfcs/pull/3762); Tracking Issue #143874]** ⚠️ nightly only
...
> **跨层映射**: 本文件 Const Generics 形式化 ↔ [`../02_intermediate/01_generics/02_generics.md`](../../02_intermediate/01_generics/02_generics.md) §5.7 "Const Generics 进阶用法" · [`../07_future/05_rust_version_tracking.md`](../../07_future/00_version_tracking/05_rust_version_tracking.md) §3.3 "`_` 推断 const generics"
