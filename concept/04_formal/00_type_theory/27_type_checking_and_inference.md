> **内容分级**: [综述级]
> **本节关键术语**: Type Checking · Type Inference · `typeck` · `Ty<'tcx>` · `InferCtxt` · Inference Variable · Unification · Region Constraint · Snapshot — [完整对照表](../../00_meta/01_terminology/terminology_glossary.md)
>
# rustc 类型检查与类型推断
