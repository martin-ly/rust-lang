...
1. **问题识别**: 为什么 Rust Reference 附录值得关注？附录汇总了完整文法、语法索引和宏歧义规则，是阅读规范时的快速参考。
...
Rust Reference 附录的 Test Summary 将规范规则映射到 rustc 测试文件，帮助实现者和研究者验证规范与编译器行为的一致性。
