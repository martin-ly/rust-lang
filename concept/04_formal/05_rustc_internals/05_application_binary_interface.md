...
| 概念 | 关系 |
|:---|:---|
| [Linkage](../../03_advanced/04_ffi/03_linkage.md) | ABI 属性影响链接器可见的符号和段 |
| [FFI Advanced](../../03_advanced/04_ffi/02_ffi_advanced.md) | FFI 场景是 ABI 控制的主要用例 |
| [Unsafe Rust](../../03_advanced/02_unsafe/01_unsafe.md) | 多数 ABI 属性需要 `unsafe` |
| [Inline Assembly](../../03_advanced/05_inline_assembly/01_inline_assembly.md) | 与底层段/符号控制经常协同使用 |
...
> · 链接权威页（交叉语义）：[`27_linkage.md`](../../03_advanced/04_ffi/03_linkage.md)
