...
> **双维定位**: S×Ana — 规范分析
> **前置依赖**: [Notation](../06_notation/01_notation.md) · [Programming Language Foundations](../04_model_checking/05_programming_language_foundations.md)
> **后置概念**: [Names and Resolution](06_names_and_resolution.md) · [Items Reference](11_items_reference.md) · [Keywords](../../01_foundation/00_start/06_keywords.md)
...
详细列表见 [Keywords](../../01_foundation/00_start/06_keywords.md)。
...
>
> **过渡**: 从 token 分类过渡到语法产生式，可以链接 [Notation](../06_notation/01_notation.md) 与条目参考，形成完整参考链。
>
---
