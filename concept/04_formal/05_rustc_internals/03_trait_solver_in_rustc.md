> **内容分级**: [综述级]
> **本节关键术语**: Trait Solver · Selection · Fulfillment · Evaluation · Obligation · Candidate · Winnowing · Coinduction · Next-Gen Solver — [完整对照表](../../00_meta/01_terminology/01_terminology_glossary.md)
>
...
> **前置概念**: [Type System](../../01_foundation/02_type_system/01_type_system.md) · [Traits](../../02_intermediate/00_traits/01_traits.md) · [Type Inference](../00_type_theory/03_type_inference.md) · [Name Resolution and HIR](04_name_resolution_and_hir.md) · [Unsafe Rust](../../03_advanced/02_unsafe/01_unsafe.md)
> **后置概念**: [Rustc Query System](01_rustc_query_system.md) · [Ownership Formal](../01_ownership_logic/02_ownership_formal.md)
