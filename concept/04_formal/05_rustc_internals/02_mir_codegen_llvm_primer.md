> **内容分级**: [综述级]
> **本节关键术语**: MIR · HIR · THIR · LLVM IR · Codegen · Monomorphization · `rustc_codegen_ssa` · `rustc_codegen_llvm` · Basic Block · Place · Rvalue — [完整对照表](../../00_meta/01_terminology/01_terminology_glossary.md)
>
...
> **前置概念**: [Rustc Query System](01_rustc_query_system.md) · [Type System](../../01_foundation/02_type_system/01_type_system.md) · [Unsafe Rust](../../03_advanced/02_unsafe/01_unsafe.md)
> **后置概念**: [LLVM Backend and Code Generation](../../06_ecosystem/00_toolchain/09_llvm_backend_and_codegen.md) · [Compiler Infrastructure](../../06_ecosystem/00_toolchain/05_compiler_infrastructure.md)
...
「嵌入式测验」涉及测验 1：MIR 与 LLVM IR 的主要区别是什么？、测验 2：`--emit=mir` 输出的是优化前还是优化后的 MIR？、测验 3：单态化发生在流水线的哪一步？与测验 4：为什么 LLVM IR 不适合作为长期稳定的后端接口？，本节逐一说明其要点。
