...
> **双维定位**: S×Ana — 规范分析
> **前置依赖**: [Modules and Paths](../../01_foundation/07_modules_and_items/11_modules_and_paths.md) · [Names and Resolution](40_names_and_resolution.md) · [Visibility and Privacy](../../03_advanced/06_low_level_patterns/34_visibility_and_privacy.md)
...
| 宏（Macro）命名空间 | `macro_rules!`, 过程宏 | 通过 `name!()` 调用 |
