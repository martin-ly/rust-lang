...
3. **迁移应用**: 将名称、作用域与解析与前置/后置概念链接，形成跨层知识网络。
...
| 概念 | 关系 |
|:---|:---|
| [Modules and Paths](../../01_foundation/07_modules_and_items/01_modules_and_paths.md) | 模块系统是路径与可见性的基础 |
| [Preludes](../../01_foundation/07_modules_and_items/10_preludes.md) | prelude 注入隐式声明的名称 |
| [Name Resolution and HIR](04_name_resolution_and_hir.md) | 编译器内部名称解析与 HIR 表示 |
| [Linkage](../../03_advanced/04_ffi/03_linkage.md) | 名称解析影响链接器可见符号 |
| [Attributes and Macros](../../01_foundation/09_macros_basics/01_attributes_and_macros.md) | 宏展开可以引入新名称 |
| [Unsafe Rust](../../03_advanced/02_unsafe/01_unsafe.md) | `unsafe` 块中的外部符号解析有特殊规则 |
