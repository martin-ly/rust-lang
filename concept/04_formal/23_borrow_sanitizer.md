...
> **双维定位**: C×Eva
> **前置依赖**: [Unsafe Rust](../03_advanced/03_unsafe.md) · [Miri](../06_ecosystem/47_formal_verification_tools.md) · [所有权形式化](03_ownership_formal.md) · [Tree Borrows](25_tree_borrows_deep_dive.md)
...
- [Tree Borrows 深度](25_tree_borrows_deep_dive.md)
