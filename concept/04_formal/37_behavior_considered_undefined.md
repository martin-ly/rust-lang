...
> **双维定位**: S×Ana — 规范分析
> **前置依赖**: [Unsafe Rust](../03_advanced/03_unsafe.md) · [Atomics and Memory Ordering](../03_advanced/11_atomics_and_memory_ordering.md) · [Pointer Aliasing](03_ownership_formal.md)
...
| [Miri](31_miri.md) | Miri 用于在运行时（Runtime）检测部分 UB |
