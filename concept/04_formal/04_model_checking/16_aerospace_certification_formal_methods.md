...
- [Hoare 逻辑](../03_operational_semantics/15_hoare_logic.md) — 程序验证的形式化基础
- [RustBelt](../02_separation_logic/04_rustbelt.md) — Rust 类型系统（Type System）的 Iris 形式化
- [Separation Logic](../02_separation_logic/11_separation_logic.md) — 分离逻辑与内存模型
- [Unsafe](../../03_advanced/02_unsafe/03_unsafe.md) — Unsafe Rust 的边界
