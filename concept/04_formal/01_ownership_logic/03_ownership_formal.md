...
> **跨层映射**: 本文件定理 ↔ [`00_meta/inter_layer_map.md`](../../00_meta/04_navigation/inter_layer_map.md) §3.1 "L1-L4 形式化映射" · §4.1 "内存安全（Memory Safety）完备性"
...
| 类型论 | [`./02_type_theory.md`](../00_type_theory/02_type_theory.md) | 约束求解 |
| RustBelt | [`./04_rustbelt.md`](../02_separation_logic/04_rustbelt.md) | 验证实现 |
| Unsafe | [`../03_advanced/02_unsafe/03_unsafe.md`](../../03_advanced/02_unsafe/03_unsafe.md) | 别名模型应用 |
| Pin / 自引用 | [`../03_advanced/01_async/02_async.md`](../../03_advanced/01_async/02_async.md) §3.2 | 📎 详见: Pin 的形式化语义与 location stability
...
> **跨层映射**: 本文件 LTL 规约 ↔ [`../03_advanced/01_async/02_async.md`](../../03_advanced/01_async/02_async.md) §3.2 "Pin 的形式化语义" · [`../03_advanced/01_async/02_async.md`](../../03_advanced/01_async/02_async.md) §5.1 定理矩阵 L2 "Pin ⟹ 自引用安全"
...
> **补充来源**
> **相关谓词映射**:
> [RustBelt 核心谓词](../../00_meta/02_sources/rustbelt_predicate_map.md#一rustbelt-核心谓词定义) ·
> [定理推导链](../../00_meta/02_sources/rustbelt_predicate_map.md#六从谓词到定理的推导链)
