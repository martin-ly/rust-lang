...
> **前置依赖**: [L4 所有权（Ownership）形式化](../01_ownership_logic/03_ownership_formal.md) · L4 RustBelt · L4 分离逻辑 · L3 Unsafe
> **后置延伸**: [L6 形式化验证工具](../../06_ecosystem/08_formal_verification/74_formal_verification_tools.md) · [L7 形式化方法](../../07_future/04_research_and_experimental/02_formal_methods.md)
...
- [L4 RustBelt](../02_separation_logic/04_rustbelt.md)
- [L4 分离逻辑](../02_separation_logic/11_separation_logic.md)
- [L4 所有权（Ownership）形式化](../01_ownership_logic/03_ownership_formal.md)
