...
> **前置依赖**: [Async/Await](../../03_advanced/01_async/01_async.md) · [Interior Mutability](../../02_intermediate/02_memory_management/02_interior_mutability.md) · [Concurrency Patterns](../../03_advanced/00_concurrency/03_concurrency_patterns.md)
> **后置延伸**: [Async Drop](22_async_drop_preview.md)
