...
> **Summary**: - [编译期执行与常量求值](#编译期执行与常量求值) - [📑 目录](#-目录) - [一、核心概念](#一核心概念) - [1.1 const fn](#11-const-fn) - [1.2 const 上下文](#12-const-上下文) - [1.3 const generics](#13-const-generics) - [二、编译期能力边界](#二编译期能力边界) - [2.1 稳定的编译期操作](#21-稳定的编译期操作) - [2.2 不稳定特性](#22-不稳定特性) - [三、应用模式](#三应用模式) - [3.1 编译期计算](#31-编译期计算) - [3.2 types状态机](#32-
>
> **受众**: [专家]
> **内容分级**: [综述级]
> **Bloom 层级**: 分析 → 评价
