...
|:---|:---|:---|:---|
| [Safety Tags](../03_preview_features/31_safety_tags_preview.md) | `unsafe` 契约的机器可读标注 | Safety Tags 声明契约，BorrowSanitizer 在运行时（Runtime）验证契约执行 | [深度形式化](../../04_formal/02_separation_logic/33_safety_tags_in_formal.md) |
