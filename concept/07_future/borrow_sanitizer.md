...
> **权威来源**:
>
> - [BorrowSanitizer MCP]<https://github.com/rust-lang/compiler-team/issues/>...
> - [Rust Project Goals 2026 — BorrowSanitizer](https://rust-lang.github.io/rust-project-goals/2026/...)
> - [BSan 月度博客](https://...)
...
> **当前状态** (2026-04): `cargo-bsan` 插件已支持多语言库，正在扩展测试套件（Miri 测试通过率 80%）。
...
| LLVM RFC | 2026 春季 | 🔄 起草中（比预期延迟，但值得） |
| RustConf 演讲 | 2026-09 | ✅ 已接受 |
| 上游合并 | 2026 H2 | 📋 目标 |
...
| Rust Project Goals 2026 | rust-lang.github.io/rust-project-goals/2026 | 项目目标 |
| Miri Book | rustc-dev-guide.rust-lang.org/miri.html | 互补工具 |
| Tree Borrows 论文 | [PLDI 2025] | 理论基础 |
| BSan 月度更新 (Jan) | [blog post] | 进展博客 |
| BSan 月度更新 (Feb) | [blog post] | 进展博客 |
| BSan 月度更新 (Mar) | [blog post] | 进展博客 |
| BSan 月度更新 (Apr) | [blog post] | 进展博客 |
