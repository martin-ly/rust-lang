...
### 第 2 步：为什么Rust需要形式化方法？

unsafe边界/并发正确性/安全关键系统
...
| **RustBelt 证明 safe 子集安全** | Iris分离逻辑 ⟹ | 无数据竞争/UAF | unsafe未覆盖 | POPL 2018里程碑 |

| **Miri 检测 UB 子集** | 解释执行+栈借用 ⟹ | 开发期工具 | 不证明正确性 | unsafe代码验证 |

| **Kani 符号执行验证** | AWS开发 ⟹ | bounded验证 | 状态空间限制 | 安全关键代码 |
...
graph TD
    ...
    Q -->|反例2| C3_1["RustBelt影响设计"]

    style C3_1 fill:#f66

    Q -->|反例3| C3_2["Kani/Prusti工具"]
