...
> [Rust 1.98+ 前沿特性预览](../00_version_tracking/rust_1_98_preview.md) ·
> [Rust Blog — Announcing Rust 1.97.0](https://blog.rust-lang.org/2026/07/09/Rust-1.97.0/)（P2 生态官方发布信息，curl 200 实测 2026-07-13）
>
> **前置概念**:
