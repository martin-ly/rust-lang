...
> **交叉链接**：`unsafe` 块的契约规范见 [`../03_advanced/02_unsafe/03_unsafe.md`](../../03_advanced/02_unsafe/03_unsafe.md) · 生命周期（Lifetimes）省略（Lifetime Elision）规则见 [`../01_foundation/01_ownership_borrow_lifetime/03_lifetimes.md`](../../01_foundation/01_ownership_borrow_lifetime/03_lifetimes.md)。
...
- **生命周期（Lifetimes）可视化**：在 Chat 模式中，Cursor 可对复杂生命周期标注进行解释，并建议简化方案（如将显式 `'a` 替换为 `impl Trait` 返回类型）。[来源: 原创分析]
...
> **交叉链接**：工具链与 `rust-analyzer` 配置见 [`../06_ecosystem/01_toolchain.md`](../../06_ecosystem/00_toolchain/01_toolchain.md) · Trait 重构模式见 [`../02_intermediate/00_traits/01_traits.md`](../../02_intermediate/00_traits/01_traits.md)。
...
> **交叉链接**：Rust 并发与通道见 [`../03_advanced/00_concurrency/01_concurrency.md`](../../03_advanced/00_concurrency/01_concurrency.md) · `async` 运行时（Runtime）见 [`../03_advanced/01_async/02_async.md`](../../03_advanced/01_async/02_async.md)。
...
> **交叉链接**：CI/CD 与工具链集成详见 [`../06_ecosystem/01_toolchain.md`](../../06_ecosystem/00_toolchain/01_toolchain.md) · `unsafe` 安全审计规范见 [`../03_advanced/02_unsafe/03_unsafe.md`](../../03_advanced/02_unsafe/03_unsafe.md)。
...
| 概念 | 文件 | 关系 |
|:---|:---|:---|
| Unsafe | [`../03_advanced/02_unsafe/03_unsafe.md`](../../03_advanced/02_unsafe/03_unsafe.md) | AI 生成边界约束 |
| 形式化验证 | [`../04_formal/04_rustbelt.md`](../../04_formal/02_separation_logic/04_rustbelt.md) | 验证闭环 |
| 工具链 | [`../06_ecosystem/01_toolchain.md`](../../06_ecosystem/00_toolchain/01_toolchain.md) | CI 集成 |
| 形式化方法 | [`../02_formal_methods.md`](../04_research_and_experimental/02_formal_methods.md) | 协同趋势 |
| 语言演进 | [`../03_evolution.md`](../04_research_and_experimental/03_evolution.md) | AI 驱动演进 |
| 安全边界 | [`../05_comparative/04_safety_boundaries.md`](../../05_comparative/03_domain_comparisons/04_safety_boundaries.md) | 生成约束 |
| Rust vs C++ | [`../05_comparative/01_rust_vs_cpp.md`](../../05_comparative/01_systems_languages/01_rust_vs_cpp.md) | AI 时代对比 |
...
>
> 生态工具见 [`../06_ecosystem/01_toolchain.md`](../../06_ecosystem/00_toolchain/01_toolchain.md)。
...
> **相关文件**: [能力图谱](../../00_meta/00_framework/competency_graph.md) · [Unsafe](../../03_advanced/02_unsafe/03_unsafe.md) · [Rust in AI](../04_research_and_experimental/21_rust_in_ai.md)
