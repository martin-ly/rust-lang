...
> **交叉链接**：`unsafe` 块的契约规范见 [`../03_advanced/03_unsafe.md`](../../03_advanced/03_unsafe.md) · 生命周期（Lifetimes）省略（Lifetime Elision）规则见 [`../01_foundation/01_ownership_borrow_lifetime/03_lifetimes.md`](../../01_foundation/01_ownership_borrow_lifetime/03_lifetimes.md)。
