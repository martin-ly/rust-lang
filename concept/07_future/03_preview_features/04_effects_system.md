...
> **[Rust Project Goals 2025H1 — Prepare const traits for stabilization](https://rust-lang.github.io/rust-project-goals/) <!-- link: known-broken -->(<https://rust-lang.github.io/rust-project-goals/2025h1/const-trait.html>)** ✅
...
本节将「代数效果的数学基础」分解为若干主题：代数效果的形式化定义、代数效果与 Monad 的关系、Rust 效果系统的未来演进与Effect × Pin：效果与自引用类型的交叉。
