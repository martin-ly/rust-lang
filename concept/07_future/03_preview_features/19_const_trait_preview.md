...
> **前置依赖**: [Trait](../../02_intermediate/00_traits/01_traits.md) · [Const Generics](../../02_intermediate/01_generics/01_generics.md) · [Const Items and Const Fn](../../01_foundation/07_modules_and_items/09_const_items_and_const_fn.md)
> **后置延伸**: [Const Trait Impl](06_const_trait_impl_preview.md) · [Inline Const Pattern](08_inline_const_pattern_preview.md)
