...
> **前置概念**: [Unsafe Rust](../../03_advanced/02_unsafe/03_unsafe.md) · [Ownership](../../01_foundation/01_ownership_borrow_lifetime/01_ownership.md) · [Borrowing](../../01_foundation/01_ownership_borrow_lifetime/02_borrowing.md) · [Version Tracking](../00_version_tracking/05_rust_version_tracking.md)
...
基于 LLVM 的 sanitizer 基础设施，在编译时注入检查代码，运行时追踪借用状态，检测悬垂引用（Reference）、非法别名等违规。
</details>
