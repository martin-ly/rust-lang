...
> **前置概念**: [Unsafe Rust](../../03_advanced/02_unsafe/03_unsafe.md) · [Version Tracking](../00_version_tracking/05_rust_version_tracking.md)
> **后置概念**: [Formal Methods](../04_research_and_experimental/02_formal_methods.md) · [Rust for Linux](../../06_ecosystem/06_data_and_distributed/04_application_domains.md)
...
- [Application Domains](../../06_ecosystem/06_data_and_distributed/04_application_domains.md) — 安全关键应用领域
