...
> **后置概念**: [Evolution](03_evolution.md) · [NLL](../03_advanced/02_unsafe/08_nll_and_polonius.md)
...
`gen` 块、`if let` 临时生命周期延长、`unsafe_op_in_unsafe_fn` 默认启用、`lifetime_capture_rules` 改进、模式匹配（Pattern Matching）中的 `|` 或操作符等。
</details>
