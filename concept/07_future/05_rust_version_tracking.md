...
| `#[my_macro] mod foo;` (proc_macro_hygiene) | #157857 | 9 天 · PFCP / `S-waiting-on-t-lang` | 过程宏卫生性：属性宏应用于模块声明 |
...
| `derive(CoercePointee)` | #139673 | 566 天 · FCP finished / `S-blocked` | 智能指针类型强制转换，简化内核抽象封装 |
