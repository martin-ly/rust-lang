...
| [07_mcdc_coverage_preview.md](02_preview_features/02_mcdc_coverage_preview.md) | MC/DC Coverage 预研 | 安全关键覆盖率验证、DO-178C/ISO 26262 合规 | ✅ v1.0 | L3 Unsafe, L1 Type System | L6 安全关键应用 |
| [08_safety_tags_preview.md](02_preview_features/03_safety_tags_preview.md) | Safety Tags 预研 | Unsafe 契约机器可读标注、AI 生成安全边界 | ✅ v1.0 | L3 Unsafe, L1 Ownership | L3 Unsafe 契约工具化 |
| [09_parallel_frontend_preview.md](02_preview_features/04_parallel_frontend_preview.md) | 并行前端编译预研 | 查询系统并行化、类型检查并行化、编译时间优化 | ✅ v1.0 | L6 Toolchain, L3 Concurrency | L6 编译工具链性能演进 |
| [10_derive_coerce_pointee_preview.md](02_preview_features/05_derive_coerce_pointee_preview.md) | 派生 CoercePointee 预研 | 智能指针（Smart Pointer）自动类型强制、零 unsafe 代码 | ✅ v1.0 | L2 Generics, L3 Unsafe | L3 Unsafe 代码消除 |
| [11_const_trait_impl_preview.md](02_preview_features/06_const_trait_impl_preview.md) | Const Trait Impl 预研 | 常量上下文 Trait 泛化、~const 效果限定 | ✅ v1.0 | L2 Trait, L1 Type System | L2 Trait 编译期扩展 |
| [12_return_type_notation_preview.md](02_preview_features/09_return_type_notation_preview.md) | Return Type Notation 预研 | use<..> 精确捕获、生命周期（Lifetimes）显式控制 | ✅ v1.0 | L2 Trait, L3 Async | L3 Async API 稳定性 |
| [13_unsafe_fields_preview.md](02_preview_features/11_unsafe_fields_preview.md) | Unsafe Fields 预研 | 字段级 unsafe 标记、安全边界细化 | ✅ v1.0 | L3 Unsafe, L1 Ownership | L3 Unsafe 粒度细化 |
| [14_ferrocene_preview.md](02_preview_features/12_ferrocene_preview.md) | Ferrocene 预研 | Rust 安全关键认证工具链、ISO 26262 / DO-178C | ✅ v1.0 | L6 Toolchain, L7 Future | L6 安全关键工具链 |
| [15_gen_blocks_preview.md](02_preview_features/25_gen_blocks_preview.md) | Gen Blocks 预研 | 泛化生成器、惰性迭代、异步流 | ✅ v1.0 | L3 Async, L2 Trait | L3 控制流泛化 |
| [16_cranelift_backend_preview.md](02_preview_features/16_cranelift_backend_preview.md) | Cranelift 后端预研 | 快速调试编译、LLVM 替代后端 | ✅ v1.0 | L6 Toolchain | L6 编译工具链扩展 |
| [17_rust_specification_preview.md](02_preview_features/21_rust_specification_preview.md) | Rust 语言规范预研 | 形式化规范演进、Ferrocene 先行探索 | ✅ v1.0 | L4 Formal, L7 Future | L4-L7 规范桥梁 |
| [18_async_drop_preview.md](02_preview_features/22_async_drop_preview.md) | Async Drop 预研 | 异步资源销毁、[Async Drop Initiative](https://rust-lang.github.io/async-fundamentals-initiative/roadmap/async_drop.html)、Pin 交互、workaround 模式 | ⚠️ nightly | L3 Async, L3 Pin | 异步生态完善 |
| [26_specialization_preview.md](02_preview_features/31_specialization_preview.md) | Specialization 预研 | Trait 实现特化、重叠 impl、min_specialization | ⚠️ nightly | L2 Trait, L2 Generics | 泛型表达能力扩展 |
| [04_effects_system.md](02_preview_features/01_effects_system.md) | 效果系统预研 | Effect 类型论、Rust 现有 effect 映射、跨语言对比、演进路线 | ✅ v1.0 | L2 Trait, L3 Async, L4 Type Theory | L2-L3 效果统一化 |

---

### 补充文件索引

- [Stable ABI Preview](02_preview_features/07_stable_abi_preview.md)
- [Inline Const Pattern Preview](02_preview_features/08_inline_const_pattern_preview.md)
- [`must_not_suspend` Lint Preview](02_preview_features/10_must_not_suspend_preview.md)
- [Lifetime Capture in `impl Trait` Preview](02_preview_features/13_lifetime_capture_preview.md)
- [RPITIT Preview](02_preview_features/15_rpitit_preview.md)
- [TAIT Preview](02_preview_features/17_type_alias_impl_trait_preview.md)
- [Arbitrary Self Types 预览：自定义方法接收器](02_preview_features/18_arbitrary_self_types_preview.md)
- [Const Trait Impl Preview](02_preview_features/06_const_trait_impl_preview.md)
- [Field Projections 预览：安全的字段级投影](02_preview_features/23_field_projections_preview.md)
...
- [Gen Blocks Preview](02_preview_features/25_gen_blocks_preview.md)
- [`std::autodiff`：Rust 官方自动微分前沿追踪](02_preview_features/26_std_autodiff_preview.md)
...
- [WASM Target Evolution Preview](02_preview_features/28_wasm_target_evolution.md)
- [cargo-semver-checks 预览：从社区工具到 Cargo 官方集成](02_preview_features/27_cargo_semver_checks_preview.md)
- [AArch64 SVE / SME 预览：可伸缩向量扩展](02_preview_features/29_aarch64_sve_sme_preview.md)
- [Rust in Space Preview](02_preview_features/30_rust_in_space.md)
- [编译期执行与常量求值](02_preview_features/32_compile_time_execution.md)
...
| **确定性容器** | L1 Ownership, L2 Memory | 消除运行时（Runtime）非确定性（如 AI 推理的副作用隔离） | 可能引入 `Deterministic<T>` 类型构造 |
...
| **GATs 完整化** | L2 Generics, L4 Type Theory | 泛型关联类型消除更多 boilerplate | 类型系统（Type System）向 System Fω 靠拢 |
...
- **L1-L3**: 概念定义需预留演进空间（如 Effects 对所有权（Ownership）的影响）
...
理解「嵌入式测验（Embedded Quiz）」需要把握测验 1：《L7 前沿趋势层（Future & Trends）》在本知…、测验 2：使用本索引文件时，最有效的学习策略是什么？（理解层）与测验 3：索引文档能否替代具体概念文件的学习？（理解层），本节依次展开。

### 测验 1：《L7 前沿趋势层（Future & Trends）》在本知识体系中扮演什么角色？（理解层）

**题目**: 《L7 前沿趋势层（Future & Trends）》在本知识体系中扮演什么角色？
