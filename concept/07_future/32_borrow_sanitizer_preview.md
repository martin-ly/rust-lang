...
> **双维定位**: C×Eva
> **前置依赖**: [Unsafe Rust](../03_advanced/03_unsafe.md) · [Miri](../04_formal/31_miri.md) · [所有权（Ownership）形式化](../04_formal/03_ownership_formal.md)
...
- [BorrowSanitizer 深度](../04_formal/34_borrow_sanitizer_in_formal.md)
