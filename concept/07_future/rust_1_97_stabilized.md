...
> **Summary**: Comprehensive coverage of features stabilized in Rust 1.97.0 (2026-07-09), including language, standard library, toolchain, and target changes.
>
> **受众**: [进阶]
> **内容分级**: [参考级]
> **状态**: Rust 1.97.0 已稳定发布（2026-07-09）
> **跟踪版本**: Rust 1.97.0 stable (2026-07-09)
