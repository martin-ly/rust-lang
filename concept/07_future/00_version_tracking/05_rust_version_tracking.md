...
| :--- | :--- | :--- | :--- | :---: | :--- |
| `return_type_notation` (RTN) | unstable | D2 类型 | [`concept/07_future/12_return_type_notation_preview.md`](../03_preview_features/12_return_type_notation_preview.md) | 中 | 继续演进 |
| `associated_type_defaults` | unstable | D2 类型 | `02_intermediate/00_traits/01_traits.md` | 中 | 继续演进 |
| `generic_const_exprs` | unstable | D1 计算 / D2 类型 | `02_intermediate/01_generics/02_generics.md` | 中 | 继续演进 |
| `unsafe_fields` | experimental | D7 安全边界 | [`concept/07_future/13_unsafe_fields_preview.md`](../03_preview_features/13_unsafe_fields_preview.md) | **高** | 早期实验 |
| `new_range_syntax` (`..<`) | unstable | D1 计算 | `01_foundation/02_type_system/04_type_system.md` | 低 | 继续演进 |
| `effects` (keyword generics) | experimental | D3 控制流 / D7 安全 | `07_future/04_effects_system.md` | **高** | 长期演进 |
| `const_trait_impl` (`~const`) | unstable | D1 计算 | [`concept/07_future/11_const_trait_impl_preview.md`](../03_preview_features/11_const_trait_impl_preview.md) | **高** | 继续演进 |
| `gen_blocks` | unstable | D3 控制流 | [`concept/07_future/22_gen_blocks_preview.md`](../03_preview_features/22_gen_blocks_preview.md) | **高** | 继续演进 |
...
| `adt_const_params` | unstable | D2 类型 / D1 计算 | `02_intermediate/01_generics/02_generics.md` | **高** | 目标稳定 |
| `min_generic_const_args` | unstable | D2 类型 / D1 计算 | `02_intermediate/01_generics/02_generics.md` | **高** | 目标稳定 |
...
| **Ferrocene** | 已认证（ISO 26262 ASIL-D） | D7 安全 / D6 生态 | [`concept/07_future/35_ferrocene_preview.md`](../03_preview_features/35_ferrocene_preview.md) | **高** | 持续更新 |
...
| **RUSTSEC-2026-0012** | `tokio` (mpsc) | Medium | 边界条件导致内存泄漏，长时间运行服务受影响 | ≥1.44.0 | `concept/03_advanced/01_async/02_async.md` |
...
| 特性 | 类别 | 项目覆盖 | 状态 |
|:---|:---|:---|:---:|
| `assert_matches!` / `debug_assert_matches!` | 标准库宏（Macro） | `docs/02_reference/quick_reference/assert_matches_guide.md` · [`concept/02_intermediate/06_macros_and_metaprogramming/05_assert_matches.md`](../../02_intermediate/06_macros_and_metaprogramming/05_assert_matches.md) | ✅ 已创建 |
| `core::range` 补齐 (`Range`/`RangeFrom`/`RangeToInclusive` + 迭代器（Iterator）) | 标准库 API | `crates/c02_type_system/src/rust_196_features.rs` · [`concept/02_intermediate/04_types_and_conversions/06_range_types.md`](../../02_intermediate/04_types_and_conversions/06_range_types.md) | ✅ 已更新 |
...
| **Safety Tags** | 设计讨论（Pre-RFC 准备中） | 2027+ | ✅ 已创建 | [`concept/07_future/08_safety_tags_preview.md`](../03_preview_features/08_safety_tags_preview.md) |
| **Unsafe Fields** | ✅ RFC 3458 已接受（2026-02）；Clippy #16767 等待 review；Project Goals 2026 Continued | 2027+ | ✅ 已创建 | [`concept/07_future/13_unsafe_fields_preview.md`](../03_preview_features/13_unsafe_fields_preview.md) |
| **Ergonomic ref-counting** | 🔄 RFC 决策和预览阶段；Project Goals 2026 Continued；Niko Matsakis + Santiago Pastorino 主导 | 2027+ | ✅ 已创建 | [`concept/07_future/17_ergonomic_ref_counting_preview.md`](../03_preview_features/40_ergonomic_ref_counting_preview.md) |
| **derive(CoercePointee)** | nightly 可用 | 2027+ | 🟡 跟踪 | [`concept/07_future/10_derive_coerce_pointee_preview.md`](../03_preview_features/10_derive_coerce_pointee_preview.md) |
| **并行前端编译** | nightly 可用 | 2026–2027 | 🟡 跟踪 | [`concept/07_future/09_parallel_frontend_preview.md`](../03_preview_features/09_parallel_frontend_preview.md) |
| **Cranelift 后端** | ⚠️ **官方因资金不足进展停滞**（Project Goals 2026 Not completed） | 待定 | ✅ 已更新 | [`concept/07_future/38_cranelift_backend_preview.md`](../03_preview_features/38_cranelift_backend_preview.md) |
...
| v1.21 | 2026-05-26 | 权威内容对齐 R20+R21：① Crate 生态动态（sqlx 0.9.0 MSRV 1.94、tokio 1.52.2/1.52.3 安全修复、reqwest aws-lc-rs FIPS、arrow-rs 整数溢出修复）；② Rust for Linux 进展（Linux 7.1-rc5、NOVA 驱动 6.15、DRM Rust Mandate ~2026-12） [crate releases](https://docs.rs/crate/latest/crate/); kernel.org
...
**文档版本**: 1.26
**对应 Rust 版本**: 1.97.0+ stable / 1.97.0 beta 跟踪中 / 1.98.0 nightly 前瞻 (Edition 2024)
**最后更新**: 2026-07-04
...
> **补充来源**
> **相关文件**: [工具链](../../06_ecosystem/00_toolchain/01_toolchain.md) · [演进](../04_research_and_experimental/03_evolution.md) · [质量仪表板](../../00_meta/03_audit/quality_dashboard_v2.md)
...
| **Async** | 初学者常忽略 async；使用者面临 runtime 选择、`Pin`、异步 trait、cancellation 等复杂问题 | `concept/03_advanced/01_async/02_async.md` / `02_async_advanced.md` / `02_async_patterns.md` 已系统覆盖 |
