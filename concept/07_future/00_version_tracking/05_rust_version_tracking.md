...
| v1.31 | 2026-05-28 | 全项目版本号批量对齐：2,200+ 文件 `1.95.0+` → `1.96.1+`，覆盖所有活跃轨道；crates/ 17 个 Cargo.toml rust-version 同步；`.clippy.toml` msrv 同步；Miri R30 验证报告归档 |
...
**文档版本**: 1.26
**对应 Rust 版本**: 1.96.1+ stable / 1.97.0 beta 跟踪中 / 1.98.0 nightly 前瞻 (Edition 2024)
**最后更新**: 2026-07-04
