...
| v1.30 | 2026-05-28 | Rust 1.96.1 stable 发布对齐：① 演进表新增 1.96 列（`core::range` 完整迭代器（Iterator）、`ManuallyDrop` 模式、never 元组强制、null 有效性定义重构）；② 状态更新为 1.96.1 stable 已发布 [Rust 1.96.0 Release Notes 2026-05-28](https://releases.rs/docs/1.96.0/) |
