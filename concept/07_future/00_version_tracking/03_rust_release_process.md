...
> **L1 基础入口**: [版本与工具链基础](../../01_foundation/00_start/07_operators_and_symbols.md)
> **前置依赖**: [Toolchain](../../06_ecosystem/00_toolchain/01_toolchain.md) · [Editions](02_editions.md)
> **后置概念**: [Nightly Rust](04_nightly_rust.md) · [Rust 1.96 Stabilized](rust_1_96_stabilized.md) · [Rust 1.97.0 Preview (Beta)](rust_1_97_preview.md)
