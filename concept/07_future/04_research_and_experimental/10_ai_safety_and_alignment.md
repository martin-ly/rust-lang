...
> [Russell — Human Compatible: AI and the Problem of Control](https://people.eecs.berkeley.edu/~russell/hc.html) ·
> [Mitchell et al. — Model Cards for Model Reporting](https://arxiv.org/abs/1810.03993) ·
> [Katz et al. — Reluplex: An Efficient SMT Solver for Verifying Deep Neural Networks](https://arxiv.org/abs/1702.01135) ·
> [Verus — Rust Program Verifier](https://github.com/verus-lang/verus) ·
> [Aeneas — Verification for Rust](https://aeneasverif.github.io/) ·
> [Kani — Rust Verifier](https://docs.rs/kani/)
>
