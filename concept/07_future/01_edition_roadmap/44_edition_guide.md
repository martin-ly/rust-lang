...
> **后置概念**: [Evolution](../04_research_and_experimental/03_evolution.md) · [NLL](../../03_advanced/02_unsafe/08_nll_and_polonius.md)
...
> 伴随 lint 级别变化：`never_type_fallback_flowing_into_unsafe` 在 edition 2024 由 **warn 升至 deny**（防止 fallback 到 `!` 与 `unsafe` 交互产生 UB）。完整推导见承载页 [`31_never_type.md`](../../01_foundation/02_type_system/31_never_type.md)。
