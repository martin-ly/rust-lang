...
> **前置概念**: [Rust vs Java](../02_managed_languages/06_rust_vs_java.md)
...
- [L5 Rust vs Go](../01_systems_languages/02_rust_vs_go.md) —— 语言级并发哲学对比
...
- [L6 设计模式](../../06_ecosystem/03_design_patterns/02_patterns.md) —— 并发设计模式
- [L7 Effects 系统](../../07_future/03_preview_features/04_effects_system.md) —— 异步与效果系统前沿
