...
>
> **EN**: Type System
> **Summary**: - [Rust vs Scala：types系统的两种哲学](#rust-vs-scalatypes系统的两种哲学) - [📑 目录](#-目录) - [一、核心对比](#一核心对比) - [1.1 types系统](#11-types系统) - [1.2 模式匹配](#12-模式匹配) - [1.3 concurrency模型](#13-concurrency模型) - [二、语言特性差异](#二语言特性差异) - [2.1 types推断](#21-types推断) - [2.2 隐式与 Trait](#22-隐式与-trait) - [2.3 宏系统](#23-宏系统) - [三、工程实践差异](#三工程实践差异) - [3.1 构建系统](#31-构建系统
>
> **受众**: [进阶]
> **Bloom 层级**: 分析 → 评价
...
> **过渡**: Rust vs Scala：类型系统的两种哲学 的设计理念体现了 Rust 零成本抽象与安全保证的核心权衡，理解这一权衡有助于迁移到更高级的并发与形式化验证领域。
