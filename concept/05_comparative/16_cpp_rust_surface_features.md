...
> **双维定位**: C×Ana
> **前置概念**: [Rust vs C++](01_rust_vs_cpp.md) · [Variable Model](../01_foundation/03_values_and_references/20_variable_model.md) · [RTTI](../02_intermediate/04_types_and_conversions/25_rtti_and_dynamic_typing.md) · [所有权（Ownership）形式化](../04_formal/03_ownership_formal.md)
