...
> **Summary**: - [Rust vs Swift：现代系统语言的两种路径](#rust-vs-swift现代系统语言的两种路径) - [📑 目录](#-目录) - [一、核心对比](#一核心对比) - [1.1 memory管理模型](#11-memory管理模型) - [1.2 types系统与安全性](#12-types系统与安全性) - [1.3 ownership与borrowing](#13-ownership与borrowing) - [二、工程实践差异](#二工程实践差异) - [2.1 平台与生态](#21-平台与生态) - [2.2 互操作与 FFI](#22-互操作与-ffi) - [2.3 性能特征](#23-性能特征) - [三、互补使用场景](#三互补使用场景)
>
> **受众**: [进阶]
