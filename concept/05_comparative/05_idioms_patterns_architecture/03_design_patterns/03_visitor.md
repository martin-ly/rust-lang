...
- **P0**: [The Rust Reference — Trait Objects](https://doc.rust-lang.org/reference/types/trait-object.html)
...
- **P1**: Palsberg, J., Jay, C. B. *The Essence of the Visitor Pattern*. In COMPSAC '98, IEEE, 1998. [IEEE Xplore](https://ieeexplore.ieee.org/document/716629)
...
- **P2**: [Rust Design Patterns - Visitor](https://rust-unofficial.github.io/patterns/patterns/behavioural/visitor.html)
- **P2**: [Refactoring Guru - Visitor Pattern](https://refactoring.guru/design-patterns/visitor)
