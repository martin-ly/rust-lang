...
| 机制 | 不信任假设 | 验证方式 | 失效后果 |
|:---|:---|:---|:---|
| `&mut T` | 存在其他活跃引用 | 编译期借用（Borrowing）检查 | 编译错误 E0597 / E0502 |
...
| 借用规则突破 | [`../01_foundation/01_ownership_borrow_lifetime/02_borrowing.md`](../../01_foundation/01_ownership_borrow_lifetime/02_borrowing.md) §7.1 反命题与边界分析 |
