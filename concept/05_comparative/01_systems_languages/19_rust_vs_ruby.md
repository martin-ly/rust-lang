...
- [Rust vs Python](../02_managed_languages/07_rust_vs_python.md) — Rust vs Python
- [Web Development](../../06_ecosystem/06_data_and_distributed/04_application_domains.md) — Web 开发
