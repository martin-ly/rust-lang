...
> **来源**: [PostgreSQL 官方文档] · [Bitcoin 白皮书] · [Ethereum 黄皮书] · [The Rust Programming Language](https://doc.rust-lang.org/book/) · [Git 内部原理] · [Wikipedia: Zero trust security model](https://en.wikipedia.org/wiki/Zero_trust_security_model)
...
| **论断** | **来源** | **可信度** |
|:---|:---|:---|
| Safe Rust 无 UAF/double-free | [The Rust Programming Language](https://doc.rust-lang.org/book/) · [RustBelt — POPL 2018](https://plv.mpi-sws.org/rustbelt/popl18/) | ✅ |
