...
> **后置概念**: [WebAssembly](../../06_ecosystem/11_domain_applications/11_webassembly.md) · [Rust vs JavaScript](08_rust_vs_javascript.md)
...
- [Async/Await](../../03_advanced/01_async/02_async.md) — 异步编程深度分析
- [WebAssembly](../../06_ecosystem/11_domain_applications/11_webassembly.md) — WASM 生态与工具链
