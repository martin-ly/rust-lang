...
> **前置概念**: [Ownership](../../01_foundation/01_ownership_borrow_lifetime/01_ownership.md) · [Type System](../../01_foundation/02_type_system/01_type_system.md) · [Null Safety](../../02_intermediate/03_error_handling/01_error_handling.md)
> **后置概念**: [JVM Ecosystem](../../06_ecosystem/02_core_crates/01_core_crates.md) · [Android Development](../../06_ecosystem/06_data_and_distributed/01_application_domains.md)
...
> **权威来源**: [Rust Reference](https://doc.rust-lang.org/reference/introduction.html), [Kotlin Documentation](https://kotlinlang.org/docs/home.html)
>
...
理解「嵌入式测验（Embedded Quiz）」需要把握测验 1：Kotlin 的 null safety 与 Rust 的…、测验 2：Kotlin 的协程（Coroutines）与 Rust 的…、测验 3：Kotlin 运行在 JVM 上，Rust 编译为原生代码。…、测验 4：Kotlin 的扩展函数与 Rust 的 trait imp…等5个方面，本节依次展开。
