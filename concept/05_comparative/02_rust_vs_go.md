...
> **前置概念**: [Ownership](../01_foundation/01_ownership_borrow_lifetime/01_ownership.md) · [Concurrency](../03_advanced/00_concurrency/01_concurrency.md) · [Memory Management](../02_intermediate/02_memory_management/03_memory_management.md)
...
> **相关文件**: [Rust vs C++](01_rust_vs_cpp.md) · [范式矩阵](03_paradigm_matrix.md) · [问题图谱](../00_meta/04_navigation/problem_graph.md#三并发系统设计问题树)
