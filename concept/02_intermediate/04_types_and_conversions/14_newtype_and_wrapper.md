> **内容分级**: [综述级]
>
> **本节关键术语**: 新类型模式 (Newtype Pattern) · 包装类型 (Wrapper Type) · 类型安全 (Type Safety) · 零成本抽象（Zero-Cost Abstraction） · Deref — [完整对照表](../../00_meta/01_terminology/terminology_glossary.md)
>
