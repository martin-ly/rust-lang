...
> **双维定位**: C×Eva
> **前置概念**: [RTTI](../02_intermediate/25_rtti_and_dynamic_typing.md) · [Preprocessor vs Macros](../02_intermediate/26_c_preprocessor_vs_rust_macros.md) · [Exception Safety](../02_intermediate/27_exception_safety_rust_cpp.md) · [Construction](../02_intermediate/28_construction_and_initialization.md) · [Friend vs Privacy](../02_intermediate/29_friend_vs_module_privacy.md) · [Move Semantics](../01_foundation/23_move_semantics.md) · [Value vs Reference Semantics](../01_foundation/19_value_vs_reference_semantics.md)
> **后置概念**: N/A
---
