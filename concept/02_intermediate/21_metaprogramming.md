...
- [元编程：Rust 的编译期代码生成与变换](#元编程rust-的编译期代码生成与变换)
  ...
  - [一、核心概念](#一核心概念)
    ...
    - [1.2 声明宏（Declarative Macro）：模式匹配（Pattern Matching）驱动](#12-声明宏模式匹配驱动)
    - [1.3 过程宏（Procedural Macro）：语法树操作](#13-过程宏语法树操作)
  - [二、技术细节](#二技术细节)
    - [2.1 syn/quote/proc-macro2 工具体系](#21-synquoteproc-macro2-工具体系)
    - [2.2 Derive 宏（Macro）的实现机制](#22-derive-宏的实现机制)
  ...
  - [十、边界测试：元编程的编译错误](#十边界测试元编程的编译错误)
    ...
    - [10.2 边界测试：常量泛型（Generics）的非常量表达式（编译错误）](#102-边界测试常量泛型的非常量表达式编译错误)
