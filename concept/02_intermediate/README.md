...
- [测验：C/C++ → Rust 基础知识对比](08_quizzes/30_quiz_cpp_rust_foundations.md)
...
理解「嵌入式测验（Embedded Quiz）」需要把握测验 1：《L2 进阶概念层（Intermediate）》在本知识体系…、测验 2：使用本索引文件时，最有效的学习策略是什么？（理解层）与测验 3：索引文档能否替代具体概念文件的学习？（理解层），本节依次展开。
