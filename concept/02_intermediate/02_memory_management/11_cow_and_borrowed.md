> **内容分级**: [综述级]
> **本节关键术语**: 写时复制 (Copy-on-Write) · Cow · 借用（Borrowing）数据 (Borrowed Data) · 克隆 (Clone) · ToOwned — [完整对照表](../../00_meta/01_terminology/terminology_glossary.md)
>
# Cow：写时克隆与零拷贝抽象
>
> **EN**: Cow and Borrowed
...
> **后置概念**: [String Patterns](../00_traits/09_serde_patterns.md) · [Zero Cost Abstractions](../../01_foundation/00_start/06_zero_cost_abstractions.md)
