...
- [Rust 知识体系自测题库（Self-Assessment）](#rust-知识体系自测题库self-assessment)
  - [📑 目录](#-目录)
  - [L1 基础层：所有权与类型系统（8 题） 题目基于 TRPL Ch4 (所有权), Ch10 (生命周期), Ch6 (枚举) / 2024; Rust Reference — Ownership, Lifetimes, Types / 2025; RustBelt (Jung et al., POPL 2018)](#l1-基础层所有权与类型系统8-题-题目基于-trpl-ch4-所有权-ch10-生命周期-ch6-枚举--2024-rust-reference--ownership-lifetimes-types--2025-rustbelt-jung-et-al-popl-2018)
    ...
    - [Q8: 泛型单态化](#q8-泛型单态化)
  - [L2 进阶层：泛型与错误处理（7 题） 题目基于 TRPL Ch10 (泛型), Ch9 (错误处理) / 2024; Rust Reference — Generic Parameters, The ? operator / 2025; Pierce — TAPL (2002)](#l2-进阶层泛型与错误处理7-题-题目基于-trpl-ch10-泛型-ch9-错误处理--2024-rust-reference--generic-parameters-the--operator--2025-pierce--tapl-2002)
    ...
    - [Q14: Sized vs ?Sized](#q14-sized-vs-sized)
    - [Q15: 闭包捕获](#q15-闭包捕获)
  - [L3 高级层：并发与异步（8 题） 题目基于 TRPL Ch16 (并发), Rust Async Book / 2025; RustBelt (Jung et al., POPL 2018); RFC 2394 / 2018; Herlihy \& Shavit — The Art of Multiprocessor Programming (2020)](#l3-高级层并发与异步8-题-题目基于-trpl-ch16-并发-rust-async-book--2025-rustbelt-jung-et-al-popl-2018-rfc-2394--2018-herlihy--shavit--the-art-of-multiprocessor-programming-2020)
  ...
  - [L5 对比层：多语言范式（5 题） 题目基于 TRPL 跨章节对比 / 2024; Rust Reference — Types, Traits / 2025; Wikipedia — Object-oriented Programming(https://en.wikipedia.org/wiki/Object-oriented\_programming)](#l5-对比层多语言范式5-题-题目基于-trpl-跨章节对比--2024-rust-reference--types-traits--2025-wikipedia--object-oriented-programminghttpsenwikipediaorgwikiobject-oriented_programming)
  ...
  - [L6 生态层：工程实践（5 题） 题目基于 Cargo Book / 2025; Rust Reference — Crates, unsafe / 2025; Rust Internals — Edition System(https://internals.rust-lang.org/)](#l6-生态层工程实践5-题-题目基于-cargo-book--2025-rust-reference--crates-unsafe--2025-rust-internals--edition-systemhttpsinternalsrust-langorg)
  ...
  - [L5 扩展层：多语言范式对比（4 题） 题目基于 TRPL 跨语言对比 / 2024; Rust Reference — unsafe, FFI / 2025; Wikipedia — Capability-based Security(https://en.wikipedia.org/wiki/Capability-based\_security)\]](#l5-扩展层多语言范式对比4-题-题目基于-trpl-跨语言对比--2024-rust-reference--unsafe-ffi--2025-wikipedia--capability-based-securityhttpsenwikipediaorgwikicapability-based_security)
    - [Q73: Rust vs Swift](#q73-rust-vs-swift)
    - [Q74: Rust vs C# Span](#q74-rust-vs-c-span)
    - [Q75: 零成本抽象](#q75-零成本抽象)
    - [Q76: 基于能力的安全](#q76-基于能力的安全)
  - [L6 扩展层：工程实践与生态（4 题） 题目基于 Cargo Book / 2025; Rust Reference — Macros, Documentation / 2025; SemVer 2.0.0(https://semver.org/)\]](#l6-扩展层工程实践与生态4-题-题目基于-cargo-book--2025-rust-reference--macros-documentation--2025-semver-200httpssemverorg)
  ...
  - [嵌入式测验（Embedded Quiz）](#嵌入式测验embedded-quiz)
    - [测验 1：本文档《Rust 知识体系自测题库（Self-Assessment）》在 Rust 知识体系中属于哪一层级的元数据？（理解层）](#测验-1本文档rust-知识体系自测题库self-assessment在-rust-知识体系中属于哪一层级的元数据理解层)
...
## L2 进阶层：泛型与错误处理（7 题） 题目基于 TRPL Ch10 (泛型), Ch9 (错误处理) / 2024; [Rust Reference — Generic Parameters, The ? operator / 2025](https://doc.rust-lang.org/reference/items/generics.html); [Pierce — TAPL (2002)](https://www.cis.upenn.edu/~bcpierce/tapl/)

> **来源: [The Rust Programming Language](https://doc.rust-lang.org/book/title-page.html)** 泛型基于参数多态，错误处理基于代数数据类型。
...
> **来源**: [Bloom's Taxonomy (2001 Revision)](https://en.wikipedia.org/wiki/Bloom%27s_taxonomy) · [The Rust Programming Language](https://doc.rust-lang.org/book/title-page.html) · [Rust Reference](https://doc.rust-lang.org/reference/introduction.html) · [concept/知识体系]
>
## L4 形式化层：类型理论与证明（7 题） 题目基于 TAPL (Pierce, 2002); [RustBelt (Jung et al., POPL 2018)](https://plv.mpi-sws.org/rustbelt/); [Girard — Linear Logic / 1987](https://doi.org/10.1016/0304-3975(87)90045-4); [Jung — Tree Borrows (arXiv 2023)](https://arxiv.org/abs/2304.14774)

> **[TAPL](https://www.cis.upenn.edu/~bcpierce/tapl/); RustBelt; Girard; Jung** 形式化方法基于类型论、线性逻辑和分离逻辑。
...
> **来源**: [Bloom's Taxonomy (2001 Revision)](https://en.wikipedia.org/wiki/Bloom%27s_taxonomy) ·
> [The Rust Programming Language](https://doc.rust-lang.org/book/title-page.html) ·
> [Rust Reference](https://doc.rust-lang.org/reference/introduction.html) ·
> [concept/知识体系]
> **来源**: [Bloom's Taxonomy (2001 Revision)](https://en.wikipedia.org/wiki/Bloom%27s_taxonomy) ·
...
「L5 对比层：多语言范式（5 题） 题目基于 TRPL 跨…」涉及 Q31: Rust vs C++ RAII、Q32: Rust vs Haskell 类型类、Q33: Rust vs Go 并发模型、Q34: 依赖类型等5个方面，本节逐一说明其要点。
...
本节将「L6 生态层：工程实践（5 题） 题目基于 Cargo B…」分解为若干主题： Q36: Cargo Workspace、Q37: 条件编译、Q38: Miri 用途、Q39: Rust 版本兼容性等5个方面。
...
「L1 扩展层：所有权与类型系统（8 题） 来源: 题目基于…」涉及 Q41: 函数参数传递、Q42: Copy 边界、Q43: 多输入引用生命周期与Q64: Send 推导，本节逐一说明其要点。
...
>
## L2 扩展层：Trait、泛型、内存管理与错误处理（8 题） 题目基于 TRPL Ch10 (泛型), Ch9 (错误处理), Ch15 (智能指针) / 2024; [Rust Reference — Generic Parameters, The ? operator / 2025](https://doc.rust-lang.org/reference/items/generics.html); [Wikipedia — Copy-on-Write](https://en.wikipedia.org/wiki/Copy-on-write)(<https://en.wikipedia.org/wiki/Copy-on-write>)]
...
>
## L4 扩展层：线性逻辑、类型论、所有权形式化与 RustBelt（8 题） 题目基于 TAPL (Pierce, 2002); [RustBelt (Jung et al., POPL 2018)](https://plv.mpi-sws.org/rustbelt/); [Girard — Linear Logic / 1987](https://doi.org/10.1016/0304-3975(87)90045-4); [Wikipedia — Substructural Type System](https://en.wikipedia.org/wiki/Substructural_Type_System)(<https://en.wikipedia.org/wiki/Substructural_type_system>)]

本节将「L4 扩展层：线性逻辑、类型论、所有权形式化与 RustB…」分解为若干主题： Q65: 子结构逻辑、Q66: Curry-Howard 同构、Q67: Type Soundness vs Memory Safety、Q68: Iris 模态断言等8个方面。
...
> **深入阅读**：
> - L1-L3 完整理论见 [`semantic_space.md`](../00_framework/semantic_space.md) §2-3
...
fn main() {
    let mut v = vec![1, 2, 3];
    v.push(4); // 简单直观: 向向量末尾添加元素
}
```

```rust,compile_fail
// ❌ 编译错误: L1 学习者的常见误区——在存在引用时修改集合
// 试图在持有元素引用时向 Vec 添加元素

fn main() {
    let mut v = vec![1, 2, 3];
    let first = &v[0];       // 不可变借用 v 的元素
    v.push(4);               // ❌ 编译错误: 存在借用时不能可变修改 Vec
    println!("first = {}", first); // 如果允许 push，first 可能悬垂（realloc 后）
}
```
...
> **认知路径**: 本文件作为 Rust 分层知识体系的 **Rust 知识体系自测题库（Self-Assessment）** 元层导航节点，连接概念定义、学习路径与质量评估框架。

### 核心推理链

| 定理 | 前提 | 结论 | 置信度 |
|:---|:---|:---|:---|
| Self Assessment 结构化定义 ⟹ 学习者认知锚点可建立 | 本文件定义了元层结构 | 支持上层概念定位 | 高 |

> **过渡**: 利用本文件的导航结构，读者可以从当前位置快速跃迁到任意概念层级，实现非线性学习。
> **过渡**: Rust 知识体系自测题库（Self-Assessment） 的维护需要与概念内容同步更新，确保元数据与实际知识体系的一致性。
> **过渡**: 将 Rust 知识体系自测题库（Self-Assessment） 作为学习起点或复习锚点，有助于建立全局视野，避免陷入局部细节而忽视整体架构。

### 反命题与边界

> **反命题**: "元层文档可以替代具体概念学习" —— 错误。Rust 知识体系自测题库（Self-Assessment） 提供的是导航与评估框架，不能替代对核心概念（L1-L5）的深入理解与实践。
> **内容分级**: [综述级]

## 嵌入式测验（Embedded Quiz）

本节从测验 1：本文档《Rust 知识体系自测题库（Self-Assessm…、测验 2：《Rust 知识体系自测题库（Self-Assessment…与测验 3：元数据层文档能否替代 L1-L7 的核心概念学习？（理解层）切入，剖析「嵌入式测验（Embedded Quiz）」的核心内容。

### 测验 1：本文档《Rust 知识体系自测题库（Self-Assessment）》在 Rust 知识体系中属于哪一层级的元数据？（理解层）

**题目**: 本文档《Rust 知识体系自测题库（Self-Assessment）》在 Rust 知识体系中属于哪一层级的元数据？
...
### 测验 2：《Rust 知识体系自测题库（Self-Assessment）》的主要用途是什么？（理解层）

**题目**: 《Rust 知识体系自测题库（Self-Assessment）》的主要用途是什么？
