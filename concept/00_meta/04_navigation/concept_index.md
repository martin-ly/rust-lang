...
| **Gillian-Rust** | [L4: 操作语义](../../04_formal/03_operational_semantics/17_operational_semantics.md) | L4 RustBelt、L4 Miri | 评价 | ← 符号执行 + 分离逻辑 → 自动验证
...
| **Iris (Logic)** | [L4: RustBelt](../../04_formal/02_separation_logic/04_rustbelt.md) | L3 并发、L4 分离逻辑 | 评价 | → RustBelt 验证框架 |
...
| 概念 | 主文件 | 交叉引用 | Bloom 层级 | 语义链接 |
|:---|:---|:---|:---|:---|
| **Macros** | [L3: 宏](../../03_advanced/03_proc_macros/04_macros.md) | L1 类型系统、L4 元编程 | 分析 | ← 语法扩展 → DSL |
| **MaybeUninit** | [L3: Unsafe](../../03_advanced/02_unsafe/03_unsafe.md) | L1 所有权、L4 内存模型 | 评价 | ← unsafe → 延迟初始化 |
| **Memory Model** | [L3: Unsafe](../../03_advanced/02_unsafe/03_unsafe.md) | L4 RustBelt、L5 对比 | 分析 | → Stacked/Tree Borrows |
...
| **Region Types** | [L4: 所有权形式化](../../04_formal/01_ownership_logic/03_ownership_formal.md) | L1 生命周期 | 评价 | ≡ 生命周期 |
| **repr** | [L3: Unsafe](../../03_advanced/02_unsafe/03_unsafe.md) | L5 Rust vs C++ | 应用 | ← FFI → 内存布局控制 |
...
| **Separation Logic** | [L4: RustBelt](../../04_formal/02_separation_logic/04_rustbelt.md) | L1 借用、L3 并发 | 评价 | ≡ 借用规则 + 并发安全 |
| **Specialization** | [L2: Trait](../../02_intermediate/00_traits/01_traits.md) | L4 类型论、L7 演进 | 评价 | ← 泛型 → 特化实现 |
| **Stacked Borrows / Tree Borrows** | [L4: RustBelt](../../04_formal/02_separation_logic/04_rustbelt.md) | L3 Unsafe、L4 形式化 | 评价 | → Unsafe 代码别名规则 |
...
| 概念 | 主文件 | 交叉引用 | Bloom 层级 | 语义链接 |
|:---|:---|:---|:---|:---|
| **Unsafe Rust** | [L3: Unsafe](../../03_advanced/02_unsafe/03_unsafe.md) | L1 所有权、L4 RustBelt、L5 对比 | 评价 | ⚡ 所有 safe 定理的边界 |
| **Unsafe Escape Hatch** | [L0: 语义空间](../00_framework/semantic_space.md) | L3 Unsafe、L5 对比 | 分析 | ⊘ safe 封闭性 → 局部逃逸 |
| **Unpin** | [L3: 异步](../../03_advanced/01_async/02_async.md) | L3 Pin | 分析 | ⊘ Pin → 默认可移动 |
...
### 3.1 Pin（出现在 4+ 个文件中） [来源: 跨文件概念一致性检查参照 [RFC 2349](https://rust-lang.github.io/rfcs//2349-pin.html) — Pin / 2018; concept/03_advanced/01_async/02_async.md 等 4+ 文件中的 Pin 定义一致性验证]

| 文件 | 定义侧重点 | 一致性检查 |
|:---|:---|:---|
| [L3: 异步](../../03_advanced/01_async/02_async.md) | Pin 的核心定义：自引用安全 | ✅ 主定义 |
...
| [L4: 形式化](../../04_formal/01_ownership_logic/03_ownership_formal.md) | Pin 的形式化语义 | ✅ 已添加 🔍 待补充标记，链接到 L3 §8 |
...
| [L4: RustBelt](../../04_formal/02_separation_logic/04_rustbelt.md) | Send/Sync 的并发分离逻辑语义 | ✅ 已显式映射 |
...
| [L3: 异步](../../03_advanced/01_async/02_async.md) | 生命周期在 Future 中的传播 | ⚠️ 需链接 |
| [L4: 形式化](../../04_formal/01_ownership_logic/03_ownership_formal.md) | 区域类型的形式化对应 | ✅ 已显式映射 |
...
| 项目 | 规范 |
|:---|:---|
| **主定义文件** | [`../03_advanced/01_async/02_async.md`](../../03_advanced/01_async/02_async.md) §5–§8 |
...
| 项目 | 规范 |
|:---|:---|
| **主定义文件** | [`../03_advanced/02_unsafe/03_unsafe.md`](../../03_advanced/02_unsafe/03_unsafe.md) §1–§3 |
...
| 异步判定树 | `03_advanced/01_async/02_async.md` | 4 | 4 | 5 |
| Unsafe 判定树 | `03_advanced/02_unsafe/03_unsafe.md` | 3 | 5 | 6 |
