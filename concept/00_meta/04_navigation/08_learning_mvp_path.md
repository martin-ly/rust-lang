...
理解「Week 1: 基础能力构建」需要把握 Day 1-2: Hello World + 基础语法 [4h]、Day 3-4: 所有权与借用 [6h]、Day 5-6: 类型系统与错误处理 [6h]与Day 7: 第一个 CLI 工具（无并发） [4h]，本节依次展开。
...
本节从 Day 8-9: 集合与迭代器 [4h]、Day 10-11: 多线程与并发 [6h]、Day 12-13: 异步基础 [6h]与Day 14: 综合项目：多线程/异步 CLI [4h]切入，剖析「Week 2: 并发与工程化」的核心内容。
