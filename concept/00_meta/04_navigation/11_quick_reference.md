...
## 一、核心概念速查（按字母序） 来源: 速查内容基于 Rust Reference / [The Rust Programming Language](https://doc.rust-lang.org/book/title-page.html) / [Rustonomicon](https://doc.rust-lang.org/nomicon/index.html) / RFCs; 概念定义与 concept / 目录核心文件保持一致

> **来源: [Rust Standard Library](https://doc.rust-lang.org/std/index.html) / 2025; Rust Reference / 2025; TRPL / 2024** 本速查表的所有概念定义均来源于 Rust 官方文档和学术论文。
...
**深入**: [`02_async.md`](../../03_advanced/01_async/01_async.md)
...
**深入**: [`03_memory_management.md`](../../02_intermediate/02_memory_management/01_memory_management.md)
...
**关联**: 消费型方法链 · 类型状态
**深入**: [`02_patterns.md`](../../06_ecosystem/03_design_patterns/01_patterns.md)
...
**深入**: [`02_generics.md`](../../02_intermediate/01_generics/01_generics.md)
...
**深入**: [`04_type_system.md`](../../01_foundation/02_type_system/01_type_system.md)
...
**深入**: [`04_error_handling.md`](../../02_intermediate/03_error_handling/01_error_handling.md)
...
**深入**: [`03_unsafe.md`](../../03_advanced/02_unsafe/01_unsafe.md)
...
**深入**: [`02_type_theory.md`](../../04_formal/00_type_theory/01_type_theory.md)
...
**关联**: 过程宏 · 卫生宏 · 元编程
**深入**: [`04_macros.md`](../../03_advanced/03_proc_macros/01_macros.md)
...
**关联**: 嵌入式 · 裸机 · libcore
**深入**: [`04_application_domains.md`](../../06_ecosystem/06_data_and_distributed/01_application_domains.md)
...
| **E0277** | size not known at compile time | 使用 `?Sized` 但未正确处理 DST | 通过引用/Box 使用 DST | [02_generics](../../02_intermediate/01_generics/01_generics.md) |
| **E0308** | mismatched types | 类型不匹配 | 检查泛型参数、类型推断歧义 | [04_type_system](../../01_foundation/02_type_system/01_type_system.md) |
...
| **E0392** | parameter `T` is never used | 泛型参数未在类型中使用 | 使用 `PhantomData<T>` 标记 | [02_generics](../../02_intermediate/01_generics/01_generics.md) |
| **E0433** | failed to resolve use statement | 模块路径错误 | 检查 `use` 路径和模块结构 | [04_type_system](../../01_foundation/02_type_system/01_type_system.md) |
...
| **E0603** | module is private | 访问私有模块 | 使用 `pub` 暴露或检查可见性 | [04_type_system](../../01_foundation/02_type_system/01_type_system.md) |
...
> **深入阅读**: 本速查的完整理论背景见 [`semantic_space.md`](../00_framework/semantic_space.md) §4（等价表达的语义保持）；系统学习路径见 [`07_learning_guide.md`](07_learning_guide.md)。
---
...
> | 来源 | 链接 |
> |:---|:---|
> | Rust Reference | [doc.rust-lang.org/reference](https://doc.rust-lang.org/reference/introduction.html) |
> | TRPL | [doc.rust-lang.org/book](https://doc.rust-lang.org/book/title-page.html) |
> | Rustonomicon | [doc.rust-lang.org/nomicon](https://doc.rust-lang.org/nomicon/index.html) |
> | Rust Standard Library | [doc.rust-lang.org/std](https://doc.rust-lang.org/std/index.html) |
> | Rust Async Book | [rust-lang.github.io/async-book](https://rust-lang.github.io/async-book/index.html) |
> | Cargo Book | [doc.rust-lang.org/cargo](https://doc.rust-lang.org/cargo/index.html) |
...
>
> [Authority Source Sprint Batch 8](../02_sources/05_international_authority_index.md)
