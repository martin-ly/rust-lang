...
- [Rust 知识体系自测题库（Self-Assessment）](#rust-知识体系自测题库self-assessment)
  ...
  - [L5 对比层：多语言范式（5 题）](#l5-对比层多语言范式5-题)
  ...
  - [](#)
  - [L1 扩展层：所有权与类型系统（8 题）](#l1-扩展层所有权与类型系统8-题)
  ...
  - [L2 扩展层：Trait、泛型、内存管理与错误处理（8 题）](#l2-扩展层trait泛型内存管理与错误处理8-题)
  ...
  - [L3 扩展层：并发、异步、unsafe 与宏（8 题）](#l3-扩展层并发异步unsafe-与宏8-题)
  ...
  - [L4 扩展层：线性逻辑、类型论、所有权形式化与 RustBelt（8 题）](#l4-扩展层线性逻辑类型论所有权形式化与-rustbelt8-题)
    - [Q65: 子结构逻辑](#q65-子结构逻辑)
