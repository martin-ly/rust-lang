...
| **Async/Await** | Reference § async blocks · [RFC 3185](https://rust-lang.github.io/rfcs//3185-static-async-fn-in-trait.html) (async fn in traits) | POPL 2023 *"Asynchronous Execution in Rust"* 类工作 | Without Boats *"Pin and Suffering"* · Niko Matsakis *"Async/Await I: Self-Referential Structs"* | C++20 Coroutines (`co_await`) | Async/IO Monads · `async`/`await` 语法糖 | Goroutine + Channel（隐式调度） |
