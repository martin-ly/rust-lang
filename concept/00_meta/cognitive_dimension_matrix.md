...
- [Rust 知识体系双维认知矩阵（Krathwohl × Bloom）](.#rust-知识体系双维认知矩阵krathwohl--bloom)
  ...
  - [嵌入式测验（Embedded Quiz）](.#嵌入式测验embedded-quiz)
    - [测验 1：本文档《Rust 知识体系双维认知矩阵（Krathwohl × Bloom）》在 Rust 知识体系中属于哪一层级的元数据？（理解层）](.#测验-1本文档rust-知识体系双维认知矩阵krathwohl--bloom在-rust-知识体系中属于哪一层级的元数据理解层)
    - [测验 2：《Rust 知识体系双维认知矩阵（Krathwohl × Bloom）》的主要用途是什么？（理解层）](.#测验-2rust-知识体系双维认知矩阵krathwohl--bloom的主要用途是什么理解层)
...
> **认知功能**:
> 本 mindmap 展示双维矩阵的**三维结构**——两个维度（知识类型 × 认知过程）加上交叉示例。
...
> **关键洞察**:
> 传统编程教育过度强调事实性知识（语法记忆），而 Rust 的独特挑战在于**概念性知识**（所有权心智模型）和**程序性知识**（与编译器"协商"的策略）。
> 本矩阵明确标注每种内容的知识类型，帮助学习者分配认知资源。[来源: 💡 原创分析]
...
> **相关文件**: [A/S/P 标记规范](asp_marking_guide.md) · [能力图谱](competency_graph.md) · [方法论](methodology.md) · [概念索引](concept_index.md)
...
| 定理 | 前提 | 结论 | 置信度 |
|:---|:---|:---|:---|
| Cognitive Dimension Matrix 结构化定义 ⟹ 学习者认知锚点可建立 | 本文件定义了元层结构 | 支持上层概念定位 | 高 |
...
### 测验 1：本文档《Rust 知识体系双维认知矩阵（Krathwohl × Bloom）》在 Rust 知识体系中属于哪一层级的元数据？（理解层）

**题目**: 本文档《Rust 知识体系双维认知矩阵（Krathwohl × Bloom）》在 Rust 知识体系中属于哪一层级的元数据？
...
### 测验 2：《Rust 知识体系双维认知矩阵（Krathwohl × Bloom）》的主要用途是什么？（理解层）

**题目**: 《Rust 知识体系双维认知矩阵（Krathwohl × Bloom）》的主要用途是什么？
