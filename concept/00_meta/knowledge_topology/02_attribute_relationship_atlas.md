...
| [TRPL 3rd Ed 章节映射](../06_trpl_3rd_ed_mapping.md) | L0 元信息层 | — | — | — | — | — |
...
| [控制流：表达式导向的流程控制](../../01_foundation/04_control_flow/01_control_flow.md) | L1 基础概念层 | 初学者 | 综述级 | — | L2-L3 | — |
| [模式匹配](../../01_foundation/04_control_flow/02_patterns.md) | L1 基础概念层 | 初学者 | 综述级 | S | L2-L3 | Pattern → Refutability → Exhaustiveness |
| [语句与表达式](../../01_foundation/04_control_flow/04_statements_and_expressions.md) | L1 基础概念层 | 初学者 | 综述级 | S | L2-L3 | Expression → Evaluation Order → Statement Sequencing |
| [集合类型：Rust 标准库的数据结构谱系](../../01_foundation/05_collections/01_collections.md) | L1 基础概念层 | 初学者 | 综述级 | A | L2-L4 | — |
| [高级集合类型：BTreeMap、VecDeque、BinaryHeap 与自定义 Hasher 深度分析](../../01_foundation/05_collections/02_collections_advanced.md) | L1 基础概念层 | 初学者 | 综述级 | — | L4-L5 | — |
| [字符串与文本：Rust 的 Unicode 处理与格式化系统](../../01_foundation/06_strings_and_text/01_strings_and_text.md) | L1 基础概念层 | 初学者 | 综述级 | — | L2-L4 | — |
| [字符串与编码：Rust 的文本处理类型系统](../../01_foundation/06_strings_and_text/02_strings_and_encoding.md) | L1 基础概念层 | 初学者 | 综述级 | — | L3-L4 | — |
| [格式化与显示](../../01_foundation/06_strings_and_text/03_formatting_and_display.md) | L1 基础概念层 | 初学者 | 基础级 | A | L1-L3 | — |
| [模块系统与路径：Rust 的代码组织哲学](../../01_foundation/07_modules_and_items/01_modules_and_paths.md) | L1 基础概念层 | 初学者 | 综述级 | A | L1-L3 | — |
| [Functions](../../01_foundation/07_modules_and_items/02_functions.md) | L1 基础概念层 | 初学者 | 基础级 | — | L1-L2 | — |
| [Use Declarations](../../01_foundation/07_modules_and_items/03_use_declarations.md) | L1 基础概念层 | 初学者 | 基础级 | — | L1-L3 | — |
...
| [智能指针：堆内存管理与共享语义](../../02_intermediate/02_memory_management/04_smart_pointers.md) | L2 进阶概念层 | 进阶 | 综述级 | — | L3-L4 | — |
...
| [高级类型系统：从关联类型到类型级编程](../../02_intermediate/04_types_and_conversions/04_type_system_advanced.md) | L2 进阶概念层 | 进阶 | 综述级 | S | L4-L5 | — |
| [RTTI 与动态类型识别：从 C++ 到 Rust](../../02_intermediate/04_types_and_conversions/05_rtti_and_dynamic_typing.md) | L2 进阶概念层 | 进阶 | 参考级 | — | L2-L5 | — |
...
| [Cross-Platform Concurrency](../../03_advanced/00_concurrency/05_cross_platform_concurrency.md) | L3 高级概念层 | 专家 | 专家级 | — | L4-L5 | — |
| [原子操作与内存序：无锁并发的精确控制](../../03_advanced/00_concurrency/06_atomics_and_memory_ordering.md) | L3 高级概念层 | 专家 | 专家级 | — | L4-L5 | — |
| [无锁编程与内存模型](../../03_advanced/00_concurrency/07_lock_free.md) | L3 高级概念层 | 专家 | 专家级 | — | L4-L5 | — |
| [并行与分布式模式谱系：从线程池到共识算法](../../03_advanced/00_concurrency/08_parallel_distributed_pattern_spectrum.md) | L3 高级概念层 | 专家 | 专家级 | — | L3-L6 | — |
...
| [Stream 代数与背压：拉取式序列的形式刻画](../../03_advanced/01_async/09_stream_algebra_and_backpressure.md) | L3 高级概念层 | 进阶-专家 | 专家级 | S | L3-L4 | — |
...
| [术语表 - C11 Macro System](../../03_advanced/03_proc_macros/06_macro_glossary.md) | L3 高级概念层 | 研究者 | 参考级 | S | L4-L5 | Terminology Standardization ⟹ Concept Alignment ⟹ Communication Efficiency |
...
| [内联汇编 (Inline Assembly)](../../03_advanced/05_inline_assembly/01_inline_assembly.md) | L3 高级概念层 | 专家 | 专家级 | P | L4-L5 | — |
| [自定义分配器与内存布局优化](../../03_advanced/06_low_level_patterns/01_custom_allocators.md) | L3 高级概念层 | 专家 | 专家级 | — | L3-L4 | — |
| [零拷贝解析与序列化优化](../../03_advanced/06_low_level_patterns/02_zero_copy_parsing.md) | L3 高级概念层 | 专家 | 专家级 | — | L3-L4 | — |
...
| [Type Theory](../../04_formal/00_type_theory/01_type_theory.md) | L4 形式化理论层 | 研究者 | 专家级 | S | L4-L5 | — |
| [子类型与变型：Rust 类型系统中的协变、逆变与不变](../../04_formal/00_type_theory/02_subtype_variance.md) | L4 形式化理论层 | 研究者 | 专家级 | S | L4-L5 | — |
| [类型推断：Hindley-Milner 算法与 Rust 的工业实现](../../04_formal/00_type_theory/03_type_inference.md) | L4 形式化理论层 | 研究者 | 专家级 | S | L4-L5 | — |
| [范畴论与 Rust：从函子到单子](../../04_formal/00_type_theory/04_category_theory.md) | L4 形式化理论层 | 研究者 | 专家级 | — | L4-L5 | — |
| [Lambda 演算与 Rust 计算模型](../../04_formal/00_type_theory/05_lambda_calculus.md) | L4 形式化理论层 | 研究者 | 专家级 | — | L4-L5 | — |
| [Type Semantics](../../04_formal/00_type_theory/06_type_semantics.md) | L4 形式化理论层 | 研究者 | 专家级 | S | — | — |
| [rustc 类型检查与类型推断](../../04_formal/00_type_theory/07_type_checking_and_inference.md) | L4 形式化理论层 | 专家 / 研究者 | 综述级 | F | L2-L4 | — |
| [Type Inference Complexity](../../04_formal/00_type_theory/08_type_inference_complexity.md) | L4 形式化理论层 | 研究者 | 专家级 | F | L4-L5 | — |
| [类型系统参考](../../04_formal/00_type_theory/09_type_system_reference.md) | L4 形式化理论层 | 研究者 | 研究级 | S | L2-L4 | Type → Kind → Size/Align → Lifetime → Trait Bounds |
| [Linear Logic & Affine Logic](../../04_formal/01_ownership_logic/01_linear_logic.md) | L4 形式化理论层 | 研究者 | 专家级 | S | L4-L5 | — |
| [Ownership Formalization](../../04_formal/01_ownership_logic/02_ownership_formal.md) | L4 形式化理论层 | 研究者 | 专家级 | — | — | — |
| [线性逻辑在 Rust 中的工程应用](../../04_formal/01_ownership_logic/03_linear_logic_applications.md) | L4 形式化理论层 | 研究者 | 专家级 | — | L4-L5 | — |
| [Borrow Checking Decidability](../../04_formal/01_ownership_logic/04_borrow_checking_decidability.md) | L4 形式化理论层 | 研究者 | 专家级 | — | L4-L5 | — |
| [Tree Borrows 深度解析](../../04_formal/01_ownership_logic/05_tree_borrows_deep_dive.md) | L4 形式化理论层 | 进阶 | 专家级 | S | L4-L5 | N/A — 操作语义研究 |
| [未定义行为清单](../../04_formal/01_ownership_logic/06_behavior_considered_undefined.md) | L4 形式化理论层 | 专家 | 研究级 | S | L2-L4 | Unsafe Contract → UB 清单 → Soundness |
| [RustBelt & Verification Toolchain](../../04_formal/02_separation_logic/01_rustbelt.md) | L4 形式化理论层 | 研究者 | 专家级 | — | L4-L5 | — |
| [分离逻辑：Rust 所有权的形式化根基](../../04_formal/02_separation_logic/02_separation_logic.md) | L4 形式化理论层 | 研究者 | 专家级 | — | L5-L6 | — |
| [Safety Tags](../../04_formal/02_separation_logic/03_safety_tags_in_formal.md) | L4 形式化理论层 | — | — | — | — | — |
| [BorrowSanitizer 运行时别名模型检测](../../04_formal/02_separation_logic/04_borrow_sanitizer_in_formal.md) | L4 形式化理论层 | 进阶 | 专家级 | — | L4-L5 | N/A — 工具链/运行时（Runtime）研究 |
| [指称语义与领域理论](../../04_formal/03_operational_semantics/01_denotational_semantics.md) | L4 形式化理论层 | 研究者 | 专家级 | — | L4-L5 | — |
| [Hoare 逻辑：程序验证的形式化基础与 Rust 契约](../../04_formal/03_operational_semantics/02_hoare_logic.md) | L4 形式化理论层 | 研究者 | 专家级 | — | L4-L5 | — |
...
| [认证工具链与认证包清单](../../04_formal/04_model_checking/10_certified_toolchains_and_packages.md) | L4 形式化理论层 | 专家 | 专家级 | S | L4-L6 | — |
| [Rustc 查询系统与增量编译](../../04_formal/05_rustc_internals/01_rustc_query_system.md) | L4 形式化理论层 | 专家 / 研究者 | 综述级 | F | L2-L4 | — |
| [MIR、Codegen 与 LLVM IR 入门](../../04_formal/05_rustc_internals/02_mir_codegen_llvm_primer.md) | L4 形式化理论层 | 专家 / 研究者 | 综述级 | F | L2-L4 | — |
| [rustc 中的 Trait Solver](../../04_formal/05_rustc_internals/03_trait_solver_in_rustc.md) | L4 形式化理论层 | 专家 / 研究者 | 综述级 | F | L2-L4 | — |
| [Rustc 名称解析与 HIR](../../04_formal/05_rustc_internals/04_name_resolution_and_hir.md) | L4 形式化理论层 | 专家 / 研究者 | 综述级 | F | L2-L4 | — |
| [Application Binary Interface](../../04_formal/05_rustc_internals/05_application_binary_interface.md) | L4 形式化理论层 | 专家 | 研究级 | S | L2-L3 | N/A — 语言规范/平台相关文档 |
| [名称、作用域与解析](../../04_formal/05_rustc_internals/06_names_and_resolution.md) | L4 形式化理论层 | 研究者 | 研究级 | S | L2-L4 | Entity → Declaration → Scope → Namespace → Path → Resolution |
| [特殊类型与 Trait](../../04_formal/05_rustc_internals/07_special_types_and_traits.md) | L4 形式化理论层 | 研究者 | 研究级 | S | L2-L4 | Special Type → Compiler Support → Safety Guarantee |
| [类型布局](../../04_formal/05_rustc_internals/08_type_layout.md) | L4 形式化理论层 | 研究者 | 研究级 | S | L2-L4 | Type → Size/Align/Offset → Repr → ABI |
| [析构函数与 Drop Scope](../../04_formal/05_rustc_internals/09_destructors.md) | L4 形式化理论层 | 研究者 | 研究级 | S | L2-L4 | Scope → Drop Order → Temporary Lifetime Extension |
| [词法结构](../../04_formal/05_rustc_internals/10_lexical_structure.md) | L4 形式化理论层 | 研究者 | 研究级 | S | L2-L4 | Source Bytes → Unicode → Tokens → AST |
| [条目参考](../../04_formal/05_rustc_internals/11_items_reference.md) | L4 形式化理论层 | 研究者 | 研究级 | S | L2-L4 | Crate → Module → Item → Declaration |
...
| [Rust vs Kotlin：静态安全的两种路径](../../05_comparative/02_managed_languages/04_rust_vs_kotlin.md) | L5 对比分析层 | 进阶 | 综述级 | — | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Rust vs Scala：类型系统的两种哲学](../../05_comparative/02_managed_languages/05_rust_vs_scala.md) | L5 对比分析层 | 进阶 | 综述级 | — | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Rust vs C#：托管与原生之路](../../05_comparative/02_managed_languages/06_rust_vs_csharp.md) | L5 对比分析层 | 进阶 | 综述级 | — | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Rust vs Elixir 对比分析](../../05_comparative/02_managed_languages/07_rust_vs_elixir.md) | L5 对比分析层 | 进阶 | 综述级 | — | L5-L6 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Rust vs TypeScript：静态类型系统的两种哲学 —— 编译期证明与渐进式工程](../../05_comparative/02_managed_languages/08_rust_vs_typescript.md) | L5 对比分析层 | 进阶 | 综述级 | — | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Rust 安全保证的边界条件全景](../../05_comparative/03_domain_comparisons/01_safety_boundaries.md) | L5 对比分析层 | 进阶 | 专家级 | — | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Toolchain](../../06_ecosystem/00_toolchain/01_toolchain.md) | L6 生态工程层 | 进阶 | 综述级 | — | L2-L6 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [日志与可观测性：Rust 服务端监控生态](../../06_ecosystem/00_toolchain/02_logging_observability.md) | L6 生态工程层 | 进阶 | 综述级 | — | L2-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [DevOps 与 CI/CD：Rust 的持续交付工程实践](../../06_ecosystem/00_toolchain/03_devops_and_ci_cd.md) | L6 生态工程层 | 进阶 | 综述级 | — | L3-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
...
| [Rustdoc 1.96–1.97 变更](../../06_ecosystem/00_toolchain/07_rustdoc_196_changes.md) | L6 生态工程层 | 进阶 / 工程 | 专家级 | A | L2-L3 | — |
...
| [rustc / Cargo `-Z` 不稳定选项参考清单](../../06_ecosystem/00_toolchain/15_z_flags_reference.md) | L6 生态工程层 | — | — | — | L4-L5 | — |
...
| [Cargo Registry 与包发布](../../06_ecosystem/01_cargo/08_cargo_registries_and_publishing.md) | L6 生态工程层 | 中级 → 高级 | 综述级 | A | L2-L3 | — |
| [Cargo 认证与构建缓存](../../06_ecosystem/01_cargo/09_cargo_authentication_and_cache.md) | L6 生态工程层 | 中级 → 高级 | 综述级 | A | L2-L3 | — |
| [Cargo Manifest 参考速查](../../06_ecosystem/01_cargo/10_cargo_manifest_reference.md) | L6 生态工程层 | 中级 → 高级 | 参考级 | A | L2-L3 | — |
...
| [Cargo 指南实践](../../06_ecosystem/01_cargo/17_cargo_guide_practices.md) | L6 生态工程层 | 进阶 | 参考级 | A | L2-L3 | — |
| [Cargo 配置与环境变量](../../06_ecosystem/01_cargo/18_cargo_configuration.md) | L6 生态工程层 | 进阶 | 参考级 | A | L2-L3 | — |
| [Cargo 命令参考](../../06_ecosystem/01_cargo/19_cargo_commands_reference.md) | L6 生态工程层 | 进阶 | 参考级 | A | L2-L3 | — |
| [Cargo Manifest 目标与元数据](../../06_ecosystem/01_cargo/20_cargo_manifest_targets.md) | L6 生态工程层 | 进阶 | 参考级 | A | L2-L3 | — |
| [Cargo Registry 内部机制](../../06_ecosystem/01_cargo/21_cargo_registry_internals.md) | L6 生态工程层 | 专家 | 参考级 | P | L2-L4 | — |
| [Cargo build-std](../../06_ecosystem/01_cargo/22_build_std.md) | L6 生态工程层 | 进阶 / 工程 | — | A | L2-L3 | — |
| [Cargo 1.97 新特性与工具链变更](../../06_ecosystem/01_cargo/23_cargo_197_features.md) | L6 生态工程层 | 进阶 / 工程 | 专家级 | A | L2-L3 | — |
...
| [Rust CLI 开发生态](../../06_ecosystem/05_systems_and_embedded/04_cli_development.md) | L6 生态工程层 | 进阶 | 综述级 | — | L3-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Rust 操作系统内核开发](../../06_ecosystem/05_systems_and_embedded/05_os_kernel.md) | L6 生态工程层 | 进阶 | 专家级 | — | — | — |
| [Robotics & ROS2 in Rust](../../06_ecosystem/05_systems_and_embedded/06_robotics.md) | L6 生态工程层 | 进阶 | 综述级 | — | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Rust 嵌入式图形开发](../../06_ecosystem/05_systems_and_embedded/07_embedded_graphics.md) | L6 生态工程层 | 进阶 | 综述级 | — | — | — |
| [C-to-Rust Translation Ecosystem](../../06_ecosystem/05_systems_and_embedded/08_c_to_rust_translation.md) | L6 生态工程层 | 进阶 | 综述级 | P | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Embedded-HAL 1.0 迁移与 Embassy 生产状态](../../06_ecosystem/05_systems_and_embedded/09_embedded_hal_1_0_migration.md) | L6 生态工程层 | 进阶 / 工程 | — | — | L2-L4 | — |
| [Target Tier 平台支持全景：分层保证与 1.90–1.97 变迁](../../06_ecosystem/05_systems_and_embedded/10_target_tier_platform_support.md) | L6 生态工程层 | — | — | — | L3-L4 | — |
| [Application Domains](../../06_ecosystem/06_data_and_distributed/01_application_domains.md) | L6 生态工程层 | 进阶 | 综述级 | — | L4-L6 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Rust 数据库访问生态](../../06_ecosystem/06_data_and_distributed/02_database_access.md) | L6 生态工程层 | 进阶 | 综述级 | — | L3-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [流处理生态：Rust 实现与工业系统全景](../../06_ecosystem/06_data_and_distributed/03_stream_processing_ecosystem.md) | L6 生态工程层 | 进阶 | 专家级 | P | L3-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [数据库系统：Rust 在存储引擎中的语义](../../06_ecosystem/06_data_and_distributed/04_database_systems.md) | L6 生态工程层 | 进阶 | 专家级 | P | L3-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
...
| [cargo vet 与供应链审计](../../06_ecosystem/07_security_and_cryptography/03_cargo_vet_supply_chain.md) | L6 生态工程层 | 进阶 / 工程 | 专家级 | P | L3-L4 | — |
| [Formal Ecosystem Tower](../../06_ecosystem/08_formal_verification/01_formal_ecosystem_tower.md) | L6 生态工程层 | 进阶 | 专家级 | — | L5-L6 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Formal Verification Tools](../../06_ecosystem/08_formal_verification/02_formal_verification_tools.md) | L6 生态工程层 | 进阶 | 专家级 | — | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Rust 测试策略：从单元测试到属性验证](../../06_ecosystem/09_testing_and_quality/01_testing_strategies.md) | L6 生态工程层 | 进阶 | 专家级 | — | L3-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [文档生态：rustdoc、文档测试与 API 文档规范](../../06_ecosystem/09_testing_and_quality/02_documentation.md) | L6 生态工程层 | 进阶 | 综述级 | A | L2-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [测试生态：单元测试、集成测试与验证策略](../../06_ecosystem/09_testing_and_quality/03_testing.md) | L6 生态工程层 | 进阶 | 综述级 | — | L2-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [基准测试：Rust 代码性能测量与回归检测](../../06_ecosystem/09_testing_and_quality/04_benchmarking.md) | L6 生态工程层 | 进阶 | 指南级 | — | L2-L4 | — |
| [性能优化：Rust 代码的测量与调优](../../06_ecosystem/10_performance/01_performance_optimization.md) | L6 生态工程层 | 进阶 | 专家级 | — | L3-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Blockchain & Smart Contract Security](../../06_ecosystem/11_domain_applications/01_blockchain.md) | L6 生态工程层 | 进阶 | 专家级 | — | L4-L6 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Game Development & ECS Architecture](../../06_ecosystem/11_domain_applications/02_game_ecs.md) | L6 生态工程层 | 进阶 | 专家级 | — | L3-L6 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [WebAssembly 生态：Rust 的浏览器外运行时](../../06_ecosystem/11_domain_applications/03_webassembly.md) | L6 生态工程层 | 进阶 | 综述级 | — | L3-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [许可证与合规：Rust 项目的法律工程](../../06_ecosystem/11_domain_applications/04_licensing_and_compliance.md) | L6 生态工程层 | 进阶 | 专家级 | — | L3-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
...
| [安全关键 Rust 专题索引](../../06_ecosystem/11_domain_applications/21_safety_critical_topic_index.md) | L6 生态工程层 | — | — | — | L4-L6 | — |
| [AUTOSAR 与 Rust](../../06_ecosystem/11_domain_applications/22_autosar_and_rust.md) | L6 生态工程层 | 进阶 / 专家 | 专家级 | S | L3-L5 | — |
...
| [Rust 的发布流程与 Nightly Rust](../../07_future/00_version_tracking/04_nightly_rust.md) | L7 前沿趋势层 | 初学者 | 研究级 | S | L2 | N/A — 流程/生态文档 |
...
| [Effects System: Concept Pre-study](../../07_future/02_preview_features/01_effects_system.md) | L7 前沿趋势层 | 专家 | 综述级 | S | L4-L7 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [MC/DC Coverage 概念预研：安全关键 Rust 的覆盖率验证](../../07_future/02_preview_features/02_mcdc_coverage_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Safety Tags 概念预研：Unsafe 契约的机器可读标注](../../07_future/02_preview_features/03_safety_tags_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [并行 前端编译预研：Rust 编译器 的多核扩展](../../07_future/02_preview_features/04_parallel_frontend_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L3-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [派生 CoercePointee 预研：智能指针的自动类型强制](../../07_future/02_preview_features/05_derive_coerce_pointee_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L3-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Const Trait Impl 预研：常量上下文中的 Trait 泛化](../../07_future/02_preview_features/06_const_trait_impl_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L3-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Stable ABI Preview](../../07_future/02_preview_features/07_stable_abi_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L2-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Inline Const Pattern 预览](../../07_future/02_preview_features/08_inline_const_pattern_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | A | L2-L3 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Return Type Notation（RTN）预研：为 AFIT/RPITIT 返回类型添加边界](../../07_future/02_preview_features/09_return_type_notation_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [`must_not_suspend` Lint Preview](../../07_future/02_preview_features/10_must_not_suspend_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | P | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Unsafe Fields 预研：字段级安全边界的精确标注](../../07_future/02_preview_features/11_unsafe_fields_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Ferrocene：已交付的 Rust 安全关键认证工具链](../../07_future/02_preview_features/12_ferrocene_preview.md) | L7 前沿趋势层 | 专家 | 专家级 | — | L4-L5 | — |
| [Lifetime Capture in `impl Trait` Preview](../../07_future/02_preview_features/13_lifetime_capture_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Pin Ergonomics 与 Reborrow Traits 预研：超越 `Pin::as_mut`](../../07_future/02_preview_features/14_pin_ergonomics_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | — | L4-L5 | — |
| [特质中返回位置 impl Trait（RPITIT）预览](../../07_future/02_preview_features/15_rpitit_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | — | L3-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Cranelift 后端预研：Rust 编译器的快速调试编译](../../07_future/02_preview_features/16_cranelift_backend_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L3-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [TAIT Preview](../../07_future/02_preview_features/17_type_alias_impl_trait_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L3-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Arbitrary Self Types 预览：自定义方法接收器](../../07_future/02_preview_features/18_arbitrary_self_types_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Const Trait 实现预览](../../07_future/02_preview_features/19_const_trait_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | — | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Ergonomic Ref-Counting 预研：人机工学引用计数](../../07_future/02_preview_features/20_ergonomic_ref_counting_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | — | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Rust 语言规范预研：从参考文档到形式化规范](../../07_future/02_preview_features/21_rust_specification_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Async Drop：异步资源的优雅销毁](../../07_future/02_preview_features/22_async_drop_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Field Projections 预览：安全的字段级投影](../../07_future/02_preview_features/23_field_projections_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [BorrowSanitizer：动态别名规则验证工具](../../07_future/02_preview_features/24_borrow_sanitizer.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L4-L5 | N/A — 描述性/综述性/工具链文档 |
| [Gen Blocks 预研：超越异步的泛化生成器](../../07_future/02_preview_features/25_gen_blocks_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L3-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [`std::autodiff`：Rust 官方自动微分前沿追踪](../../07_future/02_preview_features/26_std_autodiff_preview.md) | L7 前沿趋势层 | 研究者 | 实验级 | — | L5-L6 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [cargo-semver-checks：从社区工具到 Cargo 官方集成](../../07_future/02_preview_features/27_cargo_semver_checks_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | P | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [WASM Target Evolution Preview](../../07_future/02_preview_features/28_wasm_target_evolution.md) | L7 前沿趋势层 | 专家 | 综述级 | — | L2-L4 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [AArch64 SVE / SME：可伸缩向量扩展预览](../../07_future/02_preview_features/29_aarch64_sve_sme_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Rust in Space Preview](../../07_future/02_preview_features/30_rust_in_space.md) | L7 前沿趋势层 | 专家 | 综述级 | — | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [Specialization：Trait 实现的精确化与重叠解析](../../07_future/02_preview_features/31_specialization_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [编译期执行与常量求值](../../07_future/02_preview_features/32_compile_time_execution.md) | L7 前沿趋势层 | 专家 | 综述级 | — | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [AutoVerus / Verus 预览跟踪](../../07_future/02_preview_features/33_autoverus_preview.md) | L7 前沿趋势层 | 进阶 | 专家级 | — | L7（版本与生态跟踪） | N/A — 形式化验证工具/AI 辅助证明研究跟踪 |
| [Open Enums 概念预研：从 `#[non_exhaustive]` 到可扩展枚举](../../07_future/02_preview_features/34_open_enums_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L4-L5 | N/A — 描述性/综述性/导航性文档，不涉及形式化定理链 |
| [f16 / f128 预研：半精度与四精度浮点类型](../../07_future/02_preview_features/35_f16_f128_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L3-L4 | N/A — 描述性/跟踪性文档，不涉及形式化定理链 |
| [UnsafePinned 预研：可变引用别名语义的精确标注](../../07_future/02_preview_features/36_unsafe_pinned_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L4-L5 | N/A — 描述性/跟踪性文档，不涉及形式化定理链 |
| [Default Field Values 预研：结构体字段默认值](../../07_future/02_preview_features/37_default_field_values_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L2-L3 | N/A — 描述性/跟踪性文档，不涉及形式化定理链 |
| [Complex Numbers 预研：标准库复数类型](../../07_future/02_preview_features/38_complex_numbers_preview.md) | L7 前沿趋势层 | 专家 | 实验级 | S | L2-L3 | N/A — 描述性/跟踪性文档，不涉及形式化定理链 |
...
本节聚焦「属性分布统计」，覆盖A/S/P 分布、内容分级分布与Bloom 层级分布。论述顺序由定义到边界：先明确「属性分布统计」在「属性关系图谱（Attribute Relationship Atlas）」中的确切含义与适用范围，再给出可核验的例证或数据，最后标注它与相邻主题的分界线。读完后应能用一句话复述「属性分布统计」的判定标准，并指出它在全页论证链中的位置。
