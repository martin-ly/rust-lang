...
| L0 元信息层 | [Rust 职业市场全景：2026 年数据与分析](../../00_meta/04_navigation/career_landscape.md) | L6 生态工程层 | Application Domains |
...
| L1 基础概念层 | [标准 I/O 与进程](../../01_foundation/00_start/47_std_io_and_process.md) | L3 高级概念层 | Async I/O |
| L1 基础概念层 | [标准 I/O 与进程](../../01_foundation/00_start/47_std_io_and_process.md) | L6 生态工程层 | Command Line Apps |
...
| L1 基础概念层 | [语句与表达式](../../01_foundation/04_control_flow/41_statements_and_expressions.md) | L3 高级概念层 | Async/Await |
...
- 更详细的层间依赖图见 [../04_navigation/inter_layer_map.md](../04_navigation/inter_layer_map.md)
