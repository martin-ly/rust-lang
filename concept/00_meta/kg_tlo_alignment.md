...
> **主要来源**: [Rust Reference](https://doc.rust-lang.org/reference/) · [TRPL](https://doc.rust-lang.org/book/) · [RFCs](https://github.com/rust-lang/rfcs)
...
| 领域本体 | 描述 Rust 语言专属概念与关系 | `kg_ontology_v2.md`、`kg_data_v2.json` |

---

## 5. `kg_data_v2.json` 关键实体 TLO 映射示例
...
后续可在 `kg_data_v2.json` 的 `@context` 或 `classes` 段中显式加入 `bfo:` / `dolce:` 前缀与映射断言，使对齐从文档级进入**数据级**。
