...
- v1.0 (2026-05-23): 初始版本 — own/shr/生命周期令牌三大谓词定义 + L4→L1 映射可视化 + 标准库谓词规范 + 定理推导链 + 与判定森林对照 [权威来源对齐 Wave 6](international_authority_index.md)

---

> **相关文件**: [RustBelt](../../04_formal/02_separation_logic/04_rustbelt.md) · [所有权形式化](../../04_formal/01_ownership_logic/03_ownership_formal.md) · [定理推理森林](../00_framework/theorem_inference_forest.md) · [概念判定森林](../00_framework/concept_definition_decision_forest.md)
