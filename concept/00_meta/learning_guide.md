...
- [Rust 知识体系学习指南（Learning Guide）](#rust-知识体系学习指南learning-guide)
  ...
  - [二、按背景的详细起点指南](#二按背景的详细起点指南)
    - [2.1 完全新手路径（无系统编程经验）](#21-完全新手路径无系统编程经验)
    - [2.2 C/C++ 开发者路径](#22-cc-开发者路径)
    - [2.3 Java/Go 开发者路径](#23-javago-开发者路径)
    - [2.4 Haskell/ML 开发者路径](#24-haskellml-开发者路径)
