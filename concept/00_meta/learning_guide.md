...
> **Summary**: - [Rust 知识体系学习指南（Learning Guide）](#rust-知识体系学习指南learning-guide) - [📑 目录](#-目录) - [〇、学习路径选择全景](#〇学习路径选择全景) - [一、如何使用本指南](#一如何使用本指南) - [1.1 选择你的起点](#11-选择你的起点) - [1.2 选择你的目标](#12-选择你的目标) - [二、按背景的详细起点指南](#二按背景的详细起点指南) - [2.1 完全新手路径（无系统编程经验） \[来源: TRPL Ch1-3; Rust by Example; 前置依赖: 无; 认知负荷管理参照 Sweller 
>
> **受众**: [初学者]
>
