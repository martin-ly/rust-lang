...
> **来源**: [Rust Reference: Constant Evaluation] · [RFC 2344: const_loop] · [Rust Internals: const eval limitations]
...
> **来源**: [Rust Reference: Constant Evaluation — Query cycles] · [Rust Internals: const eval step limit]
...
> **来源**: [Rust Reference: Types] · [Pierce 2002 TAPL Ch.23-24] · [RFC 1210: impl Trait] · [RFC 1598: GATs]
...
> **来源**: [Rust Internals: HKT; why Rust doesn't have them] · [Type Theory Research: System Fω complexity] · [RFC 1210 coherence rules]
...
> **来源**: [Pierce 2002 TAPL Ch.23-29] · [RustBelt: POPL 2018 — 类型系统的逻辑关系证明] · [Oxide: Ownership and Borrowing in Rust]
...
> **来源**: [Rust Reference: Expressions] · [RFC 243: trait-based exception handling] · [RFC 3668: AsyncFn]
...
> **来源**: [Rust Internals: why no goto] · [RFC 230: remove green threads] · [without.boats blog: async/await design]
...
> **来源**: [without.boats blog: Zero-cost async] · [Rust Reference: Async blocks] · [RustBelt 扩展: async 语义]
...
> **来源**: [Rust Reference: Memory model] · [Rustonomicon: Ownership] · [RustBelt: POPL 2018 — 内存安全定理]
...
> **来源**: [Rust Reference: Memory model] · [Jung et al. POPL 2019 — Stacked Borrows] · [Pichon-Pharabod & Dreyer — Tree Borrows]
...
> **来源**: [Girard 1987 — Linear Logic] · [04_formal/01_linear_logic.md] · [RustBelt: POPL 2018 — Iris 逻辑模型]
...
| 并发内存模型 | [](../03_advanced/01_concurrency.md) | §2 happens-before |
...
> **来源**: [Rust Reference: Send and Sync] · [RustBelt: POPL 2018 §5-6] · [Rayon Documentation] · [Tokio Documentation]
...
> **来源**: [Rust Reference: Auto traits] · [RustBelt: POPL 2018 §5 — Send/Sync 充分性证明]
...
> **来源**: [RustBelt: POPL 2018 §5-6] · [O'Hearn 2007 — Separation Logic] · [Iris Project: iris-project.org]
...
> **来源**: [Rust Reference: Macros] · [Rust Reference: Items] · [RFC 1584: macros 2.0]
...
> **来源**: [Wadler 1989 — Theorems for Free] · [Rust Reference: Generic parameters] · [RFC 1210: coherence]
...
> **来源**: [Rust Reference: Unsafety] · [Rustonomicon: What Unsafe Can Do] · [RustBelt: POPL 2018 §8 — 能力边界]
...
> **来源**: [Rust Reference: Behavior considered undefined] · [Miri Book: UB detection] · [Unsafe Code Guidelines]
...
> **来源**: [RustBelt: POPL 2018 §1, §8] · [Kani Documentation] · [Verus Documentation]
...
| 本维度内容 | 对应 L0-L7 文件 | 对应章节 |
|:---|:---|:---|
| `unsafe` 语义 | [](../03_advanced/03_unsafe.md) | 全文 |
| UB 分类 | [](../03_advanced/03_unsafe.md) | §5 UB 分类 |
...
| D7 安全边界 | [](../04_formal/05_verification_toolchain.md) | 全文 | `==>` 工具链扩展安全边界 |
...
| 定理 | 前提 | 结论 | 置信度 |
|:---|:---|:---|:---|
| Rust Semantic Expressiveness: A Panoramic Survey（Rust 语义表达力全景梳理） 结构化组织 ⟹ 高效检索 | 理解分类维度与索引关系 | 能快速定位目标概念 | 高 |
| Rust Semantic Expressiveness: A Panoramic Survey（Rust 语义表达力全景梳理） 质量评估 ⟹ 持续改进 | 建立量化指标与审计流程 | 识别知识缺口并优先修复 | 高 |
| Rust Semantic Expressiveness: A Panoramic Survey（Rust 语义表达力全景梳理） 跨层映射 ⟹ 系统掌握 | 打通 L0-L7 的关联路径 | 形成完整的 Rust 能力图谱 | 高 |
