...
- [Rust 知识体系跨层依赖与蕴含拓扑图](#rust-知识体系跨层依赖与蕴含拓扑图)
  ...
  - [嵌入式测验（Embedded Quiz）](#嵌入式测验embedded-quiz)
    - [测验 1：本文档《Rust 知识体系跨层依赖与蕴含拓扑图》在 Rust 知识体系中属于哪一层级的元数据？（理解层）](#测验-1本文档rust-知识体系跨层依赖与蕴含拓扑图在-rust-知识体系中属于哪一层级的元数据理解层)
    - [测验 2：《Rust 知识体系跨层依赖与蕴含拓扑图》的主要用途是什么？（理解层）](#测验-2rust-知识体系跨层依赖与蕴含拓扑图的主要用途是什么理解层)
...
| 定理 | 前提 | 结论 | 置信度 |
|:---|:---|:---|:---|
| 拓扑结构 ⟹ 概念覆盖无遗漏 | 本文件定义了元层结构 | 支持上层概念定位 | 高 |
...
### 测验 1：本文档《Rust 知识体系跨层依赖与蕴含拓扑图》在 Rust 知识体系中属于哪一层级的元数据？（理解层）

**题目**: 本文档《Rust 知识体系跨层依赖与蕴含拓扑图》在 Rust 知识体系中属于哪一层级的元数据？
...
### 测验 2：《Rust 知识体系跨层依赖与蕴含拓扑图》的主要用途是什么？（理解层）

**题目**: 《Rust 知识体系跨层依赖与蕴含拓扑图》的主要用途是什么？
