...
> **Summary**: - [Rust 知识体系能力图谱（Competency Graph）](#rust-知识体系能力图谱competency-graph) - [📑 目录](#-目录) - [〇、能力图谱认知全景](#〇能力图谱认知全景) - [一、六维能力模型](#一六维能力模型) - [六维能力矩阵](#六维能力矩阵) - [二、Dreyfus 技能层级映射](#二dreyfus-技能层级映射) - [三、自评工具](#三自评工具) - [3.1 六维自评量表](#31-六维自评量表) - [C1 — 语法能力](#c1--语法能力) - [C2 — 概念理解](#c2--概念理解) - [C3 — 设计能力
...
| **C4 调试** | 修复一个 bug 需要多次尝试 | Miri 专题练习 + `concept/03_advanced/03_unsafe.md` 反例 | 能用 Miri 定位一个隐藏 UB |
