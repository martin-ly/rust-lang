...
- [全局待办清单（Global TODO Tracker）](#全局待办清单global-todo-tracker)
  - [📑 目录](#-目录)
  - [一、高优先级 TODO（建议优先处理） \[来源: 优先级排序基于概念依赖图的前置节点数量 — 前置越多的概念优先级越高\]](#一高优先级-todo建议优先处理-来源-优先级排序基于概念依赖图的前置节点数量--前置越多的概念优先级越高)
    - [L1 基础概念层](#l1-基础概念层)
    - [L2 进阶概念层](#l2-进阶概念层)
    - [L3 高级概念层](#l3-高级概念层)
    - [L4-L7 其他](#l4-l7-其他)
  ...
  - [四、质量审计检查清单 \[来源: 审计方法论参照 IEEE 1012 — 软件验证与确认标准; Rust RFC 流程 — 设计决策的公开审查机制\]](#四质量审计检查清单-来源-审计方法论参照-ieee-1012--软件验证与确认标准-rust-rfc-流程--设计决策的公开审查机制)
    - [4.1 已完成的门禁检查](#41-已完成的门禁检查)
    - [4.2 已完成的门禁检查（v1.1 关系审计）](#42-已完成的门禁检查v11-关系审计)
    - [4.3 待完成的门禁检查](#43-待完成的门禁检查)
  - [五、v1.1 权威来源对齐任务清单 \[来源: 来源对齐 Sprint 参照 AGENTS.md 质量铁三角 — Bloom 层级 100%、来源标注率 ≥15%、跨文件链接 ≥3/文件\]](#五v11-权威来源对齐任务清单-来源-来源对齐-sprint-参照-agentsmd-质量铁三角--bloom-层级-100来源标注率-15跨文件链接-3文件)
...
- [x] `03_advanced/02_async.md` —— 补充 Wikipedia、CMU 17-350、PLDI 论文 ✅ 2026-05-13
- [x] `03_advanced/03_unsafe.md` —— 补充 Wikipedia、Rustonomicon、Miri 论文 ✅ 2026-05-13
- [x] `03_advanced/04_macros.md` —— 补充 Wikipedia、CMU 17-363、Hygienic Macros ✅ 2026-05-13
- [x] `03_advanced/01_concurrency.md` —— 补充 Stanford CS340R、RustBelt CSL ✅ 2026-05-13
