...
> **双维定位**: C×Ana / C×Eva
> **前置概念**: [Patterns](../../06_ecosystem/02_patterns.md) · [Type System](../../01_foundation/02_type_system/04_type_system.md)
...
| 如何处理分布式失败 | [Parallel Distributed Pattern Spectrum](../../03_advanced/00_concurrency/19_parallel_distributed_pattern_spectrum.md) | [CQRS and Event Sourcing](../../06_ecosystem/33_cqrs_event_sourcing.md) |
