...
- [概念审计指南](../03_audit/08_concept_audit_guide.md) — 质量检查与维护规范
- [交叉引用矩阵](../04_navigation/05_cross_reference_matrix.md) — 概念间关联映射
...
### 测验 2：《Bloom Taxonomy（Bloom 分类法）》的主要用途是什么？（理解层）

**题目**: 《Bloom Taxonomy（Bloom 分类法）》的主要用途是什么？
