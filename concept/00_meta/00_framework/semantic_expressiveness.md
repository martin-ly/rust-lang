...
> **对齐来源**: [Rust Reference](https://doc.rust-lang.org/reference/) · [Rust RFCs](https://rust-lang.github.io/rfcs/) · [Rust Internals Forum] · [RustBelt / Oxide](https://plv.mpi-sws.org/rustbelt/) · [KRust]
...
| 层级 | 来源 | 作用 |
|:---|:---|:---|
| **一级** | [Rust Reference](https://doc.rust-lang.org/reference/) | 语法和语义定义的**最权威来源**。本文件的 7 个维度直接映射到 Reference 的 20 章结构 |
| **一级** | [Rust RFCs](https://rust-lang.github.io/rfcs/) | 设计决策记录，回答"为什么 Rust 选择这样的语义边界" |
...
> **来源**: [Rust Reference: Constant Evaluation](https://doc.rust-lang.org/reference/) · [RFC 2344: const_loop](https://github.com/rust-lang/rfcs/pull/2344) · [Rust Internals: const eval limitations]
...
> **来源**: [Rust Reference: Types](https://doc.rust-lang.org/reference/) · [Pierce 2002 TAPL Ch.23-24] · [RFC 1210: impl Trait](https://github.com/rust-lang/rfcs/pull/1210) · [RFC 1598: GATs](https://github.com/rust-lang/rfcs/pull/1598)
...
> **来源**: [Rust Internals: HKT; why Rust doesn't have them] · [Type Theory Research: System Fω complexity] · [RFC 1210 coherence rules](https://github.com/rust-lang/rfcs/pull/1210)
...
| 本维度内容 | 对应 L0-L7 文件 | 对应章节 |
|:---|:---|:---|
| 参数多态 / System F | [](../../04_formal/00_type_theory/02_type_theory.md) | §2.2 参数多态 |
...
| `const` generics | [](../../02_intermediate/01_generics/02_generics.md) | §5.7 Const Generics |
| 类型推断 / HM | [](../../04_formal/00_type_theory/02_type_theory.md) | §2.3 类型推断 |
...
| `async` / `await` | [](../../03_advanced/01_async/02_async.md) | 全文 |
| `gen` blocks | [](../../03_advanced/01_async/02_async.md) | §13 gen blocks |
| 闭包捕获语义 | [](../../02_intermediate/00_traits/01_traits.md) | §4 闭包与 `Fn` 家族 |
| 状态机形式化 | [](../../04_formal/01_ownership_logic/03_ownership_formal.md) | §9.5 Pin LTL 形式化 |
...
> **来源**: [Rust Reference: Memory model](https://doc.rust-lang.org/reference/) · [Rustonomicon: Ownership](https://doc.rust-lang.org/nomicon/) · [RustBelt](https://plv.mpi-sws.org/rustbelt/)
...
| `Pin` 不动性 | [](../../03_advanced/01_async/02_async.md) | §3.2 Pin 形式化 |
| 别名模型 | [](../../04_formal/01_ownership_logic/03_ownership_formal.md) | §11 SB/TB |
...
> **来源**: [Rust Reference: Send and Sync](https://doc.rust-lang.org/reference/) · [RustBelt](https://plv.mpi-sws.org/rustbelt/) · [Rayon Documentation] · [Tokio Documentation](https://tokio.rs/)
...
> **来源**: [Rust Reference: Auto traits](https://doc.rust-lang.org/reference/) · [RustBelt](https://plv.mpi-sws.org/rustbelt/)
...
> **来源**: [Rust Reference: Unsafety](https://doc.rust-lang.org/reference/) · [Rustonomicon: What Unsafe Can Do](https://doc.rust-lang.org/nomicon/) · [RustBelt](https://plv.mpi-sws.org/rustbelt/)
...
> **来源**: [Rust Reference: Behavior considered undefined](https://doc.rust-lang.org/reference/) · [Miri Book: UB detection] · [Unsafe Code Guidelines]
...
| 本维度内容 | 对应 L0-L7 文件 | 对应章节 |
|:---|:---|:---|
| `unsafe` 语义 | [](../../03_advanced/02_unsafe/03_unsafe.md) | 全文 |
| UB 分类 | [](../../03_advanced/02_unsafe/03_unsafe.md) | §5 UB 分类 |
...
| D1 计算表达力 | [](../../04_formal/00_type_theory/02_type_theory.md) | §10.1b Const Generics 演进 | `==>` 形式化对应依赖类型子集 |
...
| D2 类型表达力 | [](../../04_formal/00_type_theory/02_type_theory.md) | §2.2 参数多态 | `==>` 形式化类型论根基 |
| D3 控制流表达力 | [](../../02_intermediate/03_error_handling/04_error_handling.md) | 全文 | `==>` Result/? 是控制流核心 |
| D3 控制流表达力 | [](../../03_advanced/01_async/02_async.md) | 全文 | `==>` async 是控制流扩展 |
| D3 控制流表达力 | [](../../03_advanced/01_async/02_async.md) | §13 gen blocks | `==>` gen 是控制流对偶 |
...
| D4 内存表达力 | [](../../04_formal/01_ownership_logic/03_ownership_formal.md) | §11 SB/TB | `==>` 别名模型形式化 |
| D5 并发表达力 | [](../../03_advanced/00_concurrency/01_concurrency.md) | 全文 | `==>` Send/Sync 是并发类型安全 |
| D5 并发表达力 | [](../../04_formal/02_separation_logic/04_rustbelt.md) | §3 CSL | `==>` 并发分离逻辑形式化 |
| D6 抽象表达力 | [](../../02_intermediate/00_traits/01_traits.md) | 全文 | `==>` Trait 是抽象核心 |
| D6 抽象表达力 | [](../../03_advanced/03_proc_macros/04_macros.md) | 全文 | `==>` 宏是元编程扩展 |
