...
- [语义桥：算法、设计模式与工作流模式的统一谱系](#语义桥算法设计模式与工作流模式的统一谱系)
  ...
  - [三、分治算法 ↔ Composite + Parallel Split 的完整同构](#三分治算法--composite--parallel-split-的完整同构)
    - [3.1 算法层：归并排序 (CLRS — Introduction to Algorithms, 4th Ed.)](#31-算法层归并排序来源-clrs--introduction-to-algorithms-4th-ed)
    ...
    - [3.4 统一语义 (Category Theory for Programmers — Bartosz Milewski)](#34-统一语义来源-category-theory-for-programmers--bartosz-milewski)
    - [3.5 递归细化：递归 ↔ Composite 后序遍历 ↔ 工作流 Sequence](#35-递归细化递归--composite-后序遍历--工作流-sequence)
      - [概念对应](#概念对应)
      - [Rust 示例](#rust-示例)
      - [范畴论语境](#范畴论语境)
  - [四、动态规划 ↔ Memoization + Deferred Choice (Wikipedia — Dynamic Programming)](#四动态规划--memoization--deferred-choice来源-wikipedia--dynamic-programming)
    ...
    - [4.5 惰性求值细化：动态规划 ↔ Memoization ↔ Lazy Evaluation](#45-惰性求值细化动态规划--memoization--lazy-evaluation)
      ...
      - [Rust 示例](#rust-示例-1)
      - [范畴论语境](#范畴论语境-1)
  - [五、图遍历 ↔ Visitor + Arbitrary Cycles (Wikipedia — Graph Traversal)](#五图遍历--visitor--arbitrary-cycles来源-wikipedia--graph-traversal)
    - [5.1 统一语义](#51-统一语义)
    - [5.2 遍历细化：图遍历 ↔ Visitor ↔ Iterator](#52-遍历细化图遍历--visitor--iterator)
      - [概念对应](#概念对应-2)
      - [Rust 示例](#rust-示例-2)
      - [范畴论语境](#范畴论语境-2)
  - [六、语义桥的价值与应用 (Workflow Patterns — van der Aalst)](#六语义桥的价值与应用来源-workflow-patterns--van-der-aalst)
