...
| Comprehensive Rust 章节 | 本知识体系对应文件 | 对应章节 | 补充深度 |
|:---|:---|:---|:---|
| **Struct Memory Layout** | [`03_advanced/02_unsafe/03_unsafe.md`](../../03_advanced/02_unsafe/03_unsafe.md) | §2.1 内存布局 | 补充对齐与填充 |
...
| **Unsafe Rust** | [`03_advanced/02_unsafe/03_unsafe.md`](../../03_advanced/02_unsafe/03_unsafe.md) | §3 全部 | 补充 Miri、Stacked/Tree Borrows |
