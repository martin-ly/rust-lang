...
> **前置概念**: [Learning Guide](../04_navigation/07_learning_guide.md) · [Bloom Taxonomy](bloom_taxonomy.md)
> **后置概念**: [Application Domains](../../06_ecosystem/06_data_and_distributed/01_application_domains.md)
> **内容重叠提示**: 本文与 [`docs/02_learning/03_google_rust_mapping.md`](../../../docs/02_learning/03_google_rust_mapping.md) 内容高度重叠。`docs/` 版本提供学习映射；`concept/` 版本为项目权威主轨。
...
本节聚焦「课程概览」，覆盖Comprehensive Rust 是什么 与 课程结构。论述顺序由定义到边界：先明确「课程概览」在「Comprehensive Rust 课程映射」中的确切含义与适用范围，再给出可核验的例证或数据，最后标注它与相邻主题的分界线。读完后应能用一句话复述「课程概览」的判定标准，并指出它在全页论证链中的位置。
...
本节聚焦「章节映射表」，覆盖Day 1 — Rust 基础、Day 2 — 所有权与类型系统、Day 3 — 泛型与 Trait与Day 4 — Android & 高级主题。论述顺序由定义到边界：先明确「章节映射表」在「Comprehensive Rust 课程映射」中的确切含义与适用范围，再给出可核验的例证或数据，最后标注它与相邻主题的分界线。读完后应能用一句话复述「章节映射表」的判定标准，并指出它在全页论证链中的位置。

### 2.1 Day 1 — Rust 基础

| Comprehensive Rust 章节 | 本知识体系对应文件 | 对应章节 | 补充深度 |
|:---|:---|:---|:---|
| **Welcome** | [`00_meta/learning_guide.md`](../04_navigation/07_learning_guide.md) | 〇、学习路径选择全景 | 本体系提供更细粒度的背景适配 |
...
| **Scalar Types** | [`01_foundation/02_type_system/01_type_system.md`](../../01_foundation/02_type_system/01_type_system.md) | §2.1 标量类型 | 补充类型推导与类型别名 |
| **Compound Types** | [`01_foundation/02_type_system/01_type_system.md`](../../01_foundation/02_type_system/01_type_system.md) | §2.2 复合类型 | 补充元组 fanout 模式 (Rust 1.85+) |
| **Control Flow** | [`01_foundation/04_control_flow/01_control_flow.md`](../../01_foundation/04_control_flow/01_control_flow.md) | §1 核心概念 | 补充 `if let` temporary scope (Ed 2024) |
| **User-Defined Types** | [`01_foundation/02_type_system/01_type_system.md`](../../01_foundation/02_type_system/01_type_system.md) | §4.1 ADT（枚举 + 结构体） | 补充 `#[repr(C)]` 内存布局 |
...
| **Pattern Matching** | [`01_foundation/04_control_flow/01_control_flow.md`](../../01_foundation/04_control_flow/01_control_flow.md) | §1.2 模式匹配 | 补充穷尽性检查原理 |
...
| **Generics** | [`02_intermediate/01_generics/01_generics.md`](../../02_intermediate/01_generics/01_generics.md) | §1–3 全部 | 补充单态化与编译膨胀 |
| **Standard Library Types** | [`01_foundation/05_collections/01_collections.md`](../../01_foundation/05_collections/01_collections.md) | §1–3 全部 | 补充 `FromIterator` for tuples |

### 2.3 Day 3 — 泛型与 Trait

| Comprehensive Rust 章节 | 本知识体系对应文件 | 对应章节 | 补充深度 |
|:---|:---|:---|:---|
| **Struct Memory Layout** | [`03_advanced/02_unsafe/01_unsafe.md`](../../03_advanced/02_unsafe/01_unsafe.md) | §2.1 内存布局 | 补充对齐与填充 |
...
| **Error Handling** | [`02_intermediate/03_error_handling/01_error_handling.md`](../../02_intermediate/03_error_handling/01_error_handling.md) | §1–3 全部 | 补充 `?` 运算符与 `Try` trait |
| **Unsafe Rust** | [`03_advanced/02_unsafe/01_unsafe.md`](../../03_advanced/02_unsafe/01_unsafe.md) | §3 全部 | 补充 Miri、Stacked/Tree Borrows |
| **Concurrency** | [`03_advanced/00_concurrency/01_concurrency.md`](../../03_advanced/00_concurrency/01_concurrency.md) | §1–3 全部 | 补充 `Send`/`Sync` 自动推导 |
...
- [Learning Guide](../04_navigation/07_learning_guide.md) — 本知识体系学习指南
