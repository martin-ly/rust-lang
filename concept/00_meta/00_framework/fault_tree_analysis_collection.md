...
「FTA 格式规范」部分包含符号系统 与 分析流程 两条主线，本节依次说明。
...
理解「内存安全失效树」需要把握顶事件、故障树 Mermaid与基本事件概率与补偿，本节依次展开。
...
> **相关文件**: [概念判定森林](concept_definition_decision_forest.md) · [边界扩展树](boundary_extension_tree.md) · [安全边界](../../05_comparative/03_domain_comparisons/04_safety_boundaries.md) · [Miri 验证](../../../archive/reports/2026_07/MIRI_VALIDATION_2026_05_27.md)（归档只读）
