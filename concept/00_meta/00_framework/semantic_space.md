...
> **认知功能**: 本 mindmap 以四维结构组织 Rust 的表达力边界，帮助读者快速定位特定概念在"能/不能/等价"光谱中的位置。建议在遇到"Rust 如何做 X"的问题时，先在此图中定位 X 所属的表达维度。关键洞察：Rust 的设计哲学不是最大化表达力，而是在"安全/性能/表达"三者的帕累托前沿上寻找最优解。[💡 原创分析](methodology.md)
