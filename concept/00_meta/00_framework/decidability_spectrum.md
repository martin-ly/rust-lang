...
> **边界**: Polonius 的挑战不在于判定性，而在于**性能可扩展性**。大型函数产生的事实集可能很大，因此引入了分级分析（graded analysis）和近似。 [Polonius Update, Rust Blog 2023](https://web.archive.org/web/*/https://blog.rust-lang.org/2023/06/01/)
