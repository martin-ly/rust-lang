...
「高优先级 TODO（建议优先处理） 优先级排序基于概念依赖…」部分按 L1 基础概念层、L2 进阶概念层、L3 高级概念层与L4-L7 其他的顺序逐层展开。
...
本节从已完成的门禁检查、已完成的门禁检查（v1.1 关系审计）、待完成的门禁检查与Wave 3 待完成门禁检查切入，剖析「质量审计检查清单 审计方法论参照 IEEE 1012 —…」的核心内容。
