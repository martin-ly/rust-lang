...
> - i18n 未覆盖术语：6 个
> - `docs/` 缺少 `concept/` 权威来源链接：5 个
> - 外部链接问题：86 条（404×42 / ERR×13 / 429×31）
> - `knowledge/` 大型非 stub 文件：82 个（P2 逐步迁移）
>
>
> **来源**:
...
- [ ] i18n 双语标注覆盖率 100%（未覆盖术语清零）
- [ ] `docs/` 全部非 stub 文件包含 `concept/` 权威来源链接
- [ ] 外部链接 404/ERR 修复率 ≥90%，无法修复的标注为 known-broken
- [ ] `knowledge/` 高优先级（L1-L3 相关）大型文件迁移为 stub/summary
