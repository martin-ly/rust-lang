...
- [Rust 安全边界扩展推理树](#rust-安全边界扩展推理树)
  ...
  - [嵌入式测验（Embedded Quiz）](#嵌入式测验embedded-quiz)
    - [测验 1：本文档《Rust 安全边界扩展推理树》在 Rust 知识体系中属于哪一层级的元数据？（理解层）](#测验-1本文档rust-安全边界扩展推理树在-rust-知识体系中属于哪一层级的元数据理解层)
    - [测验 2：《Rust 安全边界扩展推理树》的主要用途是什么？（理解层）](#测验-2rust-安全边界扩展推理树的主要用途是什么理解层)
...
本节从测验 1：本文档《Rust 安全边界扩展推理树》在 Rust 知识体系…、测验 2：《Rust 安全边界扩展推理树》的主要用途是什么？（理解层）与测验 3：元数据层文档能否替代 L1-L7 的核心概念学习？（理解层）切入，剖析「嵌入式测验（Embedded Quiz）」的核心内容。

### 测验 1：本文档《Rust 安全边界扩展推理树》在 Rust 知识体系中属于哪一层级的元数据？（理解层）

**题目**: 本文档《Rust 安全边界扩展推理树》在 Rust 知识体系中属于哪一层级的元数据？
...
### 测验 2：《Rust 安全边界扩展推理树》的主要用途是什么？（理解层）

**题目**: 《Rust 安全边界扩展推理树》的主要用途是什么？
