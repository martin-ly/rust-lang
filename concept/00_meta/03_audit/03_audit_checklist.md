...
- [权威来源清单](../02_sources/03_sources.md) — 来源分级与引用规范
- [跨层知识图谱](../04_navigation/04_inter_layer_map.md) — L0-L7 层级依赖关系
...
> 以下内容原独立维护于 `04_concept_consistency_audit_checklist.md`，现已合并至此，作为单个 concept 文件快速审计使用。
...
> **Checklist**: 本清单用于审计单个 concept 文件的质量。项目级审计请参阅 [Quality Dashboard](07_quality_dashboard_v2.md)。
