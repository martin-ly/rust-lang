...
- [Rust 知识体系思维表征覆盖率仪表板（Quality Dashboard v2）](#rust-知识体系思维表征覆盖率仪表板quality-dashboard-v2)
  ...
  - [嵌入式测验（Embedded Quiz）](#嵌入式测验embedded-quiz)
    - [测验 1：本文档《Rust 知识体系思维表征覆盖率仪表板（Quality Dashboard v2）》在 Rust 知识体系中属于哪一层级的元数据？（理解层）](#测验-1本文档rust-知识体系思维表征覆盖率仪表板quality-dashboard-v2在-rust-知识体系中属于哪一层级的元数据理解层)
    - [测验 2：《Rust 知识体系思维表征覆盖率仪表板（Quality Dashboard v2）》的主要用途是什么？（理解层）](#测验-2rust-知识体系思维表征覆盖率仪表板quality-dashboard-v2的主要用途是什么理解层)
...
> **统计基准**: 2026-05-28 | Rust 1.97.0+ | Edition 2024
...
本节聚焦「认知维度覆盖」，覆盖Krathwohl × Bloom 双维覆盖 与  A/S/P 标记分布。论述顺序由定义到边界：先明确「认知维度覆盖」在「Rust 知识体系思维表征覆盖率仪表板（Quality Dashboard v2）」中的确切含义与适用范围，再给出可核验的例证或数据，最后标注它与相邻主题的分界线。读完后应能用一句话复述「认知维度覆盖」的判定标准，并指出它在全页论证链中的位置。
...
| 检查项 | 要求 | 当前状态 | 通过 |
|:---|:---|:---:|:---:|
| 新增文件含 `[...](https://doc.rust-lang.org/)` 标注 | 100% | 5/5 | ✅ |
...
> **下一波（Wave 2026-06）计划**: 问题图谱 + 能力图谱 + 知识图谱本体 + RustBelt 谓词可视化 + 范式转换矩阵。预计新增 5 个文件，15-20 个图表。[方案 B 阶段 5-6 规划](../00_framework/methodology.md)

---

**变更日志**:

- v1.0 (2026-05-23): 初始版本 — 思维表征覆盖率仪表板，统计 Wave 2026-05-23 新增的 5 个文件、19 个图表、3 种表征类型 [权威来源对齐 Wave 4](../02_sources/05_international_authority_index.md)
...
| 定理 | 前提 | 结论 | 置信度 |
|:---|:---|:---|:---|
| Quality Dashboard V2 结构化定义 ⟹ 学习者认知锚点可建立 | 本文件定义了元层结构 | 支持上层概念定位 | 高 |
...
**题目**: 本文档《Rust 知识体系思维表征覆盖率仪表板（Quality Dashboard v2）》在 Rust 知识体系中属于哪一层级的元数据？
...
### 测验 2：《Rust 知识体系思维表征覆盖率仪表板（Quality Dashboard v2）》的主要用途是什么？（理解层）

**题目**: 《Rust 知识体系思维表征覆盖率仪表板（Quality Dashboard v2）》的主要用途是什么？
