...
本项目早期通过脚本为大量 concept 文件注入了统一的尾部模板（认知路径、核心推理链、反命题与边界等）。这些模板在快速构建知识体系时很有用，但也导致：
...
- [ ] L1 基础概念层示范文件（建议：变量模型、Move 语义）
- [ ] L2 进阶概念层示范文件（建议：异常安全、RTTI）
- [ ] L3 高级概念层示范文件（建议：Async 模式）
- [ ] L4 形式化层示范文件（建议：求值策略）
- [ ] 批量去同质化脚本或清单
