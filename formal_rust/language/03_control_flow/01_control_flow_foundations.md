...
- [3. 控制流理论基础](#3-控制流理论基础)
  - [目录](#目录)
  - [3.1 引言](#31-引言)
    - [3.1.1 控制流的设计哲学](#311-控制流的设计哲学)
  - [3.2 控制流基础概念](#32-控制流基础概念)
    - [3.2.1 控制流定义](#321-控制流定义)
    - [3.2.2 控制流图](#322-控制流图)
    - [3.2.3 基本控制结构](#323-基本控制结构)
  - [3.3 Rust控制流结构](#33-rust控制流结构)
    - [3.3.1 条件控制](#331-条件控制)
    - [3.3.2 循环控制](#332-循环控制)
    - [3.3.3 模式匹配](#333-模式匹配)
    - [3.3.4 函数控制](#334-函数控制)
  - [3.4 控制流形式化](#34-控制流形式化)
    - [3.4.1 操作语义](#341-操作语义)
    - [3.4.2 控制流分析](#342-控制流分析)
    - [3.4.3 数据流分析](#343-数据流分析)
  - [3.5 高级控制流特性](#35-高级控制流特性)
    - [3.5.1 迭代器模式](#351-迭代器模式)
    - [3.5.2 错误处理控制流](#352-错误处理控制流)
    - [3.5.3 异步控制流](#353-异步控制流)
  - [3.6 控制流与内存安全](#36-控制流与内存安全)
  - [3.7 总结](#37-总结)
