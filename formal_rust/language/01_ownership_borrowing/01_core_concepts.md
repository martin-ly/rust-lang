...
- [1. 所有权与借用系统核心概念](#1-所有权与借用系统核心概念)
  - [目录](#目录)
  - [1.1 引言](#11-引言)
    - [1.1.1 设计哲学](#111-设计哲学)
  - [1.2 所有权系统基础](#12-所有权系统基础)
    - [1.2.1 所有权规则](#121-所有权规则)
    - [1.2.2 移动语义](#122-移动语义)
    - [1.2.3 作用域与生命周期](#123-作用域与生命周期)
  - [1.3 借用机制](#13-借用机制)
    - [1.3.1 不可变借用](#131-不可变借用)
    - [1.3.2 可变借用](#132-可变借用)
    - [1.3.3 借用检查器](#133-借用检查器)
  - [1.4 形式化理论基础](#14-形式化理论基础)
    - [1.4.1 线性类型理论](#141-线性类型理论)
    - [1.4.2 仿射类型系统](#142-仿射类型系统)
    - [1.4.3 分离逻辑](#143-分离逻辑)
  - [1.5 变量系统多维分析](#15-变量系统多维分析)
    - [1.5.1 执行流视角](#151-执行流视角)
    - [1.5.2 数据流视角](#152-数据流视角)
    - [1.5.3 静态分析视角](#153-静态分析视角)
  - [1.6 内部可变性](#16-内部可变性)
    - [1.6.1 Cell与RefCell](#161-cell与refcell)
    - [1.6.2 Mutex与RwLock](#162-mutex与rwlock)
    - [1.6.3 内部可变性的安全保证](#163-内部可变性的安全保证)
  - [1.7 最佳实践与模式](#17-最佳实践与模式)
    - [1.7.1 所有权API设计](#171-所有权api设计)
    - [1.7.2 生命周期管理](#172-生命周期管理)
    - [1.7.3 错误处理模式](#173-错误处理模式)
  - [1.8 总结](#18-总结)
