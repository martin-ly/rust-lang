...
- [02 借用系统形式化理论](#02-借用系统形式化理论)
  ...
  - [3. 借用类型](#3-借用类型)
    ...
    - [3.3 借用组合](#33-借用组合)
  - [4. 借用规则](#4-借用规则)
    - [4.1 基本借用规则](#41-基本借用规则)
    - [4.2 借用检查算法](#42-借用检查算法)
    - [4.3 借用传播](#43-借用传播)
  - [5. 借用检查器](#5-借用检查器)
    - [5.1 检查器架构](#51-检查器架构)
    - [5.2 检查算法](#52-检查算法)
    - [5.3 错误检测](#53-错误检测)
  - [6. 生命周期管理](#6-生命周期管理)
    - [6.1 生命周期标注](#61-生命周期标注)
    - [6.2 生命周期推断](#62-生命周期推断)
    - [6.3 生命周期省略](#63-生命周期省略)
  - [7. 实际应用](#7-实际应用)
    - [7.1 数据结构借用](#71-数据结构借用)
    - [7.2 函数借用](#72-函数借用)
    - [7.3 并发借用](#73-并发借用)
  - [8. 定理证明](#8-定理证明)
    - [8.1 借用安全定理](#81-借用安全定理)
    - [8.2 数据竞争避免定理](#82-数据竞争避免定理)
    - [8.3 借用检查完备性定理](#83-借用检查完备性定理)
  - [9. 参考文献](#9-参考文献)
    - [9.1 学术论文](#91-学术论文)
    - [9.2 技术文档](#92-技术文档)
    - [9.3 在线资源](#93-在线资源)
