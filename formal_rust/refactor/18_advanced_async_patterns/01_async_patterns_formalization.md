# 1. 异步模式形式化理论 (Async Patterns Formalization)

## 目录

1. [1. 异步模式形式化理论](#1-异步模式形式化理论)
   1. [1.1. 理论基础](#11-理论基础)
   2. [1.2. 事件循环理论](#12-事件循环理论)
   3. [1.3. Future/Promise理论](#13-futurepromise理论)
   4. [1.4. 异步状态机理论](#14-异步状态机理论)
