...
- [01. Rust 并发模型理论（01\_concurrency\_theory）](#01-rust-并发模型理论01_concurrency_theory)
  ...
  - [1.1 并发模型公理](#11-并发模型公理)
    ...
    - [1.1.3 并发模型结构体体体图](#113-并发模型结构体体体图)
  - [1.2 线程理论](#12-线程理论)
    - [1.2.1 线程定义](#121-线程定义)
    - [1.2.2 线程操作](#122-线程操作)
  ...
  - [1.6 并发安全证明与形式化分析](#16-并发安全证明与形式化分析)
    - [1.6.1 并发安全质](#161-并发安全质)
    - [1.6.2 并发安全证明](#162-并发安全证明)
  ...
  - [1.8 并发能分析与优化](#18-并发能分析与优化)
    - [1.8.1 性能指标与分析](#181-性能指标与分析)
      - [Mermaid 并发能分析流程](#mermaid-并发能分析流程)
  ...
  - [1.9 形式化验证与学术前沿](#19-形式化验证与学术前沿)
    ...
    - [1.9.3 批判性分析与未来值值值展望](#193-批判性分析与未来值值值展望)
...
- **RustBelt**：证明 Send/Sync trait 安全，详见 Jung et al. 论文。
