...
1. [12.1 术语映射表](#121-术语映射表)
    1.1 [理论基础与工程案例](#1211-理论基础与工程案例)
    1.2 [数学与形式化描述](#1212-数学与形式化描述)
    1.3 [Mermaid 可视化](#1213-mermaid-可视化)
2. [12.2 统一词汇表](#122-统一词汇表)
    2.1 [英文对照与典型用法](#1221-英文对照与典型用法)
3. [12.3 批判性分析与未来展望](#123-批判性分析与未来展望)
4. [12.4 交叉引用](#124-交叉引用)
