...
1. [17.1 MIR结构与作用](#171-mir结构与作用)
    1.1 [MIR简介与理论基础](#1711-mir简介与理论基础)
    1.2 [MIR在Rust编译流程中的地位](#1712-mir在rust编译流程中的地位)
    1.3 [MIR的基本结构与语法示例](#1713-mir的基本结构与语法示例)
2. [17.2 所有权与借用分析](#172-所有权与借用分析)
    2.1 [MIR中的所有权语义](#1721-mir中的所有权语义)
    2.2 [借用检查器与MIR分析算法](#1722-借用检查器与mir分析算法)
    2.3 [非词法作用域（NLL）与MIR的关系](#1723-非词法作用域nll与mir的关系)
3. [17.3 编译器优化策略](#173-编译器优化策略)
    3.1 [所有权信息对优化的影响](#1731-所有权信息对优化的影响)
    3.2 [内存布局与生命周期优化](#1732-内存布局与生命周期优化)
    3.3 [MIR到LLVM IR的转换与优化](#1733-mir到llvm-ir的转换与优化)
4. [17.4 批判性分析与未来展望](#174-批判性分析与未来展望)
5. [17.5 交叉引用](#175-交叉引用)
