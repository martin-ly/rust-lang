...
1. [14.1 练习题](#141-练习题)
    ...
    1.3 [理论题](#1413-理论题)
    1.4 [工程题](#1414-工程题)
    1.5 [批判与开放题](#1415-批判与开放题)
2. [14.2 思考题与多模态分析](#142-思考题与多模态分析)
    2.1 [范畴论与生命周期可视化](#1421-范畴论与生命周期可视化)
    2.2 [跨语言对比与工程影响](#1422-跨语言对比与工程影响)
3. [14.3 批判性分析与未来展望](#143-批判性分析与未来展望)
4. [14.4 交叉引用](#144-交叉引用)
...
1. 编写一个 Rust 函数，安全地转移所有权并返回新所有者。
   - **定义 14.1（所有权转移）** 设 $Own: Var \to Owner$，所有权转移后原变量失效。
...
2. 解释所有权转移与借用的区别，并举例说明。
   - **分析要点**：所有权转移使原变量失效，借用则保留原变量有效性。
...
| 未来展望       | 智能化、自动化评测与知识图谱将成为交互式学习的重要方向。               |
