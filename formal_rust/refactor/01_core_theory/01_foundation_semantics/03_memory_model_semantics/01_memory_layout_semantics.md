...
- [Rust内存布局语义深度分析](#rust内存布局语义深度分析)
  ...
  - [2. 0 内存布局算法](#2-0-内存布局算法)
    - [2.1 结构体体体体布局](#21-结构体体体体布局)
      - [2.1.1 字段对齐](#211-字段对齐)
      - [2.1.2 填充字节](#212-填充字节)
      - [2.1.3 布局优化](#213-布局优化)
    - [2.2 枚举布局](#22-枚举布局)
  ...
  - [3. 0 内存布局实现](#3-0-内存布局实现)
    - [3.1 编译器实现](#31-编译器实现)
      - [3.1.1 布局计算器结构体体体](#311-布局计算器结构体体体)
