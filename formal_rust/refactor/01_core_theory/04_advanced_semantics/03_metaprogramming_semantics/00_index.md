...
- **[01_compile_time_generation/00_index.md](01_compile_time_generation/00_index.md)** - 编译时代码生成语义
  - 代码生成语义
  - 代码变换语义
  - 代码优化语义
  - 代码验证语义
...
- **[02_reflection/00_index.md](02_reflection/00_index.md)** - 反射语义
  - 类型反射语义
  - 值反射语义
  - 结构反射语义
  - 方法反射语义
...
- **[03_code_transformation/00_index.md](03_code_transformation/00_index.md)** - 代码转换语义
  - 语法树转换语义
  - 代码重构语义
  - 代码迁移语义
  - 代码优化语义
...
- **[04_program_analysis/00_index.md](04_program_analysis/00_index.md)** - 程序分析语义
  - 静态分析语义
  - 动态分析语义
  - 符号执行语义
  - 程序验证语义
