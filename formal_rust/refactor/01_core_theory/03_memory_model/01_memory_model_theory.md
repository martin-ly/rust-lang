...
- [01. Rust 内存模型理论（01\_memory\_model\_theory）](#01-rust-内存模型理论01_memory_model_theory)
  ...
  - [1.1 内存模型公理](#11-内存模型公理)
    ...
    - [1.1.3 内存模型结构体体体图](#113-内存模型结构体体体图)
  ...
  - [1.8 内存优化技术与未来值值值展望](#18-内存优化技术与未来值值值展望)
    - [1.8.1 内存池](#181-内存池)
    - [1.8.2 内存压缩](#182-内存压缩)
    - [1.8.3 批判性分析与未来值值值展望（表格）](#183-批判性分析与未来值值值展望表格)
  - [1.9 形式化语义](#19-形式化语义)
    - [1.9.1 操作语义](#191-操作语义)
    - [1.9.2 指称语义](#192-指称语义)
...
- 本文件已完成垃圾回收理论、内存安全保证、并发内存模型、内存优化技术与未来值值值展望、形式化语义、实现策略与交叉引用等内容的批量规范化与批判性补全。
