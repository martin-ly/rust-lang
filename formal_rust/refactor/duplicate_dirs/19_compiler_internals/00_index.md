...
- 与[类型系统](../02_type_system/00_index.md)的编译时检查
- 与[所有权系统](../01_ownership_borrowing/00_index.md)的借用检查
- 与[宏系统](../07_macro_system/00_index.md)的宏展开
- 与[错误处理](../09_error_handling/00_index.md)的编译错误
