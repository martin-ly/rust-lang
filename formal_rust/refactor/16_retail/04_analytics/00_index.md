...
- **[电商语义](01_ecommerce/00_index.md)** - 销售数据基础
- **[供应链语义](02_supply_chain/00_index.md)** - 库存数据基础
- **[客户关系管理语义](03_crm/00_index.md)** - 客户数据基础

### 输出影响

- **[电商语义](01_ecommerce/00_index.md)** - 销售优化集成
- **[供应链语义](02_supply_chain/00_index.md)** - 库存优化集成
- **[客户关系管理语义](03_crm/00_index.md)** - 客户洞察集成
