//! # Rust 知识体系语义 Web 工具链
//!
//! 本 crate 为 `concept/00_meta/kg_data_v2.json` 提供轻量级解析、验证、推理与查询能力。
//! 它是 Sophia / Oxigraph / rudof 等全功能 RDF 工具链的过渡与补充：
//!
//! - 不引入重型依赖，直接消费项目自定义的 JSON-LD v2 格式。
...
//!
//! let kg = load_kg_from_json("concept/00_meta/kg_data_v2.json").unwrap();
