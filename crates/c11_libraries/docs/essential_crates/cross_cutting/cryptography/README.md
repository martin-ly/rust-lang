...
- [密码学 (Cryptography)](#密码学-cryptography)
  ...
  - [📋 概述](#-概述)
  - [🔧 核心工具](#-核心工具)
    - [1. ring (通用密码学 ⭐⭐⭐⭐⭐)](#1-ring-通用密码学-)
      - [核心特性](#核心特性)
      - [HMAC 签名](#hmac-签名)
      - [AES-GCM 加密](#aes-gcm-加密)
      - [Ed25519 签名](#ed25519-签名)
    - [2. rustls (TLS 实现 ⭐⭐⭐⭐⭐)](#2-rustls-tls-实现-)
      - [核心优势](#核心优势)
      - [TLS 客户端](#tls-客户端)
      - [TLS 服务器 (Axum)](#tls-服务器-axum)
    - [3. argon2 (密码哈希 ⭐⭐⭐⭐⭐)](#3-argon2-密码哈希-)
      - [核心特性3](#核心特性3)
      - [基础用法](#基础用法)
      - [高级配置](#高级配置)
    - [4. sha2 (哈希函数 ⭐⭐⭐⭐)](#4-sha2-哈希函数-)
    - [5. blake3 (现代哈希 💡)](#5-blake3-现代哈希-)
    - [6. jsonwebtoken (JWT ⭐⭐⭐⭐)](#6-jsonwebtoken-jwt-)
      - [生成 JWT](#生成-jwt)
    - [7. oauth2 (OAuth 2.0 💡)](#7-oauth2-oauth-20-)
  - [💡 最佳实践](#-最佳实践)
    - [1. 密钥管理](#1-密钥管理)
    - [2. 密码存储](#2-密码存储)
    - [3. API 认证](#3-api-认证)
...
密码学是保护应用程序安全的基础。
Rust 生态提供了高质量、经过审计的密码学库，涵盖加密、哈希、签名、TLS 等所有核心需求。
