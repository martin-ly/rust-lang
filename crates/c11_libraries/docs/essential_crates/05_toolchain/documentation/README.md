...
- [文档工具 (Documentation Tools)](#文档工具-documentation-tools)
  - [📋 目录](#-目录)
  - [📋 概述](#-概述)
  - [🔧 核心工具](#-核心工具)
    - [1. rustdoc (必备 ⭐⭐⭐⭐⭐)](#1-rustdoc-必备-)
      - [基础用法](#基础用法)
      - [文档注释](#文档注释)
      - [文档测试](#文档测试)
      - [文档链接](#文档链接)
    - [2. mdBook (强烈推荐 🌟)](#2-mdbook-强烈推荐-)
      - [快速开始](#快速开始)
      - [目录结构](#目录结构)
      - [book.toml 配置](#booktoml-配置)
      - [SUMMARY.md 示例](#summarymd-示例)
      - [插件支持](#插件支持)
    - [3. docs.rs (推荐)](#3-docsrs-推荐)
      - [配置 Cargo.toml](#配置-cargotoml)
      - [使用 docsrs cfg](#使用-docsrs-cfg)
    - [4. cargo-readme (可选)](#4-cargo-readme-可选)
    - [5. cargo-deadlinks (可选)](#5-cargo-deadlinks-可选)
  - [💡 最佳实践](#-最佳实践)
    - [1. 文档结构模板](#1-文档结构模板)
    - [2. 文档测试最佳实践](#2-文档测试最佳实践)
    - [3. 文档特性标记](#3-文档特性标记)
    - [4. mdBook 高级用法](#4-mdbook-高级用法)
  - [📊 文档质量检查](#-文档质量检查)
    - [检查清单](#检查清单)
  - [🎯 实战示例](#-实战示例)
    - [完整的 crate 文档](#完整的-crate-文档)
  - [🔗 相关资源](#-相关资源)
