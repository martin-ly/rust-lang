...
- [游戏开发 (Game Development)](#游戏开发-game-development)
  ...
  - [📋 概述](#-概述)
  - [🔧 核心工具](#-核心工具)
    - [1. bevy (数据驱动游戏引擎 ⭐⭐⭐⭐⭐)](#1-bevy-数据驱动游戏引擎-)
      - [核心特性](#核心特性)
      - [Hello World](#hello-world)
      - [2D 精灵示例](#2d-精灵示例)
      - [碰撞检测](#碰撞检测)
    - [2. ggez (轻量级 2D 游戏框架 ⭐⭐⭐⭐)](#2-ggez-轻量级-2d-游戏框架-)
      - [核心特性2](#核心特性2)
      - [基础示例](#基础示例)
    - [3. macroquad (跨平台游戏库 ⭐⭐⭐⭐)](#3-macroquad-跨平台游戏库-)
      - [核心特性3](#核心特性3)
      - [基础示例3](#基础示例3)
      - [交互式游戏](#交互式游戏)
    - [4. rapier (物理引擎 ⭐⭐⭐⭐⭐)](#4-rapier-物理引擎-)
      - [核心特性4](#核心特性4)
      - [2D 物理示例](#2d-物理示例)
  - [💡 最佳实践](#-最佳实践)
    - [1. 选择合适的引擎](#1-选择合适的引擎)
    - [2. ECS 模式 (Bevy)](#2-ecs-模式-bevy)
    - [3. 状态管理](#3-状态管理)
  - [📊 工具对比](#-工具对比)
  - [🎯 实战场景](#-实战场景)
    - [场景1: 简单射击游戏](#场景1-简单射击游戏)
  - [🔗 相关资源](#-相关资源)
