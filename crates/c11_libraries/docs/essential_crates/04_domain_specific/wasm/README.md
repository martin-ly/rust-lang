...
- [WebAssembly (WASM)](#webassembly-wasm)
  ...
  - [📋 概述](#-概述)
  - [🔧 核心工具](#-核心工具)
    - [1. wasm-bindgen (JS 互操作 ⭐⭐⭐⭐⭐)](#1-wasm-bindgen-js-互操作-)
      - [核心特性](#核心特性)
      - [基础示例](#基础示例)
      - [DOM 操作](#dom-操作)
      - [事件处理](#事件处理)
    - [2. wasm-pack (构建和打包 ⭐⭐⭐⭐⭐)](#2-wasm-pack-构建和打包-)
      - [核心特性2](#核心特性2)
      - [使用流程](#使用流程)
    - [3. yew (前端框架 ⭐⭐⭐⭐⭐)](#3-yew-前端框架-)
      - [核心特性3](#核心特性3)
      - [基础组件](#基础组件)
      - [组件通信](#组件通信)
    - [4. leptos (全栈框架 ⭐⭐⭐⭐)](#4-leptos-全栈框架-)
      - [核心特性4](#核心特性4)
      - [基础示例4](#基础示例4)
      - [异步数据获取](#异步数据获取)
  - [💡 最佳实践](#-最佳实践)
    - [1. 优化 WASM 大小](#1-优化-wasm-大小)
    - [2. 避免频繁的 JS \<-\> Rust 调用](#2-避免频繁的-js---rust-调用)
    - [3. 使用 Web Workers](#3-使用-web-workers)
  - [📊 工具对比](#-工具对比)
  - [🎯 实战场景](#-实战场景)
    - [场景1: 性能密集型计算](#场景1-性能密集型计算)
    - [场景2: 单页应用 (Yew)](#场景2-单页应用-yew)
  - [🔗 相关资源](#-相关资源)
