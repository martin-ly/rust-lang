...
>
> 通用概念权威页：[`concept/03_advanced/00_concurrency/03_concurrency_patterns.md`](../../../concept/03_advanced/00_concurrency/03_concurrency_patterns.md)（原通用概念解释已迁移至此）。
>
> 根据 AGENTS.md §2 Canonical 规则与 §3.3 去重政策，本文件不再维护正文。
