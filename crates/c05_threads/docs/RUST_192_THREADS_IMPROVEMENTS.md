...
- [Rust 1.92.0 线程并发改进文档](#rust-1920-线程并发改进文档)
  ...
  - [rotate_right 在线程池管理中的应用](#rotate_right-在线程池管理中的应用)
  - [NonZero::div_ceil 在线程数量计算中的应用](#nonzerodiv_ceil-在线程数量计算中的应用)
  - [实际应用示例](#实际应用示例)
  - [迁移指南](#迁移指南)
  ...
  - [展开表默认启用 (Rust 1.92.0 新增) ⭐](#展开表默认启用-rust-1920-新增-)
    - [配置说明](#配置说明)
    - [优势](#优势)
  - [panic::catch_unwind 性能优化 (Rust 1.92.0 新增) ⭐](#paniccatch_unwind-性能优化-rust-1920-新增-)
    - [性能影响](#性能影响)
    - [使用示例](#使用示例)
  - [总结](#总结)
