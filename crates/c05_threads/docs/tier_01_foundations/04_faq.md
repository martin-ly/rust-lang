...
- [Q4: Rayon vs async/await](#q4-我应该什么时候用-rayon什么时候用-asyncawait-tokiosmol)
...
**参考**: [术语表 - Send](03_glossary.md#send-trait) | [术语表 - Sync](03_glossary.md#sync-trait)
...
**参考**: [术语表 - Arc](03_glossary.md#arct-atomically-reference-counted) | [术语表 - Mutex](03_glossary.md#mutext-mutual-exclusion)
...
| **例子** | 图像处理                     | Web服务器           |
| **库**   | rayon                        | tokio, async-std [已归档]    |

#### 简单记忆

**计算用 Rayon，等待用 async！**

**参考**: [并行计算实践指南](../tier_02_guides/05_并行计算实践指南.md) | [术语表 - Rayon](03_glossary.md#rayon)
...
**参考**: [无锁编程参考](../tier_03_references/02_lock_free_programming_reference.md) | [术语表 - Atomics](03_glossary.md#atomics-原子类型)
...
**参考**: [术语表 - Deadlock](03_glossary.md#deadlock-死锁) | [同步原语使用指南](../tier_02_guides/03_同步原语使用指南.md)
...
**参考**: [消息传递实践指南](../tier_02_guides/02_消息传递实践指南.md) | [术语表 - Channel](03_glossary.md#channel-通道)
...
- 📘 [项目概览](01_project_overview.md) - 模块全景介绍
- 📘 [主索引导航](02_navigation.md) - 完整文档地图
- 📘 [术语表](03_glossary.md) - 术语快速查询
...
1. 查阅 [术语表](03_glossary.md) 了解相关概念
2. 搜索 [主索引导航](02_navigation.md) 查找相关文档
3. 在项目仓库提交 Issue
...
[返回项目概览](01_project_overview.md) | [查看主索引](02_navigation.md) | [查看术语表](03_glossary.md)
