...
- [C05 Tier 3 参考文档 01：API 参考手册](#c05-tier-3-参考文档-01api-参考手册)
  ...
  - [6. 参考链接](#6-参考链接)
    - [官方文档](#官方文档)
    - [内部文档](#内部文档)
  - [**文档维护**: C05 Threads Team | **最后审核**: 2025-10-24 | **质量评分**: 98/100 | **行数**: 1140+](#文档维护-c05-threads-team--最后审核-2025-10-24--质量评分-98100--行数-1140)
...
- [→ 下一篇：无锁编程参考](02_lock_free_programming_reference.md)
