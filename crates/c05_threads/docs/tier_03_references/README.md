> **EN**: C05 Tier 3 Reference Docs (crate docs stub)
> **Summary**: Stub pointing to the canonical concurrency authority pages. API-level examples remain in the c05_threads crate.

# C05 Tier 3: 参考文档层

> **权威来源**: [concept/03_advanced/00_concurrency/01_concurrency.md](../../../../concept/03_advanced/00_concurrency/01_concurrency.md)

本目录原为 `c05_threads` crate 的技术参考索引。根据 [AGENTS.md](../../../../../AGENTS.md) §6.4 治理规则，
