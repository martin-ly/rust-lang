...
- [并发编程模式](#并发编程模式)
  ...
  - [概述](#概述)
  - [异步编程模式](#异步编程模式)
    - [🚀 Rust 1.92.0 增强特性](#-rust-1920-增强特性)
    - [1. 异步迭代器模式](#1-异步迭代器模式)
    - [2. 异步闭包模式](#2-异步闭包模式)
  - [工作窃取模式](#工作窃取模式)
    - [🚀 Rust 1.92.0 工作窃取性能提升](#-rust-1920-工作窃取性能提升)
    - [1. 高性能工作窃取调度器](#1-高性能工作窃取调度器)
    - [2. 自适应工作分配](#2-自适应工作分配)
    - [🚀 示例：Rust 1.92.0 工作窃取实战](#-示例rust-1920-工作窃取实战)
    - [📊 工作窃取性能基准](#-工作窃取性能基准)
  - [分治并发模式](#分治并发模式)
    - [🚀 Rust 1.92.0 分治优化](#-rust-1920-分治优化)
    - [1. 并行分治算法](#1-并行分治算法)
    - [2. 流水线并发模式](#2-流水线并发模式)
    - [🚀 示例：Rust 1.92.0 高性能流水线](#-示例rust-1920-高性能流水线)
    - [📊 流水线模式性能对比](#-流水线模式性能对比)
  - [响应式并发模式](#响应式并发模式)
    - [1. 事件驱动并发](#1-事件驱动并发)
  ...
  - [📋 快速参考](#-快速参考)
    ...
    - [性能特征速查](#性能特征速查)
    - [Rust 1.92.0 新特性速查](#rust-1920-新特性速查)
  - [总结](#总结)
    - [核心优势](#核心优势)
