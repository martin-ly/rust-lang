...
- **定义**: 操作系统能够进行运算调度的最小单位，每个线程有独立的调用栈
- **类型**: 系统概念
- **范畴**: 并发编程
- **版本**: Rust 1.0+
- **相关概念**: 进程、并发、同步、消息传递
...
- [← 返回 Tier 1：项目概览](../tier_01_foundations/01_project_overview.md)
- [→ 下一篇：同步原语实践](02_synchronization_primitives_practice.md)
