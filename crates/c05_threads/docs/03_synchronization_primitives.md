...
- [第 3 章：共享状态并发与同步原语](#第-3-章共享状态并发与同步原语)
  ...
  - [📋 快速参考](#-快速参考)
    ...
    - [Rust 1.92.0 性能提升速查（自 Rust 1.90 引入）](#rust-1920-性能提升速查自-rust-190-引入)
...
| 原语            | 锁开销     | 读性能     | 写性能     | 内存开销   | 可扩展性   | Rust 1.92.0 优化 |
| --------------- | ---------- | ---------- | ---------- | ---------- | ---------- | ---------------- |
| **`Mutex<T>`**  | ⭐⭐⭐     | ⭐⭐⭐     | ⭐⭐⭐     | ⭐⭐⭐⭐   | ⭐⭐⭐     | +10% 吞吐量      |
| **`RwLock<T>`** | ⭐⭐⭐⭐   | ⭐⭐⭐⭐⭐ | ⭐⭐       | ⭐⭐⭐     | ⭐⭐⭐⭐   | +15% 读性能      |
| **`Atomic<T>`** | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | +5% 原子操作     |
...
- [01\_基础线程](01_basic_threading.md) - 线程创建和管理
- [02\_消息传递](02_message_passing.md) - 通道通信
- [03\_并发模式](03_concurrency_patterns.md) - 高级并发模式
- [04\_无锁编程](04_lock_free_programming.md) - Atomic详解
