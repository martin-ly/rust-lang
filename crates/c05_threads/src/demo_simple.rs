...
fn demonstrate_basic_sync() {
    ...
    println!("吞吐量: {:.2} ops/sec", final_count as f64 / duration.as_secs_f64());
}
...
fn demonstrate_performance_benchmark() {
    ...
    println!("  吞吐量: {:.2} ops/sec", iterations as f64 / mutex_time.as_secs_f64());
    ...
    println!("  吞吐量: {:.2} ops/sec", iterations as f64 / atomic_time.as_secs_f64());
