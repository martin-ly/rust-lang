...
impl HighPerformanceThreadPool {
    ...
    pub fn new(size: usize) -> Self {
        ...
        for id in 0..size {
            workers.push(Worker::new(id, receiver.clone(), Arc::clone(&global_queue)));
        }
...
impl<T> LockFreeStack<T> {
    ...
    pub fn push(&self, item: T) -> Result<(), T> {
        ...
        loop {
            ...
            if self
                .head
                .compare_exchange_weak(current_head, node_idx, Ordering::Release, Ordering::Relaxed)
                .is_ok()
            {
                break;
            }
    ...
    fn free_node(&self, node_idx: usize) {
        ...
        loop {
            ...
            if self
                .free_list
                .compare_exchange_weak(current, node_idx, Ordering::Release, Ordering::Relaxed)
                .is_ok()
            {
                break;
            }
