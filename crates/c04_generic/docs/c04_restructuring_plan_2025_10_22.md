> **EN**: C04 Generic Programming 文档重组计划 (crate docs stub)
> **Summary**: Stub pointing to the canonical authority page(s) for `C04 Generic Programming 文档重组计划`. Practical examples remain in the crate.
