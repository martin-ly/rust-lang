...
### 01. [高级类型技巧](01_advanced_type_techniques.md)
...
### 02. [泛型与生命周期](02_generics_and_lifetimes.md)
...
### 03. [零成本抽象](03_zero_cost_abstractions.md)
...
### 04. [类型级编程](04_type_level_programming.md)
...
### 05. [设计模式进阶](05_advanced_design_patterns.md)
...
| :--- | :--- | :--- | :--- | :--- || 01\_高级类型技巧.md   | 2500+       | PhantomData、ZST、类型状态 | 40+      | ⭐⭐⭐⭐⭐ |
| 02\_泛型与生命周期.md | 3000+       | HRTB、Variance、自引用     | 45+      | ⭐⭐⭐⭐⭐ |
| 03\_零成本抽象.md     | 2500+       | 性能分析、优化技巧         | 35+      | ⭐⭐⭐⭐   |
| 04\_类型级编程.md     | 3500+       | 类型级计算、HKT、DSL       | 50+      | ⭐⭐⭐⭐⭐ |
| 05\_设计模式进阶.md   | 3000+       | 架构模式、并发、异步       | 40+      | ⭐⭐⭐⭐   |
...
- 查看 [../tier_01_foundations/04_faq.md](../tier_01_foundations/04_faq.md)
- 提交 Issue 到项目仓库
