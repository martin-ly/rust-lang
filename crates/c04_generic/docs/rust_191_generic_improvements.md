> **EN**: Rust 1.91 泛型系统改进文档（历史版本） (crate docs stub)
> **Summary**: Stub pointing to the canonical authority page(s) for `Rust 1.91 泛型系统改进文档（历史版本）`. Practical examples remain in the crate.
...
| 主题 | 权威来源 |
| :--- | :--- |
| Rust 1.91 Stabilized Features | [concept/07_future/00_version_tracking/rust_1_91_stabilized.md](../../../concept/07_future/00_version_tracking/rust_1_91_stabilized.md) |
