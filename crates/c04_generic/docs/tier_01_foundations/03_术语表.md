...
**相关术语**: [Trait](#trait-trait-), [Send](#send-), [Sync](#sync-)
...
**相关术语**: [Zero-Sized Type](#zero-sized-type-zst-零大小类型-), [Variance](#variance-型变-), [Type-State Pattern](#type-state-pattern)
...
**参考文档**: [`analysis/rust_features/RUST_190_COMPREHENSIVE_GUIDE.md`](../analysis/rust_features/)
...
**相关术语**: [Type Parameter](#type-parameter-类型参数-), [Inference](#inference-类型推断-)
...
**相关术语**: [Generic](#generic-泛型-), [Trait Object](#trait-object-trait-对象-), [Dispatch](#dispatch-分发-)
