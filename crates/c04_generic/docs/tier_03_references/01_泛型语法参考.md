...
**泛型语法参考 (Generic Syntax Reference)**:
...
- **泛型类型参数语法**: 基础语法、类型参数命名约定
- **泛型函数语法**: 完整语法、返回类型语法
- **泛型结构体语法**: 定义语法、可见性语法
- **Const 泛型语法**: 基础语法、const 泛型约束
...
- 泛型语法参考 --[covers]--> 泛型完整语法
- 泛型程序 --[uses]--> 泛型语法

**依赖关系**:

- 泛型语法参考 --[depends-on]--> 语言规范
- 泛型编程 --[depends-on]--> 泛型语法
...
- [03\_边界约束参考.md](./03_边界约束参考.md) - 约束语法详解
- [04\_关联类型参考.md](./04_关联类型参考.md) - 关联类型语法
- [../tier*02_guides/01*泛型基础指南.md](../tier_02_guides/01_泛型基础指南.md) - 泛型基础教程
