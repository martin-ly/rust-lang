...
| 主题 | 权威来源 |
| :--- | :--- |
| 进程创建、`Command`、`spawn`、`output` | [`concept/03_advanced/08_process_ipc/01_process_model_and_lifecycle.md`](../../../concept/03_advanced/08_process_ipc/01_process_model_and_lifecycle.md) |
| 标准 IO 重定向、管道 | 同上 |
| 信号处理、SIGINT/SIGTERM | 同上 |
| IPC、Unix domain socket | [`concept/03_advanced/08_process_ipc/05_ipc_mechanisms.md`](../../../concept/03_advanced/08_process_ipc/05_ipc_mechanisms.md) |
