> **EN**: Process Management Performance Optimization (c07 example index)
> **Summary**: Stub pointing to the canonical performance optimization authority. Process-specific examples remain in the c07 crate.
