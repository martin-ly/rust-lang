...
```
**参考**: [进程模型参考](../tier_03_references/01_process_models_reference.md)
...
```
**参考**: [常见问题 - 僵尸进程](04_faq.md#q4-如何避免和处理僵尸进程)
...
let shmem = ShmemConf::new()
    ...
    .open()?;
```
**参考**: [IPC机制参考](../tier_03_references/02_ipc_mechanisms_reference.md)
...
**参考**: [同步原语参考](../tier_03_references/04_synchronization_primitives_reference.md)
