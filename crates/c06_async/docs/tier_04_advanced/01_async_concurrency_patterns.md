...
- **定义**: Rust 1.92.0 在异步编程中使用的高级并发模式和设计原则
- **类型**: 高级主题文档
- **范畴**: 异步编程、系统架构
- **版本**: Rust 1.92.0+ (Edition 2024)
- **相关概念**: Actor模式、Reactor模式、Pipeline、CSP、对象池、Work Stealing、反应式编程
...
- **[异步设计模式实践](../tier_02_guides/04_async_design_patterns_practice.md)** - 基础模式
- **[异步系统架构](02_async_system_architecture.md)** - 系统级设计
- **[Tokio完整API参考](../tier_03_references/02_tokio_complete_api_reference.md)** - API详解
