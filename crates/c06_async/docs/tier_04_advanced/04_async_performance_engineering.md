...
- [Tier 4: 异步性能工程](#tier-4-异步性能工程)
  ...
  - [10. 网络优化](#10-网络优化)
    ...
    - [10.2 io\_uring (Linux)](#102-io_uring-linux)
  - [📚 延伸阅读](#-延伸阅读)
  - [📝 总结](#-总结)
...
- **[异步性能优化指南](../tier_02_guides/05_async_performance_optimization_guide.md)** - 基础优化
- **[性能基准参考](../tier_03_references/05_performance_benchmarks_reference.md)** - 基准数据
- **[异步调试与监控](../tier_02_guides/06_async_debugging_and_monitoring.md)** - 性能分析
