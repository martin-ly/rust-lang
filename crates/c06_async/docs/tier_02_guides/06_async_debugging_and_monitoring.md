...
**异步调试与监控 (Async Debugging and Monitoring)**:

- **定义**: 调试和监控异步程序的技术和方法，包括日志、追踪、性能监控等
- **类型**: 调试和监控技术
- **范畴**: 软件工程、性能分析
- **版本**: Rust 1.39+
- **相关概念**: tracing、tokio-console、Prometheus、分布式追踪

### 属性特征

**核心属性**:

- **结构化日志**: 使用 tracing 进行结构化日志
- **实时监控**: tokio-console 实时监控
- **性能分析**: 性能指标收集和分析
- **分布式追踪**: 跨服务追踪
...
- 异步调试与监控 --[uses]--> 多种工具和技术
- 生产环境 --[uses]--> 监控体系

**依赖关系**:

- 异步调试与监控 --[depends-on]--> 监控工具
- 生产监控 --[depends-on]--> Prometheus
...
- **[异步性能优化指南](05_async_performance_optimization_guide.md)** - 性能调优
- **[异步设计模式实践](04_async_design_patterns_practice.md)** - 设计模式
- **[工具指南](../tier_03_references/README.md)** - 详细工具文档
