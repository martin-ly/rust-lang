> **EN**: Async Design Patterns Guide (c06 example index)
> **Summary**: Stub pointing to the canonical async-patterns authority. Practical examples remain in the c06 crate.
