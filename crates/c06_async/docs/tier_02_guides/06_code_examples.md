...
> **权威来源**: [Async Rust](../../concept/03_advanced/01_async)
> **文档类型**: 代码示例与实践项目（crate-specific）

本文件包含与 `Async Rust` 相关的可运行代码示例、练习项目和实战代码。通用概念解释请查阅上方权威来源；此处仅保留 crate 级别的示例实现与学习活动。
...
- 📖 深入学习: [Future与Executor机制](01_future_and_executor_mechanisms.md)
- 📖 深入学习: [异步运行时选择指南](02_async_runtime_selection_guide.md)
- 🚀 实战项目: [C06 实战项目集](07_hands_on_projects.md) (即将创建)
