...
- [Tier 3: 异步语言特性参考](.#tier-3-异步语言特性参考)
  ...
  - [4. async fn in Traits (Rust 1.75.0+)](.#4-async-fn-in-traits-rust-1750)
    - [4.1 基本语法](.#41-基本语法)
    - [4.2 限制](.#42-限制)
  ...
  - [6. Stream Trait](.#6-stream-trait)
    - [6.1 定义](.#61-定义)
    - [6.2 使用示例](.#62-使用示例)
  - [7. Rust 1.92.0 新特性](.#7-rust-1920-新特性)
...
**异步语言特性 (Async Language Features)**:

- **定义**: Rust 语言提供的异步编程相关的语法特性和类型系统支持
- **类型**: 语言特性
- **范畴**: 异步编程、语言特性
- **版本**: Rust 1.39+ (async/await), Rust 1.75.0+ (async fn in traits)
- **相关概念**: async/await、Future、Pin、Stream
...
- 异步程序 --[uses]--> 异步语言特性
- 异步运行时 --[executes]--> Future

**依赖关系**:

- 异步语言特性 --[depends-on]--> 编译器支持
...
- ✅ Future trait
- ✅ Pin/Unpin
- ✅ async fn in traits (Rust 1.75.0+)
- ✅ impl Trait
- ✅ Stream trait
