...
- [Tier 3: 性能基准参考](#tier-3-性能基准参考)
  ...
  - [📚 延伸阅读](#-延伸阅读)
  - [📝 总结](#-总结)
  - [**最后更新**: 2025-10-22 | **测试环境**: AMD Ryzen 9 5950X, 64GB RAM](#最后更新-2025-10-22--测试环境-amd-ryzen-9-5950x-64gb-ram)
...
- 性能基准参考 --[contains]--> 多个性能基准
- 性能评估 --[uses]--> 性能基准参考

**依赖关系**:

- 性能基准参考 --[depends-on]--> 基准测试工具
- 性能选择 --[depends-on]--> 性能基准参考
...
| **async-std [已归档]** | 58ms | 1.7M ops/s | 12MB |
...
| **async-std [已归档]** | channel      | 1.8M msg/s |
...
| **async-std [已归档]** | 1.0M req/s | 1.2ms      | 82%        |
...
| **surf** [unmaintained] | 900ms | 1.1K req/s | 7MB |
