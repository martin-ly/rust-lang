...
| **async-std [已归档]** | API接近标准库      | 学习、中小项目 | ⭐⭐⭐     |
| **Smol**      | 轻量级             | 嵌入式、WASM   | ⭐⭐       |
...
| **reqwest** | 易用，功能全   | ⭐⭐⭐⭐⭐ |
| **hyper**   | 底层，高性能   | ⭐⭐⭐⭐   |
| **surf**    | async-std [已归档] / surf [unmaintained] | ⭐⭐⭐     |
...
- **[异步运行时选择指南](../tier_02_guides/03_async_runtime_selection_guide.md)** - 运行时详解
- **[Tokio完整API参考](02_tokio_complete_api_reference.md)** - Tokio API
- **[异步性能优化指南](../tier_02_guides/05_async_performance_optimization_guide.md)** - 性能调优
