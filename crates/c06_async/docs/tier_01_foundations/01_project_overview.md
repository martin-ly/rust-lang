...
- **范畴**: 并发编程、I/O 编程
- **版本**: Rust 1.39+
- **相关概念**: Future、async/await、异步运行时、并发执行

**Future**:

- **定义**: 表示异步计算的值，可能尚未完成
- **类型**: Trait
- **属性**: Poll 状态、异步执行、可组合性
...
- **非阻塞**: 不阻塞当前线程，允许其他任务运行
- **高并发**: 可同时处理大量任务
- **低资源**: 内存和 CPU 占用少
- **可组合**: Future 可以组合成更复杂的异步操作

**性能特征**:

- **I/O 效率**: 高效处理 I/O 密集型任务
- **内存占用**: 比线程更节省内存
...
- 异步运行时 --[has-a]--> 任务调度器
- 异步运行时 --[has-a]--> I/O 事件循环

**依赖关系**:

- async/await --[depends-on]--> Future Trait
...
- 🌐 **生态完整**: Tokio/Smol/async-std [已归档] 等主流运行时的全面覆盖
- ⚡ **性能优化**: 从基础到高级的性能调优技术
- 🔍 **调试监控**: 完整的异步程序调试和监控体系
...
- ✅ **async fn in traits**: Rust 1.75.0+ 稳定的 trait 中的异步方法
...
| 文档                                    | 说明              | 难度 |
| :--- | :--- | :--- || [01\_项目概览.md](01_project_overview.md)     | 本文档 - 项目总览 | ⭐⭐ |
| [02\_主索引导航.md](02_navigation.md) | 完整导航系统      | ⭐   |
| [03\_术语表.md](03_glossary.md)         | 核心术语快速参考  | ⭐   |
...
| 文档                                                                       | 说明                      | 难度     |
| :--- | :--- | :--- || [01\_异步编程快速入门.md](../tier_02_guides/01_异步编程快速入门.md)        | 10分钟上手                | ⭐⭐     |
| [02_future_and_executor_mechanisms.md](../tier_02_guides/02_future_and_executor_mechanisms.md) | 执行模型深入              | ⭐⭐⭐   |
| [03\_异步运行时选择指南.md](../tier_02_guides/03_async_runtime_selection_guide.md)    | Tokio/Smol/async-std [已归档] 对比 | ⭐⭐⭐   |
| [04\_异步设计模式实践.md](../tier_02_guides/04_async_design_patterns_practice.md)        | Actor/Reactor/CSP         | ⭐⭐⭐   |
| [05\_异步性能优化指南.md](../tier_02_guides/05_async_performance_optimization_guide.md)        | 性能调优实战              | ⭐⭐⭐⭐ |
| [06\_异步调试与监控.md](../tier_02_guides/06_async_debugging_and_monitoring.md)            | 调试和监控体系            | ⭐⭐⭐   |
...
| [05\_性能基准参考.md](../tier_03_references/05_performance_benchmarks_reference.md)         | 基准测试数据      | ⭐⭐⭐     |
...
| [02\_异步系统架构.md](../tier_04_advanced/02_async_system_architecture.md)         | 微服务/分布式系统 | ⭐⭐⭐⭐⭐ |
| [03\_形式化验证与分析.md](../tier_04_advanced/03_formal_verification_and_analysis.md) | 正确性验证        | ⭐⭐⭐⭐⭐ |
| [04\_异步性能工程.md](../tier_04_advanced/04_async_performance_engineering.md)         | 极致性能优化      | ⭐⭐⭐⭐⭐ |
| [05\_跨平台异步编程.md](../tier_04_advanced/05_cross_platform_async_programming.md)     | 平台差异处理      | ⭐⭐⭐⭐   |
...
1. 📖 [项目概览](01_project_overview.md) (本文档)
2. 📖 [术语表](03_glossary.md)
3. 📚 [快速入门](../tier_02_guides/01_异步编程快速入门.md)
4. 💻 运行基础示例

#### 中级开发者

1. 📚 [Future与Executor机制](../tier_02_guides/02_future_and_executor_mechanisms.md)
2. 📚 [运行时选择指南](../tier_02_guides/03_async_runtime_selection_guide.md)
3. 📚 [设计模式实践](../tier_02_guides/04_async_design_patterns_practice.md)
4. 🎯 实战项目开发

#### 高级工程师

1. 📖 [Pin与Unsafe参考](../tier_03_references/04_pin_and_unsafe_reference.md)
2. 🚀 [异步系统架构](../tier_04_advanced/02_async_system_architecture.md)
...
- [examples/](../../examples/README.md) - 250+ 可运行示例
- [tests/](../../tests) - 完整测试套件
