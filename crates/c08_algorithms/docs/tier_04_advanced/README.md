...
| 文档                                         | 内容                 | 难度       |
| :--- | :--- | :--- || [01\_形式化算法理论](./01_形式化算法理论.md) | 算法分类与形式化体系 | ⭐⭐⭐⭐⭐ |
| [02\_并发算法模式](./02_并发算法模式.md)     | Actor/Reactor/CSP    | ⭐⭐⭐⭐   |
| [03\_分布式算法](./03_分布式算法.md)         | 分布式系统算法       | ⭐⭐⭐⭐⭐ |
| [04\_算法工程实践](./04_算法工程实践.md)     | 工程应用最佳实践     | ⭐⭐⭐⭐   |
| [05\_前沿算法技术](./05_前沿算法技术.md)     | 机器学习与前沿研究   | ⭐⭐⭐⭐⭐ |
