...
- [形式化算法理论](#形式化算法理论)
  ...
  - [7. 参考资料](#7-参考资料)
    ...
    - [复杂度理论](#复杂度理论)
    - [在线资源](#在线资源)
  - [**下一步**: 参见 `02_concurrent_algorithm_patterns.md`](#下一步-参见-02_并发算法模式md)
...
**形式化算法理论 (Formal Algorithm Theory)**:

- **定义**: Rust 1.93.1 使用数学方法严格定义和分析算法的理论体系，包括图灵机、计算模型、可计算性理论、复杂度理论、算法正确性证明、形式化验证工具等
- **类型**: 高级主题文档
- **范畴**: 算法学、理论计算机科学
- **版本**: Rust 1.93.1+ (Edition 2024)
- **相关概念**: 图灵机、复杂度理论、形式化验证、可计算性理论、Kani、Prusti

**图灵机 (Turing Machine)**:

- **定义**: 最基本的计算模型，用于定义算法的可计算性
- **类型**: 计算模型
- **属性**: 状态集合、转移函数、带字母表
- **关系**: 与算法、可计算性理论相关
...
- 形式化算法理论 --[depends-on]--> 数学基础
- 算法正确性 --[depends-on]--> 形式化证明
...
**下一步**: 参见 [`02_concurrent_algorithm_patterns.md`](02_concurrent_algorithm_patterns.md)
---
