...
- **定义**: 分析算法执行时间和空间需求随输入规模增长的变化趋势
- **类型**: 算法分析方法
- **范畴**: 算法学、性能分析
- **相关概念**: 时间复杂度、空间复杂度、渐进符号、主定理
...
- **渐进符号**: Big O、Big Omega、Big Theta
- **复杂度类型**: O(1)、O(log n)、O(n)、O(n log n)、O(n²) 等
- **递归分析**: 主定理、递归树
- **摊销分析**: 平均复杂度分析
...
- 复杂度分析 --[depends-on]--> 算法实现
- 性能评估 --[depends-on]--> 复杂度分析
...
- [数据结构实践](02_data_structures_practice.md) - 数据结构选择
- [性能优化实践](04_performance_optimization_practice.md) - 优化技巧
- [算法性能参考](../tier_03_references/04_algorithm_performance_reference.md) - 基准与 Criterion
...
**返回**: [Tier 2 索引](README.md) | **下一步**: [性能优化实践](04_performance_optimization_practice.md)
