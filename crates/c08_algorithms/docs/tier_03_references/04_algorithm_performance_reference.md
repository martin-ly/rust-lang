...
**算法性能参考 (Algorithm Performance Reference)**:

- **定义**: 提供算法性能基准数据和性能分析的技术参考
- **类型**: 性能基准文档
- **范畴**: 算法学、性能分析
- **版本**: Rust 1.0+
- **相关概念**: 性能基准、基准测试、性能对比、复杂度分析
...
- 算法性能参考 --[contains]--> 多个算法性能基准
- 性能评估 --[uses]--> 算法性能参考

**依赖关系**:

- 算法性能参考 --[depends-on]--> 基准测试工具
- 算法选择 --[depends-on]--> 算法性能参考
...
- **[02\_数据结构参考](02_data_structures_reference.md)** - 数据结构 API
- **[05\_标准库算法参考](05_standard_library_algorithms_reference.md)** - 标准库对比
