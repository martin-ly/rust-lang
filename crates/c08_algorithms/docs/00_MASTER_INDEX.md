...
- [C08 Algorithms - 主索引](#c08-algorithms---主索引)
  - [📊 目录](#-目录)
  - [📚 快速导航](#-快速导航)
    - [🎯 新手入门](#-新手入门)
    - [🚀 常用文档](#-常用文档)
    - [🆕 新增资源 (2025-10-19)](#-新增资源-2025-10-19)
  - [🗂️ 文档目录结构](#️-文档目录结构)
  - [📖 按类别浏览](#-按类别浏览)
  ...
  - [🎓 推荐学习路径](#-推荐学习路径)
    - [路径 1: 初学者 (2-3 周)](#路径-1-初学者-2-3-周)
    - [路径 2: 中级开发者 (3-4 周)](#路径-2-中级开发者-3-4-周)
    - [路径 3: 高级研究者 (持续学习)](#路径-3-高级研究者-持续学习)
    - [路径 4: 工程师 (按需学习)](#路径-4-工程师-按需学习)
  - [🔍 快速查找](#-快速查找)
    - [按主题查找](#按主题查找)
    - [按难度查找](#按难度查找)
    - [按 Rust 版本查找](#按-rust-版本查找)
  - [💻 代码资源](#-代码资源)
    - [源代码](#源代码)
    - [示例代码](#示例代码)
    - [测试与基准](#测试与基准)
