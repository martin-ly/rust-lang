...
mod tests {
    ...
    fn test_linear_regression() {
        ...
        let mut model = MachineLearningAlgorithms::LinearRegression::new(2, 0.01);
    ...
    fn test_rsa_encryption() {
        let rsa = CryptographicAlgorithms::RSA::new(64);
        let message = 12345;
    ...
    #[test]
    fn test_sha256() {
        let mut sha256 = CryptographicAlgorithms::SHA256::new();
