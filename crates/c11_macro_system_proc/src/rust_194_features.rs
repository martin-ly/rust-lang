//! Rust 1.94.0 引入的宏系统特性（1.94.0 稳定）
//! Rust 1.94 system features (stable in 1.94.0) module
...
/// demonstration Rust 1.94.0 macro system features (stable in 1.94.0)
...
/// Rust 1.94.0 macro system features (stable in 1.94.0)
