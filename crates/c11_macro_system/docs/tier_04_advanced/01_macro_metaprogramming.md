...
**宏元编程 (Macro Metaprogramming)**:

- **定义**: Rust 1.92.0 宏元编程技术，包括类型级编程、编译期计算、零成本抽象、高级宏模式等
- **类型**: 高级主题文档
- **范畴**: 元编程、宏系统
- **版本**: Rust 1.92.0+ (Edition 2024)
- **相关概念**: 宏、类型级编程、编译期计算、零成本抽象、TT Munching、Push-Down Accumulation

### 属性特征

**核心属性**:

- **类型级编程**: PhantomData 与零大小类型、类型状态模式、类型级计算、HList 异构列表
- **编译期计算**: const fn 与 const 泛型、编译期断言、编译期优化、宏驱动的代码生成
- **零成本抽象**: 内联与单态化、宏生成的零成本包装、编译期多态
- **高级宏模式**: TT Munching、Push-Down Accumulation、Internal Rules、Callback 模式

**Rust 1.92.0 新特性**:

- **改进的 const fn**: 更强大的编译期计算能力
- **增强的宏系统**: 更好的宏调试和开发体验
- **优化的编译期计算**: 更高效的编译期计算
...
| :--- | :--- | :--- | :--- | :--- | :--- || **类型级编程**             | 高     | 零开销 | 中         | 类型安全 | ✅          |
| **编译期计算**             | 中     | 零开销 | 高         | 常量计算 | ✅ 改进     |
| **零成本抽象**             | 中     | 零开销 | 低         | 代码生成 | ✅          |
| **TT Munching**            | 高     | 零开销 | 中         | 复杂解析 | ✅          |
| **Push-Down Accumulation** | 高     | 零开销 | 中         | 累积计算 | ✅          |
