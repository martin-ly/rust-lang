...
| 常见目标三元组与学习路径 | [`concept/06_ecosystem/05_systems_and_embedded/03_embedded_systems.md#六常见嵌入式目标三元组与学习路径`](../../../concept/06_ecosystem/05_systems_and_embedded/03_embedded_systems.md) |
