> **EN**: Trait Practice Guide (c02 example index)
> **Summary**: Stub pointing to the canonical trait authority. Practical examples remain in the c02 crate.

# 2.4 Rust 类型系统 - Trait 实践指南（c02 示例索引）
