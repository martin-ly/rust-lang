> **EN**: Lifetimes Guide (c02 example index)
> **Summary**: Stub pointing to the canonical lifetimes authority. Practical examples remain in the c02 crate.

# 2.5 Rust 类型系统 - 生命周期指南（c02 示例索引）
