...
- [设计模式集](../tier_04_advanced/05_design_patterns_collection.md)
...
- [类型型变参考](../tier_03_references/02_variance_reference.md)
- [类型理论深度](../tier_04_advanced/01_type_theory_in_depth.md)
...
- [生命周期指南](../tier_02_guides/05_lifetimes_guide.md)
...
- [项目概览](01_project_overview.md) - 项目整体介绍
- [主索引导航](02_navigation.md) - 完整文档索引
- [常见问题](04_faq.md) - FAQ
...
- [类型理论深度](../tier_04_advanced/01_type_theory_in_depth.md)
- [高级泛型模式](../tier_04_advanced/02_advanced_generics_patterns.md)
- [类型系统形式化](../tier_04_advanced/03_formalizing_type_systems.md)
