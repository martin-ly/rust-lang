...
**相关文档**: [分派机制参考](../tier_03_references/03_dispatch_mechanisms_reference.md)
...
- [术语表](03_glossary.md) - 核心术语

### Tier 2 (指南层)

- [基础类型指南](../tier_02_guides/01_basic_types_guide.md)
- [复合类型指南](../tier_02_guides/02_compound_types_guide.md)
...
- [跨语言对比](../tier_04_advanced/04_cross_language_comparison.md)
