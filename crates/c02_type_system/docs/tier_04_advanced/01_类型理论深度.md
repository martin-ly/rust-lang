...
- [4.1 Rust 类型系统 - 类型理论深度](#41-rust-类型系统---类型理论深度)
  ...
  - [10. 参考资源](#10-参考资源)
    ...
    - [相关文档](#相关文档)
    - [研究方向](#研究方向)
  - [_本文档深入探讨了Rust类型系统的理论基础，从线性逻辑、仿射类型到Curry-Howard同构，从HM类型推断到形式化验证，为理解Rust的设计哲学和安全保证提供了完整的理论框架。_](#本文档深入探讨了rust类型系统的理论基础从线性逻辑仿射类型到curry-howard同构从hm类型推断到形式化验证为理解rust的设计哲学和安全保证提供了完整的理论框架)
