...
> **相关文档**: [主索引](../tier_01_foundations/02_navigation.md) | [基础类型指南](../tier_02_guides/01_basic_types_guide.md)
...
- [3.6 浮点数高级主题与 const fn 语义 (Rust 1.92.0)](#36-浮点数高级主题与-const-fn-语义-rust-1920)
  ...
  - [9. 相关资源](#9-相关资源)
    ...
    - [外部资源](#外部资源)
    - [相关 Crate](#相关-crate)
  - [**下一步**：建议阅读 高级泛型模式 以了解泛型常量表达式（Generic Const Exprs），它与 const fn 结合能实现更强大的编译期编程](#下一步建议阅读-高级泛型模式-以了解泛型常量表达式generic-const-exprs它与-const-fn-结合能实现更强大的编译期编程)
...
- [基础类型指南](../tier_02_guides/01_basic_types_guide.md) - 浮点数基础
- [类型转换参考](01_type_conversions_reference.md) - 浮点数类型转换规则
- [性能优化参考](05_performance_optimization_reference.md) - 浮点数性能优化
...
**下一步**：建议阅读 [高级泛型模式](../tier_04_advanced/02_advanced_generics_patterns.md) 以了解泛型常量表达式（Generic Const Exprs），它与 const fn 结合能实现更强大的编译期编程
---
