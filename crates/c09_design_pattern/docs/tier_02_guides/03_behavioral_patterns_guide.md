...
> **目标读者**: 需要掌握对象交互模式的开发者
> **预计学习时间**: 3-4小时
> **前置知识**: [结构型模式指南](02_structural_patterns_guide.md)
...
- **定义**: 处理对象间通信和职责分配的设计模式，关注对象如何协作完成任务
- **类型**: 设计模式类别
- **范畴**: 软件设计
- **相关概念**: 创建型模式、结构型模式、设计模式

**Strategy 模式**:

- **定义**: 定义算法族，使它们可以互换使用，让算法的变化独立于使用它的客户端
- **类型**: 行为型模式
- **属性**: 算法封装、可替换、解耦
- **关系**: 与状态模式、命令模式相关
...
- 行为型模式 --[depends-on]--> 对象交互需求
- Strategy --[depends-on]--> 算法族定义
...
| 模式     | 目的     | 复杂度 | 适用场景       | 性能 |
| :--- | :--- | :--- | :--- | :--- || Strategy | 算法封装 | 低     | 多种算法选择   | 中   |
| Observer | 事件通知 | 中     | 一对多依赖     | 中   |
| Command  | 命令封装 | 中     | 请求队列、撤销 | 中   |
| Iterator | 遍历抽象 | 低     | 集合遍历       | 高   |
| State    | 状态转换 | 中     | 状态机         | 中   |
| Visitor  | 操作分离 | 高     | 复杂对象结构   | 中   |
...
**返回**: [Tier 2 索引](README.md) | **下一步**: [并发模式指南](04_concurrency_patterns_guide.md)
