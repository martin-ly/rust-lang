> **EN**: Concurrency Design Patterns Guide (c09 example index)
> **Summary**: Stub pointing to the canonical concurrency-patterns authority. Practical examples remain in the c09 crate.
...
| 主题 | 权威来源 |
| :--- | :--- |
| 相关概念 | [concept/03_advanced/00_concurrency/03_concurrency_patterns.md](../../../../concept/03_advanced/00_concurrency/03_concurrency_patterns.md) |
