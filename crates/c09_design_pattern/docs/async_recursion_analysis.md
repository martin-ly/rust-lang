> **EN**: Async Recursion: Formal Analysis and Implementation Patterns (c09_design_pattern example index)
> **Summary**: A stub page pointing to the canonical concept authority for async recursion patterns. The c09_design_pattern crate provides runnable async-recursion examples.
...
- `crates/c09_design_pattern/examples/`：异步递归可运行示例。
- `crates/c09_design_pattern/src/bin/`：异步递归模式演示。
