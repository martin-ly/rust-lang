...
| 主题 | 权威来源 |
| :--- | :--- |
| GoF 模式在 Rust 中的实现 | [`concept/06_ecosystem/03_design_patterns/01_patterns.md`](../../../concept/06_ecosystem/03_design_patterns/01_patterns.md) |
| Rust 特有模式（Newtype、RAII、Typestate） | 同上 |
| 架构与 API 设计模式 | [`concept/06_ecosystem/03_design_patterns/08_architecture_patterns.md`](../../../concept/06_ecosystem/03_design_patterns/08_architecture_patterns.md) |
