...
```text
1. 研究形式化理论 (KNOWLEDGE_GRAPH、MULTIDIMENSIONAL_MATRIX)
2. 学习高级模式组合
3. 理解性能权衡
4. 设计领域特定模式
5. 架构级最佳实践
...
| 文档                                    | 状态 | 行数 | 说明               |
| :--- | :--- | :--- | :--- || [01\_项目概览.md](01_project_overview.md)     | ✅   | 730+ | 模块介绍、学习路径 |
| [02\_主索引导航.md](02_navigation.md) | ✅   | 现有 | 导航系统 (本文档)  |
| [03\_术语表.md](03_glossary.md)         | ✅   | 完成 | 设计模式术语       |
| [04\_常见问题.md](04_faq.md)     | ✅   | 完成 | FAQ解答            |
