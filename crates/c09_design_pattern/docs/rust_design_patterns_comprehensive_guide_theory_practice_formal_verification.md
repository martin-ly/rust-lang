> **EN**: Rust Design Patterns (c09_design_pattern example index)
> **Summary**: A stub page pointing to the canonical concept authority for Rust design patterns. The c09_design_pattern crate provides runnable implementations of classic and Rust-specific patterns.
...
- `crates/c09_design_pattern/examples/`：单例、工厂、建造者、观察者、策略等可运行示例。
- `crates/c09_design_pattern/src/`：c09_design_pattern crate 的 API 实现与练习骨架。
