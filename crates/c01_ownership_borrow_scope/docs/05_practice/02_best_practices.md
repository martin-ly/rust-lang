...
- [Rust 所有权、借用与作用域实践指南](#rust-所有权借用与作用域实践指南)
  - [概述](#概述)
  - [目录](#目录)
  - [1. 基础概念](#1-基础概念)
    - [1.1 什么是所有权](#11-什么是所有权)
    - [1.2 为什么需要所有权系统](#12-为什么需要所有权系统)
  - [2. 所有权系统](#2-所有权系统)
    - [2.1 所有权规则](#21-所有权规则)
    - [2.2 移动语义](#22-移动语义)
    - [2.3 克隆与复制](#23-克隆与复制)
  - [3. 借用机制](#3-借用机制)
    - [3.1 引用规则](#31-引用规则)
    - [3.2 可变引用](#32-可变引用)
    - [3.3 借用检查器优化](#33-借用检查器优化)
  - [4. 生命周期管理](#4-生命周期管理)
    - [4.1 生命周期标注](#41-生命周期标注)
    - [4.2 生命周期省略规则](#42-生命周期省略规则)
    - [4.3 静态生命周期](#43-静态生命周期)
  - [5. 作用域控制](#5-作用域控制)
    - [5.1 作用域类型](#51-作用域类型)
    - [5.2 作用域优化](#52-作用域优化)
    - [5.3 作用域与所有权](#53-作用域与所有权)
  - [6. 常见模式](#6-常见模式)
  ...
  - [7. 性能优化](#7-性能优化)
    ...
    - [7.2 使用引用而非所有权](#72-使用引用而非所有权)
    - [7.3 利用 Copy trait](#73-利用-copy-trait)
  - [8. 错误处理](#8-错误处理)
    - [8.1 借用检查器错误](#81-借用检查器错误)
    - [8.2 生命周期错误](#82-生命周期错误)
    - [8.3 所有权错误](#83-所有权错误)
  - [9. 最佳实践](#9-最佳实践)
    - [9.1 设计原则](#91-设计原则)
    - [9.2 代码组织](#92-代码组织)
    - [9.3 测试策略](#93-测试策略)
  - [10. 实战案例](#10-实战案例)
    - [10.1 数据结构实现](#101-数据结构实现)
    - [10.2 并发安全](#102-并发安全)
    - [10.3 错误处理链](#103-错误处理链)
  - [总结](#总结)
