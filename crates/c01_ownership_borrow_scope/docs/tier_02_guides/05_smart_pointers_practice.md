...
- **参考文档**: [Tier 3: 05\_智能指针API参考](../tier_03_references/05_smart_pointer_api_reference.md)
- **高级主题**: [Tier 4: 02\_自引用结构](../tier_04_advanced/02_self_referential_structures.md)
