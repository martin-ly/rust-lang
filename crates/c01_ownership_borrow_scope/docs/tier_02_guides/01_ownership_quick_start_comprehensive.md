> **EN**: Ownership Quick Start Comprehensive Guide (c01 example index)
> **Summary**: Stub pointing to the canonical ownership authority. Practical examples and exercises remain in the c01 crate.

# 2.1 所有权系统 - 完整指南（c01 示例索引）
...
| RAII 与 Drop | [concept/01_foundation/01_ownership_borrow_lifetime/01_ownership.md](../../../../concept/01_foundation/01_ownership_borrow_lifetime/01_ownership.md) |
