> **EN**: Advanced Ownership Patterns (c01 example index)
> **Summary**: Stub pointing to canonical smart pointer and interior mutability authorities. Runnable examples remain in the c01 crate.

# 3.1 高级所有权模式（c01 示例索引）

> **权威来源**: 通用 Rust 概念解释已迁移至 canonical authority page:
> [`concept/02_intermediate/02_memory_management/04_smart_pointers.md`](../../../concept/02_intermediate/02_memory_management/12_smart_pointers.md)。
...
| 主题 | 权威来源 |
| :--- | :--- |
| 智能指针 | [../../../concept/02_intermediate/02_memory_management/12_smart_pointers.md](../../../concept/02_intermediate/02_memory_management/12_smart_pointers.md) |
