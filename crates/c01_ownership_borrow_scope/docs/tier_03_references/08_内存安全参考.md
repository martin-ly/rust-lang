...
**推荐先学习**: [Tier 2 核心概念](../tier_02_guides/README.md), [06 高级所有权模式参考](./06_高级所有权模式参考.md)
...
- **[内存安全分析](./08_内存安全参考.md)**: 深入的内存安全机制分析
- **[并发编程](../tier_04_advanced/05_跨线程所有权.md)**: 并发场景的安全实践
...
- **Tier 3 高级主题**
  ...
  - [3.2 零成本抽象](./07_零成本抽象参考.md)
  - [3.4 性能优化](./09_性能优化参考.md)
