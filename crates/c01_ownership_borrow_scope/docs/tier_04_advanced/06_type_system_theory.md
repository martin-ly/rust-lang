...
**推荐先学习**: [Tier 3 高级主题](../tier_03_references/README.md)
...
- **[所有权理论](06_type_system_theory.md)**: 所有权系统的理论基础
- **[借用理论](06_type_system_theory.md)**: 借用机制的理论分析
- **[生命周期理论](06_type_system_theory.md)**: 生命周期系统的形式化
- **[内存安全理论](../tier_03_references/08_memory_safety_reference.md)**: 内存安全的理论保证
...
- **[所有权理论](06_type_system_theory.md)**: 所有权系统的数学基础
- **[借用理论](06_type_system_theory.md)**: 借用机制的形式化
- **[生命周期理论](06_type_system_theory.md)**: 区域类型系统
- **[内存安全理论](../tier_03_references/08_memory_safety_reference.md)**: 安全性保证

### 🔗 相关主题

- **Tier 4 理论主题**
  - [4.2 形式化验证](07_formal_verification.md)
  - [4.3 学术研究](08_academic_research.md)
- **Tier 3 实践主题**
  - [06 高级所有权模式参考](../tier_03_references/06_advanced_ownership_patterns_reference.md)
  - [07 零成本抽象参考](../tier_03_references/07_zero_cost_abstractions_reference.md)
