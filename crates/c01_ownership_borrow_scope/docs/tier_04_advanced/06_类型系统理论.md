...
- **[所有权理论](./06_类型系统理论.md)**: 所有权系统的理论基础
- **[借用理论](./06_类型系统理论.md)**: 借用机制的理论分析
- **[生命周期理论](./06_类型系统理论.md)**: 生命周期系统的形式化
- **[内存安全理论](./../tier_03_references/08_内存安全参考.md)**: 内存安全的理论保证
...
- **[所有权理论](./06_类型系统理论.md)**: 所有权系统的数学基础
- **[借用理论](./06_类型系统理论.md)**: 借用机制的形式化
- **[生命周期理论](./06_类型系统理论.md)**: 区域类型系统
- **[内存安全理论](./../tier_03_references/08_内存安全参考.md)**: 安全性保证

### 🔗 相关主题

- **Tier 4 理论主题**
  - [4.2 形式化验证](./07_形式化验证.md)
  - [4.3 学术研究](./08_学术研究.md)

- **Tier 3 实践主题**
  - [06 高级所有权模式参考](../tier_03_references/06_高级所有权模式参考.md)
  - [07 零成本抽象参考](../tier_03_references/07_零成本抽象参考.md)
