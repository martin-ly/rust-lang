> **EN**: c01 所有权-借用-作用域：完整文档指南 (crate docs stub)
> **Summary**: Stub pointing to the canonical authority page(s) for `c01 所有权-借用-作用域：完整文档指南`. Practical examples remain in the crate.
