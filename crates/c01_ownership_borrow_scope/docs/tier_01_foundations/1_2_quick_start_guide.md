> **EN**: 1.2 快速开始指南 (crate docs stub)
> **Summary**: Stub pointing to the canonical authority page(s) for `1.2 快速开始指南`. Practical examples remain in the crate.
...
| 主题 | 权威来源 |
| :--- | :--- |
| Ownership Quick Start | [concept/01_foundation/01_ownership_borrow_lifetime/01_ownership.md](../../../../concept/01_foundation/01_ownership_borrow_lifetime/01_ownership.md) |
