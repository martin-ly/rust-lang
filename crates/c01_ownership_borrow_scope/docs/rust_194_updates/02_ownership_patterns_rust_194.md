> **EN**: Rust 1.94 所有权模式实战 (crate docs stub)
> **Summary**: Stub pointing to the canonical authority page(s) for `Rust 1.94 所有权模式实战`. Practical examples remain in the crate.
