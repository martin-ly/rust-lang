> **EN**: Rust 1.94 + Edition 2024: 所有权系统深度解析 (crate docs stub)
> **Summary**: Stub pointing to the canonical authority page(s) for `Rust 1.94 + Edition 2024: 所有权系统深度解析`. Practical examples remain in the crate.
