...
// ============================================================================
// Rust 1.96 回顾：`core::pin::pin!` 宏（1.68 stable） — 栈上固定 (1.68 stable, 1.96 回顾)
// ============================================================================

/// # `core::pin::pin!` 宏
///
/// Rust 1.68.0 稳定了 `core::pin::pin!`（项目 MSRV 1.96 可用） 宏，允许在栈上创建固定值，
/// 无需 `Box::pin` 的堆分配开销。
///
/// ## 所有权意义
...
// ============================================================================
// Rust 1.96 新特性：`NonNull::new` const 支持 (1.68 stable, 1.96 回顾)
// ============================================================================
