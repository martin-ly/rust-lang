...
- [📈 测试状态详情](#测试状态详情)
  - [测试统计](#测试统计)
  - [忽略的测试说明](#忽略的测试说明)
    - [1. test_bulkhead_permit_drop (Bulkhead) - `#[ignore]`](#1-test_bulkhead_permit_drop-bulkhead-ignore)
    - [2. test_redlock_basic (分布式锁) - `#[ignore]`](#2-test_redlock_basic-分布式锁-ignore)
