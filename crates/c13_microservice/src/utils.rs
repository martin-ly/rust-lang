...
impl HealthCheck {
    ...
    /// 添加依赖状态
    pub fn add_dependency(mut self, name: String, status: String, response_time: Option<u64>, error: Option<String>) -> Self {
...
mod tests {
    ...
    fn test_time_utils() {
        ...
        assert_eq!(time::parse_duration("100ms"), Some(Duration::from_millis(100)));
