...
1. 阅读 [项目概览](docs/tier_01_foundations/01_project_overview.md)
2. 运行示例 `examples/01_basic_add.rs`
3. 查看演示页面 `demo/index.html`

### Week 2: 实践（10-20 小时）

1. 学习 [Rust 编译 WASM](docs/tier_02_guides/02_compiling_rust_to_wasm.md)
2. 完成 `examples/02_string_operations.rs`
3. 实践 JavaScript 互操作

### Week 3-4: 进阶（20-30 小时）

1. 学习 [性能优化](docs/tier_02_guides/04_performance_optimization_guide.md)
...
1. **查看文档**: 先查看[常见问题](docs/tier_01_foundations/04_faq.md)
