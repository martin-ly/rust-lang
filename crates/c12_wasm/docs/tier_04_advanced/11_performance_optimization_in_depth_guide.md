> **EN**: WebAssembly Performance Optimization Deep Guide
> **Summary**: A stub page pointing to the canonical concept authority for WebAssembly advanced development and performance tuning.
...
- 运行时优化：AOT 编译与 JIT 选择
- 内存优化：预分配、内存池、零分配设计
- 零拷贝技术与 JS ↔ WASM 边界穿越
- SIMD 优化与 `std::arch::wasm32`
- 浏览器 / WasmEdge 性能分析工具
- Criterion 基准测试与性能回归检测
- 代码层面优化清单与算法选择
