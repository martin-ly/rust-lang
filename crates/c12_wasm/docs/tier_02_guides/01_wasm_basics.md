...
**WASM 基础指南 (WASM Fundamentals Guide)**:
...
- **定义**: 一种低级的二进制指令格式，用于在 Web 和服务器环境中运行代码
- **类型**: 虚拟机格式
- **属性**: 高性能、安全、可移植、紧凑
- **关系**: 与 JavaScript、WASI、Rust 相关
...
- WASM 基础指南 --[covers]--> 模块结构和指令集
- WASM 应用 --[uses]--> WASM 基础

**依赖关系**:

- WASM 基础指南 --[depends-on]--> WASM 规范
- WASM 开发 --[depends-on]--> WASM 基础
...
- [项目概览](../tier_01_foundations/01_project_overview.md) - 了解整体架构
- [Rust 编译 WASM](02_compiling_rust_to_wasm.md) - 学习编译流程
- [主索引导航](../tier_01_foundations/02_navigation.md) - 找到学习路径
