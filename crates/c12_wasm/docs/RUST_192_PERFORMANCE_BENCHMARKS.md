...
- [Rust 1.92.0 WASM 性能基准测试](#rust-1920-wasm-性能基准测试)
  ...
  - [📊 测试结果](#-测试结果)
    - [1. 内存管理性能测试](#1-内存管理性能测试)
      - [测试场景: WasmBuffer vs Vec](#测试场景-wasmbuffer-vs-vec)
    - [2. 计算性能测试](#2-计算性能测试)
      - [测试场景: NonZero::div\_ceil vs 手动计算](#测试场景-nonzerodiv_ceil-vs-手动计算)
    - [3. 迭代器性能测试](#3-迭代器性能测试)
      - [测试场景: 特化迭代器 vs 通用迭代器](#测试场景-特化迭代器-vs-通用迭代器)
    - [4. 数据操作性能测试](#4-数据操作性能测试)
      - [测试场景: rotate\_right vs 手动实现](#测试场景-rotate_right-vs-手动实现)
    - [5. 综合性能测试](#5-综合性能测试)
      - [测试场景: 完整 WASM 应用](#测试场景-完整-wasm-应用)
  - [📈 性能对比图表](#-性能对比图表)
    - [性能提升趋势图](#性能提升趋势图)
    - [性能提升汇总表](#性能提升汇总表)
  - [🔍 详细分析](#-详细分析)
