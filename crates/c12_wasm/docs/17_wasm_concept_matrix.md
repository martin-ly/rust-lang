> **EN**: WebAssembly Concept Comparison Matrix (c12_wasm example index)
> **Summary**: A stub page pointing to the canonical concept authority for WebAssembly technology choices in Rust.
...
- `crates/c12_wasm/examples/`：WASM 编译与互操作可运行示例。
- `crates/c12_wasm/src/bin/`：WASM 运行时演示程序。
