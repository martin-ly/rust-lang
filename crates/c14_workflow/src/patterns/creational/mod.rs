...
impl WorkflowPattern for WorkflowFactory {
    ...
    fn apply(&self, context: &WorkflowContext) -> Result<WorkflowResult, String> {
        ...
        let workflow_type = context.data.get("type")
            .and_then(|v| v.as_str())
            .unwrap_or("default");
...
impl WorkflowPattern for WorkflowPrototype {
    ...
    fn apply(&self, context: &WorkflowContext) -> Result<WorkflowResult, String> {
        ...
        let prototype_id = context.data.get("prototype_id")
            .and_then(|v| v.as_str())
        ...
        let result = WorkflowResult {
            ...
            message: "工作流原型模式应用成功 / Workflow prototype pattern applied successfully".to_string(),
        };
...
impl WorkflowPattern for WorkflowSingleton {
    ...
    fn apply(&self, context: &WorkflowContext) -> Result<WorkflowResult, String> {
        ...
        let result = WorkflowResult {
            ...
            message: "工作流单例模式应用成功 / Workflow singleton pattern applied successfully".to_string(),
        };
