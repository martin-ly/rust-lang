...
pub mod config {
    ...
    impl StableConfig {
        ...
        pub fn set<T: Serialize>(&mut self, key: String, value: T) -> Result<(), StableConfigError> {
        ...
        pub fn get<T: for<'de> Deserialize<'de>>(&self, key: &str) -> Result<Option<T>, StableConfigError> {
...
mod tests {
    ...
    fn test_stable_config() {
        ...
        assert_eq!(config.get_metadata("author"), Some(&"Rust Team".to_string()));
    }
