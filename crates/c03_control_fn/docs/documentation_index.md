> **EN**: 📚 C03 控制流与函数 - 完整文档索引 (crate docs stub)
> **Summary**: Stub pointing to the canonical authority page(s) for `📚 C03 控制流与函数 - 完整文档索引`. Practical examples remain in the crate.
