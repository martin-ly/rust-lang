...
- [Rust 控制流与函数概念关系网络](#rust-控制流与函数概念关系网络)
  ...
  - [🎯 跨层次关系网络](#-跨层次关系网络)
    ...
    - [3. 性能优化关系链](#3-性能优化关系链)
  - [🆕 Rust 1.92.0 特性关系网（自 Rust 1.90 引入）](#-rust-1920-特性关系网自-rust-190-引入)
    - [Rust 1.92.0 新特性集成关系（自 Rust 1.90 引入）](#rust-1920-新特性集成关系自-rust-190-引入)
  - [📊 综合关系强度矩阵](#-综合关系强度矩阵)
    - [核心概念间关系强度](#核心概念间关系强度)
    - [关系类型说明](#关系类型说明)
  - [🎓 学习路径关系网](#-学习路径关系网)
...
graph TB
    ...
    ZeroCost --> Rust192[Rust 1.92.0改进]
...
graph LR
    ...
    ZeroCost --> Rust192[Rust 1.92.0优化（自 Rust 1.90 引入）]
...
```mermaid
graph TB
    R192[Rust 1.92.0] --> Pattern[模式匹配增强]
    R190 --> Control[控制流改进]
    R190 --> Closure[闭包优化]
    R190 --> Compiler[编译器]
...
- [高级模式匹配](tier_04_advanced/01_advanced_pattern_matching.md) - 高级模式
- [闭包深入](tier_04_advanced/02_closures_in_depth.md) - 闭包深入
- [迭代器参考](tier_03_references/02_iterators_reference.md) - 迭代器高级
