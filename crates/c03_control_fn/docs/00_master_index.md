...
| 文档                                                 | 说明           |
| :--- | :--- |
| [项目概览](tier_01_foundations/01_project_overview.md)     | 项目概述和结构 |
| [主索引导航](tier_01_foundations/02_navigation.md) | 完整导航索引   |
| [术语表](tier_01_foundations/03_glossary.md)         | 术语定义       |
| [常见问题](tier_01_foundations/04_faq.md)     | 常见问题解答   |
...
| 文档                                                | 说明                  |
| :--- | :--- |
| [条件语句指南](tier_02_guides/01_conditionals_guide.md) | if/else 详解          |
| [循环结构指南](tier_02_guides/02_loops_guide.md) | loop/while/for        |
| [函数系统指南](tier_02_guides/03_functions_guide.md) | 函数定义与闭包基础    |
| [模式匹配指南](tier_02_guides/04_pattern_matching_guide.md) | match 详解            |
| [错误处理指南](tier_02_guides/05_error_handling_guide.md) | Result/Option/?运算符 |
| [代码示例集合](tier_02_guides/06_code_examples.md) | 完整代码示例          |
| [实战项目集](tier_02_guides/07_hands_on_projects.md)     | 实战项目              |
...
1. [条件语句指南](tier_02_guides/01_conditionals_guide.md)
2. [循环结构指南](tier_02_guides/02_loops_guide.md)
3. [函数系统指南](tier_02_guides/03_functions_guide.md)

**Week 2: 函数与错误**:

1. [函数系统指南](tier_02_guides/03_functions_guide.md)
2. [错误处理指南](tier_02_guides/05_error_handling_guide.md)

**Week 3: 新特性与实践**:

1. [Rust 1.92.0 控制流改进](../rust_192_control_flow_improvements.md) 🆕
2. [代码示例集合](tier_02_guides/06_code_examples.md)

### 🎓 中级路径 (3-4周)

**Week 1-2: 高级控制流**:

1. [高级模式匹配](tier_04_advanced/01_advanced_pattern_matching.md)
2. [模式匹配指南](tier_02_guides/04_pattern_matching_guide.md)
3. [闭包深入](tier_04_advanced/02_closures_in_depth.md)
4. [函数式编程](tier_04_advanced/03_functional_programming.md)

**Week 3: 函数特性**:

1. [闭包深入](tier_04_advanced/02_closures_in_depth.md)
2. [迭代器参考](tier_03_references/02_iterators_reference.md)

**Week 4: 特殊类型**:

1. [错误处理进阶](tier_04_advanced/04_advanced_error_handling.md)
...
| 需求     | 推荐方案         | 文档                                                |
| :--- | :--- | :--- || 条件分支 | if/else、match   | [条件语句指南](tier_02_guides/01_conditionals_guide.md) |
| 循环迭代 | for、while、loop | [循环结构指南](tier_02_guides/02_loops_guide.md) |
| 模式匹配 | match、if let    | [模式匹配指南](tier_02_guides/04_pattern_matching_guide.md) |
| 错误处理 | Result、?运算符  | [错误处理指南](tier_02_guides/05_error_handling_guide.md) |

### 函数编程

| 需求     | 推荐方案         | 文档                                                |
| :--- | :--- | :--- || 高阶函数 | 闭包、Fn traits  | [闭包深入](tier_04_advanced/02_closures_in_depth.md)       |
| 函数组合 | 组合子、链式调用 | [代码示例集合](tier_02_guides/06_code_examples.md) |
| 惰性求值 | 迭代器           | [迭代器参考](tier_03_references/02_iterators_reference.md) |
