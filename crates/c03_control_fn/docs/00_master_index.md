> **EN**: C03 控制流与函数: 主索引 (Master Index) (crate docs stub)
> **Summary**: Stub pointing to the canonical authority page(s) for `C03 控制流与函数: 主索引 (Master Index)`. Practical examples remain in the crate.
