> **EN**: Function System Guide (c03 guide index)
> **Summary**: Stub pointing to the canonical functions, closures, and async authorities. Practical examples remain in the c03 crate.
