...
**模式匹配指南 (Pattern Matching Guide)**:

- **定义**: 系统化学习 Rust 模式匹配的实践指南，包括各种模式和解构技巧
- **类型**: 实践指南文档
- **范畴**: 模式匹配、控制流
- **版本**: Rust 1.0+
- **相关概念**: 模式匹配、解构、绑定、守卫模式
...
- **类型**: 语言特性
- **属性**: 模式匹配、解构、绑定、守卫
- **关系**: 与 match、if let、while let 相关
...
- **字面量模式**: 匹配字面量值
- **结构化模式**: 元组、数组、结构体、枚举模式
- **高级模式**: 范围模式、绑定模式、守卫模式、或模式
- **引用模式**: 引用和解引用模式、可变性模式
...
- 模式匹配指南 --[covers]--> 多种模式类型
- match 表达式 --[uses]--> 模式匹配

**依赖关系**:

- 模式匹配 --[depends-on]--> 类型系统
- 值解构 --[depends-on]--> 模式匹配
