> **EN**: 1.0 Rust 控制流与函数 - 项目概览 (crate docs stub)
> **Summary**: Stub pointing to the canonical authority page(s) for `1.0 Rust 控制流与函数 - 项目概览`. Practical examples remain in the crate.
