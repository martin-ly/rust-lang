...
///
/// ```rust
/// use c14_macro_system_proc::Builder;
///
/// #[derive(Builder)]
/// struct Config {
///     host: String,
...
///
/// ```rust
/// use c14_macro_system_proc::debug_print;
///
/// #[debug_print]
/// fn my_function() {
///     println!("Hello!");
...
///
/// ```rust
/// use c14_macro_system_proc::timed;
///
/// #[timed]
/// fn slow_function() {
...
///
/// ```rust
/// use c14_macro_system_proc::conditional;
///
/// conditional! {
...
///
/// ```rust
/// use c14_macro_system_proc::AutoClone;
///
/// #[derive(AutoClone)]
/// struct MyStruct {
///     name: String,
...
///
/// ```rust
/// use c14_macro_system_proc::serializable;
///
/// serializable! {
///     struct User {
///         id: u32,
