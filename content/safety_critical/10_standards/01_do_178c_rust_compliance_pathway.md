...
> **权威来源**: 通用 Rust 概念解释请见 [concept/06_ecosystem/11_domain_applications/20_licensing_and_compliance.md](../../../concept/06_ecosystem/11_domain_applications/20_licensing_and_compliance.md)；本文聚焦安全关键系统工程实践。
