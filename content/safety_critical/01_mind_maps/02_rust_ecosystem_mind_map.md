...
> 通用 Rust 概念解释请见 [`concept/06_ecosystem/11_domain_applications/21_safety_critical_topic_index.md`](../../../concept/06_ecosystem/11_domain_applications/21_safety_critical_topic_index.md)。
