...
**Summary**: 教育与培训路线图 Education And Training Roadmap.

> **权威来源**: 通用 Rust 概念解释请见 [concept/07_future/01_edition_roadmap/04_roadmap.md](../../../concept/07_future/01_edition_roadmap/04_roadmap.md)；本文聚焦安全关键系统工程实践。
