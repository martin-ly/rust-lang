...
> 📌 **前置知识要求**: 本生态系统的文档假设读者已掌握 Rust 核心知识体系。如果你是 Rust 新手，请先学习 [knowledge/](../../concept/README.md) 目录下的分层文档（从 `01_fundamentals` 到 `03_advanced`）。安全关键系统开发要求对所有权、借用、并发、`unsafe` 代码和 FFI 有深入理解。
