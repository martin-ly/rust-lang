...
> **权威来源**: 通用 Rust 概念解释请见 [concept/00_meta/01_terminology/bilingual_template.md](../../../concept/00_meta/01_terminology/bilingual_template.md)；本文聚焦安全关键系统工程实践。
...
- [检查清单与模板](02_checklists_and_templates.md)
