...
>
- [CLI 应用开发指南 {#cli-应用开发指南}](#cli-应用开发指南-cli-应用开发指南)
  - [📑 目录 {#目录}](#-目录-目录)
  - [文档定位 {#文档定位}](#文档定位-文档定位)
  - [官方 CLI Book 入口 {#官方-cli-book-入口}](#官方-cli-book-入口-官方-cli-book-入口)
  - [本项目对应模块 {#本项目对应模块}](#本项目对应模块-本项目对应模块)
  - [快速开始示例 {#快速开始示例}](#快速开始示例-快速开始示例)
    - [1. 最小 CLI 应用 {#1-最小-cli-应用}](#1-最小-cli-应用-1-最小-cli-应用)
    - [2. 使用 clap 构建专业 CLI {#2-使用-clap-构建专业-cli}](#2-使用-clap-构建专业-cli-2-使用-clap-构建专业-cli)
    - [3. 异步 CLI 示例 {#3-异步-cli-示例}](#3-异步-cli-示例-3-异步-cli-示例)
    - [4. 带进度条的 CLI {#4-带进度条的-cli}](#4-带进度条的-cli-4-带进度条的-cli)
    - [5. 错误处理最佳实践 {#5-错误处理最佳实践}](#5-错误处理最佳实践-5-错误处理最佳实践)
  - [推荐学习路径 {#推荐学习路径}](#推荐学习路径-推荐学习路径)
  - [常用 crate 推荐 {#常用-crate-推荐}](#常用-crate-推荐-常用-crate-推荐)
  - [最佳实践 {#最佳实践}](#最佳实践-最佳实践)
    - [1. 使用 `?` 操作符传播错误 {#1-使用-操作符传播错误}](#1-使用--操作符传播错误-1-使用-操作符传播错误)
    - [2. 提供有意义的错误信息 {#2-提供有意义的错误信息}](#2-提供有意义的错误信息-2-提供有意义的错误信息)
    - [3. 使用 exit codes {#3-使用-exit-codes}](#3-使用-exit-codes-3-使用-exit-codes)
  - [使用场景 {#使用场景}](#使用场景-使用场景)
    - [场景1: 简单命令行工具 {#场景1-简单命令行工具}](#场景1-简单命令行工具-场景1-简单命令行工具)
    - [场景2: 专业级 CLI 应用 {#场景2-专业级-cli-应用}](#场景2-专业级-cli-应用-场景2-专业级-cli-应用)
    - [场景3: 异步 CLI 工具 {#场景3-异步-cli-工具}](#场景3-异步-cli-工具-场景3-异步-cli-工具)
    - [场景4: TUI 应用 {#场景4-tui-应用}](#场景4-tui-应用-场景4-tui-应用)
  - [形式化链接 {#形式化链接}](#形式化链接-形式化链接)
  - [相关文档 {#相关文档}](#相关文档-相关文档)
  - [Rust 1.95+ 在 CLI 开发中的应用 {#rust-195-在-cli-开发中的应用}](#rust-195-在-cli-开发中的应用-rust-195-在-cli-开发中的应用)
...
**形式化引用（Reference）**：T-OW2、T-BR1（进程间资源）、
[SAFE_UNSAFE_COMPREHENSIVE_ANALYSIS](../12_research_notes/03_formal_proofs/28_safe_unsafe_comprehensive_analysis.md)（子进程安全边界）。
...
| :--- | :--- | :--- |
| 参数解析 | clap、structopt | C03 控制流、[cargo_cheatsheet](../03_reference/quick_reference/06_cargo_cheatsheet.md) |
...
| 错误处理（Error Handling） | anyhow、thiserror | [error_handling_cheatsheet](../03_reference/quick_reference/10_error_handling_cheatsheet.md) |
| 异步（Async） CLI | tokio | [C06 异步](../../crates/c06_async/README.md)、[async_patterns](../03_reference/quick_reference/05_async_patterns.md) |
...
3. **进阶**: C03 错误处理 + [error_handling_cheatsheet](../03_reference/quick_reference/10_error_handling_cheatsheet.md)
...
| **前置知识** | C03 控制流 |
| :--- | :--- |
| **错误处理** | [error_handling_cheatsheet](../03_reference/quick_reference/10_error_handling_cheatsheet.md) |
| **异步编程** | C06 异步 |
| :--- | :--- |
| **Cargo 工具** | [cargo_cheatsheet](../03_reference/quick_reference/06_cargo_cheatsheet.md) |
| **相关指南** | [23_troubleshooting_guide.md](23_troubleshooting_guide.md) |
| :--- | :--- |
...
- C07 进程管理
- [故障排查指南](23_troubleshooting_guide.md)
- [cargo_cheatsheet](../03_reference/quick_reference/06_cargo_cheatsheet.md)
