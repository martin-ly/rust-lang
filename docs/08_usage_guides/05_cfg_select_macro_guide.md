...
>
> 说明：本文仅保留本文独特内容（基本语法速查、4 类使用场景、与 `#[cfg]`/`cfg!` 对比、嵌套与常量上下文等高级模式、4 类常见陷阱与反例），不重复 concept/ 中的条件编译概念定义、规则与定理推导。
...
- [Rust 1.95 特性速查表](../03_reference/quick_reference/19_rust_195_features_cheatsheet.md)
