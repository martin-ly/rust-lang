...
> **Summary**: AI + Rust 生态指南 Ai Rust Ecosystem Guide. 
> **分级**: [A]
> **Bloom 层级**: L3-L4
>
> **受众**: [进阶]
...
| 主题 | 入口 | 说明 |
| :--- | :--- | :--- |
| **提示词模板** | [AI_ASSISTED_RUST_PROGRAMMING_GUIDE](../../archive/03_concept_history/03_guides/AI_ASSISTED_RUST_PROGRAMMING_GUIDE_2026.md) | 概念解释、代码审查、错误修复 |
...
1. 使用 [AI_ASSISTED_RUST_PROGRAMMING_GUIDE](../../archive/03_concept_history/03_guides/AI_ASSISTED_RUST_PROGRAMMING_GUIDE_2026.md) 的提示词模板
...
| :--- | :--- |
| **相关指南** | [AI_ASSISTED_RUST_PROGRAMMING_GUIDE](../../archive/03_concept_history/03_guides/AI_ASSISTED_RUST_PROGRAMMING_GUIDE_2026.md) |
| :--- | :--- |
...
- [AI 辅助编程指南](../../archive/03_concept_history/03_guides/AI_ASSISTED_RUST_PROGRAMMING_GUIDE_2026.md)
