...
>
- [Microsoft Pragmatic Rust Guidelines 代码审查清单 {#microsoft-pragmatic-rust-guidelines-代码审查清单}](#microsoft-pragmatic-rust-guidelines-代码审查清单-microsoft-pragmatic-rust-guidelines-代码审查清单)
  - [📑 目录 {#目录}](#-目录-目录)
  - [清单使用说明 {#清单使用说明}](#清单使用说明-清单使用说明)
  ...
  - [2. 性能 (Performance) {#2-性能-performance}](#2-性能-performance-2-性能-performance)
    ...
    - [2.3 并发性能 {#23-并发性能}](#23-并发性能-23-并发性能)
  - [3. 可读性 (Readability) {#3-可读性-readability}](#3-可读性-readability-3-可读性-readability)
    - [3.1 命名规范 {#31-命名规范}](#31-命名规范-31-命名规范)
    - [3.2 代码组织 {#32-代码组织}](#32-代码组织-32-代码组织)
    - [3.3 注释与文档 {#33-注释与文档}](#33-注释与文档-33-注释与文档)
  - [4. API 设计 {#4-api-设计}](#4-api-设计-4-api-设计)
    - [4.1 类型设计 {#41-类型设计}](#41-类型设计-41-类型设计)
    - [4.2 错误设计 {#42-错误设计}](#42-错误设计-42-错误设计)
    - [4.3 Trait 设计 {#43-trait-设计}](#43-trait-设计-43-trait-设计)
  - [5. 命名规范补充 {#5-命名规范补充}](#5-命名规范补充-5-命名规范补充)
    - [5.1 项目特定约定 {#51-项目特定约定}](#51-项目特定约定-51-项目特定约定)
  - [审查清单速查表 {#审查清单速查表}](#审查清单速查表-审查清单速查表)
    - [提交前自检（开发者） {#提交前自检开发者}](#提交前自检开发者-提交前自检开发者)
    - [代码审查（审查者） {#代码审查审查者}](#代码审查审查者-代码审查审查者)
  - [自动化检查 {#自动化检查}](#自动化检查-自动化检查)
  - [相关文档 {#相关文档}](#相关文档-相关文档)
  - [相关概念 {#相关概念}](#相关概念-相关概念)
...
| S05 | 使用 Miri 验证 unsafe 代码 | SHOULD | `docs/04_guides/09_miri_guide.md` | 关键 unsafe 代码是否通过 Miri？ |
...
| P05 | 使用 Cow<'_, str> 处理可选克隆 | MAY | `docs/03_reference/quick_reference/14_ownership_cheatsheet.md` | 读多写少场景是否使用了 Cow？ |
...
| cargo-tarpaulin | `docs/04_guides/14_test_coverage.md` | 测试覆盖率 |
...
- [01_lfrs_certification_mapping.md](../02_learning/06_lfrs_certification_mapping.md) - 认证考点映射
- [01_google_rust_mapping.md](../02_learning/03_google_rust_mapping.md) - Google 课程映射
