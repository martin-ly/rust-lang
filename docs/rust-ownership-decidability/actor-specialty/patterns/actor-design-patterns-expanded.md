...
- [Actor设计模式 - 扩展版](#actor设计模式---扩展版)
  ...
  - [设计模式形式化框架](#设计模式形式化框架)
    - [模式定义模板](#模式定义模板)
  - [1. Ask vs Tell 模式](#1-ask-vs-tell-模式)
    - [1.1 形式化定义](#11-形式化定义)
    - [1.2 定理 ASK-TELL-SAFETY](#12-定理-ask-tell-safety)
    - [1.3 决策矩阵](#13-决策矩阵)
  - [2. 监督树模式](#2-监督树模式)
    - [2.1 形式化定义](#21-形式化定义)
    - [2.2 定理 SUPERVISION-SAFETY](#22-定理-supervision-safety)
    - [2.3 监督策略矩阵](#23-监督策略矩阵)
  - [3. Circuit Breaker 模式](#3-circuit-breaker-模式)
    - [3.1 形式化定义](#31-形式化定义)
    - [3.2 定理 CIRCUIT-BREAKER-SAFETY](#32-定理-circuit-breaker-safety)
    - [3.3 参数选择矩阵](#33-参数选择矩阵)
  - [4. 路由模式](#4-路由模式)
    - [4.1 一致性哈希路由](#41-一致性哈希路由)
    - [4.2 定理 ROUTING-CONSISTENCY](#42-定理-routing-consistency)
    - [4.3 路由策略对比矩阵](#43-路由策略对比矩阵)
  - [5. 状态机模式](#5-状态机模式)
    - [5.1 形式化定义](#51-形式化定义)
    - [5.2 定理 FSM-SAFETY](#52-定理-fsm-safety)
    - [5.3 状态机复杂度矩阵](#53-状态机复杂度矩阵)
  - [6. Event Sourcing 模式](#6-event-sourcing-模式)
    - [6.1 形式化定义](#61-形式化定义)
    - [6.2 定理 EVENT-SOURCING-PROPERTIES](#62-定理-event-sourcing-properties)
    - [6.3 事件溯源 vs CRUD 矩阵](#63-事件溯源-vs-crud-矩阵)
  - [7. Pub-Sub 模式](#7-pub-sub-模式)
    - [7.1 形式化定义](#71-形式化定义)
    - [7.2 定理 PUB-SUB-SCALABILITY](#72-定理-pub-sub-scalability)
  - [8. Saga 模式](#8-saga-模式)
    - [8.1 形式化定义](#81-形式化定义)
