...
- [Rust所有权与可判定性 - 形式化框架规范](#rust所有权与可判定性---形式化框架规范)
  ...
  - [1. 形式化语言层次](#1-形式化语言层次)
  - [2. 数学符号规范](#2-数学符号规范)
    - [2.1 元变量命名约定](#21-元变量命名约定)
    - [2.2 逻辑符号](#22-逻辑符号)
    - [2.3 分离逻辑符号](#23-分离逻辑符号)
    - [2.4 类型理论符号](#24-类型理论符号)
  - [3. 形式化定义模板](#3-形式化定义模板)
    - [3.1 语法定义模板](#31-语法定义模板)
    - [3.2 操作语义模板](#32-操作语义模板)
    - [3.3 类型规则模板](#33-类型规则模板)
  - [4. 可判定性分析模板](#4-可判定性分析模板)
    - [4.1 复杂度类定义](#41-复杂度类定义)
    - [4.2 可判定性证明模板](#42-可判定性证明模板)
  - [5. 引用格式规范](#5-引用格式规范)
    - [5.1 学术论文引用](#51-学术论文引用)
    - [5.2 书籍引用](#52-书籍引用)
  - [6. 图示规范](#6-图示规范)
    - [6.1 推导树](#61-推导树)
    - [6.2 状态转换图](#62-状态转换图)
    - [6.3 层次架构图](#63-层次架构图)
  - [7. 代码块规范](#7-代码块规范)
    - [7.1 数学代码 (伪代码)](#71-数学代码-伪代码)
    - [7.2 Rust代码](#72-rust代码)
    - [7.3 Coq/Lean证明代码](#73-coqlean证明代码)
  - [8. 质量检查清单](#8-质量检查清单)
