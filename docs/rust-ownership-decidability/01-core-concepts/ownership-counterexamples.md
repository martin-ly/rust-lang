...
- [所有权系统 - 反例与逻辑论证](#所有权系统---反例与逻辑论证)
  - [目录](#目录)
  - [1. 所有权规则反例](#1-所有权规则反例)
    - [1.1 规则2反例: Move后使用](#11-规则2反例-move后使用)
      - [形式化证明错误](#形式化证明错误)
      - [修复方案](#修复方案)
    - [1.2 规则3反例: 作用域与Drop](#12-规则3反例-作用域与drop)
      - [逻辑论证: RAII的强制性](#逻辑论证-raii的强制性)
  - [2. 借用规则反例](#2-借用规则反例)
    - [2.1 XOR原则反例: 可变+共享借用共存](#21-xor原则反例-可变共享借用共存)
      - [形式化证明错误](#形式化证明错误-1)
      - [修复方案](#修复方案-1)
    - [2.2 多个可变借用反例](#22-多个可变借用反例)
      - [逻辑论证: 别名与数据竞争](#逻辑论证-别名与数据竞争)
  - [3. 生命周期反例](#3-生命周期反例)
    - [3.1 生命周期不足反例](#31-生命周期不足反例)
      - [形式化证明错误](#形式化证明错误-2)
      - [修复方案](#修复方案-2)
    - [3.2 生命周期不匹配反例](#32-生命周期不匹配反例)
      - [修复: 自引用结构](#修复-自引用结构)
  - [4. Send/Sync反例](#4-sendsync反例)
    - [4.1 Rc跨线程反例](#41-rc跨线程反例)
      - [逻辑论证](#逻辑论证)
      - [修复方案](#修复方案-3)
  - [5. 常见逻辑谬误](#5-常见逻辑谬误)
  ...
  - [6. 反例总结表](#6-反例总结表)
  - [**对齐版本**: Rust 1.96.0+ (Edition 2024) | 对齐日期: 2026-05-12](#对齐版本-rust-1960-edition-2024--对齐日期-2026-05-12)
  - [权威来源索引](#权威来源索引)
  - [权威来源索引](#权威来源索引-1)
