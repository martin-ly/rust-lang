...
- [Rust 所有权系统 - 交互式学习指南](#rust-所有权系统---交互式学习指南)
  - [📑 目录](#-目录)
  - [🎯 如何使用本指南](#-如何使用本指南)
  - [模块 1: 所有权基础](#模块-1-所有权基础)
    - [问题 1: 为什么这段代码不能编译？](#问题-1-为什么这段代码不能编译)
    - [问题 2: 修复所有权错误](#问题-2-修复所有权错误)
  - [模块 2: 借用规则](#模块-2-借用规则)
    - [问题 3: 为什么不能同时可变和不可变借用？](#问题-3-为什么不能同时可变和不可变借用)
    - [问题 4: 多重可变借用](#问题-4-多重可变借用)
  - [模块 3: 生命周期](#模块-3-生命周期)
    - [问题 5: 生命周期省略规则](#问题-5-生命周期省略规则)
    - [问题 6: 结构体生命周期](#问题-6-结构体生命周期)
  - [模块 4: 智能指针](#模块-4-智能指针)
    - [问题 7: 选择合适的智能指针](#问题-7-选择合适的智能指针)
    - [问题 8: 循环引用检测](#问题-8-循环引用检测)
  - [模块 5: 综合挑战](#模块-5-综合挑战)
    - [挑战: 实现一个简单的数据库连接池](#挑战-实现一个简单的数据库连接池)
  - [🎓 学习检查](#-学习检查)
  - [📚 下一步](#-下一步)
