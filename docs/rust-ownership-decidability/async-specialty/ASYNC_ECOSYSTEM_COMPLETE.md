...
- [Rust Async 生态系统专题 - 完整完成报告](#rust-async-生态系统专题---完整完成报告)
  ...
  - [生态覆盖矩阵](#生态覆盖矩阵)
    - [嵌入式生态 (100%)](#嵌入式生态-100)
    - [标准运行时 (100%)](#标准运行时-100)
    - [io\_uring生态 (100%)](#io_uring生态-100)
    - [开源协议 (100%)](#开源协议-100)
  - [核心性能数据](#核心性能数据)
    - [io\_uring性能提升](#io_uring性能提升)
    - [运行时对比](#运行时对比)
  - [选择决策指南](#选择决策指南)
    - [决策树](#决策树)
    - [场景推荐表](#场景推荐表)
...
| 文档 | 页数 | 内容 |
|:-----|:----:|:-----|
| practices/best-practices.md | 15 | 最佳实践 |
