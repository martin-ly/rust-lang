...
- [实时系统应用场景树](#实时系统应用场景树)
  ...
  - [1. 实时系统分类](#1-实时系统分类)
  - [2. 硬实时系统](#2-硬实时系统)
    - [2.1 汽车电子控制单元 (ECU)](#21-汽车电子控制单元-ecu)
    - [2.2 航空航天系统](#22-航空航天系统)
    - [2.3 医疗设备](#23-医疗设备)
  - [3. 软实时系统](#3-软实时系统)
    - [3.1 音视频处理](#31-音视频处理)
    - [3.2 游戏开发](#32-游戏开发)
  - [4. Rust实时解决方案](#4-rust实时解决方案)
    - [4.1 硬实时框架对比](#41-硬实时框架对比)
    - [4.2 确定性编程模式](#42-确定性编程模式)
    - [4.3 无锁数据结构](#43-无锁数据结构)
  - [5. 性能保证技术](#5-性能保证技术)
    - [5.1 WCET分析](#51-wcet分析)
    - [5.2 内存分配策略](#52-内存分配策略)
  - [6. 认证与合规](#6-认证与合规)
    - [6.1 功能安全标准](#61-功能安全标准)
    - [6.2 工具链认证](#62-工具链认证)
  - [7. 实际案例](#7-实际案例)
    - [7.1 汽车制动系统](#71-汽车制动系统)
    - [7.2 无人机飞控](#72-无人机飞控)
  - [8. 结论](#8-结论)
  - **更新日期**: 2026-03-05
  - [相关概念](#相关概念)
