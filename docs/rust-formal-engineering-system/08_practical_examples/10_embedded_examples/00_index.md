...
- [嵌入式示例（Embedded Examples）索引](#嵌入式示例embedded-examples索引)
  ...
  - [🎯 目的](#-目的)
    - [核心价值](#核心价值)
  - [🆕 Rust 1.91.0 与最新研究成果](#-rust-1910-与最新研究成果)
    - [TECS/Rust框架应用示例](#tecsrust框架应用示例)
  - [📚 核心示例](#-核心示例)
...
本模块提供 Rust 嵌入式开发的实用示例，涵盖微控制器编程、硬件抽象层、传感器集成和通信协议等核心主题。
...
**研究背景**：TECS/Rust框架利用Rust的内存安全特性，为嵌入式系统提供内存安全的组件框架。

**示例场景**：使用TECS/Rust框架构建内存安全的嵌入式组件

```rust
// TECS/Rust 组件框架示例
use tecs_rust::Component;
...
fn main() {
    ...
    system.register(SensorComponent::new());
    system.run();
}
```
...
- [TECS/Rust论文](https://arxiv.org/abs/2510.25270)
- [IoT应用领域](../../04_application_domains/03_iot/00_index.md#tecsrust内存安全组件框架)
- [当前研究](../../09_research_agenda/01_current_research/00_index.md#tecsrust内存安全组件框架)
...
- **[嵌入式编程基础](./01_embedded_basics.md)** - 嵌入式编程实践示例 ✅
