...
- [物联网（IoT）索引](#物联网iot索引)
  ...
  - [🆕 Rust 1.91.0 与最新研究成果](#-rust-1910-与最新研究成果)
    - [TECS/Rust：内存安全组件框架](#tecsrust内存安全组件框架)
  - [📚 核心场景](#-核心场景)
    - [1. 设备端开发（Device Development）](#1-设备端开发device-development)
    - [2. 通信协议（Communication Protocols）](#2-通信协议communication-protocols)
    - [3. 数据管理（Data Management）](#3-数据管理data-management)
  - [🏗️ 技术架构](#️-技术架构)
    - [设备架构](#设备架构)
    - [云端架构](#云端架构)
    - [边缘计算](#边缘计算)
...
本模块梳理 Rust 在物联网领域的应用场景与最佳实践，建立嵌入式系统与物联网设备开发的标准与架构，提供从硬件到云端的完整物联网解决方案。所有内容均基于 Rust 1.91.0 和当前最佳实践。

### 核心价值

- **物联网**: 专注于 Rust 在物联网领域的应用
- **最佳实践**: 基于 Rust 社区最新物联网实践
- **完整覆盖**: 涵盖设备端开发、通信协议、数据管理等核心场景
- **易于理解**: 提供详细的物联网应用说明和代码示例
...
- [嵌入式示例](../../08_practical_examples/10_embedded_examples/00_index.md)

## 📚 核心场景

### 1. 设备端开发（Device Development）

**推荐库**: `embedded-hal`, `cortex-m`, `esp32-hal`, `rtic`, `nb`
...
**推荐库**: `tokio`, `rumqtt`, `coap`, `serde`, `paho-mqtt`
...
- [rumqtt 文档](https://docs.rs/rumqtt/)
- [coap 文档](https://docs.rs/coap/)
- [Paho MQTT Rust](https://github.com/eclipse/paho.mqtt.rust)

### 3. 数据管理（Data Management）

**推荐库**: `tokio`, `influxdb`, `timescale`, `parquet`, `arrow`
...
- [Tokio 文档](https://tokio.rs/)
- [InfluxDB Rust](https://docs.rs/influxdb/)
- [Timescale Rust](https://docs.rs/timescale/)
