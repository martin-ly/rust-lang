...
| 模块（Module） | 入口路径 | 说明 |
| :--- | :--- | :--- |
| **形式化方法** | [research_notes/formal_methods/](../research_notes/formal_methods/README.md) | 所有权（Ownership）模型、借用（Borrowing）检查器、生命周期（Lifetimes）、Pin、异步（Async）状态机 |
...
| **类型系统（Type System）** | [../research_notes/type_theory/10_type_system_foundations.md](../research_notes/type_theory/10_type_system_foundations.md) | 类型理论基础 |
