...
- [Future 机制详解](../../../crates/c06_async/docs/tier_02_guides/01_future_and_executor_mechanisms.md)
...
- [异步状态机形式化](../../12_research_notes/02_formal_methods/02_async_state_machine.md) — Def 4.1–5.2、定理 T6.1–T6.3
- [Pin 和自引用类型形式化](../../12_research_notes/02_formal_methods/10_pin_self_referential.md) — Def 1.1–2.2、定理 T1–T3
...
- [异步编程完整文档](../../../crates/c06_async/docs/README.md)
- [异步状态机研究](../../12_research_notes/02_formal_methods/02_async_state_machine.md)

### 相关速查卡 {#相关速查卡}
>
> **[来源: [The Rust Programming Language](https://doc.rust-lang.org/book/)]**

- [线程与并发速查卡](26_threads_concurrency_cheatsheet.md) - 并发编程对比
- [错误处理速查卡](10_error_handling_cheatsheet.md) - 异步错误处理
- [所有权（Ownership）系统速查卡](14_ownership_cheatsheet.md) - 异步中的所有权
- [智能指针（Smart Pointer）速查卡](23_smart_pointers_cheatsheet.md) - Arc 在异步中的应用
...
> **[async-std [已停止维护].rs Documentation](https://docs.rs/async-std/latest/async_std/)**
