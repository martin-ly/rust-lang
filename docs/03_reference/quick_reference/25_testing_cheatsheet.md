...
> **分级**: [A]
> **快速参考** | [完整文档](../../15_rust_formal_engineering_system/06_software_engineering/07_testing/README.md) | [代码示例](../../../crates/README.md)
> **创建日期**: 2026-01-27
> **最后更新**: 2026-05-08
...
- [完整测试文档（项目内）](../../15_rust_formal_engineering_system/06_software_engineering/07_testing/README.md)
...
| 概念 | 形式化文档 | 描述 |
| :--- | :--- | :--- |
| **类型系统（Type System）** | [type_system_foundations](../../12_research_notes/05_type_theory/05_type_system_foundations.md) | 测试的类型正确性 |
| **所有权（Ownership）与借用（Borrowing）** | [borrow_checker_proof](../../12_research_notes/02_formal_methods/03_borrow_checker_proof.md) | 测试中的内存安全（Memory Safety） |
| **Send/Sync** | [send_sync_formalization](../../12_research_notes/02_formal_methods/12_send_sync_formalization.md) | 并发测试安全性 |
| **反模式** | [anti_patterns](../../12_research_notes/08_software_design_theory/02_anti_patterns.md) | 测试中的常见错误模式 |
...
*证明*: 由 [FORMAL_PROOF_SYSTEM_GUIDE](../../12_research_notes/03_formal_proofs/16_formal_proof_system_guide.md)，测试用例对应形式化规范的实例化，全覆盖保证所有执行路径验证。∎
...
- [完整测试文档](../../15_rust_formal_engineering_system/06_software_engineering/07_testing/README.md)
- [WASM 测试策略](../../../crates/c12_wasm/docs/tier_05_wasm_engineering/06_testing_strategies.md)
- [测试研究笔记](../../12_research_notes/README.md)
...
- [错误处理速查卡](10_error_handling_cheatsheet.md) - 测试中的错误处理
- [模块系统速查卡](12_modules_cheatsheet.md) - 模块测试
- 宏系统速查卡 - 测试宏
- [Cargo 速查卡](06_cargo_cheatsheet.md) - Cargo 测试命令
