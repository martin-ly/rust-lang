...
> **权威来源（Canonical）**: 本文件为闭包速查卡（速查，独特内容）；通用 Rust 概念解释请以 concept 权威页为准：[`concept L1 闭包基础`](../../../concept/01_foundation/00_start/03_closure_basics.md) · [`concept L2 闭包类型`](../../../concept/02_intermediate/04_types_and_conversions/02_closure_types.md)
>
...
>
- [闭包速查卡 (Closures Cheatsheet) {#闭包速查卡-closures-cheatsheet}](#闭包速查卡-closures-cheatsheet-闭包速查卡-closures-cheatsheet)
  - [📑 目录 {#目录}](#-目录-目录)
  - [闭包基础 {#闭包基础}](#闭包基础-闭包基础)
    - [定义闭包 {#定义闭包}](#定义闭包-定义闭包)
    - [捕获环境 {#捕获环境}](#捕获环境-捕获环境)
  - [闭包 Trait {#闭包-trait}](#闭包-trait-闭包-trait)
    - [Trait 使用示例 {#trait-使用示例}](#trait-使用示例-trait-使用示例)
  - [常见用法 {#常见用法}](#常见用法-常见用法)
    - [迭代器方法 {#迭代器方法}](#迭代器方法-迭代器方法)
    - [高阶函数 {#高阶函数}](#高阶函数-高阶函数)
  - [相关文档 {#相关文档}](#相关文档-相关文档)
  - [Rust 1.95+ 在闭包与函数式编程中的深度应用 {#rust-195-在闭包与函数式编程中的深度应用}](#rust-195-在闭包与函数式编程中的深度应用-rust-195-在闭包与函数式编程中的深度应用)
    - [ControlFlow 在函数式控制流中的应用 {#controlflow-在函数式控制流中的应用}](#controlflow-在函数式控制流中的应用-controlflow-在函数式控制流中的应用)
    - [LazyLock 在闭包工厂中的应用 {#lazylock-在闭包工厂中的应用}](#lazylock-在闭包工厂中的应用-lazylock-在闭包工厂中的应用)
    - [array\_windows 在函数式数据处理中的应用 {#array\_windows-在函数式数据处理中的应用}](#array_windows-在函数式数据处理中的应用-array_windows-在函数式数据处理中的应用)
    - [数学常量在函数式数值计算中的应用 {#数学常量在函数式数值计算中的应用}](#数学常量在函数式数值计算中的应用-数学常量在函数式数值计算中的应用)
    - [生产场景：事件处理系统 {#生产场景事件处理系统}](#生产场景事件处理系统-生产场景事件处理系统)
    - [总结 {#总结}](#总结-总结)
  - [相关概念 {#相关概念}](#相关概念-相关概念)
...
- [控制流与函数速查卡](09_control_flow_functions_cheatsheet.md)
- [迭代器速查卡](08_collections_iterators_cheatsheet.md)
- [类型系统（Type System）速查卡](27_type_system.md)
