...
**文件**: [27_type_system.md](27_type_system.md)
...
**文件**: [14_ownership_cheatsheet.md](14_ownership_cheatsheet.md)
...
**文件**: [05_async_patterns.md](05_async_patterns.md)
...
**文件**: [11_generics_cheatsheet.md](11_generics_cheatsheet.md)
...
**文件**: [10_error_handling_cheatsheet.md](10_error_handling_cheatsheet.md)
...
**文件**: [26_threads_concurrency_cheatsheet.md](26_threads_concurrency_cheatsheet.md)
...
**文件**: [25_testing_cheatsheet.md](25_testing_cheatsheet.md)
...
**文件**: [09_control_flow_functions_cheatsheet.md](09_control_flow_functions_cheatsheet.md)
...
**文件**: [08_collections_iterators_cheatsheet.md](08_collections_iterators_cheatsheet.md)
...
**文件**: [23_smart_pointers_cheatsheet.md](23_smart_pointers_cheatsheet.md)
...
**文件**: [12_modules_cheatsheet.md](12_modules_cheatsheet.md)
...
**文件**: [24_strings_formatting_cheatsheet.md](24_strings_formatting_cheatsheet.md)
...
**文件**: [06_cargo_cheatsheet.md](06_cargo_cheatsheet.md)
...
**文件**: [16_process_management_cheatsheet.md](16_process_management_cheatsheet.md)
...
**文件**: [13_network_programming_cheatsheet.md](13_network_programming_cheatsheet.md)
...
**文件**: [03_algorithms_cheatsheet.md](03_algorithms_cheatsheet.md)
...
**文件**: [28_wasm_cheatsheet.md](28_wasm_cheatsheet.md)
...
**文件**: [01_ai_ml_cheatsheet.md](01_ai_ml_cheatsheet.md)
...
**文件**: [17_rust_190_to_193_features_cheatsheet.md](17_rust_190_to_193_features_cheatsheet.md)
...
**文件**: [18_rust_194_features_cheatsheet.md](18_rust_194_features_cheatsheet.md)
...
**文件**: [19_rust_195_features_cheatsheet.md](19_rust_195_features_cheatsheet.md)
...
**文件**: [20_rust_196_features_cheatsheet.md](20_rust_196_features_cheatsheet.md)
...
**文件**: [21_rust_197_features_cheatsheet.md](21_rust_197_features_cheatsheet.md)
...
| **调试问题**  | 错误处理 → 测试 → 类型系统  |
| **性能优化**  | 智能指针 → 集合与迭代器 → 测试（性能测试）→ [ALIGNMENT_GUIDE](../06_alignment_guide.md)（内存/缓存行对齐） |
| **发布项目**  | Cargo → 测试 → 模块系统  |
...
- [ALIGNMENT_GUIDE](../06_alignment_guide.md) - 对齐知识综合（内存/格式化/unsafe/缓存行/权威来源）
...
- [研究笔记快速参考](../../12_research_notes/10_tutorials_and_guides/13_quick_reference.md) - 形式化方法、类型理论、软件设计理论索引；与速查卡互为补充
- [形式化方法研究](../../12_research_notes/02_formal_methods/README.md)
- [类型理论研究](../../12_research_notes/05_type_theory/README.md)
- [实验研究](../../12_research_notes/09_experiments/README.md)
...
- ✅ **新增版本特性速查卡**: 补齐 Rust 1.90–1.97 版本特性速查表
  - `17_rust_190_to_193_features_cheatsheet.md`: 1.90–1.93 累积特性
  - `18_rust_194_features_cheatsheet.md`: 1.94 特性（从 archive 迁移）
  - `19_rust_195_features_cheatsheet.md`: 1.95 特性（已存在，确认覆盖）
  - `20_rust_196_features_cheatsheet.md`: 1.96 特性（已存在，确认覆盖）
  - `21_rust_197_features_cheatsheet.md`: 1.97 beta 特性（新增）
- ✅ **新增 1.98 nightly 前瞻速查卡**: `22_rust_198_nightly_preview_cheatsheet.md`
...
**完整速查表**: [`19_rust_195_features_cheatsheet.md`](19_rust_195_features_cheatsheet.md) — 包含所有 1.95 新 API 与示例链接
