...
- [类型系统速查卡](27_type_system.md) - 类型系统基础
- [Trait 系统速查卡](27_type_system.md#trait-系统) - Trait 与泛型
- [生命周期速查卡](27_type_system.md) - 生命周期参数
- [所有权（Ownership）系统速查卡](14_ownership_cheatsheet.md) - 所有权与泛型
...
- [类型系统完备性缺口](../../12_research_notes/02_formal_methods/00_completeness_gaps.md) — 泛型相关的完备性保证
- [类型构造能力](../../12_research_notes/05_type_theory/02_construction_capability.md) — 泛型类型的构造性分析
- [Trait 系统形式化](../../12_research_notes/05_type_theory/04_trait_system_formalization.md) — Trait 约束的形式化理论
