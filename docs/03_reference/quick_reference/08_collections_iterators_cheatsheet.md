...
- [集合研究笔记](../../12_research_notes/README.md)

### 形式化理论与类型系统 {#形式化理论与类型系统}
>
> **[来源: [docs.rs](https://docs.rs/)]**

- [类型系统基础](../../12_research_notes/05_type_theory/05_type_system_foundations.md) — 集合类型与类型理论
- [构造能力理论](../../12_research_notes/05_type_theory/02_construction_capability.md) — 迭代器的表达能力
- [泛型（Generics）编程形式化](../../12_research_notes/05_type_theory/04_trait_system_formalization.md) — Iterator trait 形式化
- [所有权（Ownership）模型](../../12_research_notes/02_formal_methods/09_ownership_model.md) — 集合所有权转移形式化
- [变型理论](../../12_research_notes/05_type_theory/06_variance_theory.md) — 集合协变/逆变

### 相关速查卡 {#相关速查卡}
>
> **[来源: [Rust Reference](https://doc.rust-lang.org/reference/)]**

- [控制流与函数速查卡](09_control_flow_functions_cheatsheet.md) - 循环与迭代器
- [类型系统速查卡](27_type_system.md) - 集合类型
- [所有权系统速查卡](14_ownership_cheatsheet.md) - 所有权与集合
- [字符串与格式化速查卡](24_strings_formatting_cheatsheet.md) - 字符串集合
