...
> **来源: [Wikipedia - Type System](https://en.wikipedia.org/wiki/Type_system)**
> **扩展**: 内存对齐见 [ALIGNMENT_GUIDE](../06_alignment_guide.md)；此处为**格式化**对齐（文本排版）。
...
- [字符串研究笔记](../../12_research_notes/README.md)

### 形式化理论与类型系统 {#形式化理论与类型系统}
>
> **[来源: [crates.io](https://crates.io/)]**

- [类型系统基础](../../12_research_notes/05_type_theory/05_type_system_foundations.md) — 字符串类型与类型理论
- [所有权（Ownership）模型](../../12_research_notes/02_formal_methods/09_ownership_model.md) — 字符串所有权转移形式化
- 生命周期（Lifetimes）形式化 — 字符串生命周期
- [构造能力理论](../../12_research_notes/05_type_theory/02_construction_capability.md) — 字符串操作表达能力

### 相关速查卡 {#相关速查卡}
>
> **[来源: [docs.rs](https://docs.rs/)]**

- [类型系统速查卡](27_type_system.md) - String 和 &str 类型
- [集合与迭代器（Iterator）速查卡](08_collections_iterators_cheatsheet.md) - 字符串集合操作
- [错误处理速查卡](10_error_handling_cheatsheet.md) - 字符串错误处理
- [模块系统速查卡](12_modules_cheatsheet.md) - 模块中的字符串处理
