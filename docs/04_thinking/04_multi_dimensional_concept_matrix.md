...
- [多维概念矩阵对比文档](#多维概念矩阵对比文档)
  ...
  - [⚡ 性能对比矩阵 {#-性能对比矩阵}](#性能对比矩阵)
    - [1. 数据结构性能矩阵](#1-数据结构性能矩阵)
    - [2. 算法性能矩阵](#2-算法性能矩阵)
    - [3. 并发原语性能矩阵](#3-并发原语性能矩阵)
  - [⚠️ Rust 1.93 行为变更影响（性能矩阵补充） {#️-rust-193-行为变更影响性能矩阵补充}](#rust-193-行为变更影响性能矩阵补充)
  - [📐 形式化理论概念对比矩阵 {#-形式化理论概念对比矩阵}](#形式化理论概念对比矩阵)
