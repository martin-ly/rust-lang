...
- [Rust 1.93.1 决策图网 / Decision Graph Network](#rust-1931-决策图网--decision-graph-network)
  - [📋 目录 {#-目录}](#-目录--目录)
  ...
  - [🔗 相关文档 {#-相关文档}](#-相关文档--相关文档)
    ...
    - [相关文档](#相关文档)
  - [Rust 1.95+ 思维表征更新](#-rust-194-思维表征更新)
    - [新增思维表征](#新增思维表征)
    - [示例](#示例)
  - [Rust 1.95+ 持续更新更新](#-rust-194-深度整合更新)
...
**最后更新**: 2026-05-08 (添加 Rust 1.94 支持)
