...
- [供应链安全指南](#供应链安全指南)
  ...
  - [1. 供应链风险模型](#1-供应链风险模型)
    - [1.1 风险分类](#11-风险分类)
    - [1.2 Rust特定风险](#12-rust特定风险)
  - [2. 依赖管理策略](#2-依赖管理策略)
    - [2.1 依赖选择标准](#21-依赖选择标准)
    - [2.2 最小依赖原则](#22-最小依赖原则)
  - [3. 安全构建流程](#3-安全构建流程)
    - [3.1 可重现构建](#31-可重现构建)
    - [3.2 构建环境锁定](#32-构建环境锁定)
  - [4. 依赖验证](#4-依赖验证)
    - [4.1 校验和验证](#41-校验和验证)
    - [4.2 源码审查清单](#42-源码审查清单)
  - [5. 私有Registry](#5-私有registry)
    - [5.1 搭建私有Registry](#51-搭建私有registry)
    - [5.2 镜像配置](#52-镜像配置)
  - [6. 安全更新管理](#6-安全更新管理)
    - [6.1 更新策略](#61-更新策略)
    - [6.2 自动化更新流程](#62-自动化更新流程)
  - [7. 事件响应](#7-事件响应)
