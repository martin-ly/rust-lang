...
- [故障排除与调试指南](#故障排除与调试指南)
  - [📑 目录](#-目录)
  - [概述](#概述)
  - [1. 编译错误故障排除](#1-编译错误故障排除)
    - [1.1 借用检查器错误](#11-借用检查器错误)
      - [错误 E0499: 多次可变借用](#错误-e0499-多次可变借用)
      - [错误 E0597: 悬垂引用](#错误-e0597-悬垂引用)
    - [1.2 泛型约束错误](#12-泛型约束错误)
    - [1.3 no\_std编译错误](#13-no_std编译错误)
  - [2. 运行时问题诊断](#2-运行时问题诊断)
    - [2.1 Panic分析与恢复](#21-panic分析与恢复)
    - [2.2 堆栈溢出检测](#22-堆栈溢出检测)
    - [2.3 死锁检测](#23-死锁检测)
  - [3. 工具链问题](#3-工具链问题)
    - [3.1 Miri常见问题](#31-miri常见问题)
    - [3.2 Kani验证失败](#32-kani验证失败)
    - [3.3 Clippy配置问题](#33-clippy配置问题)
  - [4. 性能问题](#4-性能问题)
    - [4.1 二进制大小优化](#41-二进制大小优化)
    - [4.2 实时性能调优](#42-实时性能调优)
  - [5. 认证相关问题](#5-认证相关问题)
    - [5.1 覆盖率不达标](#51-覆盖率不达标)
    - [5.2 工具链鉴定问题](#52-工具链鉴定问题)
  - [6. 调试技巧](#6-调试技巧)
    - [6.1 日志记录](#61-日志记录)
    - [6.2 断言策略](#62-断言策略)
  - [7. 常见问题速查](#7-常见问题速查)
  - [*持续更新中，欢迎贡献更多故障排除案例。*](#持续更新中欢迎贡献更多故障排除案例)
  - [相关概念](#相关概念)
  - [权威来源索引](#权威来源索引)
