...
- [动手实验练习](#动手实验练习)
  - [📑 目录](#-目录)
  - [概述](#概述)
  - [实验1: 安全LED闪烁器 (入门)](#实验1-安全led闪烁器-入门)
    - [目标](#目标)
    - [要求](#要求)
    - [代码框架](#代码框架)
    - [验证点](#验证点)
  - [实验2: 环形缓冲区 (基础)](#实验2-环形缓冲区-基础)
    - [目标](#目标-1)
    - [要求](#要求-1)
    - [代码框架](#代码框架-1)
  - [实验3: 状态机控制器 (中级)](#实验3-状态机控制器-中级)
    - [目标](#目标-2)
    - [要求](#要求-2)
    - [代码框架](#代码框架-2)
  - [实验4: 传感器驱动 (高级)](#实验4-传感器驱动-高级)
    - [目标](#目标-3)
    - [要求](#要求-3)
    - [代码框架](#代码框架-3)
  - [实验5: 安全通信协议 (专家)](#实验5-安全通信协议-专家)
    - [目标](#目标-4)
    - [要求](#要求-4)
    - [代码框架](#代码框架-4)
  - [实验检查清单](#实验检查清单)
    - [实验1: LED闪烁器](#实验1-led闪烁器)
    - [实验2: 环形缓冲区](#实验2-环形缓冲区)
    - [实验3: 状态机](#实验3-状态机)
    - [实验4: 传感器驱动](#实验4-传感器驱动)
    - [实验5: 通信协议](#实验5-通信协议)
