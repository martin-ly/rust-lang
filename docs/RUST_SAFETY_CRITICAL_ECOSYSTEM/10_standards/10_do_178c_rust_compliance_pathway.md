...
- [DO-178C Rust合规路径](#do-178c-rust合规路径)
  ...
  - [概述](#概述)
  - [DO-178C结构](#do-178c结构)
    - [软件等级(Software Level)](#软件等级software-level)
  - [DO-178C目标Rust实现](#do-178c目标rust实现)
    - [A-1: 软件计划过程](#a-1-软件计划过程)
      - [软件计划数据](#软件计划数据)
    - [A-2: 软件开发过程](#a-2-软件开发过程)
      - [软件需求数据](#软件需求数据)
      - [软件设计数据](#软件设计数据)
      - [代码标准与实现](#代码标准与实现)
    - [A-3: 软件验证过程](#a-3-软件验证过程)
      - [验证方法](#验证方法)
    - [覆盖率目标](#覆盖率目标)
  - [DO-330工具鉴定](#do-330工具鉴定)
    - [工具鉴定等级](#工具鉴定等级)
  - [适航认证检查表](#适航认证检查表)
    - [Level A软件完整检查表](#level-a软件完整检查表)
      - [计划阶段](#计划阶段)
      - [需求阶段](#需求阶段)
      - [设计阶段](#设计阶段)
      - [实现阶段](#实现阶段)
      - [验证阶段](#验证阶段)
      - [认证阶段](#认证阶段)
  - [*本文档应与DO-178C标准原文配合使用。*](#本文档应与do-178c标准原文配合使用)
  - [相关概念](#相关概念)
  - [权威来源索引](#权威来源索引)
  - [权威来源索引](#权威来源索引-1)
