...
- [定理 2.1: 线性类型基本性质](./06_theorems.md#21-线性类型定理)
...
- [定理 1.7: 多重不可变借用安全性](./06_theorems.md#42-不可变借用定理)
- [定理 1.8: 可变借用排他性](./06_theorems.md#43-可变借用定理)
- [定理 1.9: 生命周期有界性](./06_theorems.md#51-生命周期安全定理)
