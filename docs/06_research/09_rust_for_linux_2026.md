...
> 同目录旧路径 [`08_rust_for_linux.md`](08_rust_for_linux.md) 已为重定向 stub（2026-07-12 去重确认）。
...
- [Rust for Linux：2026 年全景与工程实践 {#rust-for-linux2026-年全景与工程实践}](#rust-for-linux2026-年全景与工程实践-rust-for-linux2026-年全景与工程实践)
  - [目录 {#目录}](#目录-目录)
  - [一、历史里程碑 {#一历史里程碑}](#一历史里程碑-一历史里程碑)
  - [二、Rust 在内核中的定位 {#二rust-在内核中的定位}](#二rust-在内核中的定位-二rust-在内核中的定位)
    - [2.1 设计哲学 {#21-设计哲学}](#21-设计哲学-21-设计哲学)
  ...
  - [四、`kernel` Crate API 概览 {#四kernel-crate-api-概览}](#四kernel-crate-api-概览-四kernel-crate-api-概览)
    ...
    - [4.3 同步原语 {#43-同步原语}](#43-同步原语-43-同步原语)
  - [五、生产案例研究 {#五生产案例研究}](#五生产案例研究-五生产案例研究)
    - [5.1 Android Binder IPC（Google） {#51-android-binder-ipcgoogle}](#51-android-binder-ipcgoogle-51-android-binder-ipcgoogle)
    - [5.2 Asahi GPU 驱动（Apple Silicon） {#52-asahi-gpu-驱动apple-silicon}](#52-asahi-gpu-驱动apple-silicon-52-asahi-gpu-驱动apple-silicon)
    - [5.3 NVMe 驱动子系统 {#53-nvme-驱动子系统}](#53-nvme-驱动子系统-53-nvme-驱动子系统)
  - [六、与 C 内核模块的互操作 {#六与-c-内核模块的互操作}](#六与-c-内核模块的互操作-六与-c-内核模块的互操作)
    - [6.1 绑定生成（bindgen） {#61-绑定生成bindgen}](#61-绑定生成bindgen-61-绑定生成bindgen)
    - [6.2 调用约定与 ABI {#62-调用约定与-abi}](#62-调用约定与-abi-62-调用约定与-abi)
  - [七、安全关键系统关联 {#七安全关键系统关联}](#七安全关键系统关联-七安全关键系统关联)
  - [八、挑战与未来方向 {#八挑战与未来方向}](#八挑战与未来方向-八挑战与未来方向)
    - [8.1 当前挑战 {#81-当前挑战}](#81-当前挑战-81-当前挑战)
    - [8.2 2026-2027 路线图 {#82-2026-2027-路线图}](#82-2026-2027-路线图-82-2026-2027-路线图)
  - [九、参考链接 {#九参考链接}](#九参考链接-九参考链接)
