...
- [Web 应用开发场景树 {#web-应用开发场景树}](#web-应用开发场景树-web-应用开发场景树)
  - [📑 目录 {#目录}](#-目录-目录)
  - [🌳 Web 应用场景树 {#web-应用场景树}](#-web-应用场景树-web-应用场景树)
  - [📊 RESTful API 场景 {#restful-api-场景}](#-restful-api-场景-restful-api-场景)
    - [场景 1: CRUD API {#场景-1-crud-api}](#场景-1-crud-api-场景-1-crud-api)
  - [🔗 相关文档 {#相关文档}](#-相关文档-相关文档)
  - [相关概念 {#相关概念}](#相关概念-相关概念)
