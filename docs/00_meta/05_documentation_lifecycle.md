...
- [文档生命周期管理制度 {#文档生命周期管理制度}](#文档生命周期管理制度-文档生命周期管理制度)
  - [📑 目录 {#目录}](#-目录-目录)
  - [1. 生命周期阶段 {#1-生命周期阶段}](#1-生命周期阶段-1-生命周期阶段)
  - [2. 归档流程（强制） {#2-归档流程强制}](#2-归档流程强制-2-归档流程强制)
    - [2.1 触发归档的条件 {#21-触发归档的条件}](#21-触发归档的条件-21-触发归档的条件)
    - [2.2 归档操作步骤 {#22-归档操作步骤}](#22-归档操作步骤-22-归档操作步骤)
    - [2.3 归档标记模板 {#23-归档标记模板}](#23-归档标记模板-23-归档标记模板)
  - [3. 版本升级检查清单 {#3-版本升级检查清单}](#3-版本升级检查清单-3-版本升级检查清单)
  - [4. 自动化检查脚本 {#4-自动化检查脚本}](#4-自动化检查脚本-4-自动化检查脚本)
    - [4.1 版本号一致性检查 {#41-版本号一致性检查}](#41-版本号一致性检查-41-版本号一致性检查)
    - [4.2 文档重复扫描 {#42-文档重复扫描}](#42-文档重复扫描-42-文档重复扫描)
    - [4.3 过时标记检查 {#43-过时标记检查}](#43-过时标记检查-43-过时标记检查)
  - [5. 删除策略 {#5-删除策略}](#5-删除策略-5-删除策略)
    - [5.1 禁止删除 {#51-禁止删除}](#51-禁止删除-51-禁止删除)
    - [5.2 允许删除 {#52-允许删除}](#52-允许删除-52-允许删除)
  - [6. 责任分工 {#6-责任分工}](#6-责任分工-6-责任分工)
  - [7. 相关文档 {#7-相关文档}](#7-相关文档-7-相关文档)
  - [相关概念 {#相关概念}](#相关概念-相关概念)
...
- `04_documentation_division_of_labor.md` — 文档体系分工协议
