...
| `From<bool> for {f32,f64}` | **1.93/1.95** | 1.68/1.96 | ⚠️ 待修正 |
| `VecDeque::new` const | **1.68** | 1.96 | ⚠️ 待修正 |
...
| `From<bool> for {f32,f64}` 标注为 1.68 | 实际 1.93/1.95 | 修正标签 |
| `VecDeque::new` const 标注为 1.96 | 实际 1.68 | 修正标签 |
