...
│   │   └── 11_reorganization_complete.md # 本报告
...
| 原位置 | 新位置 |
|--------|--------|
| `docs/06_research/14_rust_ecosystem_comprehensive_review_2026.md` | `01_docs/02_ecosystem_review/2026_comprehensive_review.md` |
| `docs/00_meta/16_authoritative_sources_and_citations.md` | `01_docs/03_authoritative_sources/citations.md` |
| `docs/04_guides/16_migration_guide_2026.md` | `01_docs/04_guides/migration_2026.md` |
...
- [重组记录](history/00_reorganization.md) - 详细重组过程
- [文档索引](../../archive/04_crate_reports/11_cargo_package_management/00_INDEX.md) - 已归档的 Cargo 包管理文档导航
