...
- [Rust 特性跟踪看板模板 {#rust-特性跟踪看板模板}](#rust-特性跟踪看板模板-rust-特性跟踪看板模板)
  - [📑 目录 {#目录}](#-目录-目录)
  - [当前版本状态 {#当前版本状态}](#当前版本状态-当前版本状态)
  - [特性跟踪矩阵 {#特性跟踪矩阵}](#特性跟踪矩阵-特性跟踪矩阵)
    - [语言特性 {#语言特性}](#语言特性-语言特性)
    - [标准库 API {#标准库-api}](#标准库-api-标准库-api)
    - [工具链与生态 {#工具链与生态}](#工具链与生态-工具链与生态)
    - [平台与系统编程 {#平台与系统编程}](#平台与系统编程-平台与系统编程)
  - [更新检查清单 {#更新检查清单}](#更新检查清单-更新检查清单)
  - [趋势跟踪 {#趋势跟踪}](#趋势跟踪-趋势跟踪)
    - [2026 Q2 关键里程碑 {#2026-q2-关键里程碑}](#2026-q2-关键里程碑-2026-q2-关键里程碑)
  - [相关概念 {#相关概念}](#相关概念-相关概念)
...
| 通道 | 版本 | 发布日期 | 状态 |
|------|------|---------|------|
| Stable | 1.97.0 | 2026-07-09 | ✅ 当前项目 MSRV |
| Beta | 1.97.0 | 2026-07-09 (预计) | 🔄 跟踪中（尚未 stable） |
...
- [概念文档模板](14_template_concept_doc.md)
