...
- [🦀 Rust 版本对齐检查表 {#rust-版本对齐检查表}](#-rust-版本对齐检查表-rust-版本对齐检查表)
  - [📑 目录 {#目录}](#-目录-目录)
  - [1️⃣ Rust 新版本发布跟踪 {#1-rust-新版本发布跟踪}](#1️⃣-rust-新版本发布跟踪-1-rust-新版本发布跟踪)
    - [版本信息收集 {#版本信息收集}](#版本信息收集-版本信息收集)
    - [发布说明审查 {#发布说明审查}](#发布说明审查-发布说明审查)
  - [2️⃣ Edition 兼容性检查 {#2-edition-兼容性检查}](#2️⃣-edition-兼容性检查-2-edition-兼容性检查)
    - [当前 Edition 状态 {#当前-edition-状态}](#当前-edition-状态-当前-edition-状态)
    - [Edition 迁移评估 {#edition-迁移评估}](#edition-迁移评估-edition-迁移评估)
    - [Edition 迁移计划（如适用） {#edition-迁移计划如适用}](#edition-迁移计划如适用-edition-迁移计划如适用)
  - [3️⃣ MSRV 更新评估 {#3-msrv-更新评估}](#3️⃣-msrv-更新评估-3-msrv-更新评估)
    - [当前 MSRV 审查 {#当前-msrv-审查}](#当前-msrv-审查-当前-msrv-审查)
    - [MSRV 更新分析 {#msrv-更新分析}](#msrv-更新分析-msrv-更新分析)
    - [MSRV 更新决策 {#msrv-更新决策}](#msrv-更新决策-msrv-更新决策)
    - [MSRV 更新执行清单（如决定更新） {#msrv-更新执行清单如决定更新}](#msrv-更新执行清单如决定更新-msrv-更新执行清单如决定更新)
  - [4️⃣ 废弃特性迁移计划 {#4-废弃特性迁移计划}](#4️⃣-废弃特性迁移计划-4-废弃特性迁移计划)
    - [编译器弃用警告检查 {#编译器弃用警告检查}](#编译器弃用警告检查-编译器弃用警告检查)
    - [依赖废弃项检查 {#依赖废弃项检查}](#依赖废弃项检查-依赖废弃项检查)
  - [5️⃣ 新特性集成机会 {#5-新特性集成机会}](#5️⃣-新特性集成机会-5-新特性集成机会)
    - [值得集成的新特性 {#值得集成的新特性}](#值得集成的新特性-值得集成的新特性)
    - [示例代码更新 {#示例代码更新}](#示例代码更新-示例代码更新)
  - [6️⃣ 检查结果汇总 {#6-检查结果汇总}](#6️⃣-检查结果汇总-6-检查结果汇总)
    - [行动项总结 {#行动项总结}](#行动项总结-行动项总结)
    - [风险与阻塞项 {#风险与阻塞项}](#风险与阻塞项-风险与阻塞项)
    - [完成确认 {#完成确认}](#完成确认-完成确认)
  - [相关概念 {#相关概念}](#相关概念-相关概念)
  - [权威来源索引 {#权威来源索引}](#权威来源索引-权威来源索引)

## 1️⃣ Rust 新版本发布跟踪 {#1-rust-新版本发布跟踪}
>
...
## 2️⃣ Edition 兼容性检查 {#2-edition-兼容性检查}
>
> **来源: [Rust Official Docs](https://doc.rust-lang.org/)**
