...
- [决策树/推理树标准模板 {#决策树推理树标准模板}](#决策树推理树标准模板-决策树推理树标准模板)
  - [📑 目录 {#目录}](#-目录-目录)
  - [ASCII 模板 {#ascii-模板}](#ascii-模板-ascii-模板)
  - [Mermaid 模板 {#mermaid-模板}](#mermaid-模板-mermaid-模板)
  - [使用示例：选择引用类型 {#使用示例选择引用类型}](#使用示例选择引用类型-使用示例选择引用类型)
  - [设计规则 {#设计规则}](#设计规则-设计规则)
  - [相关概念 {#相关概念}](#相关概念-相关概念)
