...
- [项目文档体系分工协议 {#项目文档体系分工协议}](#项目文档体系分工协议-项目文档体系分工协议)
  ...
  - [2. 四大文档体系定位 {#2-四大文档体系定位}](#2-四大文档体系定位-2-四大文档体系定位)
    ...
    - [2.2 `docs/08_usage_guides/` — 面向开发者的专题查阅指南 {#22-docs05\_guides-面向开发者的专题查阅指南}](#22-docs05_guides--面向开发者的专题查阅指南-22-docs05_guides-面向开发者的专题查阅指南)
    - [2.3 `docs/03_reference/` — 速查卡与边界特例 {#23-docs02\_reference-速查卡与边界特例}](#23-docs02_reference--速查卡与边界特例-23-docs02_reference-速查卡与边界特例)
    - [2.4 `docs/12_research_notes/` — 学术与形式化内容 {#24-docsresearch\_notes-学术与形式化内容}](#24-docsresearch_notes--学术与形式化内容-24-docsresearch_notes-学术与形式化内容)
    - [2.5 `docs/14_content/` — 学术与场景化内容 {#25-docscontent-学术与场景化内容}](#25-docscontent--学术与场景化内容-25-docscontent-学术与场景化内容)
