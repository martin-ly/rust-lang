...
- [项目文档体系分工协议 {#项目文档体系分工协议}](#项目文档体系分工协议-项目文档体系分工协议)
  ...
  - [2. 四大文档体系定位 {#2-四大文档体系定位}](#2-四大文档体系定位-2-四大文档体系定位)
    ...
    - [2.2 `docs/08_usage_guides/` — 面向开发者的专题查阅指南 {#22-docs05\_guides-面向开发者的专题查阅指南}](#22-docs08_usage_guides--面向开发者的专题查阅指南-22-docs05_guides-面向开发者的专题查阅指南)
    - [2.3 `docs/03_reference/` — 速查卡与边界特例 {#23-docs02\_reference-速查卡与边界特例}](#23-docs03_reference--速查卡与边界特例-23-docs02_reference-速查卡与边界特例)
    - [2.4 `docs/12_research_notes/` — 学术与形式化内容 {#24-docsresearch\_notes-学术与形式化内容}](#24-docs12_research_notes--学术与形式化内容-24-docsresearch_notes-学术与形式化内容)
    - [2.5 `docs/14_content/` — 学术与场景化内容 {#25-docscontent-学术与场景化内容}](#25-docs14_content--学术与场景化内容-25-docscontent-学术与场景化内容)
...
### 2.2 `docs/08_usage_guides/` — 面向开发者的专题查阅指南 {#22-docs05_guides-面向开发者的专题查阅指南}
...
### 2.3 `docs/03_reference/` — 速查卡与边界特例 {#23-docs02_reference-速查卡与边界特例}
...
### 2.4 `docs/12_research_notes/` — 学术与形式化内容 {#24-docsresearch_notes-学术与形式化内容}
...
### 2.5 `docs/14_content/` — 学术与场景化内容 {#25-docscontent-学术与场景化内容}
...
- `knowledge/` 中提及专题深度内容时，必须链接到 `docs/08_usage_guides/` 或 `docs/03_reference/`
- `docs/08_usage_guides/` 中提及基础知识时，必须链接到 `knowledge/` 对应层级
- `docs/12_research_notes/` 中提及代码实现时，必须链接到 `crates/` 对应模块
...
- `docs/00_meta/00_master_index.md`
- `docs/00_meta/17_terminology_standard.md`
- `docs/00_meta/16_authoritative_sources_and_citations.md`
- `knowledge/INDEX.md`
- `knowledge/README.md`
- 所有 `docs/08_usage_guides/*_GUIDE.md`
...
- `05_documentation_lifecycle.md` — 文档生命周期管理制度
