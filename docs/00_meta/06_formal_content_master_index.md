...
- [形式化内容总索引 {#形式化内容总索引}](#形式化内容总索引-形式化内容总索引)
  - [📑 目录 {#目录}](#-目录-目录)
  - [1. 索引说明 {#1-索引说明}](#1-索引说明-1-索引说明)
  - [2. 按主题索引 {#2-按主题索引}](#2-按主题索引-2-按主题索引)
    - [2.1 所有权与借用形式化 {#21-所有权与借用形式化}](#21-所有权与借用形式化-21-所有权与借用形式化)
    - [2.2 类型理论 {#22-类型理论}](#22-类型理论-22-类型理论)
    - [2.3 并发与异步形式化 {#23-并发与异步形式化}](#23-并发与异步形式化-23-并发与异步形式化)
    - [2.4 设计模式形式化 {#24-设计模式形式化}](#24-设计模式形式化-24-设计模式形式化)
    - [2.5 验证工具 {#25-验证工具}](#25-验证工具-25-验证工具)
    - [2.6 案例研究 {#26-案例研究}](#26-案例研究-26-案例研究)
  - [3. 快速决策树 {#3-快速决策树}](#3-快速决策树-3-快速决策树)
  - [4. 维护记录 {#4-维护记录}](#4-维护记录-4-维护记录)
  - [5. 相关文档 {#5-相关文档}](#5-相关文档-5-相关文档)
  - [相关概念 {#相关概念}](#相关概念-相关概念)
...
- **`docs/12_research_notes/`**: 通用研究笔记（形式化方法、类型理论、软件设计理论，150+ 文件）
...
| ⭐⭐ 研究笔记 | [`research_notes/formal_methods/10_ownership_model.md`](../12_research_notes/02_formal_methods/09_ownership_model.md) | 所有权模型概述 |
| ⭐⭐ 研究笔记 | [`research_notes/formal_methods/10_borrow_checker_proof.md`](../12_research_notes/02_formal_methods/03_borrow_checker_proof.md) | 借用检查器证明 |
...
| 深度 | 位置 | 说明 |
|------|------|------|
| ⭐⭐ 通用基础 | [`research_notes/type_theory/`](../12_research_notes/05_type_theory) | 类型系统基础、方差、常量求值 |
...
| ⭐⭐ 异步状态机 | [`research_notes/formal_methods/10_async_state_machine.md`](../12_research_notes/02_formal_methods/02_async_state_machine.md) | 异步状态机形式化 |
| ⭐⭐ Send/Sync | [`research_notes/formal_methods/10_send_sync_formalization.md`](../12_research_notes/02_formal_methods/12_send_sync_formalization.md) | Send/Sync 形式化 |
