...
> **上位文档**: CORE_THEOREMS_FULL_PROOFS
...
- **T-BR1**：将 `Parameter` 替换为具体定义；实现 L-BR1/L-BR2；见 CORE_THEOREMS_FULL_PROOFS §3
...
本骨架对应 FORMAL_VERIFICATION_GUIDE 六类验证中的**所有权模型验证**。补全证明后，可勾选该指南任务清单中的相应项。
...
| 定理 | 文档 | Coq 骨架 |
| :--- | :--- | :--- |
| T-OW1 | CORE_THEOREMS_FULL_PROOFS §2.1 | - |
| T-OW2 | CORE_THEOREMS_FULL_PROOFS §2.2 | [OWNERSHIP_UNIQUENESS.v](./coq_skeleton/OWNERSHIP_UNIQUENESS.v) |
| T-OW3 | CORE_THEOREMS_FULL_PROOFS §2.3 | - |
| T-BR1 | CORE_THEOREMS_FULL_PROOFS §3.1 | [BORROW_DATARACE_FREE.v](./coq_skeleton/BORROW_DATARACE_FREE.v) |
| T-TY1 | CORE_THEOREMS_FULL_PROOFS §4.1 | - |
| T-TY2 | CORE_THEOREMS_FULL_PROOFS §4.2 | - |
| T-TY3 | CORE_THEOREMS_FULL_PROOFS §4.3 | [TYPE_SAFETY.v](./coq_skeleton/TYPE_SAFETY.v) |
