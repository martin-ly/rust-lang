...
- [Rust 所有权系统可判定性 - 终极综合指南](#rust-所有权系统可判定性---终极综合指南)
  ...
  - [📚 第二部分：系统性文档索引](#-第二部分系统性文档索引)
    - [2.1 按难度分类](#21-按难度分类)
      - [🟢 入门级 (初学者)](#-入门级-初学者)
      - [🟡 进阶级 (有经验的开发者)](#-进阶级-有经验的开发者)
      - [🔴 专家级 (研究者/形式化方法)](#-专家级-研究者形式化方法)
    - [2.2 按主题分类](#22-按主题分类)
      - [主题 1: 所有权系统核心](#主题-1-所有权系统核心)
      - [主题 2: 借用系统](#主题-2-借用系统)
      - [主题 3: 生命周期](#主题-3-生命周期)
  ...
  - [🛤️ 第三部分：递进学习路线图](#第三部分递进学习路线图)
    ...
    - [3.2 详细路径规划](#32-详细路径规划)
      ...
      - [路径 B: 系统掌握 (2周)](#路径-b-系统掌握-2周)
      - [路径 C: 形式化专家 (持续)](#路径-c-形式化专家-持续)
  - [🔍 第四部分：快速查找指南](#-第四部分快速查找指南)
    - [4.1 按问题查找](#41-按问题查找)
      - ["我遇到了编译错误..."](#我遇到了编译错误)
      - ["我想理解..."](#我想理解)
      - ["我需要实现..."](#我需要实现)
    - [4.2 按技术栈查找](#42-按技术栈查找)
      - [Web 开发](#web-开发)
      - [系统编程](#系统编程)
      - [数据工程](#数据工程)
  - [📊 第五部分：知识体系对照表](#-第五部分知识体系对照表)
    - [5.1 自然语言 ↔ 数学符号 ↔ 代码 ↔ Coq](#51-自然语言--数学符号--代码--coq)
    - [5.2 理论约束 ↔ 设计决策](#52-理论约束--设计决策)
    - [5.3 学习阶段 ↔ 目标能力](#53-学习阶段--目标能力)
  - [🎓 第六部分：学习建议](#-第六部分学习建议)
    - [6.1 不同背景的学习建议](#61-不同背景的学习建议)
      - [来自 C/C++](#来自-cc)
      - [来自 Java/Python](#来自-javapython)
      - [来自 Haskell](#来自-haskell)
      - [来自研究/学术](#来自研究学术)
    - [6.2 常见学习误区](#62-常见学习误区)
  - [🔗 第七部分：外部资源链接](#-第七部分外部资源链接)
    - [7.1 官方资源](#71-官方资源)
    - [7.2 学术资源](#72-学术资源)
    - [7.3 工具资源](#73-工具资源)
  - [📝 第八部分：文档维护与贡献](#-第八部分文档维护与贡献)
...
│   ├── 异步运行时            Tokio, async-std [已归档], smol               │
