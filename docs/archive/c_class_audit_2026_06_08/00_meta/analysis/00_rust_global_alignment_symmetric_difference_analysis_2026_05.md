...
- [Rust 项目全面对齐与国际权威对称差分析报告（2026-05 更新版）](#rust-项目全面对齐与国际权威对称差分析报告2026-05-更新版)
  - [📑 目录](#-目录)
  - [一、执行摘要](#一执行摘要)
    - [关键发现](#关键发现)
  - [二、权威来源状态更新（集合 B 变更）](#二权威来源状态更新集合-b-变更)
    - [2.1 Rust 版本时间线（2026-05-08）](#21-rust-版本时间线2026-05-08)
    - [2.2 Rust 1.95.0 stable 新特性（2026-04-17）](#22-rust-1950-stable-新特性2026-04-17)
    - [2.3 Rust 1.96.0 beta 新特性（预计 2026-05-28 stable）](#23-rust-1960-beta-新特性预计-2026-05-28-stable)
    - [2.4 Rust 2026 Project Goals 更新（2026-02-23 发布）](#24-rust-2026-project-goals-更新2026-02-23-发布)
    - [2.5 ACM/IEEE 2026 新论文](#25-acmieee-2026-新论文)
  - [三、项目内部现状（集合 A 变更）](#三项目内部现状集合-a-变更)
    - [3.1 2026-04-24 以来已完成的修复](#31-2026-04-24-以来已完成的修复)
    - [3.2 版本引用分布扫描（docs/ 活跃目录）](#32-版本引用分布扫描docs-活跃目录)
    - [3.3 crates 代码覆盖与标签准确性](#33-crates-代码覆盖与标签准确性)
  - [四、对称差分析（A Δ B）](#四对称差分析a-δ-b)
    - [4.1 新增差距（自 2026-04-24 报告以来）](#41-新增差距自-2026-04-24-报告以来)
      - [🔴 P0 — 紧急（标签错误 + 特性缺失）](#-p0--紧急标签错误--特性缺失)
      - [🟡 P1 — 重要（内容缺失）](#-p1--重要内容缺失)
      - [🟢 P2 — 扩展](#-p2--扩展)
    - [4.2 已修复差距（自 2026-04-24 报告以来）](#42-已修复差距自-2026-04-24-报告以来)
  - [五、分阶段执行建议](#五分阶段执行建议)
    - [阶段 1: 紧急标签修正（1-2 天）](#阶段-1-紧急标签修正1-2-天)
    - [阶段 2: 1.95/1.96 特性代码补齐（3-5 天）](#阶段-2-195196-特性代码补齐3-5-天)
    - [阶段 3: docs 版本统一与内容补齐（1-2 周）](#阶段-3-docs-版本统一与内容补齐1-2-周)
    - [阶段 4: 权威来源深度对齐（持续）](#阶段-4-权威来源深度对齐持续)
  - [六、验收标准](#六验收标准)
  - [七、参考](#七参考)
  - [权威来源索引](#权威来源索引)
...
| `VecDeque::new` const | **1.68.0** | ❌ 错位（标注为 1.96） | 🔴 **已修正** |
...
|-------|---------------------|---------------------|-----------|
| c01 | ✅ 有 | ✅ 有（if let guards） | ❌ 1.96 文件含 1.95.0 特性 |
| c02 | ✅ 有 | ✅ 有 | 待核查 |
| c03 | ✅ 有 | ✅ 有 | 待核查 |
| c04 | ✅ 有 | ✅ 有 | 待核查 |
| c05 | ✅ 有 | ✅ 有 | 待核查 |
| c06 | ✅ 有 | ✅ 有 | 待核查 |
| c07 | ✅ 有 | ✅ 有 | 待核查 |
| c08 | ✅ 有 | ✅ 有（if let guards + Range） | ❌ 1.96 文件含 1.95.0 特性 |
| c09 | ✅ 有 | ✅ 有 | 待核查 |
| c10 | ✅ 有 | ✅ 有 | 待核查 |
| c11 | ✅ 有 | ✅ 有 | 待核查 |
| c12 | ✅ 有 | ✅ 有 | 待核查 |
...
| 23 | Next-generation trait solver | 2026-05-08 | `docs/04_research/04_next_generation_trait_solver.md` (304 行)
| 24 | C++ ↔ Rust interop evaluation | 2026-05-08 | `docs/05_guides/05_cxx_rust_interop_evaluation.md` (285 行)
| 25 | Rust for Linux tooling | 2026-05-08 | `docs/06_toolchain/06_rust_for_linux_tooling_guide.md` (263 行)
| 26 | Endangered by Language (POPL 2026) | 2026-05-08 | `docs/04_research/04_endangered_by_language_saved_by_compiler_popl_2026.md` (263 行)
