...
- [⚠️ Rust 错误处理速查卡 ](#️-rust-错误处理速查卡-️-rust-错误处理速查卡)
  - [📋 目录 ](#-目录--目录)
  - [🎯 核心概念 ](#-核心概念--核心概念)
    - [Result 类型](#result-类型)
    - [Option 类型](#option-类型)
  ...
  - [🚫 反例速查 ](#-反例速查--反例速查)
    ...
    - [反例 2: 在非 Result 返回类型函数中使用 ? ](#反例-2-在非-result-返回类型函数中使用--反例-2-在非-result-返回类型函数中使用-)
    - [反例 3: 混淆 Option 与 Result 语义](#反例-3-混淆-option-与-result-语义)
  - [📚 相关文档 ](#-相关文档--相关文档)
  - [🧩 相关示例代码 ](#-相关示例代码--相关示例代码)
  - [🔗 相关资源 ](#-相关资源--相关资源)
  - [🆕 Rust 1.93.0 错误处理改进 ](#-rust-1930-错误处理改进--rust-1930-错误处理改进)
