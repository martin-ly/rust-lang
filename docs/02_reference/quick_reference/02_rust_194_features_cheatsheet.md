...
> **分级**: [A]
> **引入版本**: 1.94.0 | **稳定版本**: 1.97.0+ (项目 MSRV)
> **最后更新**: 2026-05-08
> **状态**: ✅ 完整
>
> **受众**: [初学者] / [进阶]
...
- [Rust 1.94 引入特性速查卡（1.96+ 稳定可用）/ Rust 1.94 Features Cheatsheet (Stable in 1.96+) {#rust-194-引入特性速查卡196-稳定可用-rust-194-features-cheatsheet-stable-in-196}](#rust-194-引入特性速查卡196-稳定可用-rust-194-features-cheatsheet-stable-in-196-rust-194-引入特性速查卡196-稳定可用-rust-194-features-cheatsheet-stable-in-196)
  - [📋 目录 {#目录}](#-目录-目录)
  - [🎯 快速参考 {#快速参考}](#-快速参考-快速参考)
  - [1. Array Windows（数组窗口） {#1-array-windows数组窗口}](#1-array-windows数组窗口-1-array-windows数组窗口)
    - [基本用法 {#基本用法}](#基本用法-基本用法)
    - [滑动窗口平均值 {#滑动窗口平均值}](#滑动窗口平均值-滑动窗口平均值)
    - [模式检测（ABBA） {#模式检测abba}](#模式检测abba-模式检测abba)
  - [2. LazyCell \& LazyLock 新方法 {#2-lazycell-lazylock-新方法}](#2-lazycell--lazylock-新方法-2-lazycell-lazylock-新方法)
    - [LazyCell（单线程） {#lazycell单线程}](#lazycell单线程-lazycell单线程)
    - [LazyLock（多线程） {#lazylock多线程}](#lazylock多线程-lazylock多线程)
  - [3. 数学常量 {#3-数学常量}](#3-数学常量-3-数学常量)
    - [可用常量 {#可用常量}](#可用常量-可用常量)
    - [黄金分割搜索 {#黄金分割搜索}](#黄金分割搜索-黄金分割搜索)
    - [调和级数估算 {#调和级数估算}](#调和级数估算-调和级数估算)
  - [4. Peekable 迭代器 {#4-peekable-迭代器}](#4-peekable-迭代器-4-peekable-迭代器)
    - [next\_if\_map {#next\_if\_map}](#next_if_map-next_if_map)
    - [词法分析器示例 {#词法分析器示例}](#词法分析器示例-词法分析器示例)
  - [5. char 到 usize 转换 {#5-char-到-usize-转换}](#5-char-到-usize-转换-5-char-到-usize-转换)
    - [基本转换 {#基本转换}](#基本转换-基本转换)
    - [应用场景 {#应用场景}](#应用场景-应用场景)
  - [🔧 完整示例 {#完整示例}](#-完整示例-完整示例)
    - [综合示例：数据处理器 {#综合示例数据处理器}](#综合示例数据处理器-综合示例数据处理器)
  - [📚 相关资源 {#相关资源}](#-相关资源-相关资源)
  - [Rust 1.95+ 特性速查 - 完整版 {#rust-195-特性速查---完整版}](#rust-195-特性速查---完整版-rust-195-特性速查---完整版)
    - [array\_windows {#array\_windows}](#array_windows-array_windows)
