...
- [🎯 Rust 智能指针速查卡 ](#-rust-智能指针速查卡--rust-智能指针速查卡)
  - [📋 目录 ](#-目录--目录)
  - [🎯 智能指针概览 ](#-智能指针概览--智能指针概览)
  - [📦 `Box<T>` - 堆分配 ](#-boxt---堆分配--box---堆分配)
    - [基本用法](#基本用法)
    - [使用场景 ](#使用场景--使用场景)
    - [API](#api)
  - [🔗 `Rc<T>` - 引用计数（单线程） ](#-rct---引用计数单线程--rc---引用计数单线程)
    - [基本用法 ](#基本用法-基本用法-1)
    - [使用场景 ](#使用场景-使用场景-1)
    - [API ](#api-api-1)
  - [🔗 `Arc<T>` - 原子引用计数（多线程） ](#-arct---原子引用计数多线程--arc---原子引用计数多线程)
    - [基本用法 ](#基本用法-基本用法-2)
    - [使用场景 ](#使用场景-使用场景-2)
    - [API ](#api-api-2)
  - [🔓 `RefCell<T>` - 内部可变性（单线程） ](#-refcellt---内部可变性单线程--refcell---内部可变性单线程)
    - [基本用法 ](#基本用法-基本用法-3)
    - [使用场景 ](#使用场景-使用场景-3)
    - [API ](#api-api-3)
    - [运行时借用检查](#运行时借用检查)
  - [🔒 `Mutex<T>` - 互斥锁（多线程） ](#-mutext---互斥锁多线程--mutex---互斥锁多线程)
    - [基本用法 ](#基本用法-基本用法-4)
    - [使用场景 ](#使用场景-使用场景-4)
    - [API ](#api-api-4)
  - [🔓 `RwLock<T>` - 读写锁（多线程） ](#-rwlockt---读写锁多线程--rwlock---读写锁多线程)
    - [基本用法 ](#基本用法-基本用法-5)
    - [使用场景 ](#使用场景-使用场景-5)
    - [API ](#api-api-5)
  - [🔗 `Weak<T>` - 弱引用 ](#-weakt---弱引用--weak---弱引用)
    - [基本用法 ](#基本用法-基本用法-6)
    - [使用场景 ](#使用场景-使用场景-6)
    - [API ](#api-api-6)
  - [🔄 组合模式 ](#-组合模式--组合模式)
