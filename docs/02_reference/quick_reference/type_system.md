...
- [🔷 Rust 类型系统速查卡 ](#-rust-类型系统速查卡--rust-类型系统速查卡)
  - [📋 目录 ](#-目录--目录)
  - [🎯 核心概念 ](#-核心概念--核心概念)
    - [类型安全三支柱](#类型安全三支柱)
  - [📐 基本类型速查 ](#-基本类型速查--基本类型速查)
    - [标量类型](#标量类型)
    - [复合类型](#复合类型)
  - [🏗️ Trait 系统 ](#️-trait-系统-️-trait-系统)
    - [定义与实现](#定义与实现)
