...
>
- [网络编程快速参考卡片 {#网络编程快速参考卡片}](#网络编程快速参考卡片-网络编程快速参考卡片)
  - [📑 目录 {#目录}](#-目录-目录)
  - [🚀 快速开始 {#快速开始}](#-快速开始-快速开始)
    - [HTTP 客户端 {#http-客户端-1}](#http-客户端-http-客户端-1)
    - [TCP 服务器 {#tcp-服务器}](#tcp-服务器-tcp-服务器)
  - [📋 常用 API {#常用-api}](#-常用-api-常用-api)
    - [HTTP 客户端 {#http-客户端-1}](#http-客户端-http-客户端-1-1)
    - [TCP/UDP {#tcpudp}](#tcpudp-tcpudp)
    - [WebSocket {#websocket}](#websocket-websocket)
    - [DNS 解析 {#dns-解析}](#dns-解析-dns-解析)
  - [🔧 配置选项 {#配置选项}](#-配置选项-配置选项)
    - [HTTP 客户端配置 {#http-客户端配置}](#http-客户端配置-http-客户端配置)
    - [TCP 服务器配置 {#tcp-服务器配置}](#tcp-服务器配置-tcp-服务器配置)
  - [⚡ 异步模式 {#异步模式}](#-异步模式-异步模式)
    - [并发处理多个请求 {#并发处理多个请求}](#并发处理多个请求-并发处理多个请求)
    - [流式处理 {#流式处理}](#流式处理-流式处理)
  - [🐛 错误处理 {#错误处理}](#-错误处理-错误处理)
  - [🔒 安全特性 {#安全特性}](#-安全特性-安全特性)
    - [HTTPS/TLS {#httpstls}](#httpstls-httpstls)
    - [认证 {#认证}](#认证-认证)
  - [📊 性能优化 {#性能优化}](#-性能优化-性能优化)
    - [连接池 {#连接池}](#连接池-连接池)
    - [压缩 {#压缩}](#压缩-压缩)
  - [🚫 反例速查 {#反例速查}](#-反例速查-反例速查)
    - [反例 1: 忽略连接错误 {#反例-1-忽略连接错误}](#反例-1-忽略连接错误-反例-1-忽略连接错误)
    - [反例 2: 未设置超时导致无限阻塞 {#反例-2-未设置超时导致无限阻塞}](#反例-2-未设置超时导致无限阻塞-反例-2-未设置超时导致无限阻塞)
  - [📚 相关文档 {#相关文档}](#-相关文档-相关文档)
  - [🧩 相关示例代码 {#相关示例代码}](#-相关示例代码-相关示例代码)
  - [🎯 使用场景 {#使用场景}](#-使用场景-使用场景)
    - [场景 1: REST API 客户端 {#场景-1-rest-api-客户端}](#场景-1-rest-api-客户端-场景-1-rest-api-客户端)
    - [场景 2: 实时聊天服务器 {#场景-2-实时聊天服务器}](#场景-2-实时聊天服务器-场景-2-实时聊天服务器)
    - [场景 3: 高性能代理服务器 {#场景-3-高性能代理服务器}](#场景-3-高性能代理服务器-场景-3-高性能代理服务器)
  ...
  - [Rust 1.95+ 在网络编程中的深度应用 {#rust-195-在网络编程中的深度应用}](#rust-195-在网络编程中的深度应用-rust-195-在网络编程中的深度应用)
    - [ControlFlow 在请求处理管道中的应用 {#controlflow-在请求处理管道中的应用}](#controlflow-在请求处理管道中的应用-controlflow-在请求处理管道中的应用)
    - [LazyLock 在连接池管理中的应用 {#lazylock-在连接池管理中的应用}](#lazylock-在连接池管理中的应用-lazylock-在连接池管理中的应用)
...
/// HTTP 中间件链
pub fn process_request(req: Request) -> ControlFlow<Response, Request> {
    let req = auth_middleware(req)?;
    let req = rate_limit_middleware(req)?;
...
/// 全局连接池（延迟初始化）
static CONNECTION_POOL: LazyLock<Pool> = LazyLock::new(|| {
    Pool::builder()
        .max_size(100)
        .build()
