...
- [🦀 所有权系统速查卡 ](#-所有权系统速查卡--所有权系统速查卡)
  - [📋 目录 ](#-目录--目录)
  - [🧠 所有权系统思维导图](#-所有权系统思维导图)
  - [📊 概念定义-属性关系-解释论证](#-概念定义-属性关系-解释论证)
  - [📐 三大规则（核心） ](#-三大规则核心--三大规则核心)
    - [所有权转移决策树](#所有权转移决策树)
  - [🎯 常见模式速查 ](#-常见模式速查--常见模式速查)
  ...
  - [🌳 决策树 ](#-决策树--决策树)
  - [⚡ 常见错误与解决 ](#-常见错误与解决--常见错误与解决)
    - [错误 1: 借用检查器错误](#错误-1-借用检查器错误)
    - [错误 2: 悬垂引用](#错误-2-悬垂引用)
    - [错误 3: 循环中的借用](#错误-3-循环中的借用)
  - [🏗️ 智能指针速查 ](#️-智能指针速查-️-智能指针速查)
    - [`Box<T>` - 堆分配](#boxt---堆分配)
  ...
  - [🎓 生命周期速查 ](#-生命周期速查--生命周期速查)
    - [基本语法](#基本语法)
    - [生命周期省略规则](#生命周期省略规则)
  - [📊 性能提示 ](#-性能提示--性能提示)
    - [✅ 高效模式 ](#-高效模式--高效模式)
    - [⚠️ 低效模式 ](#️-低效模式-️-低效模式)
  - [🚫 反例速查 ](#-反例速查--反例速查)
  ...
  - [🆕 Rust 1.92.0 内存优化 ](#-rust-1920-内存优化--rust-1920-内存优化)
    - [内存分配优化](#内存分配优化)
  - [📚 相关文档 ](#-相关文档--相关文档)
