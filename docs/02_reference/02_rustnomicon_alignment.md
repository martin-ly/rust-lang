...
>
- [The Rustonomicon 内容对齐 {#the-rustonomicon-内容对齐}](#the-rustonomicon-内容对齐-the-rustonomicon-内容对齐)
  - [📑 目录 {#目录}](#-目录-目录)
  - [已覆盖内容 {#已覆盖内容}](#已覆盖内容-已覆盖内容)
  - [新增补齐内容 {#新增补齐内容}](#新增补齐内容-新增补齐内容)
    - [c01: 布局保证 (align, size) {#c01-布局保证-align-size}](#c01-布局保证-align-size-c01-布局保证-align-size)
    - [c12: FFI 高级用法 {#c12-ffi-高级用法}](#c12-ffi-高级用法-c12-ffi-高级用法)
    - [c13: 裸指针、volatile、内联汇编 {#c13-裸指针volatile内联汇编}](#c13-裸指针volatile内联汇编-c13-裸指针volatile内联汇编)
...
>
> **权威来源对齐变更日志**: 2026-05-19 新增 Rustonomicon 官方文档来源标注 [Authority Source Sprint Batch 8](../../concept/00_meta/02_sources/05_international_authority_index.md)
