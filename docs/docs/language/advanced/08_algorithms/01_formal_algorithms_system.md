...
- [Rust算法系统形式化理论](#rust算法系统形式化理论)
  ...
  - [2. 算法基础理论](#2-算法基础理论)
    - [2.1 计算模型](#21-计算模型)
    - [2.2 Rust算法特性](#22-rust算法特性)
  - [3. 排序算法](#3-排序算法)
    - [3.1 排序问题定义](#31-排序问题定义)
    - [3.2 快速排序](#32-快速排序)
    - [3.3 归并排序](#33-归并排序)
  - [4. 搜索算法](#4-搜索算法)
    ...
    - [4.3 线性搜索](#43-线性搜索)
  - [5. 图论算法](#5-图论算法)
    - [5.1 图的基本定义](#51-图的基本定义)
    - [5.2 广度优先搜索](#52-广度优先搜索)
    - [5.3 深度优先搜索](#53-深度优先搜索)
    - [5.4 Dijkstra算法](#54-dijkstra算法)
  - [6. 数值算法](#6-数值算法)
  ...
  - [9. 形式化语义](#9-形式化语义)
    ...
    - [9.3 不变量](#93-不变量)
  - [10. 正确性证明](#10-正确性证明)
    - [10.1 排序算法正确性](#101-排序算法正确性)
    - [10.2 搜索算法正确性](#102-搜索算法正确性)
    - [10.3 图算法正确性](#103-图算法正确性)
  - [11. 参考文献](#11-参考文献)

## 1. 引言

Rust的算法系统是计算机科学理论在实践中的体现，通过类型系统和所有权模型提供了安全、高效的算法实现。
从形式化角度看，算法可以被建模为状态转换系统，其中每个操作都受到类型系统的严格约束。
