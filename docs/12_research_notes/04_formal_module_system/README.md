...
| 文件 | 说明 | 状态 |
| :--- | :--- | :--- |
| [01_formalization_ecology_mindmap.md](01_formalization_ecology_mindmap.md) | Rust 形式化验证生态思维导图 | 已从 archive 迁回，待升级到 Rust 1.96+ |
| [02_module_system_specification.md](02_module_system_specification.md) | 模块系统规范：crate/module/path/use/visibility | ✅ 已完成 |
| [03_linkage_and_symbols.md](03_linkage_and_symbols.md) | Linkage、extern crate、crate-type、符号可见性 | ✅ 已完成 |
| [04_module_hir_mir_mapping.md](04_module_hir_mir_mapping.md) | 模块结构到 HIR / MIR 的映射 | ✅ 已完成 |
| [05_module_safety_abstraction.md](05_module_safety_abstraction.md) | 模块系统与安全抽象边界 | ✅ 已完成 |
| [06_formal_tools_module_mapping.md](06_formal_tools_module_mapping.md) | Aeneas / coq-of-rust / RustBelt 中的模块处理 | ✅ 已完成 |
...
- [知识图谱索引](../06_concept_models/13_knowledge_graph_index.md) — 模块系统在整个知识体系中的层级定位与关系边
- [跨文档映射网络](../06_concept_models/09_cross_reference_index.md) — 层级-主题-文档三维矩阵
- [层次化梳理与映射总结](../06_concept_models/12_hierarchical_mapping_and_summary.md) — 概念族↔文档↔定理映射
- [Rust Book 对齐](../01_alignment_matrices/32_rust_book_alignment.md) — TRPL Ch 7 模块系统映射
- [形式化方法索引](../02_formal_methods)
- [研究笔记主索引](../README.md)
- [Crate 架构分析](../08_software_design_theory/08_crate_architectures)
