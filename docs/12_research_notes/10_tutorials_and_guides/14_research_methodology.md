...
- [研究方法论 {#研究方法论}](#研究方法论-研究方法论)
  ...
  - [📚 研究方法 {#研究方法}](#-研究方法-研究方法)
    - [1. 形式化研究方法 {#1-形式化研究方法}](#1-形式化研究方法-1-形式化研究方法)
    - [2. 实验研究方法 {#2-实验研究方法}](#2-实验研究方法-2-实验研究方法)
    - [3. 实证研究方法 {#3-实证研究方法}](#3-实证研究方法-3-实证研究方法)
    - [1.1 形式化研究方法详解 {#11-形式化研究方法详解}](#11-形式化研究方法详解-11-形式化研究方法详解)
    - [Rust 形式化方法的国际论文与工具链 {#rust-形式化方法的国际论文与工具链}](#rust-形式化方法的国际论文与工具链-rust-形式化方法的国际论文与工具链)
    - [Iris/RustBelt 风格 Coq 示例 {#irisrustbelt-风格-coq-示例}](#irisrustbelt-风格-coq-示例-irisrustbelt-风格-coq-示例)
    - [Lean 4 / Aeneas 后端示例 {#lean-4-aeneas-后端示例}](#lean-4--aeneas-后端示例-lean-4-aeneas-后端示例)
    - [相关概念 {#相关概念}](#相关概念-相关概念)
    - [理论背景 {#理论背景}](#理论背景-理论背景)
    - [4. 理论研究方法 {#4-理论研究方法}](#4-理论研究方法-4-理论研究方法)
    - [2.1 实验研究方法要点 {#21-实验研究方法要点}](#21-实验研究方法要点-21-实验研究方法要点)
    - [3.1 实证研究方法要点 {#31-实证研究方法要点}](#31-实证研究方法要点-31-实证研究方法要点)
    - [4.1 理论研究方法要点 {#41-理论研究方法要点}](#41-理论研究方法要点-41-理论研究方法要点)
  - [🔬 研究工具 {#研究工具}](#-研究工具-研究工具)
    - [分析工具 {#分析工具}](#分析工具-分析工具)
    - [验证工具 {#验证工具}](#验证工具-验证工具)
    - [实验工具 {#实验工具}](#实验工具-实验工具)
    - [数据收集工具 {#数据收集工具}](#数据收集工具-数据收集工具)
  - [💻 实践指南 {#实践指南}](#-实践指南-实践指南)
    - [研究设计 {#研究设计}](#研究设计-研究设计)
    - [数据收集 {#数据收集}](#数据收集-数据收集)
    - [结果分析 {#结果分析}](#结果分析-结果分析)
  ...
  - [📐 质量评估标准与研究模板 {#质量评估标准与研究模板}](#-质量评估标准与研究模板-质量评估标准与研究模板)
    - [质量评估标准 {#质量评估标准}](#质量评估标准-质量评估标准)
    - [研究模板 {#研究模板}](#研究模板-研究模板)
  - [🔗 工具集成与案例研究索引 {#工具集成与案例研究索引}](#-工具集成与案例研究索引-工具集成与案例研究索引)
    - [工具集成 {#工具集成}](#工具集成-工具集成)
    - [工具使用要点 {#工具使用要点}](#工具使用要点-工具使用要点)
    - [案例研究索引 {#案例研究索引}](#案例研究索引-案例研究索引)
  - [📖 参考文献 {#参考文献}](#-参考文献-参考文献)
    - [方法论文献 {#方法论文献}](#方法论文献-方法论文献)
    - [工具文档 {#工具文档}](#工具文档-工具文档)
    - [最佳实践 {#最佳实践}](#最佳实践-最佳实践)
  - [🔄 研究进展 {#研究进展}](#-研究进展-研究进展)
    - [已完成 ✅ {#已完成}](#已完成--已完成)
...
**Axiom RM1**：形式化证明保证正确性；实验验证提供经验支持；二者互补，不可相互替代。见 [experiments/README](../09_experiments/README.md) 推论 EX-C1。

**定理 RM-T1（方法衔接）**：若研究 $Q$ 的形式化定理 $T$ 有证明，且实验 $E$ 验证 $T$，则 $Q$ 的结果可追溯至 [PROOF_INDEX](../03_formal_proofs/21_proof_index.md) 与 [FORMAL_PROOF_SYSTEM_GUIDE](../03_formal_proofs/16_formal_proof_system_guide.md) 的论证链。

*证明*：由 [experiments/README](../09_experiments/README.md) 定理 EX-T1；实验验证与定理结论一致；形式化证明在 PROOF_INDEX 可查。∎
...
- **详见**：[10_performance_benchmarks.md](../09_experiments/05_performance_benchmarks.md) 的「数据收集执行指南」与「结果分析模板」。
...
- **模式**：归纳「所有权（Ownership）/借用（Borrowing）/并发/异步（Async）」等在项目中的用法与坑点。
- **详见**：[11_practical_applications.md](11_practical_applications.md) 的「案例报告模板」与「案例快速索引」。
...
- **详见**： [10_type_system_foundations.md](../05_type_theory/05_type_system_foundations.md)、[10_trait_system_formalization.md](../05_type_theory/04_trait_system_formalization.md)、[10_borrow_checker_proof.md](../02_formal_methods/03_borrow_checker_proof.md)。
...
- **交叉引用（Reference）**：与 [formal_methods](../02_formal_methods/README.md)、[type_theory](../05_type_theory/README.md)、[experiments](../09_experiments/README.md)、[practical_applications](11_practical_applications.md) 的关联明确。
...
- **与 [16_tools_guide.md](16_tools_guide.md)**：本「研究工具」中的 Clippy、Miri、Criterion、Valgrind、perf 等，安装、常用参数与样例见 TOOLS_GUIDE。
- **与各实验**： [performance_benchmarks](../09_experiments/05_performance_benchmarks.md)、
- [memory_analysis](../09_experiments/04_memory_analysis.md)、
- [compiler_optimizations](../09_experiments/01_compiler_optimizations.md)、
- [concurrency_performance](../09_experiments/02_concurrency_performance.md)、
- [macro_expansion_performance](../09_experiments/03_macro_expansion_performance.md) 的「数据收集执行指南」即工具在具体研究中的集成方式；
...
- **cargo expand / bloat**：宏（Macro）展开与二进制体积分析；见 [macro_expansion_performance](../09_experiments/03_macro_expansion_performance.md)。
...
| 类型 | 文档 | 说明 |
| :--- | :--- | :--- |
| 形式化 | [ownership_model](../02_formal_methods/09_ownership_model.md), [borrow_checker_proof](../02_formal_methods/03_borrow_checker_proof.md), [async_state_machine](../02_formal_methods/02_async_state_machine.md), lifetime_formalization, [pin_self_referential](../02_formal_methods/10_pin_self_referential.md) | 形式化方法 + 证明/定理 + 系统集成 |
| 类型理论 | [type_system_foundations](../05_type_theory/05_type_system_foundations.md), [trait_system_formalization](../05_type_theory/04_trait_system_formalization.md), [lifetime_formalization](../05_type_theory/03_lifetime_formalization.md), [advanced_types](../05_type_theory/01_advanced_types.md), [variance_theory](../05_type_theory/06_variance_theory.md) | 类型、Trait、生命周期、型变 |
| 实验 | [performance_benchmarks](../09_experiments/05_performance_benchmarks.md), [memory_analysis](../09_experiments/04_memory_analysis.md), [compiler_optimizations](../09_experiments/01_compiler_optimizations.md), [concurrency_performance](../09_experiments/02_concurrency_performance.md), [macro_expansion_performance](../09_experiments/03_macro_expansion_performance.md) | 数据收集指南 + 结果分析模板 |
| 实证 | [practical_applications](11_practical_applications.md) | 案例报告模板 + 案例快速索引 + 最佳实践 |
...
- [研究工具使用指南](16_tools_guide.md) - 详细的工具安装和使用方法
...
- Rust 研究最佳实践
- 性能研究指南
- [形式化验证指南](https://doc.rust-lang.org/book/ch19-00-advanced-features.html)
...
>
> **权威来源对齐变更日志**: 2026-06-29 新增 RustBelt、Aeneas、RustHorn、Iris 等国际形式化方法来源 [Authority Source Sprint Batch 9](../../concept/00_meta/02_sources/05_international_authority_index.md)
