...
**与形式化衔接**：Prusti 可验证 [ownership_model](../02_formal_methods/09_ownership_model.md) 定理 T2（移动语义）、[borrow_checker_proof](../02_formal_methods/03_borrow_checker_proof.md) 定理 T1（借用（Borrowing）规则）；`#[requires]`/`#[ensures]` 对应前置/后置条件。
...
**与形式化衔接**：Kani 可验证 [borrow_checker_proof](../02_formal_methods/03_borrow_checker_proof.md) 无数据竞争、[ownership_model](../02_formal_methods/09_ownership_model.md) 内存安全（Memory Safety）；`kani::any()` 对应全称量化。
...
**与形式化衔接**：Miri 检测违反 [ownership_model](../02_formal_methods/09_ownership_model.md)、[borrow_checker_proof](../02_formal_methods/03_borrow_checker_proof.md) 的 UB；
与 [SAFE_UNSAFE_COMPREHENSIVE_ANALYSIS](../03_formal_proofs/28_safe_unsafe_comprehensive_analysis.md) 契约体系对应。
...
- [研究方法论](14_research_methodology.md) - 研究方法概述
- [实验研究索引](../09_experiments/README.md) - 实验研究工具
- [形式化方法索引](../02_formal_methods/README.md) - 形式化工具
