...
- **相关**: [借用检查器证明](../02_formal_methods/03_borrow_checker_proof.md)

**异步状态机 (Async State Machine)**:

- **定义**: 用于建模异步（Async）程序执行的状态机
- **应用**: Rust 的 async/await 机制可以转换为状态机
- **相关**: [异步状态机形式化](../02_formal_methods/02_async_state_machine.md)
...
- **相关**: [所有权模型形式化](../02_formal_methods/09_ownership_model.md)
...
- **应用**: 用于自引用类型和异步编程
- **相关**: [Pin 和自引用类型形式化](../02_formal_methods/10_pin_self_referential.md)

**过程宏 (Procedural Macro)**:

- **定义**: 在编译时执行的宏（Macro），可以生成代码
- **类型**: 函数式宏、派生宏、属性宏
- **相关**: [宏展开性能](../09_experiments/03_macro_expansion_performance.md)
...
- **相关**: [SAFE_UNSAFE_COMPREHENSIVE_ANALYSIS](../03_formal_proofs/28_safe_unsafe_comprehensive_analysis.md)
...
- **相关**: [Trait 系统形式化](../05_type_theory/04_trait_system_formalization.md)
...
- **示例**: `[T; N]` 中的 `N` 是常量泛型参数
- **相关**: [高级类型特性](../05_type_theory/01_advanced_types.md)

**协变 (Covariance)**:

- **定义**: 类型参数在子类型关系中的变化方向
- **示例**: `&'a T` 在 `'a` 上是协变的
- **相关**: [型变理论](../05_type_theory/06_variance_theory.md)
...
- **相关**: [性能基准测试](../09_experiments/05_performance_benchmarks.md)
...
- **定义**: 多线程程序的性能特征
- **考虑**: 线程开销、锁竞争、数据竞争
- **相关**: [并发性能](../09_experiments/02_concurrency_performance.md)
...
- **定义**: 通过实验验证假设的研究方法
- **步骤**: 假设、实验设计、数据收集、分析
- **相关**: [研究方法论](14_research_methodology.md)
...
- [研究方法论](14_research_methodology.md) - 研究方法框架
