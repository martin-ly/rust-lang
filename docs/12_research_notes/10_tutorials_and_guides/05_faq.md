...
2. 查看 [系统总结](../13_meta_reports/16_system_summary.md) 了解系统概览
3. 浏览 [快速参考](13_quick_reference.md) 查找感兴趣的主题
...
**简短回答**：按 [CONTENT_ENHANCEMENT](../13_meta_reports/08_content_enhancement.md) 的实质内容检查清单：形式化（Def/定理）、代码、场景、反例、衔接。

**详细说明**：

- **形式化**：含 Def、Axiom、定理及证明或证明思路
- **代码**：可运行 Rust 示例，对应某定理（如所有权（Ownership）移动对应 [ownership_model](../02_formal_methods/09_ownership_model.md) T2）
- **衔接**：与 [PROOF_INDEX](../03_formal_proofs/21_proof_index.md)、[formal_methods](../02_formal_methods/README.md) 有交叉引用（Reference）

**相关资源**：[BEST_PRACTICES](03_best_practices.md) Def BP2、实践对照表、[PROOF_INDEX](../03_formal_proofs/21_proof_index.md)
...
**简短回答**: 查看 [工具使用指南](16_tools_guide.md) 中的 Coq 部分。
...
**简短回答**: 查看 [工具使用指南](16_tools_guide.md) 中的 Criterion.rs 部分。
...
- [工具使用指南 - Criterion.rs](16_tools_guide.md#criterionrs)
- [性能基准测试](../09_experiments/05_performance_benchmarks.md)
...
- [形式化方法研究](../02_formal_methods/README.md)
- [研究方法论](14_research_methodology.md)
