...
3. **Rust's Type System**
   - 作者: Various
   - 摘要: Rust 类型系统的相关研究
   - 相关: [类型系统基础](../05_type_theory/05_type_system_foundations.md)
   - 形式化衔接: [00_completeness_gaps](../02_formal_methods/00_completeness_gaps.md)、[PROOF_INDEX](../03_formal_proofs/21_proof_index.md)
...
1. **Optimizing Rust Compiler Performance**
   ...
   - 摘要: Rust 编译器的性能优化技术
   - 相关: [编译器优化](../09_experiments/01_compiler_optimizations.md)
2. **Memory Management in Rust**
   - 作者: Various
   - 摘要: Rust 内存管理的研究
   - 相关: [内存分析](../09_experiments/04_memory_analysis.md)
...
- **Coq**
  ...
  - 描述: 交互式定理证明器
  - 相关: [工具使用指南 - Coq](16_tools_guide.md)
- **Lean**
  - 链接: <https://leanprover.github.io/>
  - 描述: 函数式编程语言和证明助手
  - 相关: [工具使用指南 - Lean](16_tools_guide.md)
- **Prusti**
  - 链接: <https://www.pm.inf.ethz.ch/research/prusti.html>
  - 描述: Rust 的形式化验证工具
  - 相关: [工具使用指南 - Prusti](16_tools_guide.md#prusti)
- **Kani**
  - 链接: <https://github.com/model-checking/kani>
  - 描述: Rust 的模型检查工具
  - 相关: [工具使用指南 - Kani](16_tools_guide.md#kani)
...
- **Criterion.rs**
  ...
  - 描述: Rust 的基准测试框架
  - 相关: [工具使用指南 - Criterion.rs](16_tools_guide.md#criterionrs)
- **perf**
  - 链接: <https://perf.wiki.kernel.org/>
  - 描述: Linux 性能分析工具
  - 相关: [工具使用指南 - perf](16_tools_guide.md#perf)
- **flamegraph**
  - 链接: <https://github.com/flamegraph-rs/flamegraph>
  - 描述: 性能分析可视化工具
  - 相关: [工具使用指南 - flamegraph](16_tools_guide.md#flamegraph)
...
- **Miri**
  ...
  - 描述: Rust 的 MIR 解释器
  - 相关: [工具使用指南 - Miri](16_tools_guide.md#miri)
- **Valgrind**
  - 链接: <https://valgrind.org/>
  - 描述: 内存调试和性能分析工具
  - 相关: [工具使用指南 - Valgrind](16_tools_guide.md#valgrind)
- **heaptrack**
  - 链接: <https://github.com/KDE/heaptrack>
  - 描述: 堆内存分析工具
  - 相关: [工具使用指南 - heaptrack](16_tools_guide.md#heaptrack)
...
- **Clippy**
  ...
  - 描述: Rust 代码检查工具
  - 相关: [工具使用指南 - Clippy](16_tools_guide.md#clippy)
- **rust-analyzer**
  - 链接: <https://rust-analyzer.github.io/>
  - 描述: Rust 语言服务器
  - 相关: [工具使用指南 - rust-analyzer](16_tools_guide.md#rust-analyzer)
- **cargo-expand**
  - 链接: <https://github.com/dtolnay/cargo-expand>
  - 描述: 宏（Macro）展开工具
  - 相关: [工具使用指南 - cargo-expand](16_tools_guide.md#cargo-expand)
...
详见 [PROOF_INDEX](../03_formal_proofs/21_proof_index.md) 全证明索引、

[INTERNATIONAL_FORMAL_VERIFICATION_INDEX](../03_formal_proofs/18_international_formal_verification_index.md) 国际对标、

[FORMAL_PROOF_CRITICAL_ANALYSIS_AND_PLAN_2026_02](../03_formal_proofs/15_formal_proof_critical_analysis_and_plan_2026_02.md) 批判性分析与推进计划、

[practical_applications](11_practical_applications.md) 案例与定理对应。
...
- [形式化方法研究](../02_formal_methods/README.md) - 形式化方法索引
- [类型理论研究](../05_type_theory/README.md) - 类型理论索引
- [实验研究](../09_experiments/README.md) - 实验研究索引
...
- [批判性分析与推进计划](../03_formal_proofs/15_formal_proof_critical_analysis_and_plan_2026_02.md) - 阶段 1–3 完成总结
