...
> **后置延伸**: [ROD 形式语义](../../../archive/rust-ownership-decidability/formal-foundations/README.md)（归档只读） · [concept L7 效果系统](../../../concept/07_future/02_preview_features/01_effects_system.md)
