...
- [型变参考文档](../../../crates/c02_type_system/docs/tier_03_references/03_variance_reference.md)
- [型变理论（本篇）](06_variance_theory.md)
...
`fn(T) -> U` 逆变等与 [type_system_foundations](05_type_system_foundations.md)

的 subtyping 及 [lifetime_formalization](03_lifetime_formalization.md) 的 $\ell <:$ 一致。
...
同理逆变、不变由 [variance_theory](06_variance_theory.md) T1–T4 保证。
