...
- [RustBelt 逐章对标 {#rustbelt-逐章对标}](#rustbelt-逐章对标-rustbelt-逐章对标)
  - [📑 目录 {#目录}](#-目录-目录)
...
| 类型安全 | type_system T3 | 同上；见 [CORE_THEOREMS_FULL_PROOFS](../03_formal_proofs/07_core_theorems_full_proofs.md) §4 |
