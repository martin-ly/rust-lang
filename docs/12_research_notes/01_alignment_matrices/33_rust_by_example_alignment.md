...
| Rust By Example 章节 | 项目文档/示例 | 状态 | 备注 |
|----------------------|---------------|------|------|
| [Ownership](https://doc.rust-lang.org/rust-by-example/scope.html) | [../02_formal_methods/09_ownership_model.md](../02_formal_methods/09_ownership_model.md) | ✅ | 作用域与所有权 |
| [Borrowing](https://doc.rust-lang.org/rust-by-example/scope/borrow.html) | [../02_formal_methods/17_ownership_counterexamples.md](../02_formal_methods/17_ownership_counterexamples.md) §2-§3 | ✅ | &T / &mut T |
| [Lifetimes](https://doc.rust-lang.org/rust-by-example/scope/lifetime.html) | [../05_type_theory/03_lifetime_formalization.md](../05_type_theory/03_lifetime_formalization.md) | ✅ | 生命周期标注 |
...
| Rust By Example 章节 | 项目文档/示例 | 状态 | 备注 |
|----------------------|---------------|------|------|
| [Generics](https://doc.rust-lang.org/rust-by-example/generics.html) | [../05_type_theory/04_trait_system_formalization.md](../05_type_theory/04_trait_system_formalization.md) | ✅ | 泛型 |
| [Traits](https://doc.rust-lang.org/rust-by-example/trait.html) | [../05_type_theory/04_trait_system_formalization.md](../05_type_theory/04_trait_system_formalization.md) | ✅ | trait 定义与实现 |
| [Trait Objects](https://doc.rust-lang.org/rust-by-example/trait/dyn.html) | [../05_type_theory/07_type_system_counterexamples.md](../05_type_theory/07_type_system_counterexamples.md) §3 | ✅ | dyn Trait |
| [Associated Items](https://doc.rust-lang.org/rust-by-example/generics/assoc_items.html) | [../05_type_theory/07_type_system_counterexamples.md](../05_type_theory/07_type_system_counterexamples.md) §6 | ✅ | 关联类型 |
...
| Rust By Example 章节 | 项目文档/示例 | 状态 | 备注 |
|----------------------|---------------|------|------|
| [Error Handling](https://doc.rust-lang.org/rust-by-example/error.html) | [../11_cheatsheets/02_error_handling_cheatsheet.md](../11_cheatsheets/02_error_handling_cheatsheet.md) | ✅ | Result / Option / ? |
| [panic!](https://doc.rust-lang.org/rust-by-example/error/panic.html) | [../02_formal_methods/18_unsafe_counterexamples.md](../02_formal_methods/18_unsafe_counterexamples.md) §2 | ✅ | RefCell borrow_mut panic |
...
| Rust By Example 章节 | 项目文档/示例 | 状态 | 备注 |
|----------------------|---------------|------|------|
| [Unsafe Operations](https://doc.rust-lang.org/rust-by-example/unsafe.html) | [../02_formal_methods/18_unsafe_counterexamples.md](../02_formal_methods/18_unsafe_counterexamples.md) | ✅ | unsafe 块 |
| [FFI](https://doc.rust-lang.org/rust-by-example/std_misc/ffi.html) | [../02_formal_methods/18_unsafe_counterexamples.md](../02_formal_methods/18_unsafe_counterexamples.md) §6 | ✅ | 外部函数接口 |
