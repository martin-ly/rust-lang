...
- [权威内容对齐状态报告 {#权威内容对齐状态报告}](#权威内容对齐状态报告-权威内容对齐状态报告)
  - [📑 目录 {#目录}](#-目录-目录)
  - [📊 对齐概览 {#对齐概览}](#-对齐概览-对齐概览)
    - [对齐统计 {#对齐统计}](#对齐统计-对齐统计)
    - [对齐维度覆盖 {#对齐维度覆盖}](#对齐维度覆盖-对齐维度覆盖)
  - [P0: 官方权威对齐 {#p0-官方权威对齐}](#p0-官方权威对齐-p0-官方权威对齐)
    - [The Rust Book 对齐 {#the-rust-book-对齐}](#the-rust-book-对齐-the-rust-book-对齐)
    - [Rust Reference 对齐 {#rust-reference-对齐}](#rust-reference-对齐-rust-reference-对齐)
    - [releases.rs 对齐 {#releasesrs-对齐}](#releasesrs-对齐-releasesrs-对齐)
  - [P1: 学术权威对齐 {#p1-学术权威对齐}](#p1-学术权威对齐-p1-学术权威对齐)
    - [RustBelt 对齐 {#rustbelt-对齐}](#rustbelt-对齐-rustbelt-对齐)
    - [形式化方法对齐 {#形式化方法对齐}](#形式化方法对齐-形式化方法对齐)
  - [P2: 社区权威对齐 {#p2-社区权威对齐}](#p2-社区权威对齐-p2-社区权威对齐)
  ...
  - [对齐标记示例 {#对齐标记示例}](#对齐标记示例-对齐标记示例)
    ...
    - [扩展标记格式 {#扩展标记格式}](#扩展标记格式-扩展标记格式)
  - [持续对齐机制 {#持续对齐机制}](#持续对齐机制-持续对齐机制)
    - [检查频率 {#检查频率}](#检查频率-检查频率)
    - [更新响应 {#更新响应}](#更新响应-更新响应)
  - [结论 {#结论}](#结论-结论)
...
| Hoare逻辑 | ../03_formal_proofs/16_formal_proof_system_guide.md | ✅ 一致 |
...
| 指南 | 对应项目文档 | 对齐状态 |
| :--- | :--- | :--- |
| 命名规范 | ../10_tutorials_and_guides/03_best_practices.md | ✅ 一致 |
