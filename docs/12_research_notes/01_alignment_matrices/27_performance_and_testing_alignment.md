...
- [性能优化与测试质量权威来源对齐矩阵 {#性能优化与测试质量权威来源对齐矩阵}](#性能优化与测试质量权威来源对齐矩阵-性能优化与测试质量权威来源对齐矩阵)
  - [目录 {#目录}](#目录-目录)
  - [一、对齐说明 {#一对齐说明}](#一对齐说明-一对齐说明)
  - [二、P0 官方权威来源 {#二p0-官方权威来源}](#二p0-官方权威来源-二p0-官方权威来源)
    - [2.1 Rust Performance Book {#21-rust-performance-book}](#21-rust-performance-book-21-rust-performance-book)
    - [2.2 Cargo 测试文档 {#22-cargo-测试文档}](#22-cargo-测试文档-22-cargo-测试文档)
    - [2.3 rustdoc 测试 {#23-rustdoc-测试}](#23-rustdoc-测试-23-rustdoc-测试)
    - [2.4 Miri {#24-miri}](#24-miri-24-miri)
  ...
  - [四、测试策略矩阵 {#四测试策略矩阵}](#四测试策略矩阵-四测试策略矩阵)
    ...
    - [4.2 Property-based / Fuzzing / Mutation {#42-property-based-fuzzing-mutation}](#42-property-based--fuzzing--mutation-42-property-based-fuzzing-mutation)
...
本文档将 `docs/12_research_notes/` 及项目代码库中的性能优化、测试质量内容与 P0 官方文档、P2 社区/行业权威工具建立对齐矩阵，确保：
...
|-----------------------|----------|------|------|
| [Benchmarking](https://nnethercote.github.io/perf-book/benchmarking.html) | [../09_experiments/05_performance_benchmarks.md](../09_experiments/05_performance_benchmarks.md) | ✅ | Criterion.rs、iai-callgrind、black_box |
| [Profiling](https://nnethercote.github.io/perf-book/profiling.html) | [../09_experiments/05_performance_benchmarks.md](../09_experiments/05_performance_benchmarks.md) §4-§5 | ✅ | perf、flamegraph、coprof |
| [Heap Allocations](https://nnethercote.github.io/perf-book/heap-allocations.html) | [../09_experiments/04_memory_analysis.md](../09_experiments/04_memory_analysis.md) | ✅ | 分配器、堆分配统计 |
| [Inlining](https://nnethercote.github.io/perf-book/inlining.html) | [../09_experiments/01_compiler_optimizations.md](../09_experiments/01_compiler_optimizations.md) | ✅ | `#[inline]`、LTO、codegen-units |
| [Parallelism](https://nnethercote.github.io/perf-book/parallelism.html) | [../09_experiments/02_concurrency_performance.md](../09_experiments/02_concurrency_performance.md) | ✅ | 并发基准、Rayon、tokio |
| [Compiler Options](https://nnethercote.github.io/perf-book/build-configuration.html) | [../09_experiments/01_compiler_optimizations.md](../09_experiments/01_compiler_optimizations.md) §3 | ✅ | release 配置、profile |
...
|--------------|----------|------|------|
| [Documentation tests](https://doc.rust-lang.org/rustdoc/write-documentation/documentation-tests.html) | [docs/09_toolchain/02_rustdoc_advanced.md](../../09_toolchain/02_rustdoc_advanced.md) | ✅ | doctests、隐藏代码、属性 |
| [Test attributes](https://doc.rust-lang.org/rustdoc/write-documentation/documentation-tests.html#attributes) | [docs/09_toolchain/02_rustdoc_advanced.md](../../09_toolchain/02_rustdoc_advanced.md) | ✅ | `ignore`、`no_run`、`should_panic` |

### 2.4 Miri {#24-miri}

| Miri 主题 | 项目文档 | 状态 | 备注 |
|-----------|----------|------|------|
| [Undefined Behavior detection](https://github.com/rust-lang/miri) | [../03_formal_proofs/28_safe_unsafe_comprehensive_analysis.md](../03_formal_proofs/28_safe_unsafe_comprehensive_analysis.md) | ✅ | 栈借用（Borrowing）、数据竞争检测 |
| [Concurrency with Miri](https://github.com/rust-lang/miri#miri-) | [../02_formal_methods/16_concurrency_async_counterexamples.md](../02_formal_methods/16_concurrency_async_counterexamples.md) | ✅ | 异步（Async）/并发 UB 检测 |
| [Foreign Function Interface](https://github.com/rust-lang/miri#miri-) | [../02_formal_methods/18_unsafe_counterexamples.md](../02_formal_methods/18_unsafe_counterexamples.md) | 🔄 | FFI 行为检测 |

### 2.5 Clippy {#25-clippy}

| Clippy 主题 | 项目文档 | 状态 | 备注 |
|-------------|----------|------|------|
| [Lint categories](https://doc.rust-lang.org/clippy/) | [../10_tutorials_and_guides/16_tools_guide.md](../10_tutorials_and_guides/16_tools_guide.md) | ✅ | correctness、suspicious、perf、style |
| [Performance lints](https://rust-lang.github.io/rust-clippy/master/index.html) | [../09_experiments/01_compiler_optimizations.md](../09_experiments/01_compiler_optimizations.md) | ✅ | `clippy::perf` 家族 |
| [Configuration](https://doc.rust-lang.org/clippy/usage.html#clippy-configuration) | [../10_tutorials_and_guides/16_tools_guide.md](../10_tutorials_and_guides/16_tools_guide.md) | ✅ | `.clippy.toml`、允许/拒绝规则 |
...
| 工具/来源 | 类型 | 项目文档 | 状态 | 备注 |
|-----------|------|----------|------|------|
| [Criterion.rs Book](https://bheisler.github.io/criterion.rs/book/) | 基准测试框架 | [../09_experiments/05_performance_benchmarks.md](../09_experiments/05_performance_benchmarks.md) | ✅ | 统计驱动基准 |
| [cargo-bench](https://doc.rust-lang.org/cargo/commands/cargo-bench.html) | Cargo 子命令 | [../09_experiments/05_performance_benchmarks.md](../09_experiments/05_performance_benchmarks.md) | ✅ | libtest bench / criterion 集成 |
| [iai-callgrind](https://github.com/iai-callgrind/iai-callgrind) | 指令计数基准 | [../09_experiments/05_performance_benchmarks.md](../09_experiments/05_performance_benchmarks.md) §3 | ✅ | 稳定、低噪声微基准 |
| [flamegraph](https://github.com/flamegraph-rs/flamegraph) | 火焰图生成 | [../09_experiments/05_performance_benchmarks.md](../09_experiments/05_performance_benchmarks.md) §5 | ✅ | cargo flamegraph |
| [coz](https://github.com/plasma-umass/coz) | 因果性能分析 | [../09_experiments/05_performance_benchmarks.md](../09_experiments/05_performance_benchmarks.md) §5 | 🔄 | Linux causal profiling |
...
| 工具/来源 | 类型 | 项目文档 | 状态 | 备注 |
|-----------|------|----------|------|------|
| [valgrind](https://valgrind.org/) | 内存/性能分析 | [../09_experiments/04_memory_analysis.md](../09_experiments/04_memory_analysis.md) | ✅ | massif、cachegrind、callgrind |
| [AddressSanitizer](https://doc.rust-lang.org/unstable-book/compiler-flags/sanitizer.html#addresssanitizer) | 内存错误检测 | [../03_formal_proofs/28_safe_unsafe_comprehensive_analysis.md](../03_formal_proofs/28_safe_unsafe_comprehensive_analysis.md) | ✅ | `-Z sanitizer=address` |
| [ThreadSanitizer](https://doc.rust-lang.org/unstable-book/compiler-flags/sanitizer.html#threadsanitizer) | 数据竞争检测 | [../02_formal_methods/16_concurrency_async_counterexamples.md](../02_formal_methods/16_concurrency_async_counterexamples.md) | ✅ | `-Z sanitizer=thread` |
| [LeakSanitizer](https://doc.rust-lang.org/unstable-book/compiler-flags/sanitizer.html#leaksanitizer) | 内存泄漏检测 | [../09_experiments/04_memory_analysis.md](../09_experiments/04_memory_analysis.md) | ✅ | 与 ASan 联用 |
...
- [社区最佳实践对齐矩阵](17_community_best_practices_alignment.md)
- [工具链生态权威来源对齐矩阵](42_toolchain_ecosystem_alignment.md)
- [实验与性能研究反例](../09_experiments/06_experiments_counterexamples.md)
- [安全与 unsafe 权威来源对齐矩阵](40_safety_and_unsafe_authoritative_alignment.md)
