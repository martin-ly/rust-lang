...
本文档将 `docs/12_research_notes/` 及项目代码库中的 CI/CD、测试质量、供应链安全、发布签名内容与国际化权威来源建立映射，确保：
...
| 权威来源/主题 | 项目文档 | 状态 | 备注 |
|---------------|----------|------|------|
| [crates.io policies](https://crates.io/policies) | [15_cargo_book_alignment.md](15_cargo_book_alignment.md) | ✅ | 命名、 squatting、 安全披露 |
| [Publishing on crates.io](https://doc.rust-lang.org/cargo/reference/publishing.html) | [15_cargo_book_alignment.md](15_cargo_book_alignment.md) §7 | ✅ | `cargo publish`、metadata、SemVer |
...
| 主题 | 项目内部锚点 | 说明 |
|------|--------------|------|
| Cargo 发布与 SemVer | [15_cargo_book_alignment.md](15_cargo_book_alignment.md) | package、workspace、features、发布流程 |
| 工具链与 lint | [../10_tutorials_and_guides/16_tools_guide.md](../10_tutorials_and_guides/16_tools_guide.md) | rustfmt、clippy、rust-analyzer、cargo-expand |
...
- [性能优化与测试质量权威来源对齐矩阵](27_performance_and_testing_alignment.md)
- [安全与 unsafe 权威来源对齐矩阵](40_safety_and_unsafe_authoritative_alignment.md)
- [版本演进权威来源对齐矩阵](45_version_evolution_alignment.md)
