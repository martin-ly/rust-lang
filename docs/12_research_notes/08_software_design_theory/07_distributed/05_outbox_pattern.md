...
- [Outbox 模式形式化定义 {#outbox-模式形式化定义}](#outbox-模式形式化定义-outbox-模式形式化定义)
  - [📑 目录 {#目录}](#-目录-目录)
  - [1. 概念定义 (Def) {#1-概念定义-def}](#1-概念定义-def-1-概念定义-def)
    - [Def OB1: Outbox {#def-ob1-outbox}](#def-ob1-outbox-def-ob1-outbox)
    - [Def OB2: 事务边界 {#def-ob2-事务边界}](#def-ob2-事务边界-def-ob2-事务边界)
    - [Def OB3: 消息状态 {#def-ob3-消息状态}](#def-ob3-消息状态-def-ob3-消息状态)
  - [2. 基本假设 (Axiom) {#2-基本假设-axiom}](#2-基本假设-axiom-2-基本假设-axiom)
    - [Axiom OB1: 事务原子性 {#axiom-ob1-事务原子性}](#axiom-ob1-事务原子性-axiom-ob1-事务原子性)
    - [Axiom OB2: 中继幂等性 {#axiom-ob2-中继幂等性}](#axiom-ob2-中继幂等性-axiom-ob2-中继幂等性)
    - [Axiom OB3: 最终投递 {#axiom-ob3-最终投递}](#axiom-ob3-最终投递-axiom-ob3-最终投递)
  - [3. 定理 (Theorem) {#3-定理-theorem}](#3-定理-theorem-3-定理-theorem)
    - [Theorem OB1: 消息不丢失 {#theorem-ob1-消息不丢失}](#theorem-ob1-消息不丢失-theorem-ob1-消息不丢失)
    - [Theorem OB2: 消息不重复 {#theorem-ob2-消息不重复}](#theorem-ob2-消息不重复-theorem-ob2-消息不重复)
  - [4. Rust 实现示例 {#4-rust-实现示例}](#4-rust-实现示例-4-rust-实现示例)
  - [5. 与 Saga 模式的关系 {#5-与-saga-模式的关系}](#5-与-saga-模式的关系-5-与-saga-模式的关系)
