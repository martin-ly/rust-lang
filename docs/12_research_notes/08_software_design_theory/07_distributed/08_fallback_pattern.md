...
- [Fallback / Degrade 韧性模式 {#fallback-degrade-韧性模式}](#fallback--degrade-韧性模式-fallback-degrade-韧性模式)
  - [目录 {#目录}](#目录-目录)
  - [一、问题定义 {#一问题定义}](#一问题定义-一问题定义)
  - [二、核心定义 {#二核心定义}](#二核心定义-二核心定义)
    - [Def Fallback（回退） {#def-fallback回退}](#def-fallback回退-def-fallback回退)
    - [Def Degrade（降级） {#def-degrade降级}](#def-degrade降级-def-degrade降级)
    - [Fallback vs Degrade 对比 {#fallback-vs-degrade-对比}](#fallback-vs-degrade-对比-fallback-vs-degrade-对比)
  ...
  - [四、反例边界 {#四反例边界}](#四反例边界-四反例边界)
    - [反例 1：Fallback 级联失败 {#反例-1fallback-级联失败}](#反例-1fallback-级联失败-反例-1fallback-级联失败)
    - [反例 2：降级后不再恢复 {#反例-2降级后不再恢复}](#反例-2降级后不再恢复-反例-2降级后不再恢复)
  - [五、权威来源 {#五权威来源}](#五权威来源-五权威来源)
  - [六、相关概念 {#六相关概念}](#六相关概念-六相关概念)
...
- [../05_compositional_engineering/README.md](../05_compositional_engineering/README.md) — 服务组合与降级策略。
