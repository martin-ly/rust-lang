...
`Arc` 引用计数保证共享安全；由 [ownership_model](../../../02_formal_methods/09_ownership_model.md) 无悬垂。
...
由 FL-T1、FL-T2 及 [safe_unsafe_matrix](../../06_boundary_system/02_safe_unsafe_matrix.md) SBM-T1，得证。$\square$
...
| 模式 | 关系 |
| :--- | :--- |
| [Proxy](07_proxy.md) | Proxy 可包装 Flyweight 做延迟/缓存 |
| [Singleton](../01_creational/05_singleton.md) | 同为共享；Flyweight 按 key 共享，Singleton 全局唯一 |
