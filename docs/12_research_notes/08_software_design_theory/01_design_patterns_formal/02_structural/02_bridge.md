...
由 [trait_system_formalization](../../../05_type_theory/04_trait_system_formalization.md)，trait 对象或泛型保证类型安全。
...
由 BR-T1、BR-T2 及 [safe_unsafe_matrix](../../06_boundary_system/02_safe_unsafe_matrix.md) SBM-T1，得证。$\square$
...
| 模式 | 关系 |
| :--- | :--- |
| [Adapter](01_adapter.md) | Bridge 解耦；Adapter 适配已有接口 |
| [Strategy](../03_behavioral/09_strategy.md) | 实现可视为策略 |
| [Abstract Factory](../01_creational/01_abstract_factory.md) | 工厂可创建抽象+实现组合 |
