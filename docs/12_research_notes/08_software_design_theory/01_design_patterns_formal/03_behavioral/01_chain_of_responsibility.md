...
`Option<Box<Handler>>` 链由 [ownership_model](../../../02_formal_methods/09_ownership_model.md) 保证无悬垂。
...
递归或循环处理时借用规则满足；由 [borrow_checker_proof](../../../02_formal_methods/03_borrow_checker_proof.md)。
...
由 CR-T1、CR-T2 及 [safe_unsafe_matrix](../../06_boundary_system/02_safe_unsafe_matrix.md) SBM-T1，得证。$\square$
...
| 模式 | 关系 |
| :--- | :--- |
| [Command](02_command.md) | 链中每节点可封装为 Command |
| [Decorator](../02_structural/04_decorator.md) | 链式包装，但 Chain 为委托传递 |
| [Composite](../02_structural/03_composite.md) | 树结构 vs 链结构；可组合使用 |
