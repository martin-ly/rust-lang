...
- [与 ownership/borrow/trait 的衔接 {#与-ownershipborrowtrait-的衔接}](#与-ownershipborrowtrait-的衔接-与-ownershipborrowtrait-的衔接)
  ...
  - [多层次组合链条（实质内容） {#多层次组合链条实质内容}](#多层次组合链条实质内容-多层次组合链条实质内容)
    ...
    - [链条 2：Decorator + Strategy + Observer（完整实现） {#链条-2decorator-strategy-observer完整实现}](#链条-2decorator--strategy--observer完整实现-链条-2decorator-strategy-observer完整实现)
...
由 [ownership_model](../../02_formal_methods/09_ownership_model.md) 规则 1–3、[borrow_checker_proof](../../02_formal_methods/03_borrow_checker_proof.md) 规则 5–8。
...
*证明*：由 [async_state_machine](../../02_formal_methods/02_async_state_machine.md) T6.1–T6.3；Future 跨 await 点持有时，需 Send 才能跨线程。
...
组合软件工程有效性
        ...
        ├── 所有权：[ownership_model](../../02_formal_methods/09_ownership_model.md) T2, T3
        ...
        ├── 借用：[borrow_checker_proof](../../02_formal_methods/03_borrow_checker_proof.md) T1
        ...
        ├── 生命周期：lifetime_formalization T2
        ...
        ├── 类型系统：[type_system_foundations](../../05_type_theory/05_type_system_foundations.md) T1–T3
        ...
        └── 异步：[async_state_machine](../../02_formal_methods/02_async_state_machine.md) T6.1–T6.3
...
- [THEORETICAL_AND_ARGUMENTATION_SYSTEM_ARCHITECTURE](../../06_concept_models/16_theoretical_and_argumentation_system_architecture.md) § 1.2 理论族依赖
- [COMPREHENSIVE_SYSTEMATIC_OVERVIEW](../../13_meta_reports/06_comprehensive_systematic_overview.md) 概念族谱
