...
- [工作流：23 安全 vs 43 完全模型 {#工作流23-安全-vs-43-完全模型}](#工作流23-安全-vs-43-完全模型-工作流23-安全-vs-43-完全模型)
  ...
  - [使用流程 {#使用流程}](#使用流程-使用流程)
  - [快速参考 {#快速参考}](#快速参考-快速参考)
  - [层次推进阅读路径 {#层次推进阅读路径}](#层次推进阅读路径-层次推进阅读路径)
  - [23 vs 43 选型指南（实质内容） {#23-vs-43-选型指南实质内容}](#23-vs-43-选型指南实质内容-23-vs-43-选型指南实质内容)
  - [场景→模式→代码完整链条（实质内容） {#场景模式代码完整链条实质内容}](#场景模式代码完整链条实质内容-场景模式代码完整链条实质内容)
    - [链条 1：Web API 分层 {#链条-1web-api-分层}](#链条-1web-api-分层-链条-1web-api-分层)
    - [链条 2：可撤销编辑器 {#链条-2可撤销编辑器}](#链条-2可撤销编辑器-链条-2可撤销编辑器)
  - [工作流引擎表达力（状态机、补偿、Temporal 式） {#工作流引擎表达力状态机补偿temporal-式}](#工作流引擎表达力状态机补偿temporal-式-工作流引擎表达力状态机补偿temporal-式)
  - [权威对标 {#权威对标}](#权威对标-权威对标)
  - [23/43 与工作流关系（D3.4） {#2343-与工作流关系d34}](#2343-与工作流关系d34-2343-与工作流关系d34)
...
| [02_complete_43_catalog](01_complete_43_catalog.md) | 43 种完全模型索引 |
| `03_semantic_boundary_map` | 语义边界图 |
| [04_expressiveness_boundary](02_expressiveness_boundary.md) | 充分表达 vs 非充分表达论证 |
...
2. **查 43 完全**：扩展模式（Repository、DTO 等）→ [02_complete_43_catalog](01_complete_43_catalog.md)
3. **查语义边界**：选模式 → `03_semantic_boundary_map`
4. **查表达边界**：等价 vs 近似 → [04_expressiveness_boundary](02_expressiveness_boundary.md)
...
| 需持久化抽象 | 43 完全 → Repository | 见 [02_complete_43_catalog](01_complete_43_catalog.md) |
...
**扩展模式深入**：20 种扩展模式均有 Rust 实现、核心意图、与 23 安全的关系；见 [02_complete_43_catalog](01_complete_43_catalog.md) 扩展模式选型决策树。
...
**引用（Reference）**：[04_expressiveness_boundary 分布式模式](02_expressiveness_boundary.md#分布式模式形式化边界event-sourcingsagacqrs)、[06_boundary_analysis 并发选型](../04_execution_models/06_boundary_analysis.md)
...
**引用**：[03_execution_models](../04_execution_models/README.md)、[04_expressiveness_boundary](02_expressiveness_boundary.md) 工作流引擎表达力、[COMPREHENSIVE_ARGUMENTATION_GAP_ANALYSIS_AND_PLAN](../04_comprehensive_argumentation_gap_analysis_and_plan.md)。
