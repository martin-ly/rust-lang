...
**引用（Reference）**：[LANGUAGE_SEMANTICS_EXPRESSIVENESS](../../03_formal_proofs/20_language_semantics_expressiveness.md) EB1–EB6。
...
**论证**：由 [LANGUAGE_SEMANTICS_EXPRESSIVENESS](../../03_formal_proofs/20_language_semantics_expressiveness.md) 表达能力边界，Rust 故意限制此类能力以换取安全与可预测性。
...
**引用**：[06_boundary_analysis 并发选型](../04_execution_models/06_boundary_analysis.md)、[04_compositional_engineering](../05_compositional_engineering/README.md)
...
**Def WF3（补偿链）**：同 [05_distributed](../04_execution_models/05_distributed.md) Saga Def DI-SG1；$\mathit{Comp}_1 \circ \mathit{Comp}_2 \circ \cdots$。
...
**引用**：[02_workflow README 23/43 与工作流关系](README.md#2343-与工作流关系d34)、[05_distributed](../04_execution_models/05_distributed.md)。
...
- [LANGUAGE_SEMANTICS_EXPRESSIVENESS](../../03_formal_proofs/20_language_semantics_expressiveness.md)：边界定理 EB1–EB6
- [DESIGN_MECHANISM_RATIONALE](../../06_concept_models/10_design_mechanism_rationale.md)：设计机制理由
- [04_compositional_engineering 表达力×组合联合判定树](../05_compositional_engineering/README.md#表达力组合联合判定树支柱-23)：表达力与组合层级 L1–L4 联合选型
