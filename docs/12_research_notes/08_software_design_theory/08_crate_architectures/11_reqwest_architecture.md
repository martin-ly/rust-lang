...
> [Reqwest 官方文档](https://docs.rs/reqwest/latest/reqwest/blocking/index.html)(<https://docs.rs/reqwest/latest/reqwest/blocking/index.html>)
...
## 2. Builder 模式：从 Client 到 Response {#2-builder-模式从-client-到-response}
...
> [来源: Reqwest 官方文档 — ClientBuilder](https://docs.rs/reqwest/latest/reqwest/blocking/index.html)

### 2.2 `RequestBuilder`：请求构造层 {#22-requestbuilder请求构造层}
...
### 3.1 `reqwest_middleware` 扩展机制 {#31-reqwest_middleware-扩展机制}
...
> [reqwest-middleware crate 文档](https://docs.rs/reqwest-middleware/latest/reqwest_middleware/)(<https://docs.rs/reqwest-middleware/latest/reqwest_middleware/>)

---

## 4. 异步与同步双 API {#4-异步与同步双-api}

>
> **[来源: [Rust Reference](https://doc.rust-lang.org/reference/)]**

### 4.1 异步 API（默认） {#41-异步-api默认}
...
## 5. 连接池与 HTTP/2 {#5-连接池与-http2}

>
> **[来源: [Rustonomicon](https://doc.rust-lang.org/nomicon/)]**

### 5.1 Hyper 连接池机制 {#51-hyper-连接池机制}
...
> [Hyper 官方文档 — Client](https://docs.rs/hyper/latest/hyper/)(<https://docs.rs/hyper/latest/hyper/>)
...
### 6.1 JSON 与 Serde {#61-json-与-serde}
...
> [serde 官方文档](https://serde.rs/)(<https://docs.rs/serde/latest/serde/>)
...
- [Reqwest 官方文档](https://docs.rs/reqwest/latest/reqwest/blocking/index.html) — Client、RequestBuilder、Response API
