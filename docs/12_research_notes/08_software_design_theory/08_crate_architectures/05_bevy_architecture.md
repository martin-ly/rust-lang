...
> 若只需要使用指南与生态定位，请优先参考：
>
> - [游戏 ECS](../../../../concept/06_ecosystem/11_domain_applications/02_game_ecs.md)
...
# Bevy Crate 架构解构 {#bevy-crate-架构解构}

> **EN**: Bevy Architecture
> **Summary**: Bevy Crate 架构解构 Bevy Architecture.
>
> **最后更新**: 2026-06-09
> **概念族**: 软件设计 / Crate 架构
> **内容分级**: [归档级]
...
### 2.1 Entity = ID（薄手柄） {#21-entity-id薄手柄}
...
## 3. Archetype 存储：缓存友好的核心 {#3-archetype-存储缓存友好的核心}

>
> **[来源: [Rust Cookbook](https://rust-lang-nursery.github.io/rust-cookbook/)]**

### 3.1 Archetype 的定义 {#31-archetype-的定义}
...
## 4. System 调度图 {#4-system-调度图}

>
> **[来源: [The Rust Programming Language](https://doc.rust-lang.org/book/)]**

### 4.1 调度核心概念 {#41-调度核心概念}
...
### 5.1 Query 的 HRTB 设计 {#51-query-的-hrtb-设计}
...
### 7.1 ECS vs OOP 继承 {#71-ecs-vs-oop-继承}
...
| 设计决策 | Rust 特性 | 收益 |
|----------|-----------|------|
| Archetype 存储 | 泛型（Generics） + 类型擦除 | 缓存友好、零成本抽象（Zero-Cost Abstraction） |
| System 并行调度 | HRTB + Borrow Checker | 编译期数据竞争检测 |
| Query 安全借用 | 生命周期系统 | 无运行时借用检查开销 |
| Commands 延迟执行 | 所有权（Ownership） + Send | 线程安全的结构修改 |
...
- [Wgpu GPU 图形架构](13_wgpu_architecture.md)
