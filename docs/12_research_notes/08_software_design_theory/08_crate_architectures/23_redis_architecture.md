...
> [redis-rs Documentation](https://docs.rs/redis/latest/redis/aio/index.html)(<https://docs.rs/redis/latest/redis/aio/index.html>)
...
> [redis-rs Connection Docs](https://docs.rs/redis/latest/redis/aio/index.html)(<https://docs.rs/redis/latest/redis/aio/index.html>)
...
> [redis-rs aio Module](https://docs.rs/redis/latest/redis/aio/index.html)(<https://docs.rs/redis/latest/redis/aio/index.html>)
...
> [来源: redis-rs ConnectionManager](https://docs.rs/redis/latest/redis/aio/index.html)
...
> [redis-rs MultiplexedConnection](https://docs.rs/redis/latest/redis/aio/index.html)(<https://docs.rs/redis/latest/redis/aio/index.html>)
...
> [来源: redis-rs PubSub](https://docs.rs/redis/latest/redis/aio/index.html)
...
> [redis-rs Streams](https://docs.rs/redis/latest/redis/aio/index.html)(<https://docs.rs/redis/latest/redis/aio/index.html>)
...
> [来源: redis-rs Cluster](https://docs.rs/redis/latest/redis/aio/index.html)
...
> [redis-rs Pipeline](https://docs.rs/redis/latest/redis/aio/index.html)(<https://docs.rs/redis/latest/redis/aio/index.html>)
...
> [redis-rs FromRedisValue](https://docs.rs/redis/latest/redis/aio/index.html)(<https://docs.rs/redis/latest/redis/aio/index.html>)
...
> [c06_async Crate](https://github.com/rust-lang/rust)(<../../../../../crates/c06_async>)
...
- [并行与分布式模式谱系](../../../../concept/03_advanced/00_concurrency/08_parallel_distributed_pattern_spectrum.md)
- [事件驱动架构](../../../../concept/06_ecosystem/03_design_patterns/06_event_driven_architecture.md)
...
> **[来源: [redis-rs crates.io](https://crates.io/crates/redis)]**
> **[来源: [redis-rs docs.rs](https://docs.rs/redis/latest/redis/aio/index.html)]**
> **[来源: [redis-rs GitHub](https://github.com/redis-rs/redis-rs)]**
> **[来源: [Redis 官方命令参考](https://redis.io/commands)]**
> **[来源: [The Rust Programming Language](https://doc.rust-lang.org/book/)]**
> **权威来源**: [redis-rs crates.io](https://crates.io/crates/redis), [redis-rs docs.rs](https://docs.rs/redis/latest/redis/aio/index.html), [Redis 官方命令参考](https://redis.io/commands)
>
...
> **P0（官方/必读）**:
>
> - [来源: [redis-rs Documentation](https://docs.rs/redis/latest/redis/aio/index.html)]
> - [来源: [redis-rs crates.io](https://crates.io/crates/redis)]
