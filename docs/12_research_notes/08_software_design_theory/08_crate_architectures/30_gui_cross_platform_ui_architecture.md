...
- [21_ratatui_architecture.md](21_ratatui_architecture.md) — 终端 UI 框架对比
- [13_wgpu_architecture.md](13_wgpu_architecture.md) — 底层 GPU 渲染抽象
- [15_wasm_architecture.md](15_wasm_architecture.md) — WebAssembly 互操作基础
