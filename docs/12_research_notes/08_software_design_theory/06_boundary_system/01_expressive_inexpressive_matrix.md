...
由 [LANGUAGE_SEMANTICS_EXPRESSIVENESS](../../03_formal_proofs/20_language_semantics_expressiveness.md) EB1–EB3。
...
| 用 `static mut` 实现 Singleton 且多线程 | UB；违反 Safe 边界 | 见 [safe_unsafe_matrix](02_safe_unsafe_matrix.md) |
...
| 任意子类型 | 协变/逆变复杂 | 型变严格；见 [variance_theory](../../05_type_theory/06_variance_theory.md) |
...
- [LANGUAGE_SEMANTICS_EXPRESSIVENESS](../../03_formal_proofs/20_language_semantics_expressiveness.md)
- [DESIGN_MECHANISM_RATIONALE](../../06_concept_models/10_design_mechanism_rationale.md)
- [04_expressiveness_boundary 分布式模式形式化](../03_workflow_safe_complete_models/02_expressiveness_boundary.md#分布式模式形式化边界event-sourcingsagacqrs) — Event Sourcing、Saga、CQRS 与 Rust 表达力边界
