...
**引用**：见 [experiments/README](README.md) 定理 EX-T1、EX-T2；[FORMAL_PROOF_SYSTEM_GUIDE](../03_formal_proofs/16_formal_proof_system_guide.md)。
...
| 文档 | 链接 | 内容 |
| :--- | :--- | :--- |
| 内存分析 | [04_memory_analysis.md](04_memory_analysis.md) | 内存分配与使用分析 |
| 并发性能 | [02_concurrency_performance.md](02_concurrency_performance.md) | 并发性能研究 |
| 编译器优化 | [01_compiler_optimizations.md](01_compiler_optimizations.md) | 编译器优化研究 |
| 宏展开性能 | [03_macro_expansion_performance.md](03_macro_expansion_performance.md) | 宏展开性能分析 |
...
| 文档 | 链接 | 定理 |
| :--- | :--- | :--- |
| CORE_THEOREMS_FULL_PROOFS | [../03_formal_proofs/07_core_theorems_full_proofs.md](../03_formal_proofs/07_core_theorems_full_proofs.md) | 核心定理完整证明 |
...
| 文档 | 链接 | 内容 |
| :--- | :--- | :--- |
| 理论体系架构 | [../06_concept_models/16_theoretical_and_argumentation_system_architecture.md](../06_concept_models/16_theoretical_and_argumentation_system_architecture.md) | 四层理论体系 |
| 证明索引 | [../03_formal_proofs/21_proof_index.md](../03_formal_proofs/21_proof_index.md) | 形式化证明索引 |
| 系统总结 | [../13_meta_reports/16_system_summary.md](../13_meta_reports/16_system_summary.md) | 研究笔记系统总结 |
