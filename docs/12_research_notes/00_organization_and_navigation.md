...
| 我的目标 | 入口 | 预计时间 |
| :--- | :--- | :--- |
| **我想理解 Rust 形式化证明** | [FORMAL_FULL_MODEL_OVERVIEW](03_formal_proofs/12_formal_full_model_overview.md) → [CORE_THEOREMS_FULL_PROOFS](03_formal_proofs/07_core_theorems_full_proofs.md) | 30min |
| **我想查某个概念的证明/定义** | [QUICK_FIND](10_tutorials_and_guides/12_quick_find.md)（按关键词） | 2min |
| **我想选设计模式/并发模型** | [software_design_theory/00_MASTER_INDEX](08_software_design_theory/03_master_index.md) → 03_semantic_boundary_map、06_boundary_analysis | 15min |
| **我想理解权威对齐体系** | [AUTHORITATIVE_ALIGNMENT_GUIDE](01_alignment_matrices/06_authoritative_alignment_guide.md) | 10min |
| **三大支柱** | [AUTHORITATIVE_ALIGNMENT_GUIDE](01_alignment_matrices/06_authoritative_alignment_guide.md)（原 RESEARCH_PILLARS_AND_SUSTAINABLE_PLAN 已归档） | 10min |
| **我想看完整总结与论证脉络** | [00_COMPREHENSIVE_SUMMARY](13_meta_reports/05_comprehensive_summary.md) → [ARGUMENTATION_CHAIN_AND_FLOW](06_concept_models/02_argumentation_chain_and_flow.md) | 15min |
...
| **我想看目录缺失与内容深化计划** | [00_COMPREHENSIVE_SUMMARY](13_meta_reports/05_comprehensive_summary.md) | 10min |
| **我想查层次化映射（文档树/概念↔定理/文档↔思维表征）** | [HIERARCHICAL_MAPPING_AND_SUMMARY](06_concept_models/12_hierarchical_mapping_and_summary.md) | 5min |
...
| **我想贡献/维护** | [CONTRIBUTING](../../archive/07_research_notes/02_snapshot_2026_06_25/10_contributing.md) → [QUALITY_CHECKLIST](13_meta_reports/11_quality_checklist.md) | 5min |
...
本目录围绕 [AUTHORITATIVE_ALIGNMENT_GUIDE](01_alignment_matrices/06_authoritative_alignment_guide.md) 所述的三大支柱组织，现推荐参考 [AUTHORITATIVE_ALIGNMENT_GUIDE](01_alignment_matrices/06_authoritative_alignment_guide.md)：
...
├── 10_tutorials_and_guides/12_quick_find.md                       ← 按关键词/领域/目标快速查找
│
├── 【支柱 1 形式化】
│   ├── formal_methods/                 ← 所有权、借用、异步、Pin、Send/Sync（六篇并表）
│   ├── type_theory/                    ← 类型、Trait、型变
│   ├── 03_formal_proofs/12_formal_full_model_overview.md   ← 统一形式系统入口
│   ├── FORMAL_LANGUAGE_AND_PROOFS.md   ← 推理规则、操作语义
│   ├── 03_formal_proofs/07_core_theorems_full_proofs.md    ← T-OW2/T-BR1/T-TY3 证明
│   ├── 03_formal_proofs/21_proof_index.md                  ← 105+ 证明索引
│   └── coq_skeleton/                   ← Coq 骨架
│
├── 【支柱 2+3 设计与组合】
...
│   ├── 10_tutorials_and_guides/11_practical_applications.md
│   └── 10_tutorials_and_guides/14_research_methodology.md
│
└── 【导航/框架/指南】（按需查阅）
    ├── 13_meta_reports/05_comprehensive_summary.md      ← 完整总结综合、知识地图、论证总览
    ├── ARGUMENTATION_CHAIN_AND_FLOW.md  ← 论证思路、论证脉络关系、文档依赖
    ├── [AUTHORITATIVE_ALIGNMENT_GUIDE](01_alignment_matrices/06_authoritative_alignment_guide.md) - 权威对齐指南、技术决策参考
    ├── 13_meta_reports/03_classification.md                ← 按角色/层次/主题分类
    ├── RESEARCH_NOTES_CRITICAL_ANALYSIS_AND_IMPROVEMENT_PLAN.md  ← 批判性分析、层次化/矩阵/思维表征缺口、可持续改进计划
    ├── 06_concept_models/12_hierarchical_mapping_and_summary.md                      ← 文档树、概念↔文档↔Def/定理、文档↔思维表征映射
    ├── ARGUMENTATION_GAP_INDEX.md
    ├── 10_contributing.md、13_meta_reports/11_quality_checklist.md
    └── 其他运维/参考文档
```
...
| 想查「组合反例→错误码」 | [04_compositional_engineering](08_software_design_theory/05_compositional_engineering/README.md#组合反例编译错误映射ce-t1t2t3) |
| 想查「并发选型 Actor/channel/async」 | [06_boundary_analysis](08_software_design_theory/04_execution_models/06_boundary_analysis.md) |
...
新文档引用 FLS 或 releases 时可直接引用本小节；详见 [RUST_193_LANGUAGE_FEATURES_COMPREHENSIVE_ANALYSIS](12_version_research/01_rust_193_language_features_comprehensive_analysis.md) § 权威来源对齐。
...
| docs/02_learning 研究者路径 | RESEARCH_PILLARS、FORMAL_FULL_MODEL、CORE_THEOREMS |
| docs/11_project TASK_INDEX | RESEARCH_PILLARS 阶段任务、AENEAS_INTEGRATION_PLAN |
