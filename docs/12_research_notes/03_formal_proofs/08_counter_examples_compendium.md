...
- [反例汇编 (Counter-Examples Compendium) {#反例汇编-counter-examples-compendium}](#反例汇编-counter-examples-compendium-反例汇编-counter-examples-compendium)
  - [📑 目录 {#目录}](#-目录-目录)
  - [如何使用本文档 {#如何使用本文档}](#如何使用本文档-如何使用本文档)
  - [一、所有权反例 {#一所有权反例}](#一所有权反例-一所有权反例)
    - [反例 1.1: 使用已移动的值 {#反例-11-使用已移动的值}](#反例-11-使用已移动的值-反例-11-使用已移动的值)
    - [反例 1.2: 部分移动后的使用 {#反例-12-部分移动后的使用}](#反例-12-部分移动后的使用-反例-12-部分移动后的使用)
  - [二、借用反例 {#二借用反例}](#二借用反例-二借用反例)
    - [反例 2.1: 可变借用与不可变借用冲突 {#反例-21-可变借用与不可变借用冲突}](#反例-21-可变借用与不可变借用冲突-反例-21-可变借用与不可变借用冲突)
    - [反例 2.2: 多个可变借用 {#反例-22-多个可变借用}](#反例-22-多个可变借用-反例-22-多个可变借用)
    - [反例 2.3: 悬垂引用 {#反例-23-悬垂引用}](#反例-23-悬垂引用-反例-23-悬垂引用)
  - [三、生命周期反例 {#三生命周期反例}](#三生命周期反例-三生命周期反例)
    - [反例 3.1: 返回局部变量的引用 {#反例-31-返回局部变量的引用}](#反例-31-返回局部变量的引用-反例-31-返回局部变量的引用)
  - [四、Send/Sync反例 {#四sendsync反例}](#四sendsync反例-四sendsync反例)
    - [反例 4.1: Rc跨线程 {#反例-41-rc跨线程}](#反例-41-rc跨线程-反例-41-rc跨线程)
    - [反例 4.2: RefCell跨线程 {#反例-42-refcell跨线程}](#反例-42-refcell跨线程-反例-42-refcell跨线程)
  - [五、异步反例 {#五异步反例}](#五异步反例-五异步反例)
    - [反例 5.1: 跨await持有锁 {#反例-51-跨await持有锁}](#反例-51-跨await持有锁-反例-51-跨await持有锁)
  - [六、设计模式反例 {#六设计模式反例}](#六设计模式反例-六设计模式反例)
    - [反例 6.1: 尝试实现经典单例 {#反例-61-尝试实现经典单例}](#反例-61-尝试实现经典单例-反例-61-尝试实现经典单例)
  - [七、反例索引表 {#七反例索引表}](#七反例索引表-七反例索引表)
  - [八、从反例学习 {#八从反例学习}](#八从反例学习-八从反例学习)
    - [反例的教育价值 {#反例的教育价值}](#反例的教育价值-反例的教育价值)
    - [学习建议 {#学习建议}](#学习建议-学习建议)
