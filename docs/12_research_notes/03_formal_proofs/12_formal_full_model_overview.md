...
> **上位文档**: [FORMAL_PROOF_CRITICAL_ANALYSIS_AND_PLAN_2026_02](15_formal_proof_critical_analysis_and_plan_2026_02.md)、[THEORETICAL_AND_ARGUMENTATION_SYSTEM_ARCHITECTURE](../06_concept_models/16_theoretical_and_argumentation_system_architecture.md)
...
- [Rust 形式化全模型：统一形式系统入口 {#rust-形式化全模型统一形式系统入口}](#rust-形式化全模型统一形式系统入口-rust-形式化全模型统一形式系统入口)
  - [📑 目录 {#目录}](#-目录-目录)
  - [一、统一形式系统总览 {#一统一形式系统总览}](#一统一形式系统总览-一统一形式系统总览)
    - [1.1 核心机制与公理层 {#11-核心机制与公理层}](#11-核心机制与公理层-11-核心机制与公理层)
    - [1.2 定理依赖 DAG（简化） {#12-定理依赖-dag简化}](#12-定理依赖-dag简化-12-定理依赖-dag简化)
...
| 机制 | 公理/定义 | 子文档 |
| :--- | :--- | :--- |
| **所有权（Ownership）** | 规则 1–3：唯一所有者、移动转移、作用域结束释放 | [ownership_model](../02_formal_methods/09_ownership_model.md) |
| **借用（Borrowing）** | 规则 5–8：共享借用、可变借用（Mutable Borrow）、互斥、作用域 | [borrow_checker_proof](../02_formal_methods/03_borrow_checker_proof.md) |
| **生命周期** | Axiom LF1–LF2、Def 1.4、$\ell \subseteq \text{lft}$ | lifetime_formalization |
| **类型系统（Type System）** | 进展性、保持性、typing rules | [type_system_foundations](../05_type_theory/05_type_system_foundations.md) |
| **型变** | Def 1.1–3.1（协变、逆变、不变） | [variance_theory](../05_type_theory/06_variance_theory.md) |
| **Trait** | Axiom COH1/COH2、对象安全、impl 解析 | [trait_system_formalization](../05_type_theory/04_trait_system_formalization.md) |
| **异步（Async）** | Def 4.1–5.2（Future、Poll、Ready/Pending） | [async_state_machine](../02_formal_methods/02_async_state_machine.md) |
| **Pin** | Def 1.1–2.2（位置稳定、自引用（Reference）） | [pin_self_referential](../02_formal_methods/10_pin_self_referential.md) |
| **Send/Sync** | Def SEND1/SYNC1、SYNC-L1（$T:\text{Sync} \Leftrightarrow \&T:\text{Send}$）；SEND-T1/SYNC-T1 | [send_sync_formalization](../02_formal_methods/12_send_sync_formalization.md) |
| **控制流** | A-CF1：控制流归约保持类型与所有权 | [formal_methods/README](../02_formal_methods/README.md#控制流形式化) |
| **变量** | Def 1.4 绑定、Def 1.5 遮蔽 | [ownership_model](../02_formal_methods/09_ownership_model.md) |
...
| 子文档 | 本模型对应 | 定理编号 |
| :--- | :--- | :--- |
| [ownership_model](../02_formal_methods/09_ownership_model.md) | §2.1 内存与所有权、§2.3 A-BIND1/SHADOW1 | T2, T3, Def 1.4/1.5, RC-T1, … |
| [borrow_checker_proof](../02_formal_methods/03_borrow_checker_proof.md) | §2.1 A-BR1–4 | T1, T2, CHAN-T1, MUTEX-T1, … |
| lifetime_formalization | §2.2 A-LF1–2 | LF-T1, LF-T2, LF-T3 |
| [type_system_foundations](../05_type_theory/05_type_system_foundations.md) | §2.2 A-TY1–2 | T1–T5, LUB-T1, … |
| [variance_theory](../05_type_theory/06_variance_theory.md) | §2.2 A-VAR1–3 | T1–T4, VAR-COM-T1 |
| [trait_system_formalization](../05_type_theory/04_trait_system_formalization.md) | - | T1–T3, COH-T1, RPIT-T1, … |
| [async_state_machine](../02_formal_methods/02_async_state_machine.md) | §2.4 A-AS1–2 | T6.1–T6.3, SPAWN-T1 |
| [pin_self_referential](../02_formal_methods/10_pin_self_referential.md) | §2.4 A-PIN1–2 | T1–T3 |
| [04_compositional_engineering](../08_software_design_theory/05_compositional_engineering/README.md) | 组合层 | CE-T1–T3, CE-L1, CE-C1 |
| [UNIFIED_SYSTEMATIC_FRAMEWORK](../06_concept_models/17_unified_systematic_framework.md) | 顶层 | USF-T1, USF-C1 |
...
- [CORE_THEOREMS_FULL_PROOFS](07_core_theorems_full_proofs.md) — 核心定理 T-OW2、T-BR1、T-TY3 完整证明（L2）
- [FORMAL_LANGUAGE_AND_PROOFS](13_formal_language_and_proofs.md) — 形式语言与形式证明（推理规则、操作语义、判定形式）
- [FORMAL_FULL_MODEL_EN_SUMMARY](11_formal_full_model_en_summary.md) — 英文摘要
- [PROOF_INDEX](21_proof_index.md) — 105+ 证明索引、按深度导航
- [INTERNATIONAL_FORMAL_VERIFICATION_INDEX](18_international_formal_verification_index.md) — 国际对标
- [FORMAL_PROOF_CRITICAL_ANALYSIS_AND_PLAN_2026_02](15_formal_proof_critical_analysis_and_plan_2026_02.md) — 批判性分析与推进计划
