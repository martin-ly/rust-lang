...
> **状态**: ✅ 已完成
> **Source**: [07_core_theorems_full_proofs.md](07_core_theorems_full_proofs.md) (Chinese)
...
| **SEND-T1 / SYNC-T1** | Send ⇒ safe cross-thread transfer; Sync ⇒ safe cross-thread shared reference | Def SEND1/SYNC1, SYNC-L1 ($T:\text{Sync} \Leftrightarrow \&T:\text{Send}$); [send_sync_formalization](../02_formal_methods/12_send_sync_formalization.md) |
...
| SYNC-L1 | $T : \text{Sync} \Leftrightarrow \&T : \text{Send}$ (Rust std; [send_sync_formalization](../02_formal_methods/12_send_sync_formalization.md)) |
...
| SEND-T1 / SYNC-T1 | [send_sync_formalization](../02_formal_methods/12_send_sync_formalization.md) | L2 proofs in doc; no Coq skeleton yet |
...
- [FORMAL_LANGUAGE_AND_PROOFS](13_formal_language_and_proofs.md) — Formal language (inference rules, operational semantics, judgment forms) and mathematical proofs; complements Coq skeletons.
...
- [FORMAL_FULL_MODEL_OVERVIEW](12_formal_full_model_overview.md) — Unified formal system (incl. Send/Sync)
- [send_sync_formalization](../02_formal_methods/12_send_sync_formalization.md) — Send/Sync Def SEND1/SYNC1, SEND-T1/SYNC-T1, SEND-SYNC-T1
- [SAFE_DECIDABLE_MECHANISMS_OVERVIEW](27_safe_decidable_mechanisms_overview.md) — Safe decidable mechanisms (per-mechanism sections + 4-dim tables)
- [PROOF_INDEX](21_proof_index.md) — 105+ proof index
- [AENEAS_INTEGRATION_PLAN](01_aeneas_integration_plan.md) — Safe Rust → proof assistant
