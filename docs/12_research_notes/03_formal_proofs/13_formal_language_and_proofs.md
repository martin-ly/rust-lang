...
> **上位文档**: [CORE_THEOREMS_FULL_PROOFS](07_core_theorems_full_proofs.md)、[FORMAL_FULL_MODEL_OVERVIEW](12_formal_full_model_overview.md)
...
**与 Rust 的衔接**：形式语言为**数学规范层**；Rust 示例为**实现层**；见 [THEOREM_RUST_EXAMPLE_MAPPING](29_theorem_rust_example_mapping.md)。
