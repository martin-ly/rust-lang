...
| **Aeneas** | INRIA 等 | Safe Rust → Coq/F*/HOL4/Lean | `01_aeneas_integration_plan.md` |
...
- [证明索引](21_proof_index.md)
- [定理与证明策略汇编](30_theorems_and_proof_strategies.md)
- [L3 机器可检查证明实施指南](19_l3_machine_proof_guide.md)
- [国际 Rust 形式化验证成果对标索引](18_international_formal_verification_index.md)
- [形式化证明批判性分析与计划 2026-02](15_formal_proof_critical_analysis_and_plan_2026_02.md)
- [研究笔记主索引](../README.md)
- [上级目录](../README.md)
