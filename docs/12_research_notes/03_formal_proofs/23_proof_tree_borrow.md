...
- [借用证明树 (Proof Tree: Borrowing) {#借用证明树-proof-tree-borrowing}](#借用证明树-proof-tree-borrowing-借用证明树-proof-tree-borrowing)
  - [📑 目录 {#目录}](#-目录-目录)
  - [🌳 定理陈述 {#定理陈述}](#-定理陈述-定理陈述)
...
- [所有权（Ownership）证明树](24_proof_tree_ownership.md)
