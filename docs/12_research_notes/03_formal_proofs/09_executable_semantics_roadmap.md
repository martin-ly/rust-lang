...
> **参考**: [RustSEM (K-Framework, 2024)](https://link.springer.com/article/10.1007/s10703-024-00460-3)、[INTERNATIONAL_FORMAL_VERIFICATION_INDEX](18_international_formal_verification_index.md)
...
- [可执行语义路线图 {#可执行语义路线图}](#可执行语义路线图-可执行语义路线图)
  - [📑 目录 {#目录}](#-目录-目录)
  - [一、现状与目标 {#一现状与目标}](#一现状与目标-一现状与目标)
  - [二、可选技术路线 {#二可选技术路线}](#二可选技术路线-二可选技术路线)
    - [2.1 K-Framework {#21-k-framework}](#21-k-framework-21-k-framework)
    - [2.2 PLT Redex {#22-plt-redex}](#22-plt-redex-22-plt-redex)
    - [2.3 自研最小子集 {#23-自研最小子集}](#23-自研最小子集-23-自研最小子集)
  - [三、分阶段路线图 {#三分阶段路线图}](#三分阶段路线图-三分阶段路线图)
    - [阶段 1：调研（1–2 个月） {#阶段-1调研12-个月}](#阶段-1调研12-个月-阶段-1调研12-个月)
    - [阶段 2：最小可执行语义（2–3 个月） {#阶段-2最小可执行语义23-个月}](#阶段-2最小可执行语义23-个月-阶段-2最小可执行语义23-个月)
    - [阶段 3：扩展（按需） {#阶段-3扩展按需}](#阶段-3扩展按需-阶段-3扩展按需)
  - [四、与现有文档的衔接 {#四与现有文档的衔接}](#四与现有文档的衔接-四与现有文档的衔接)
  - [五、资源与依赖 {#五资源与依赖}](#五资源与依赖-五资源与依赖)
...
| 项目 | 说明 |
| :--- | :--- |
| **Racket 生态** | 小步语义、类型系统（Type System）、测试 |
...
| [FORMAL_FULL_MODEL_OVERVIEW](12_formal_full_model_overview.md) | 公理列表 → 语义规则 |
