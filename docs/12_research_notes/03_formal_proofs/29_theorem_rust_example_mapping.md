...
// 示例位置: docs/12_research_notes/08_software_design_theory/07_distributed/01_saga_pattern.md
...
// 示例位置: docs/12_research_notes/08_software_design_theory/07_distributed/03_circuit_breaker.md
...
// 示例位置: docs/12_research_notes/08_software_design_theory/02_workflow/01_workflow_state_machine.md
...
// 示例位置: docs/12_research_notes/08_software_design_theory/02_workflow/02_compensation_chain.md
...
- [核心定理完整证明](07_core_theorems_full_proofs.md)
- [所有权证明树](24_proof_tree_ownership.md)
- [借用证明树](23_proof_tree_borrow.md)
- [类型安全证明树](25_proof_tree_type_safety.md)
