...
> **状态**: ✅ 已完成
> **Source**: [12_formal_full_model_overview.md](12_formal_full_model_overview.md) (Chinese)
...
- [FORMAL_LANGUAGE_AND_PROOFS](13_formal_language_and_proofs.md) — Inference rules, operational semantics, judgment forms, formal proof derivations (mathematical level; complements Coq skeletons)
...
- [CORE_THEOREMS_FULL_PROOFS](07_core_theorems_full_proofs.md) — Full proofs for T-OW2, T-BR1, T-TY3 (L2)
- [PROOF_INDEX](21_proof_index.md) — 105+ proof index
- [INTERNATIONAL_FORMAL_VERIFICATION_INDEX](18_international_formal_verification_index.md) — International alignment
