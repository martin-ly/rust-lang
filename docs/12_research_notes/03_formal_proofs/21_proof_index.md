...
**本索引现状**: 多数为 L1；部分（如型变、组合工程、CORE_THEOREMS_FULL_PROOFS）为 L2；L3 骨架已创建（[coq_skeleton](../README.md) T-OW2/T-BR1/T-TY3，证明 Admitted 待补全），见 [COQ_ISABELLE_PROOF_SCAFFOLDING](../../../archive/07_research_notes/02_snapshot_2026_06_25/10_coq_isabelle_proof_scaffolding.md)、[FORMAL_LANGUAGE_AND_PROOFS](13_formal_language_and_proofs.md)。
...
| **L3** | Coq 骨架已创建 [coq_skeleton/OWNERSHIP_UNIQUENESS.v](../../../archive/05_formal_methods/04_coq_aeneas_deprecated/coq_skeleton/OWNERSHIP_UNIQUENESS.v)（归档只读）（证明 Admitted）；补全见 [COQ_ISABELLE_PROOF_SCAFFOLDING](../../../archive/07_research_notes/02_snapshot_2026_06_25/10_coq_isabelle_proof_scaffolding.md)、[L3_MACHINE_PROOF_GUIDE](19_l3_machine_proof_guide.md) |
