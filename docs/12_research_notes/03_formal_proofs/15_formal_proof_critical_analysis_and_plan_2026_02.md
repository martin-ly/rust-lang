...
4. **状态升级**：将 `21_proof_index.md`、`30_theorems_and_proof_strategies.md` 等状态更新为 ✅ 完成。
...
3. **知识沉淀**：将新定义/定理迁移到 `knowledge/` 与 `concept/`，保持 `docs/12_research_notes/` 与上层知识的单向依赖。
...
| :--- | :--- | :--- | :--- |
| λRust 操作语义 | `../02_formal_methods/09_ownership_model.md` | 无 MIR 级语义模型 | P0 |
...
| :--- | :--- | :--- | :--- |
| Safe Rust → 特征语言 | `01_aeneas_integration_plan.md` | 未实际运行翻译 | P1 |
...
- [形式化证明系统指南](16_formal_proof_system_guide.md)
- [研究笔记主索引](../README.md)
...
- [形式化证明系统指南](16_formal_proof_system_guide.md)
- [国际 Rust 形式化验证成果对标索引](18_international_formal_verification_index.md)
- [研究笔记主索引](../README.md)
- [上级目录](../README.md)
