...
- [Aeneas 集成计划 {#aeneas-集成计划}](#aeneas-集成计划-aeneas-集成计划)
  - [📑 目录 {#目录}](#-目录-目录)
  - [一、概述 {#一概述}](#一概述-一概述)
  - [二、Aeneas 简介 {#二aeneas-简介}](#二aeneas-简介-二aeneas-简介)
    - [2.1 什么是 Aeneas {#21-什么是-aeneas}](#21-什么是-aeneas-21-什么是-aeneas)
    - [2.2 核心能力 {#22-核心能力}](#22-核心能力-22-核心能力)
    - [2.3 与类似工具对比 {#23-与类似工具对比}](#23-与类似工具对比-23-与类似工具对比)
  - [三、集成目标 {#三集成目标}](#三集成目标-三集成目标)
    - [3.1 主要目标 {#31-主要目标}](#31-主要目标-31-主要目标)
    - [3.2 验证范围 {#32-验证范围}](#32-验证范围-32-验证范围)
  - [四、技术方案 {#四技术方案}](#四技术方案-四技术方案)
    - [4.1 架构设计 {#41-架构设计}](#41-架构设计-41-架构设计)
    - [4.2 项目集成点 {#42-项目集成点}](#42-项目集成点-42-项目集成点)
    - [4.3 注释规范 {#43-注释规范}](#43-注释规范-43-注释规范)
  - [五、实施路线图 {#五实施路线图}](#五实施路线图-五实施路线图)
    - [5.1 阶段规划 {#51-阶段规划}](#51-阶段规划-51-阶段规划)
    - [5.2 里程碑 {#52-里程碑}](#52-里程碑-52-里程碑)
  - [六、示例验证 {#六示例验证}](#六示例验证-六示例验证)
    - [6.1 所有权验证示例 {#61-所有权验证示例}](#61-所有权验证示例-61-所有权验证示例)
    - [6.2 数据结构验证示例 {#62-数据结构验证示例}](#62-数据结构验证示例-62-数据结构验证示例)
    - [6.3 算法验证示例 {#63-算法验证示例}](#63-算法验证示例-63-算法验证示例)
  - [七、相关资源 {#七相关资源}](#七相关资源-七相关资源)
    - [7.1 内部文档 {#71-内部文档}](#71-内部文档-71-内部文档)
    - [7.2 外部资源 {#72-外部资源}](#72-外部资源-72-外部资源)
    - [7.3 相关工具链 {#73-相关工具链}](#73-相关工具链-73-相关工具链)
...
- [VERIFICATION_TOOLS_MATRIX](32_verification_tools_matrix.md) — 工具对比矩阵
- [VERIFICATION_TOOLS_DECISION_TREE](31_verification_tools_decision_tree.md) — 选型决策树
...
> **注意**: 本文档替代已归档的旧版本。旧版本位于 `archive/deprecated/10_aeneas_integration_plan.md`
