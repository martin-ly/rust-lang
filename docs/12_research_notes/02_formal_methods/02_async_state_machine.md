...
**定理 SPAWN-T1**：spawn 与 Send 约束保证数据竞争自由：闭包捕获的 `T` 必须 `Send`，故跨线程无共享可变；与 [borrow_checker_proof](03_borrow_checker_proof.md) 定理 1、[async_state_machine](02_async_state_machine.md) 定理 6.2 一致。
...
| 类型 | 位置 |
| :--- | :--- |
| 思维导图 | [MIND_MAP_COLLECTION](../../07_thinking/03_mind_map_collection.md) §5、C06 |
| 多维矩阵 | [MULTI_DIMENSIONAL_CONCEPT_MATRIX](../../07_thinking/04_multi_dimensional_concept_matrix.md) §3,5；[README §六篇并表](README.md#formal_methods-六篇并表) 第 4 行 |
| 证明树 | 本文状态机与定理结构；[PROOF_GRAPH_NETWORK](../../07_thinking/05_proof_graph_network.md) |
| 决策树 | [DECISION_GRAPH_NETWORK](../../07_thinking/02_decision_graph_network.md) §4 |
