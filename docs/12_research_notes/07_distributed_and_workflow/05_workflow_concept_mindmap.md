...
- [工作流引擎概念族谱 {#工作流引擎概念族谱}](#工作流引擎概念族谱-工作流引擎概念族谱)
  - [📑 目录 {#目录}](#-目录-目录)
  - [概念族谱概览 {#概念族谱概览}](#概念族谱概览-概念族谱概览)
  - [核心概念详解 {#核心概念详解}](#核心概念详解-核心概念详解)
    - [1. 工作流定义语言 {#1-工作流定义语言}](#1-工作流定义语言-1-工作流定义语言)
    - [2. 状态机实现 {#2-状态机实现}](#2-状态机实现-2-状态机实现)
    - [3. Saga 模式实现 {#3-saga-模式实现}](#3-saga-模式实现-3-saga-模式实现)
  - [Rust 工作流工具链 {#rust-工作流工具链}](#rust-工作流工具链-rust-工作流工具链)
    - [框架对比 {#框架对比}](#框架对比-框架对比)
    - [与 Tokio 集成 {#与-tokio-集成}](#与-tokio-集成-与-tokio-集成)
  - [工作流模式实现 {#工作流模式实现}](#工作流模式实现-工作流模式实现)
    - [1. 并行分支 {#1-并行分支}](#1-并行分支-1-并行分支)
    - [2. 定时器与延迟 {#2-定时器与延迟}](#2-定时器与延迟-2-定时器与延迟)
    - [3. 事件驱动工作流 {#3-事件驱动工作流}](#3-事件驱动工作流-3-事件驱动工作流)
...
- 工作流引擎决策树
- [工作流引擎矩阵](../02_formal_methods/15_workflow_engines_matrix.md)
- [软件设计理论 - 工作流](../08_software_design_theory/03_workflow_safe_complete_models/README.md)
