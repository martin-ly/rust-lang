...
- [分布式架构决策树](01_distributed_architecture_decision_tree.md)
- [分布式模式矩阵](04_distributed_patterns_matrix.md)
- [软件设计理论 - 分布式](../08_software_design_theory/04_execution_models/05_distributed.md)
