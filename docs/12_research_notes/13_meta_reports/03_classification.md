...
> **EN**: Classification
> **Summary**: 研究笔记分类体系 Classification.
> **概念族**: 文档分类体系
> **内容分级**: [归档级]
>
> **分级**: [B]
...
- [研究笔记分类体系 {#研究笔记分类体系}](#研究笔记分类体系-研究笔记分类体系)
  - [📑 目录 {#目录}](#-目录-目录)
  - [宗旨 {#宗旨}](#宗旨-宗旨)
  - [一、按文档角色分类 {#一按文档角色分类}](#一按文档角色分类-一按文档角色分类)
  - [二、按知识层次分类 {#二按知识层次分类}](#二按知识层次分类-二按知识层次分类)
  - [三、按主题域分类 {#三按主题域分类}](#三按主题域分类-三按主题域分类)
  - [四、按研究领域分类（扩展） {#四按研究领域分类扩展}](#四按研究领域分类扩展-四按研究领域分类扩展)
  - [五、扩展路线 {#五扩展路线}](#五扩展路线-五扩展路线)
    - [5.1 内容扩展 {#51-内容扩展}](#51-内容扩展-51-内容扩展)
...
| **指南** | [FORMAL_PROOF_SYSTEM_GUIDE](../03_formal_proofs/16_formal_proof_system_guide.md)、[FORMAL_VERIFICATION_GUIDE](../03_formal_proofs/17_formal_verification_guide.md)、[BEST_PRACTICES](../10_tutorials_and_guides/03_best_practices.md)、[CONTENT_ENHANCEMENT](08_content_enhancement.md)、[WRITING_GUIDE](../../../archive/07_research_notes/02_snapshot_2026_06_25/10_writing_guide.md) | 论证规范、验证流程、实质内容自检 |
| **运维** | [CONTRIBUTING](../../../archive/07_research_notes/02_snapshot_2026_06_25/10_contributing.md)、[MAINTENANCE_GUIDE](../../../archive/07_research_notes/02_snapshot_2026_06_25/10_maintenance_guide.md)、[CHANGELOG](02_changelog.md)、[STATISTICS](../../../archive/07_research_notes/02_snapshot_2026_06_25/10_statistics.md)、[QUALITY_CHECKLIST](11_quality_checklist.md) | 贡献、维护、统计、质量 |
| **参考** | [GLOSSARY](../10_tutorials_and_guides/07_glossary.md)、[RESOURCES](../10_tutorials_and_guides/15_resources.md)、[FAQ](../10_tutorials_and_guides/05_faq.md)、[EXAMPLE](../../../archive/07_research_notes/02_snapshot_2026_06_25/10_example.md)、[GETTING_STARTED](../../../archive/07_research_notes/02_snapshot_2026_06_25/10_getting_started.md) | 术语、资源、示例、入门 |
| **规划** | [RESEARCH_ROADMAP](15_research_roadmap.md)、[TASK_CHECKLIST](../../../archive/07_research_notes/02_snapshot_2026_06_25/10_task_checklist.md)、[PROGRESS_TRACKING](../../../archive/07_research_notes/02_snapshot_2026_06_25/10_progress_tracking.md)、TASK_ORCHESTRATION_AND_EXECUTION_PLAN | 路线图、任务、进展 |
...
| 查设计模式与反模式 | [software_design_theory](../08_software_design_theory/README.md)、[07_anti_patterns](../08_software_design_theory/02_anti_patterns.md) |
