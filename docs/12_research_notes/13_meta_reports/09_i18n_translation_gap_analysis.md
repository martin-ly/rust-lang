...
- [国际化翻译版本差异检测与对齐指南 {#国际化翻译版本差异检测与对齐指南}](#国际化翻译版本差异检测与对齐指南-国际化翻译版本差异检测与对齐指南)
  - [目录 {#目录}](#目录-目录)
  - [一、指南说明 {#一指南说明}](#一指南说明-一指南说明)
  - [二、官方翻译版本现状 {#二官方翻译版本现状}](#二官方翻译版本现状-二官方翻译版本现状)
...
本文档建立 `docs/12_research_notes/` 中核心概念与国际化多语言权威来源之间的**版本差异检测机制**，确保中文、日文等翻译版本与英文原版保持同步，并识别因翻译滞后导致的知识偏差。
...
|------|------|----------|----------|----------|
| 中文 | [TRPL 中文版](https://kaisery.github.io/trpl-zh-cn/) | [rust-lang/book](https://github.com/rust-lang/book) | 🔄 通常滞后 1-3 个小版本 | [../01_alignment_matrices/32_rust_book_alignment.md](../01_alignment_matrices/32_rust_book_alignment.md) |
| 中文 | [Rust Reference 中文](https://rustwiki.org/zh-CN/reference/) | [rust-lang/reference](https://github.com/rust-lang/reference) | ⏳ 滞后较多 | [../01_alignment_matrices/34_rust_reference_alignment.md](../01_alignment_matrices/34_rust_reference_alignment.md) |
| 日文 | [TRPL 日本語版](https://doc.rust-jp.rs/book-ja/) | [rust-lang/book](https://github.com/rust-lang/book) | 🔄 滞后 1-2 个小版本 | [../01_alignment_matrices/32_rust_book_alignment.md](../01_alignment_matrices/32_rust_book_alignment.md) |
| 日文 | [Rust by Example 日本語版](https://doc.rust-jp.rs/rust-by-example-ja/) | [rust-lang/rust-by-example](https://github.com/rust-lang/rust-by-example) | ⏳ 部分章节未翻译 | [../01_alignment_matrices/33_rust_by_example_alignment.md](../01_alignment_matrices/33_rust_by_example_alignment.md) |
...
| 维度 | 检测内容 | 项目响应 |
|------|----------|----------|
| 版本号 | 翻译仓库的 commit 与原版的 commit 差距 | 在 [../01_alignment_matrices/14_authoritative_source_version_tracking.md](../01_alignment_matrices/14_authoritative_source_version_tracking.md) 记录 |
| 章节增删 | 原版新增/删除/重排章节 | 同步调整对齐矩阵 |
| 代码示例 | 示例是否随原版更新 | 检查项目示例 crate |
| 术语变更 | 英文术语翻译一致性 | 更新多语言术语对照表 |
| 版本特性标注 | 翻译是否标注最低 Rust 版本 | 项目文档显式标注 `Rust 1.97.0+` |
...
```bash
# 获取原版与翻译仓库的最新 release/tag {#获取原版与翻译仓库的最新-releasetag}
...
- [权威来源对齐网络总索引](../01_alignment_matrices/10_authoritative_source_alignment_network.md)
- [国际化多语言来源对齐](../01_alignment_matrices/24_i18n_source_alignment.md)
- [权威来源版本跟踪](../01_alignment_matrices/14_authoritative_source_version_tracking.md)
- [Rust Book 对齐](../01_alignment_matrices/32_rust_book_alignment.md)
