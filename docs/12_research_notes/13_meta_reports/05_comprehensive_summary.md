...
> **上位文档**: [00_ORGANIZATION_AND_NAVIGATION](../00_organization_and_navigation.md)、[AUTHORITATIVE_ALIGNMENT_GUIDE](../01_alignment_matrices/06_authoritative_alignment_guide.md)
...
| :--- | :--- | :--- | :--- |
| **支柱 1：公理判定系统** | 类型、控制流、变量、Send/Sync 等全面形式化推理与证明 | 公理→定理的形式化推理链可追溯 | FORMAL_FULL_MODEL_OVERVIEW、CORE_THEOREMS_FULL_PROOFS、PROOF_INDEX、[send_sync_formalization](../02_formal_methods/12_send_sync_formalization.md)、[SAFE_DECIDABLE_MECHANISMS_OVERVIEW](../03_formal_proofs/27_safe_decidable_mechanisms_overview.md) |
...
| **Send/Sync** | 跨线程转移/共享安全；SEND-T1、SYNC-T1、SYNC-L1 | [send_sync_formalization](../02_formal_methods/12_send_sync_formalization.md) |
| **安全可判定机制** | 每机制概念定义·属性关系·形式证明·反例；并发/Trait 族四维表 | [SAFE_DECIDABLE_MECHANISMS_OVERVIEW](../03_formal_proofs/27_safe_decidable_mechanisms_overview.md) |
...
见 [FORMAL_METHODS_COMPLETENESS_CHECKLIST](../02_formal_methods/05_formal_methods_completeness_checklist.md)。

**论证流向**（详见 [ARGUMENTATION_CHAIN_AND_FLOW](../06_concept_models/02_argumentation_chain_and_flow.md)）：
...
| **格式统一与 Rust 1.93 对齐** | ✅ 100%：元信息全库补全、92 项→落点文档、[RUST_193_COUNTEREXAMPLES_INDEX](../../../archive/07_research_notes/01_version_research/10_rust_193_counterexamples_index.md)、权威来源约定、CONTRIBUTING/MAINTENANCE_GUIDE 门禁与季度复核；见 FORMAT_AND_CONTENT_ALIGNMENT_PLAN |
...
| L3 机器证明 | 📦 已归档（[archive/deprecated/](../../../archive/05_formal_methods/04_coq_aeneas_deprecated/README.md)）；聚焦 L2 数学风格 + Rust 示例 |
...
详见 [RUST_194_RESEARCH_UPDATE](../12_version_research/02_rust_194_research_update.md) 及 [Rust Edition Guide](https://doc.rust-lang.org/edition-guide/rust-2024/index.html)。
