...
- [Rust 版本增量更新流程 {#rust-版本增量更新流程}](#rust-版本增量更新流程-rust-版本增量更新流程)
  - [📑 目录 {#目录}](#-目录-目录)
  - [触发条件 {#触发条件}](#触发条件-触发条件)
  - [增量更新步骤 {#增量更新步骤}](#增量更新步骤-增量更新步骤)
    - [1. 收集变更 {#1-收集变更}](#1-收集变更-1-收集变更)
    - [2. 更新文档 {#2-更新文档}](#2-更新文档-2-更新文档)
    - [3. 对齐权威 {#3-对齐权威}](#3-对齐权威-3-对齐权威)
    - [4. 兼容性 {#4-兼容性}](#4-兼容性-4-兼容性)
  - [检查清单 {#检查清单}](#检查清单-检查清单)
    - [版本发布后 {#版本发布后}](#版本发布后-版本发布后)
    - [季度复核 {#季度复核}](#季度复核-季度复核)
  - [研究场景与代码示例 {#研究场景与代码示例}](#研究场景与代码示例-研究场景与代码示例)
    - [场景 1：新语言特性研究 {#场景-1新语言特性研究}](#场景-1新语言特性研究-场景-1新语言特性研究)
    - [场景 2：性能改进验证 {#场景-2性能改进验证}](#场景-2性能改进验证-场景-2性能改进验证)
    - [场景 3：API 稳定化跟踪 {#场景-3api-稳定化跟踪}](#场景-3api-稳定化跟踪-场景-3api-稳定化跟踪)
  - [相关文档 {#相关文档-1}](#相关文档-相关文档-1)
    - [核心流程文档 {#核心流程文档}](#核心流程文档-核心流程文档)
    - [形式化方法文档 {#形式化方法文档}](#形式化方法文档-形式化方法文档)
    - [更新记录文档 {#更新记录文档}](#更新记录文档-更新记录文档)
    - [形式化证明文档 {#形式化证明文档}](#形式化证明文档-形式化证明文档)
...
| 步骤 | 文档 | 操作 |
| :--- | :--- | :--- |
| 2.1 | [RUST_193_LANGUAGE_FEATURES_COMPREHENSIVE_ANALYSIS](../12_version_research/01_rust_193_language_features_comprehensive_analysis.md) | 新增「Rust X.Y 新增/变更」表；更新特性总数 |
...
| 文档 | 用途 | 链接 |
| :--- | :--- | :--- |
| formal_methods/00_completeness_gaps | 形式化缺口 | [../02_formal_methods/00_completeness_gaps.md](../02_formal_methods/00_completeness_gaps.md) |
| type_theory/00_completeness_gaps | 类型理论缺口 | [../02_formal_methods/00_completeness_gaps.md](../02_formal_methods/00_completeness_gaps.md) |
...
| 类别 | 文档 | 链接 |
| :--- | :--- | :--- |
| 形式化方法 | 所有权（Ownership）模型 | [../02_formal_methods/09_ownership_model.md](../02_formal_methods/09_ownership_model.md) |
| 形式化方法 | 借用（Borrowing）检查器 | [../02_formal_methods/03_borrow_checker_proof.md](../02_formal_methods/03_borrow_checker_proof.md) |
| 类型理论 | 类型系统（Type System）基础 | [../05_type_theory/05_type_system_foundations.md](../05_type_theory/05_type_system_foundations.md) |
| 实验研究 | 性能基准测试 | [../09_experiments/05_performance_benchmarks.md](../09_experiments/05_performance_benchmarks.md) |
