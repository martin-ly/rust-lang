...
| 衔接 | 至少 1 处链接至 formal_methods/type_theory/PROOF_INDEX | `[ownership_model](../02_formal_methods/09_ownership_model.md)` |

**薄弱文档优先修复**：索引/概览类可放宽「代码」项，但需保证「衔接」充分；研究笔记/设计模式/实验五项均需满足。修复指引见 [BEST_PRACTICES](../10_tutorials_and_guides/03_best_practices.md#实质内容不足判断与修复) 四步修复法。
...
**Def CE1（内容完备性）**：研究笔记 $N$ 满足**内容完备**，当且仅当 $N$ 对核心概念有 Def、对主要结论有定理及证明或证明思路、对边界有反例、与 [PROOF_INDEX](../03_formal_proofs/21_proof_index.md) 衔接。

**Axiom CE1**：形式化完备（见 [BEST_PRACTICES](../10_tutorials_and_guides/03_best_practices.md) Def BP1）蕴含内容完备；Def CE1 为 Def BP1 的细化。**实质内容完备**见 [BEST_PRACTICES](../10_tutorials_and_guides/03_best_practices.md) Def BP2 与实践对照表。
...
**可选**：文末「相关思维表征」注明本页对应的思维导图章节、矩阵位置、证明树、决策树（见 [HIERARCHICAL_MAPPING_AND_SUMMARY](../06_concept_models/12_hierarchical_mapping_and_summary.md)）。

**检查**：见 [QUALITY_CHECKLIST](11_quality_checklist.md) 对应项。
...
**已实施**：23 模式均在元信息中含「23 模式矩阵」行号；执行模型矩阵、formal_methods **六篇并表**均含文档列。新增矩阵时按上表补全双向链接；见 [MAINTENANCE_GUIDE](../../../archive/07_research_notes/02_snapshot_2026_06_25/10_maintenance_guide.md) 更新流程。
...
- [研究工具使用指南](../10_tutorials_and_guides/16_tools_guide.md)
- [研究方法论](../10_tutorials_and_guides/14_research_methodology.md)
- [最佳实践](../10_tutorials_and_guides/03_best_practices.md)
...
- [研究笔记示例](../../../archive/07_research_notes/02_snapshot_2026_06_25/10_example.md)
