...
**上位文档**：[THEORETICAL_AND_ARGUMENTATION_SYSTEM_ARCHITECTURE](16_theoretical_and_argumentation_system_architecture.md) —— 理论体系四层架构、论证体系五层结构、安全与非安全全面论证（顶层框架）。
...
| 缺少编程语言构造性语义 | [LANGUAGE_SEMANTICS_EXPRESSIVENESS](../03_formal_proofs/20_language_semantics_expressiveness.md) |
...
*证明*：由 [COMPREHENSIVE_SYSTEMATIC_OVERVIEW](../13_meta_reports/06_comprehensive_systematic_overview.md) 全局一致性矩阵；术语、公理编号、定义链已校验。∎
...
| 领域 | 反例 | 违反的边界 | 文档 |
| :--- | :--- | :--- | :--- |
| 型变 | `&mut T` 协变 | 唯一可变借用（Borrowing） | [variance_theory](../05_type_theory/06_variance_theory.md) |
| 型变 | `fn(T)` 参数协变 | 生命周期 | [variance_theory](../05_type_theory/06_variance_theory.md) |
| 型变 | `Cell<T>` 协变 | 内部可变 | [variance_theory](../05_type_theory/06_variance_theory.md) |
| 所有权 | 使用已移动值 | 唯一性 | [ownership_model](../02_formal_methods/09_ownership_model.md) |
| 借用 | 双重可变借用 | 互斥 | [borrow_checker_proof](../02_formal_methods/03_borrow_checker_proof.md) |
| 生命周期 | 返回局部引用 | outlives | lifetime_formalization |
| 生命周期 | 存储短生命周期引用 | 约束冲突 | lifetime_formalization |
| 异步（Async） | 非 Send 跨线程 | Send 边界 | [async_state_machine](../02_formal_methods/02_async_state_machine.md) |
| 异步（Async） | 未 Pin 自引用 | Pin 边界 | [async_state_machine](../02_formal_methods/02_async_state_machine.md) |
| Pin | 移动未 Pin 自引用 | 位置稳定 | [pin_self_referential](../02_formal_methods/10_pin_self_referential.md) |
| Trait | 对象安全违规 | vtable 约束 | [trait_system_formalization](../05_type_theory/04_trait_system_formalization.md) |
| 类型系统 | 类型不匹配 | 类型安全 | [type_system_foundations](../05_type_theory/05_type_system_foundations.md) |
| 设计模式 | Singleton 全局可变未同步 | 数据竞争 | [singleton](../08_software_design_theory/01_design_patterns_formal/01_creational/05_singleton.md) |
| 设计模式 | Observer 共享可变无 Mutex | 数据竞争 | [observer](../08_software_design_theory/01_design_patterns_formal/03_behavioral/07_observer.md) |
| 设计模式 | Composite 循环引用 | 所有权无法表达 | [composite](../08_software_design_theory/01_design_patterns_formal/02_structural/03_composite.md) |
| 设计模式 | Builder 必填未设 | 不变式违反 | [builder](../08_software_design_theory/01_design_patterns_formal/01_creational/02_builder.md) |
| 设计模式 | Memento 恢复非法状态 | 不变式违反 | [memento](../08_software_design_theory/01_design_patterns_formal/03_behavioral/06_memento.md) |
...
| 指称语义 | 类型=命题，程序=证明，Result/! 对应 ∨/⊥ | [LANGUAGE_SEMANTICS_EXPRESSIVENESS](../03_formal_proofs/20_language_semantics_expressiveness.md) |
...
| 特性族 | 矩阵 | 决策树 | 完整链 |
| :--- | :--- | :--- | :--- |
| **Rust 1.93 全特性** | [RUST_193_FEATURE_MATRIX](../../../archive/07_research_notes/01_version_research/10_rust_193_feature_matrix.md) 五维矩阵 | RUST_193 特性覆盖 | [RUST_193_LANGUAGE_FEATURES_COMPREHENSIVE_ANALYSIS](../12_version_research/01_rust_193_language_features_comprehensive_analysis.md) |
...
| **控制流** | - | - | [CORE_FEATURES_FULL_CHAIN](../03_formal_proofs/05_core_features_full_chain.md) match/for/? |
| **并发与异步** | 五维矩阵 § Future/Pin | 表达能力边界决策树 § 并发/异步 | [CORE_FEATURES_FULL_CHAIN](../03_formal_proofs/05_core_features_full_chain.md) Send/Sync/Future |
...
| 类型族 | 构造能力 | 决策树 | 文档 |
| :--- | :--- | :--- | :--- |
| **基本类型** | TCON 矩阵 Unique | 类型构造决策树 | [construction_capability](../05_type_theory/02_construction_capability.md) |
| **复合类型** | struct/enum/tuple | 同上 | [construction_capability](../05_type_theory/02_construction_capability.md) |
| **泛型（Generics）/GAT** | Multi 或 Unique | 同上 | [construction_capability](../05_type_theory/02_construction_capability.md)、[advanced_types](../05_type_theory/01_advanced_types.md) |
| **impl Trait / dyn Trait** | Unique | 同上 | [trait_system_formalization](../05_type_theory/04_trait_system_formalization.md) |
...
| 模型 | 边界 | 确定性判定 | 文档 |
| :--- | :--- | :--- | :--- |
| **同步** | 五模型 × 三维边界 | Def EB-DET1 Sequential | [06_boundary_analysis](../08_software_design_theory/04_execution_models/06_boundary_analysis.md) |
...
| 维度 | 决策树 | 文档 |
| :--- | :--- | :--- |
| **设计模式表达** | [04_expressiveness_boundary](../08_software_design_theory/03_workflow_safe_complete_models/02_expressiveness_boundary.md) | 等价/近似/不可表达 |
| **组件构建** | [04_compositional_engineering](../08_software_design_theory/05_compositional_engineering/README.md) 构建能力确定性判定树 | Def CE-MAT1、L1–L4 成熟度 |
...
| 文档 | 用途 |
| [THEORETICAL_AND_ARGUMENTATION_SYSTEM_ARCHITECTURE](16_theoretical_and_argumentation_system_architecture.md) | **顶层框架**：理论体系、论证体系、安全与非安全 |
...
| [FEATURE_TEMPLATE](../../../archive/07_research_notes/02_snapshot_2026_06_25/10_feature_template.md) | 79 项特性精简模板 |
