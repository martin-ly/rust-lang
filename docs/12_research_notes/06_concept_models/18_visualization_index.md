...
- [可视化文档索引 {#可视化文档索引-1}](#可视化文档索引-可视化文档索引-1)
  - [📑 目录 {#目录}](#-目录-目录)
  - [🎯 概述 {#概述}](#-概述-概述)
  - [🧠 思维导图 {#思维导图}](#-思维导图-思维导图)
    - [1. 任务关系网络图 {#1-任务关系网络图}](#1-任务关系网络图-1-任务关系网络图)
  - [📊 概念对比矩阵 {#概念对比矩阵}](#-概念对比矩阵-概念对比矩阵)
    - [1. 任务类型对比矩阵 {#1-任务类型对比矩阵}](#1-任务类型对比矩阵-1-任务类型对比矩阵)
    - [2. 任务完成策略对比矩阵 {#2-任务完成策略对比矩阵}](#2-任务完成策略对比矩阵-2-任务完成策略对比矩阵)
    - [3. 工具选择对比矩阵 {#3-工具选择对比矩阵}](#3-工具选择对比矩阵-3-工具选择对比矩阵)
  - [🌳 决策树 {#决策树}](#-决策树-决策树)
    - [1. 任务优先级决策树 {#1-任务优先级决策树}](#1-任务优先级决策树-1-任务优先级决策树)
  - [📈 进度可视化 {#进度可视化}](#-进度可视化-进度可视化)
    - [1. 周进度跟踪表 {#1-周进度跟踪表}](#1-周进度跟踪表-1-周进度跟踪表)
    - [2. 任务完成度热力图 {#2-任务完成度热力图}](#2-任务完成度热力图-2-任务完成度热力图)
  - [🔗 相关文档 {#相关文档}](#-相关文档-相关文档)
    - [核心文档 {#核心文档}](#核心文档-核心文档)
    - [工具资源 {#工具资源}](#工具资源-工具资源)
  - [💻 可视化代码示例 {#可视化代码示例}](#-可视化代码示例-可视化代码示例)
    - [示例 1: Mermaid 思维导图代码 {#示例-1-mermaid-思维导图代码}](#示例-1-mermaid-思维导图代码-示例-1-mermaid-思维导图代码)
    - [示例 2: 概念对比矩阵代码 {#示例-2-概念对比矩阵代码}](#示例-2-概念对比矩阵代码-示例-2-概念对比矩阵代码)
    - [示例 3: 决策树代码 {#示例-3-决策树代码}](#示例-3-决策树代码-示例-3-决策树代码)
    - [示例 4: Rust 可视化代码 {#示例-4-rust-可视化代码}](#示例-4-rust-可视化代码-示例-4-rust-可视化代码)
  - [🔗 形式化链接 {#形式化链接}](#-形式化链接-形式化链接)
    - [可视化文档索引 {#可视化文档索引-1}](#可视化文档索引-可视化文档索引-1-1)
    - [研究笔记链接 {#研究笔记链接}](#研究笔记链接-研究笔记链接)
    - [形式化定理链接 {#形式化定理链接}](#形式化定理链接-形式化定理链接)
...
| 可视化类型 | 文档 | 内容 |
| :--- | :--- | :--- |
| 思维导图 | [MIND_MAP_COLLECTION](../../07_thinking/03_mind_map_collection.md) | 知识结构化思维导图 |
| 概念矩阵 | [MULTI_DIMENSIONAL_CONCEPT_MATRIX](../../07_thinking/04_multi_dimensional_concept_matrix.md) | 多维概念对比矩阵 |
| 决策树 | [DECISION_GRAPH_NETWORK](../../07_thinking/02_decision_graph_network.md) | 决策图网络 |
| 证明树 | [PROOF_INDEX](../03_formal_proofs/21_proof_index.md) | 证明树结构 |
...
| 类别 | 文档 | 可视化内容 |
| :--- | :--- | :--- |
| 形式化方法 | [../02_formal_methods/09_ownership_model.md](../02_formal_methods/09_ownership_model.md) | 所有权（Ownership）状态图 |
| 类型理论 | [../05_type_theory/05_type_system_foundations.md](../05_type_theory/05_type_system_foundations.md) | 类型推导树 |
| 实验研究 | [../09_experiments/05_performance_benchmarks.md](../09_experiments/05_performance_benchmarks.md) | 性能图表 |
