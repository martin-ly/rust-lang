...
>
- [Rust 概念层次体系框架 {#rust-概念层次体系框架}](#rust-概念层次体系框架-rust-概念层次体系框架)
  - [📑 目录 {#目录}](#-目录-目录)
  - [🎯 概述 {#概述}](#-概述-概述)
  - [五层概念体系 {#五层概念体系}](#五层概念体系-五层概念体系)
    ...
    - [L5: 代码实践 {#l5-代码实践}](#l5-代码实践-l5-代码实践)
      ...
      - [L5.2: 高级代码模式 {#l52-高级代码模式}](#l52-高级代码模式-l52-高级代码模式)
      - [L5.3: 代码-概念追溯 {#l53-代码-概念追溯}](#l53-代码-概念追溯-l53-代码-概念追溯)
  - [层间关系映射 {#层间关系映射}](#层间关系映射-层间关系映射)
    - [自顶向下映射 {#自顶向下映射}](#自顶向下映射-自顶向下映射)
    - [自底向上映射 {#自底向上映射}](#自底向上映射-自底向上映射)
  - [概念与文档映射 {#概念与文档映射}](#概念与文档映射-概念与文档映射)
    - [按层次组织的文档树 {#按层次组织的文档树}](#按层次组织的文档树-按层次组织的文档树)
    - [文档层次完整性检查表 {#文档层次完整性检查表}](#文档层次完整性检查表-文档层次完整性检查表)
  - [概念与定理映射 {#概念与定理映射}](#概念与定理映射-概念与定理映射)
    - [概念-定理对应表 {#概念-定理对应表}](#概念-定理对应表-概念-定理对应表)
    - [定理层次 DAG {#定理层次-dag}](#定理层次-dag-定理层次-dag)
  - [📚 相关文档 {#相关文档}](#-相关文档-相关文档)
...
L2 核心概念族
├── ../02_formal_methods/09_ownership_model.md
├── ../02_formal_methods/03_borrow_checker_proof.md
├── ../02_formal_methods/06_lifetime_formalization.md
├── ../05_type_theory/05_type_system_foundations.md
├── ../05_type_theory/04_trait_system_formalization.md
└── ../02_formal_methods/12_send_sync_formalization.md
...
| 文档 | 用途 | 层次 |
| :--- | :--- | :--- |
| [ARGUMENTATION_CHAIN_AND_FLOW](02_argumentation_chain_and_flow.md) | 论证脉络关系 | L2-L3 |
| [HIERARCHICAL_MAPPING_AND_SUMMARY](12_hierarchical_mapping_and_summary.md) | 层次化映射 | L2-L4 |
| [FORMAL_FULL_MODEL_OVERVIEW](../03_formal_proofs/12_formal_full_model_overview.md) | 统一形式系统 | L1-L2 |
| [PROOF_INDEX](../03_formal_proofs/21_proof_index.md) | 定理索引 | L3-L4 |
