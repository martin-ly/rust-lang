...
- [所有权系统概念族谱 {#所有权系统概念族谱}](#所有权系统概念族谱-所有权系统概念族谱)
  - [📑 目录 {#目录}](#-目录-目录)
  - [🧬 核心概念族谱 {#核心概念族谱}](#-核心概念族谱-核心概念族谱)
  - [📊 概念关系矩阵 {#概念关系矩阵}](#-概念关系矩阵-概念关系矩阵)
  - [🎯 核心定理映射 {#核心定理映射}](#-核心定理映射-核心定理映射)
  - [🌿 概念层次结构 {#概念层次结构}](#-概念层次结构-概念层次结构)
    - [Level 1: 基础层 {#level-1-基础层}](#level-1-基础层-level-1-基础层)
    - [Level 2: 机制层 {#level-2-机制层}](#level-2-机制层-level-2-机制层)
    - [Level 3: 抽象层 {#level-3-抽象层}](#level-3-抽象层-level-3-抽象层)
    - [Level 4: 高级层 {#level-4-高级层}](#level-4-高级层-level-4-高级层)
  - [🔗 与Rust示例的映射 {#与rust示例的映射}](#-与rust示例的映射-与rust示例的映射)
  - [📚 相关文档 {#相关文档}](#-相关文档-相关文档)
...
- [所有权形式化定义](../02_formal_methods/09_ownership_model.md)
- [借用检查器证明](../02_formal_methods/03_borrow_checker_proof.md)
- 生命周期形式化
- [Send/Sync（Sync）形式化](../02_formal_methods/12_send_sync_formalization.md)
