...
> **分级**: [A]
> **层级**: L6 生态工具 / L3 高级网络
> **前置概念**: [Async](../../concept/03_advanced/01_async/01_async.md) · [Network Programming](../../crates/c10_networks)
> **Bloom 层级**: L3-L4
...
**libp2p** 是 Protocol Labs 开发的模块（Module）化 P2P（点对点）网络框架，为 IPFS、Filecoin、Polkadot 等去中心化系统提供网络基础设施。
