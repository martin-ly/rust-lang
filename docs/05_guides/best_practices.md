...
- [Rust 项目最佳实践指南 {#rust-项目最佳实践指南}](#rust-项目最佳实践指南-rust-项目最佳实践指南)
  - [📋 目录 {#目录}](#-目录-目录)
  - [概述 {#概述}](#概述-概述)
  - [1. 代码质量最佳实践 {#1-代码质量最佳实践}](#1-代码质量最佳实践-1-代码质量最佳实践)
    - [1.1 所有权（Ownership）和借用（Borrowing） {#11-所有权和借用}](#11-所有权和借用-11-所有权和借用)
    - [1.2 类型安全 {#12-类型安全}](#12-类型安全-12-类型安全)
    - [1.3 错误处理（Error Handling） {#13-错误处理}](#13-错误处理-13-错误处理)
  - [2. 性能优化最佳实践 {#2-性能优化最佳实践}](#2-性能优化最佳实践-2-性能优化最佳实践)
    - [2.1 内存管理 {#21-内存管理}](#21-内存管理-21-内存管理)
    - [2.2 迭代器（Iterator）优化 {#22-迭代器优化}](#22-迭代器优化-22-迭代器优化)
    - [2.3 零成本抽象（Zero-Cost Abstraction） {#23-零成本抽象}](#23-零成本抽象-23-零成本抽象)
  - [3. 错误处理最佳实践 {#3-错误处理最佳实践}](#3-错误处理最佳实践-3-错误处理最佳实践)
    - [3.1 自定义错误类型 {#31-自定义错误类型}](#31-自定义错误类型-31-自定义错误类型)
    - [3.2 错误传播 {#32-错误传播}](#32-错误传播-32-错误传播)
  - [4. 测试最佳实践 {#4-测试最佳实践}](#4-测试最佳实践-4-测试最佳实践)
    - [4.1 单元测试 {#41-单元测试}](#41-单元测试-41-单元测试)
    - [4.2 集成测试 {#42-集成测试}](#42-集成测试-42-集成测试)
    - [4.3 文档测试 {#43-文档测试}](#43-文档测试-43-文档测试)
  - [5. 文档最佳实践 {#5-文档最佳实践}](#5-文档最佳实践-5-文档最佳实践)
    - [5.1 代码文档 {#51-代码文档}](#51-代码文档-51-代码文档)
    - [5.2 README 文档 {#52-readme-文档}](#52-readme-文档-52-readme-文档)
  - [6. 安全性最佳实践 {#6-安全性最佳实践}](#6-安全性最佳实践-6-安全性最佳实践)
    - [6.1 输入验证 {#61-输入验证}](#61-输入验证-61-输入验证)
    - [6.2 资源管理 {#62-资源管理}](#62-资源管理-62-资源管理)
  - [7. 并发编程最佳实践 {#7-并发编程最佳实践}](#7-并发编程最佳实践-7-并发编程最佳实践)
    - [7.1 线程安全 {#71-线程安全}](#71-线程安全-71-线程安全)
    - [7.2 无锁编程 {#72-无锁编程}](#72-无锁编程-72-无锁编程)
  - [8. 异步（Async）编程最佳实践 {#8-异步编程最佳实践}](#8-异步编程最佳实践-8-异步编程最佳实践)
    - [8.1 Future 和 async/await {#81-future-和-asyncawait}](#81-future-和-asyncawait-81-future-和-asyncawait)
    - [8.2 错误处理 {#82-错误处理}](#82-错误处理-82-错误处理)
  - [9. 模块（Module）设计最佳实践 {#9-模块设计最佳实践}](#9-模块设计最佳实践-9-模块设计最佳实践)
    - [9.1 模块组织 {#91-模块组织}](#91-模块组织-91-模块组织)
    - [9.2 可见性控制 {#92-可见性控制}](#92-可见性控制-92-可见性控制)
  - [10. 项目组织最佳实践 {#10-项目组织最佳实践}](#10-项目组织最佳实践-10-项目组织最佳实践)
    - [10.1 目录结构 {#101-目录结构}](#101-目录结构-101-目录结构)
    - [10.2 特性标志 {#102-特性标志}](#102-特性标志-102-特性标志)
  - [11. 工具使用 {#11-工具使用}](#11-工具使用-11-工具使用)
    - [11.1 Clippy {#111-clippy}](#111-clippy-111-clippy)
    - [11.2 rustfmt {#112-rustfmt}](#112-rustfmt-112-rustfmt)
    - [11.3 依赖管理 {#113-依赖管理}](#113-依赖管理-113-依赖管理)
  - [12. 性能监控 {#12-性能监控}](#12-性能监控-12-性能监控)
    - [12.1 基准测试 {#121-基准测试}](#121-基准测试-121-基准测试)
    - [12.2 性能分析 {#122-性能分析}](#122-性能分析-122-性能分析)
  - [13. 代码示例 {#13-代码示例}](#13-代码示例-13-代码示例)
    - [13.1 新类型模式 {#131-新类型模式}](#131-新类型模式-131-新类型模式)
    - [13.2 Builder 模式 {#132-builder-模式}](#132-builder-模式-132-builder-模式)
    - [13.3 状态机模式 {#133-状态机模式}](#133-状态机模式-133-状态机模式)
  - [14. 使用场景 {#14-使用场景}](#14-使用场景-14-使用场景)
    - [场景1: 新项目启动 {#场景1-新项目启动}](#场景1-新项目启动-场景1-新项目启动)
    - [场景2: 代码审查 {#场景2-代码审查}](#场景2-代码审查-场景2-代码审查)
    - [场景3: 性能优化 {#场景3-性能优化}](#场景3-性能优化-场景3-性能优化)
    - [场景4: 团队代码规范 {#场景4-团队代码规范}](#场景4-团队代码规范-场景4-团队代码规范)
  - [15. 形式化链接 {#15-形式化链接}](#15-形式化链接-15-形式化链接)
  - [相关资源 {#相关资源}](#相关资源-相关资源)
    - [官方资源 {#官方资源}](#官方资源-官方资源)
    - [在线课程 (Coursera) {#在线课程-coursera}](#在线课程-coursera-在线课程-coursera)
    - [项目资源 {#项目资源}](#项目资源-项目资源)
  - [Rust 1.95+ 最佳实践（深度指南） {#rust-195-最佳实践深度指南}](#rust-195-最佳实践深度指南-rust-195-最佳实践深度指南)
    - [1. array\_windows - 零开销滑动窗口 {#1-array\_windows---零开销滑动窗口}](#1-array_windows---零开销滑动窗口-1-array_windows---零开销滑动窗口)
      - [什么时候使用 array\_windows？ {#什么时候使用-array\_windows}](#什么时候使用-array_windows-什么时候使用-array_windows)
      - [最佳实践示例 {#最佳实践示例-1}](#最佳实践示例-最佳实践示例-1)
      - [性能检查清单 {#性能检查清单-1}](#性能检查清单-性能检查清单-1)
    - [2. ControlFlow - 清晰的提前终止语义 {#2-controlflow---清晰的提前终止语义}](#2-controlflow---清晰的提前终止语义-2-controlflow---清晰的提前终止语义)
      - [ControlFlow vs Result/Option 选择指南 {#controlflow-vs-resultoption-选择指南}](#controlflow-vs-resultoption-选择指南-controlflow-vs-resultoption-选择指南)
      - [最佳实践：验证管道 {#最佳实践验证管道}](#最佳实践验证管道-最佳实践验证管道)
      - [最佳实践：搜索与短路 {#最佳实践搜索与短路}](#最佳实践搜索与短路-最佳实践搜索与短路)
    - [3. LazyLock/LazyCell - 延迟初始化优化 {#3-lazylocklazycell---延迟初始化优化}](#3-lazylocklazycell---延迟初始化优化-3-lazylocklazycell---延迟初始化优化)
      - [热路径优化模式 {#热路径优化模式}](#热路径优化模式-热路径优化模式)
      - [单线程可变缓存模式 {#单线程可变缓存模式}](#单线程可变缓存模式-单线程可变缓存模式)
    - [4. 数学常量 - 精确计算 {#4-数学常量---精确计算}](#4-数学常量---精确计算-4-数学常量---精确计算)
      - [使用标准库常量的好处 {#使用标准库常量的好处}](#使用标准库常量的好处-使用标准库常量的好处)
    - [5. 综合性能优化检查清单 {#5-综合性能优化检查清单-1}](#5-综合性能优化检查清单-5-综合性能优化检查清单-1)
      - [array\_windows 优化 {#array\_windows-优化}](#array_windows-优化-array_windows-优化)
      - [ControlFlow 优化 {#controlflow-优化}](#controlflow-优化-controlflow-优化)
      - [LazyLock 优化 {#lazylock-优化}](#lazylock-优化-lazylock-优化)
    - [快速参考卡片 {#快速参考卡片}](#快速参考卡片-快速参考卡片)
  - [🆕 新增最佳实践 {#新增最佳实践}](#-新增最佳实践-新增最佳实践)
    - [1. isqrt - 整数平方根运算 {#1-isqrt---整数平方根运算}](#1-isqrt---整数平方根运算-1-isqrt---整数平方根运算)
      - [什么时候使用 isqrt？ {#什么时候使用-isqrt}](#什么时候使用-isqrt-什么时候使用-isqrt)
      - [最佳实践示例 {#最佳实践示例-1}](#最佳实践示例-最佳实践示例-1-1)
      - [性能检查清单 {#性能检查清单-1}](#性能检查清单-性能检查清单-1-1)
    - [2. HashMap::get\_disjoint\_mut - 安全并行访问 {#2-hashmapget\_disjoint\_mut---安全并行访问}](#2-hashmapget_disjoint_mut---安全并行访问-2-hashmapget_disjoint_mut---安全并行访问)
      - [什么时候使用 get\_disjoint\_mut？ {#什么时候使用-get\_disjoint\_mut}](#什么时候使用-get_disjoint_mut-什么时候使用-get_disjoint_mut)
      - [最佳实践：并发状态管理 {#最佳实践并发状态管理}](#最佳实践并发状态管理-最佳实践并发状态管理)
      - [常见模式 {#常见模式}](#常见模式-常见模式)
    - [3. async Fn Trait - 异步抽象改进 {#3-async-fn-trait---异步抽象改进}](#3-async-fn-trait---异步抽象改进-3-async-fn-trait---异步抽象改进)
      - [最佳实践：清晰的异步 Trait 定义 {#最佳实践清晰的异步-trait-定义}](#最佳实践清晰的异步-trait-定义-最佳实践清晰的异步-trait-定义)
      - [与 ControlFlow 结合 {#与-controlflow-结合}](#与-controlflow-结合-与-controlflow-结合)
    - [4. Vec::pop\_if - 条件弹出 {#4-vecpop\_if---条件弹出}](#4-vecpop_if---条件弹出-4-vecpop_if---条件弹出)
      - [最佳实践：栈和队列操作 {#最佳实践栈和队列操作}](#最佳实践栈和队列操作-最佳实践栈和队列操作)
    - [5. 综合性能优化检查清单 {#5-综合性能优化检查清单-1}](#5-综合性能优化检查清单-5-综合性能优化检查清单-1-1)
      - [isqrt 优化 {#isqrt-优化}](#isqrt-优化-isqrt-优化)
      - [get\_disjoint\_mut 优化 {#get\_disjoint\_mut-优化}](#get_disjoint_mut-优化-get_disjoint_mut-优化)
      - [async Fn 优化 {#async-fn-优化}](#async-fn-优化-async-fn-优化)
    - [6. 版本兼容性与迁移指南 {#6-版本兼容性与迁移指南}](#6-版本兼容性与迁移指南-6-版本兼容性与迁移指南)
      - [从 1.95+ 迁移到新版本 {#从-195-迁移到新版本}](#从-195-迁移到新版本-从-195-迁移到新版本)
    - [7. 快速参考卡片 {#7-快速参考卡片}](#7-快速参考卡片-7-快速参考卡片)
  - [思维导图：Rust 最佳实践体系 {#思维导图rust-最佳实践体系}](#思维导图rust-最佳实践体系-思维导图rust-最佳实践体系)
  - [决策树：错误处理策略选择 {#决策树错误处理策略选择}](#决策树错误处理策略选择-决策树错误处理策略选择)
...
**✅ 最佳实践**: 使用新类型模式、枚举（Enum）而非魔法数字、Option 而非 null
...
**✅ 最佳实践**: Vec::with_capacity 预分配、Box 大结构体（Struct）、Cow 避免克隆
