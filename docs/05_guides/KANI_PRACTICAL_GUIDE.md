...
> [来源: [Rust Reference — MIR](https://doc.rust-lang.org/rustc/mir/index.html)]

### Kani 在 Rust 验证生态中的定位
...
```toml
[dependencies]
# Kani 验证时自动注入 kani crate，无需显式依赖

[dev-dependencies]
# 如需在测试代码中使用 kani 宏（非验证时编译），可条件编译
```
...
## 7. Kani Proof vs Unit Test：当测试通过而 Kani 发现 Bug
> **[来源: [Rust Standard Library](https://doc.rust-lang.org/std/)]**
...
- [Verus 实战指南 —— 互补的演绎验证器](VERUS_PRACTICAL_GUIDE.md)
