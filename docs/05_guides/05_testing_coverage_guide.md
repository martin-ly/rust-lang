...
- [测试覆盖率指南 {#测试覆盖率指南}](#测试覆盖率指南-测试覆盖率指南)
  ...
  - [📝 测试类型 {#测试类型}](#-测试类型-测试类型)
    ...
    - [4. 异步（Async）测试 {#4-异步测试}](#4-异步测试-4-异步测试)
  ...
  - [📚 相关资源 {#相关资源}](#-相关资源-相关资源)
  - [使用场景 {#使用场景}](#使用场景-使用场景)
    - [场景1: 新模块（Module）测试策略 {#场景1-新模块测试策略}](#场景1-新模块测试策略-场景1-新模块测试策略)
...
测试验证形式化性质见 [CORE_THEOREMS_FULL_PROOFS](../../archive/research_notes_2026_06_25/10_core_theorems_full_proofs.md)。
