...
- [嵌入式 Rust 专题指南](#嵌入式-rust-专题指南)
  ...
  - [本项目对应模块](#本项目对应模块)
  - [快速开始示例](#快速开始示例)
    - [1. 最小 no\_std 程序](#1-最小-no_std-程序)
  ...
  - [Rust 1.95+ 在嵌入式开发中的应用](#rust-195-在嵌入式开发中的应用)
    - [array\_windows 在传感器数据处理中的应用](#array_windows-在传感器数据处理中的应用)
...
**形式化引用**：T-OW3 (内存安全)、
T-BR1、[UNSAFE_RUST_GUIDE](../../concept/03_advanced/03_unsafe.md)（no_std、裸机 unsafe 契约）。
