...
- [分布式模式特性矩阵 {#分布式模式特性矩阵}](#分布式模式特性矩阵-分布式模式特性矩阵)
  - [📑 目录 {#目录}](#-目录-目录)
  - [模式特性总览 {#模式特性总览}](#模式特性总览-模式特性总览)
  - [详细模式分析 {#详细模式分析}](#详细模式分析-详细模式分析)
    - [1. Saga 模式 {#1-saga-模式}](#1-saga-模式-1-saga-模式)
    - [2. CQRS 模式 {#2-cqrs-模式}](#2-cqrs-模式-2-cqrs-模式)
  - [与 Rust 特性结合 {#与-rust-特性结合}](#与-rust-特性结合-与-rust-特性结合)
