...
- [教程：所有权与内存安全 {#教程所有权与内存安全}](#教程所有权与内存安全-教程所有权与内存安全)
  - [📑 目录 {#目录}](#-目录-目录)
  - [引言 {#引言-1}](#引言-引言-1)
  ...
  - [第二部分：所有权规则 {#第二部分所有权规则}](#第二部分所有权规则-第二部分所有权规则)
    - [三大规则 {#三大规则}](#三大规则-三大规则)
    - [作用域与生命周期 {#作用域与生命周期}](#作用域与生命周期-作用域与生命周期)
    - [内存表示 {#内存表示}](#内存表示-内存表示)
  ...
  - [第八部分：实践模式 {#第八部分实践模式}](#第八部分实践模式-第八部分实践模式)
    ...
    - [模式3: 可变借用 {#模式3-可变借用}](#模式3-可变借用-模式3-可变借用)
  ...
  - [第六部分：常见疑问 {#第六部分常见疑问}](#第六部分常见疑问-第六部分常见疑问)
    - [Q: 所有权检查有运行时开销吗？ {#q-所有权检查有运行时开销吗}](#q-所有权检查有运行时开销吗-q-所有权检查有运行时开销吗)
