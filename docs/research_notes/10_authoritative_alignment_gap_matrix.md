...
- [docs/research\_notes 权威国际化对齐缺口矩阵 {#docsresearch\_notes-权威国际化对齐缺口矩阵}](#docsresearch_notes-权威国际化对齐缺口矩阵-docsresearch_notes-权威国际化对齐缺口矩阵)
  ...
  - [📦 formal\_modules/ 形式化模块（Module） {#formal\_modules-形式化模块}](#-formal_modules-形式化模块-formal_modules-形式化模块)
...
| experiments/macro_expansion_performance | `docs/research_notes/experiments/10_macro_expansion_performance.md` | [Rust Reference – Macros](https://doc.rust-lang.org/reference/macros.html)、[The Rust Book – Macros](https://doc.rust-lang.org/book/ch19-06-macros.html) | [Macros in Rust: Little Book](https://danielkeep.github.io/tlborm/book/) | [Rust Performance Book – Macros](https://nnethercote.github.io/perf-book/procedural-macros.html) | 声明宏（Declarative Macro）与过程宏（Procedural Macro）对比、展开示意 | `cargo expand` 定量分析、compile-time 内存占用、proc-macro2 开销 | P1 | 补充 proc-macro 编译时间基准、`tt-call`/`tt-muncher` 性能对比 |
