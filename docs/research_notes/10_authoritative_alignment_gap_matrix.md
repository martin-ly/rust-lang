...
| software_design_theory/05_distributed | `docs/research_notes/software_design_theory/05_distributed/README.md` | [Cargo Book](https://doc.rust-lang.org/cargo/)、[Rust By Example – Networking](https://doc.rust-lang.org/rust-by-example/std_misc/file.html) | [DISTAL / 分布式系统形式化](https://decomposition.al/) | [Rust Design Patterns – Distributed](https://rust-unofficial.github.io/patterns/) | Saga、CQRS、Circuit Breaker 等模式 | 一致性模型、容错形式化、actor 模型与 tokio 集成 | P1 | 补充 `tarpc`/`tonic` 示例、一致性级别与错误恢复策略矩阵 |
