...
| 角色 | 文档 | 用途 |
| :--- | :--- | :--- |
| **导航** | [README](README.md)、[INDEX](INDEX.md)、[QUICK_REFERENCE](QUICK_REFERENCE.md)、[QUICK_FIND](QUICK_FIND.md) | 入口、索引、快速查找 |
...
| **规划** | [RESEARCH_ROADMAP](RESEARCH_ROADMAP.md)、[TASK_CHECKLIST](TASK_CHECKLIST.md)、[PROGRESS_TRACKING](PROGRESS_TRACKING.md)、[TASK_ORCHESTRATION_AND_EXECUTION_PLAN](TASK_ORCHESTRATION_AND_EXECUTION_PLAN.md) | 路线图、任务、进展 |
