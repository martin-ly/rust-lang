...
- [Rust 模块系统规范 {#rust-模块系统规范}](#rust-模块系统规范-rust-模块系统规范)
  - [目录 {#目录}](#目录-目录)
  - [研究目标 {#研究目标}](#研究目标-研究目标)
  - [概念定义 {#概念定义}](#概念定义-概念定义)
  - [属性关系 {#属性关系}](#属性关系-属性关系)
  - [解释与论证 {#解释与论证}](#解释与论证-解释与论证)
    - [模块树为何是树而非 DAG {#模块树为何是树而非-dag}](#模块树为何是树而非-dag-模块树为何是树而非-dag)
    - [`pub(in path)` 的形式化语义 {#pubin-path-的形式化语义}](#pubin-path-的形式化语义-pubin-path-的形式化语义)
    - [`pub use` 的封装意义 {#pub-use-的封装意义}](#pub-use-的封装意义-pub-use-的封装意义)
  - [Rust 示例 {#rust-示例}](#rust-示例-rust-示例)
    - [1. 基本模块结构 {#1-基本模块结构}](#1-基本模块结构-1-基本模块结构)
    - [2. 使用 `pub(in path)` {#2-使用-pubin-path}](#2-使用-pubin-path-2-使用-pubin-path)
    - [3. `pub use` 重导出 {#3-pub-use-重导出}](#3-pub-use-重导出-3-pub-use-重导出)
