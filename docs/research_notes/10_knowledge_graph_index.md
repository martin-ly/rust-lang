...
| depends_on | Pin | Future | `Future::poll` 要求 `Pin<&mut Self>`，Pin 是 Future 安全自引用的实现依赖 | [formal_methods/10_pin_self_referential.md](formal_methods/10_pin_self_referential.md) / P0: [Async Book – Pinning [已失效]]<!-- 原链接: https://rust-lang.github.io/async-book/ --> |
...
| contradicts | Pin 契约违反 | 自引用安全 | 破坏 Pin 的不移动契约将导致自引用指针失效 | [formal_methods/10_pin_self_referential.md](formal_methods/10_pin_self_referential.md) / P0: [Async Book – Pin contract [已失效]]<!-- 原链接: https://rust-lang.github.io/async-book/ --> |
