...
| 速查卡 | → 链接到指南 | → 链接到研究笔记 |
| :--- | :--- | :--- |
| [ownership_cheatsheet](../02_reference/quick_reference/02_ownership_cheatsheet.md) | [UNSAFE_RUST_GUIDE](../../concept/03_advanced/02_unsafe/01_unsafe.md) | [ownership_model](formal_methods/10_ownership_model.md) |
