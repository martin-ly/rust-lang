...
| [async_patterns.md](../02_reference/quick_reference/async_patterns.md) | [ASYNC_PROGRAMMING_USAGE_GUIDE](../05_guides/05_async_programming_usage_guide.md) | [async_state_machine](./formal_methods/async_state_machine.md) |
...
| **学习异步编程** | async_patterns → ASYNC_PROGRAMMING_USAGE_GUIDE → async_state_machine → pin_self_referential | [速查](../02_reference/quick_reference/async_patterns.md) → [指南](../05_guides/05_async_programming_usage_guide.md) → [形式化](./formal_methods/async_state_machine.md) |
