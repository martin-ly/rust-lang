...
2. **中期**：补全 [coq_skeleton](../../archive/deprecated/coq_skeleton/README.md)（归档只读） Admitted 证明；扩展 T-BR1/T-TY3 骨架（见 [COQ_ISABELLE_PROOF_SCAFFOLDING](10_coq_isabelle_proof_scaffolding.md)、[AENEAS_INTEGRATION_PLAN](10_aeneas_integration_plan.md)、[COQ_OF_RUST_INTEGRATION_PLAN](10_coq_of_rust_integration_plan.md)）
