...
> **EN**: Verification Tools Decision Tree
> **Summary**: 验证工具选型决策树 Verification Tools Decision Tree.
> **概念族**: 安全 / 验证
> **内容分级**: [归档级]
...
- [验证工具选型决策树 {#验证工具选型决策树}](#验证工具选型决策树-验证工具选型决策树)
  - [📑 目录 {#目录}](#-目录-目录)
  - [一、概述 {#一概述}](#一概述-一概述)
  - [二、快速决策表 {#二快速决策表}](#二快速决策表-二快速决策表)
    - [2.1 按需求快速选择 {#21-按需求快速选择}](#21-按需求快速选择-21-按需求快速选择)
    - [2.2 按经验水平选择 {#22-按经验水平选择}](#22-按经验水平选择-22-按经验水平选择)
  - [三、详细决策树 {#三详细决策树}](#三详细决策树-三详细决策树)
    - [3.1 第一层：验证目标 {#31-第一层验证目标}](#31-第一层验证目标-31-第一层验证目标)
    - [3.2 第二层：项目约束 {#32-第二层项目约束}](#32-第二层项目约束-32-第二层项目约束)
    - [3.3 第三层：团队能力 {#33-第三层团队能力}](#33-第三层团队能力-33-第三层团队能力)
  - [四、场景化推荐 {#四场景化推荐}](#四场景化推荐-四场景化推荐)
    - [4.1 场景矩阵 {#41-场景矩阵}](#41-场景矩阵-41-场景矩阵)
    - [4.2 典型决策路径 {#42-典型决策路径}](#42-典型决策路径-42-典型决策路径)
      - [路径 A：学术研究 {#路径-a学术研究}](#路径-a学术研究-路径-a学术研究)
      - [路径 B：工业应用 {#路径-b工业应用}](#路径-b工业应用-路径-b工业应用)
      - [路径 C：安全审计 {#路径-c安全审计}](#路径-c安全审计-路径-c安全审计)
  - [五、工具组合策略 {#五工具组合策略}](#五工具组合策略-五工具组合策略)
    - [5.1 分层验证策略 {#51-分层验证策略}](#51-分层验证策略-51-分层验证策略)
    - [5.2 推荐组合 {#52-推荐组合}](#52-推荐组合-52-推荐组合)
    - [5.3 渐进式采用路径 {#53-渐进式采用路径}](#53-渐进式采用路径-53-渐进式采用路径)
  - [六、相关资源 {#六相关资源}](#六相关资源-六相关资源)
    - [6.1 内部文档 {#61-内部文档}](#61-内部文档-61-内部文档)
    - [6.2 快速参考卡 {#62-快速参考卡}](#62-快速参考卡-62-快速参考卡)
    - [6.3 决策检查清单 {#63-决策检查清单}](#63-决策检查清单-63-决策检查清单)
