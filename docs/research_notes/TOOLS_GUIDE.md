...
- [Coq 教程](https://coq.inria.fr/tutorial)

---

### Lean

**用途**: 现代定理证明器，用于形式化数学和程序验证
...
- [Lean 文档](https://leanprover.github.io/learn/)
- [Lean 教程](https://leanprover.github.io/theorem_proving_in_lean/)
