...
> **概念族**: 版本特性
>
> **归档说明**: 本文档为历史研究笔记。Rust 1.96 稳定特性的权威来源已迁移至 [`concept/07_future/rust_1_96_stabilized.md`](../../concept/07_future/rust_1_96_stabilized.md)。
...
>
- [Rust 1.96.0 特性全面分析 {#rust-1960-特性全面分析}](#rust-1960-特性全面分析-rust-1960-特性全面分析)
  - [📑 目录 {#目录}](#-目录-目录)
  - [特性概述 {#特性概述}](#特性概述-特性概述)
    - [版本亮点 {#版本亮点}](#版本亮点-版本亮点)
  - [一、array\_windows 方法 {#一array\_windows-方法}](#一array_windows-方法-一array_windows-方法)
    - [1.1 特性描述 {#11-特性描述}](#11-特性描述-11-特性描述)
    - [1.2 代码示例 {#12-代码示例}](#12-代码示例-12-代码示例)
    - [1.3 ABBA 模式检测示例 {#13-abba-模式检测示例}](#13-abba-模式检测示例-13-abba-模式检测示例)
    - [1.4 使用场景 {#14-使用场景}](#14-使用场景-14-使用场景)
  - [二、element\_offset 方法 {#二element\_offset-方法}](#二element_offset-方法-二element_offset-方法)
    - [2.1 特性描述 {#21-特性描述}](#21-特性描述-21-特性描述)
    - [2.2 代码示例 {#22-代码示例}](#22-代码示例-22-代码示例)
  - [三、LazyCell 和 LazyLock 新方法 {#三lazycell-和-lazylock-新方法}](#三lazycell-和-lazylock-新方法-三lazycell-和-lazylock-新方法)
    - [3.1 新增 API {#31-新增-api}](#31-新增-api-31-新增-api)
    - [3.2 代码示例 {#32-代码示例}](#32-代码示例-32-代码示例)
  - [四、数学常量扩展 {#四数学常量扩展}](#四数学常量扩展-四数学常量扩展)
    - [4.1 新增常量 {#41-新增常量}](#41-新增常量-41-新增常量)
    - [4.2 代码示例 {#42-代码示例}](#42-代码示例-42-代码示例)
  - [五、迭代器增强 {#五迭代器增强}](#五迭代器增强-五迭代器增强)
    - [5.1 Peekable::next\_if\_map {#51-peekablenext\_if\_map}](#51-peekablenext_if_map-51-peekablenext_if_map)
  - [六、字符转换 {#六字符转换}](#六字符转换-六字符转换)
    - [6.1 `TryFrom<char>` for usize {#61-tryfromchar-for-usize}](#61-tryfromchar-for-usize-61-tryfromchar-for-usize)
  - [七、Const 上下文增强 {#七const-上下文增强}](#七const-上下文增强-七const-上下文增强)
    - [7.1 mul\_add 在 const 中稳定 {#71-mul\_add-在-const-中稳定}](#71-mul_add-在-const-中稳定-71-mul_add-在-const-中稳定)
  - [八、Cargo 新特性 {#八cargo-新特性}](#八cargo-新特性-八cargo-新特性)
    - [8.1 Config Inclusion {#81-config-inclusion}](#81-config-inclusion-81-config-inclusion)
    - [8.2 TOML 1.1 支持 {#82-toml-11-支持}](#82-toml-11-支持-82-toml-11-支持)
    - [8.3 pubtime 字段 {#83-pubtime-字段}](#83-pubtime-字段-83-pubtime-字段)
  - [九、平台支持 {#九平台支持}](#九平台支持-九平台支持)
    - [9.1 新增目标 {#91-新增目标}](#91-新增目标-91-新增目标)
    - [9.2 RISC-V 特性 {#92-risc-v-特性}](#92-risc-v-特性-92-risc-v-特性)
  - [十、语言改进 {#十语言改进}](#十语言改进-十语言改进)
    - [10.1 Lint 改进 {#101-lint-改进}](#101-lint-改进-101-lint-改进)
    - [10.2 Unicode 17 {#102-unicode-17}](#102-unicode-17-102-unicode-17)
  - [十一、兼容性说明 {#十一兼容性说明}](#十一兼容性说明-十一兼容性说明)
  - [十二、版本变更历史 {#十二版本变更历史}](#十二版本变更历史-十二版本变更历史)
  - [相关资源 {#相关资源}](#相关资源-相关资源)
  - [十三、Rust 1.95 新特性补充 {#十三rust-195-新特性补充}](#十三rust-195-新特性补充-十三rust-195-新特性补充)
    - [13.1 `if let` guards 示例 {#131-if-let-guards-示例}](#131-if-let-guards-示例-131-if-let-guards-示例)
    - [13.2 `cfg_select!` 示例 {#132-cfg\_select-示例}](#132-cfg_select-示例-132-cfg_select-示例)
  - [十四、Rust 1.96 后续新特性 {#十四rust-196-后续新特性}](#十四rust-196-后续新特性-十四rust-196-后续新特性)
    - [14.1 `core::range` 新类型 {#141-corerange-新类型}](#141-corerange-新类型-141-corerange-新类型)
    - [14.2 `assert_matches!` 与 `debug_assert_matches!` {#142-assert\_matches-与-debug\_assert\_matches}](#142-assert_matches-与-debug_assert_matches-142-assert_matches-与-debug_assert_matches)
    - [14.3 Cargo CVE-2026-5223 / CVE-2026-5222 修复 {#143-cargo-cve-2026-5223-cve-2026-5222-修复}](#143-cargo-cve-2026-5223--cve-2026-5222-修复-143-cargo-cve-2026-5223-cve-2026-5222-修复)
    - [14.4 WebAssembly 链接行为变更 {#144-webassembly-链接行为变更}](#144-webassembly-链接行为变更-144-webassembly-链接行为变更)
