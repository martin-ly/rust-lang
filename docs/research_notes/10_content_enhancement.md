...
- [研究笔记内容完善指南 {#研究笔记内容完善指南}](#研究笔记内容完善指南-研究笔记内容完善指南)
  - [📑 目录 {#目录}](#-目录-目录)
  - [层次推进计划（2026-02 新增） {#层次推进计划2026-02-新增}](#层次推进计划2026-02-新增-层次推进计划2026-02-新增)
    - [层次定义 {#层次定义}](#层次定义-层次定义)
    - [推进优先级（三阶段已完成 ✅） {#推进优先级三阶段已完成}](#推进优先级三阶段已完成--推进优先级三阶段已完成)
    - [实质内容检查清单（完成度） {#实质内容检查清单完成度}](#实质内容检查清单完成度-实质内容检查清单完成度)
    - [实质内容自检表（逐文档核对） {#实质内容自检表逐文档核对}](#实质内容自检表逐文档核对-实质内容自检表逐文档核对)
  - [📊 目录 {#目录-1}](#-目录-目录-1)
  - [🎯 指南概述 {#指南概述}](#-指南概述-指南概述)
  - [形式化论证规范 {#形式化论证规范}](#形式化论证规范-形式化论证规范)
  - [概念定义-属性关系-解释论证 层次化小节规范（2026-02 新增） {#概念定义-属性关系-解释论证-层次化小节规范2026-02-新增}](#概念定义-属性关系-解释论证-层次化小节规范2026-02-新增-概念定义-属性关系-解释论证-层次化小节规范2026-02-新增)
  - [矩阵与文档双向链接规范（2026-02 新增） {#矩阵与文档双向链接规范2026-02-新增}](#矩阵与文档双向链接规范2026-02-新增-矩阵与文档双向链接规范2026-02-新增)
  - [📚 理论基础部分完善 {#理论基础部分完善}](#-理论基础部分完善-理论基础部分完善)
    - [1. 补充相关概念 {#1-补充相关概念}](#1-补充相关概念-1-补充相关概念)
    - [2. 完善理论背景 {#2-完善理论背景}](#2-完善理论背景-2-完善理论背景)
    - [3. 添加理论联系 {#3-添加理论联系}](#3-添加理论联系-3-添加理论联系)
  - [🔬 形式化定义部分完善 {#形式化定义部分完善}](#-形式化定义部分完善-形式化定义部分完善)
    - [1. 完善形式化定义 {#1-完善形式化定义}](#1-完善形式化定义-1-完善形式化定义)
    - [2. 添加更多规则 {#2-添加更多规则}](#2-添加更多规则-2-添加更多规则)
    - [3. 提供证明框架 {#3-提供证明框架}](#3-提供证明框架-3-提供证明框架)
  - [💻 代码示例部分完善 {#代码示例部分完善}](#-代码示例部分完善-代码示例部分完善)
    - [1. 添加更多示例 {#1-添加更多示例}](#1-添加更多示例-1-添加更多示例)
    - [示例 2: 函数参数的所有权（Ownership）转移 {#示例-2-函数参数的所有权转移}](#示例-2-函数参数的所有权转移-示例-2-函数参数的所有权转移)
    - [2. 添加复杂场景 {#2-添加复杂场景}](#2-添加复杂场景-2-添加复杂场景)
    - [3. 添加错误示例 {#3-添加错误示例}](#3-添加错误示例-3-添加错误示例)
  - [📖 参考文献部分完善 {#参考文献部分完善}](#-参考文献部分完善-参考文献部分完善)
    - [1. 补充学术论文 {#1-补充学术论文}](#1-补充学术论文-1-补充学术论文)
    - [2. 添加官方文档 {#2-添加官方文档}](#2-添加官方文档-2-添加官方文档)
    - [3. 链接相关代码 {#3-链接相关代码}](#3-链接相关代码-3-链接相关代码)
  - [✅ 完善检查清单 {#完善检查清单}](#-完善检查清单-完善检查清单)
    - [理论基础部分 {#理论基础部分}](#理论基础部分-理论基础部分)
    - [形式化定义部分 {#形式化定义部分}](#形式化定义部分-形式化定义部分)
    - [代码示例部分 {#代码示例部分}](#代码示例部分-代码示例部分)
    - [参考文献部分 {#参考文献部分}](#参考文献部分-参考文献部分)
    - [整体质量 {#整体质量}](#整体质量-整体质量)
  - [🔗 相关资源 {#相关资源}](#-相关资源-相关资源)
    - [核心文档 {#核心文档}](#核心文档-核心文档)
    - [完善工具 {#完善工具}](#完善工具-完善工具)
...
| **L3 深化** | 证明思路 + 与理论衔接 | 证明草图、交叉引用（Reference）、决策树 | 证明思路、与 ownership/borrow 衔接 |
...
| 反例 | 至少 1 个反例或边界说明 | 双重可变借用（Mutable Borrow）、unwrap 空 Option |
...
- [研究笔记内容完善指南 {#研究笔记内容完善指南}](#研究笔记内容完善指南-研究笔记内容完善指南)
  ...
  - [💻 代码示例部分完善 {#代码示例部分完善}](#-代码示例部分完善-代码示例部分完善)
    - [1. 添加更多示例 {#1-添加更多示例}](#1-添加更多示例-1-添加更多示例)
    - [示例 2: 函数参数的所有权转移 {#示例-2-函数参数的所有权转移}](#示例-2-函数参数的所有权转移-示例-2-函数参数的所有权转移)
    - [2. 添加复杂场景 {#2-添加复杂场景}](#2-添加复杂场景-2-添加复杂场景)
    - [3. 添加错误示例 {#3-添加错误示例}](#3-添加错误示例-3-添加错误示例)
  - [📖 参考文献部分完善 {#参考文献部分完善}](#-参考文献部分完善-参考文献部分完善)
    - [1. 补充学术论文 {#1-补充学术论文}](#1-补充学术论文-1-补充学术论文)
...
- [类型系统（Type System）基础](type_theory/10_type_system_foundations.md)
