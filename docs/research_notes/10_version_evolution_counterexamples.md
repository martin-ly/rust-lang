...
## 1. Edition 2024 drop order 尾部表达式变化
...
> **权威来源**: [Rust Edition Guide – Tail Expr Drop Order](https://doc.rust-lang.org/edition-guide/rust-2024/tail-expr-drop-order.html)

---

## 2. `unsafe_op_in_unsafe_fn` lint 默认启用
...
- [Rust 1.94 研究更新](10_rust_194_research_update.md)
