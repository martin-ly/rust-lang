...
| 版本范围 | 官方链接 | 项目文档 |
|----------|----------|----------|
| Rust 1.96 | [https://github.com/rust-lang/rust/releases/tag/1.96.1 [已失效]]<!-- 原链接: https://github.com/rust-lang/rust/releases/tag/1.96.1 --> | [10_version_evolution_counterexamples.md](10_version_evolution_counterexamples.md) |
