...
> **权威来源（Canonical）**: 本文件为高级类型特性形式化研究笔记；通用 Rust 概念解释请以 concept 权威页为准：[`concept L2 泛型`](../../../concept/02_intermediate/01_generics/01_generics.md) · [`concept L2 类型系统`](../../../concept/01_foundation/02_type_system/01_type_system.md)
>
