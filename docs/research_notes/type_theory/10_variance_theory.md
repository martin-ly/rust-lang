...
- [型变理论 {#型变理论}](#型变理论-型变理论)
  ...
  - [⚠️ 反例：型变规则必要性 {#反例型变规则必要性}](#️-反例型变规则必要性-反例型变规则必要性)
    - [反例 1：`&mut T` 若协变则悬垂引用（Reference） {#反例-1mut-t-若协变则悬垂引用}](#反例-1mut-t-若协变则悬垂引用-反例-1mut-t-若协变则悬垂引用)
  ...
  - [💻 代码示例与实践 {#代码示例与实践}](#-代码示例与实践-代码示例与实践)
    ...
    - [示例 6: 型变与内存安全（Memory Safety） {#示例-6-型变与内存安全}](#示例-6-型变与内存安全-示例-6-型变与内存安全)
  ...
  - [🔗 系统集成与实际应用 {#系统集成与实际应用}](#-系统集成与实际应用-系统集成与实际应用)
    ...
    - [组合法则：类型 + 生命周期（Lifetimes） + 型变 {#组合法则类型-生命周期-型变}](#组合法则类型--生命周期--型变-组合法则类型-生命周期-型变)
