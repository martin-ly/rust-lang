...
4. **Ferrocene FLS** — Rust 1.93 形式化规范
   ...
   - 与本目录: outlives、引用有效性 T2 对应；[Rust 官方采纳 2025](https://blog.rust-lang.org/2025/03/26/adopting-the-fls/README.md)
...
**国际权威对标**：[RustBelt](https://plv.mpi-sws.org/rustbelt/README.md)、[Polonius](https://rust-lang.github.io/polonius/README.md)；区域类型、NLL、datalog 形式化；[FLS Ch. 15.3–15.4](https://spec.ferrocene.dev/ownership-and-deconstruction.html) References、Borrowing。
