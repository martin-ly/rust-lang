...
- [型变概念族谱 {#型变概念族谱}](#型变概念族谱-型变概念族谱)
  ...
  - [三、型变组合规则 {#三型变组合规则}](#三型变组合规则-三型变组合规则)
    ...
    - [结构体（Struct）的型变 {#结构体的型变}](#结构体的型变-结构体的型变)
  - [四、型变的实际影响 {#四型变的实际影响}](#四型变的实际影响-四型变的实际影响)
    - [影响1: 生命周期（Lifetimes）子类型 {#影响1-生命周期子类型}](#影响1-生命周期子类型-影响1-生命周期子类型)
    - [影响2: 智能指针（Smart Pointer）的使用 {#影响2-智能指针的使用}](#影响2-智能指针的使用-影响2-智能指针的使用)
