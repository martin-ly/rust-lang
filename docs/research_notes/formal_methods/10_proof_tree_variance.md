...
- [证明树：型变安全](#证明树型变安全)
  - [📑 目录](#-目录)
  - [定理陈述](#定理陈述)
    - [Def VA-1 (协变)](#def-va-1-协变)
    - [Def VA-2 (逆变)](#def-va-2-逆变)
    - [Def VA-3 (不变)](#def-va-3-不变)
    - [Thm VA-T1 (协变安全)](#thm-va-t1-协变安全)
    - [Thm VA-T2 (逆变安全)](#thm-va-t2-逆变安全)
    - [Thm VA-T3 (不变必要)](#thm-va-t3-不变必要)
  - [证明树可视化](#证明树可视化)
  - [形式化证明](#形式化证明)
    - [VA-T1: 协变安全](#va-t1-协变安全)
    - [VA-T2: 逆变安全](#va-t2-逆变安全)
    - [VA-T3: 不变必要](#va-t3-不变必要)
  - [Rust 代码示例](#rust-代码示例)
    - [协变示例](#协变示例)
    - [逆变示例](#逆变示例)
    - [不变示例](#不变示例)
