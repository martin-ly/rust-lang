...
- [并发概念族谱](#并发概念族谱)
  - [📑 目录](#-目录)
  - [并发概念全景](#并发概念全景)
  - [一、线程 (Thread)](#一线程-thread)
    - [1.1 OS线程](#11-os线程)
    - [1.2 线程池](#12-线程池)
  - [二、同步原语](#二同步原语)
    - [2.1 互斥锁 (Mutex)](#21-互斥锁-mutex)
    - [2.2 读写锁 (RwLock)](#22-读写锁-rwlock)
    - [2.3 原子操作](#23-原子操作)
    - [2.4 其他原语](#24-其他原语)
  - [三、异步 (Async)](#三异步-async)
    - [3.1 Future](#31-future)
    - [3.2 async/await](#32-asyncawait)
    - [3.3 Pin](#33-pin)
    - [3.4 执行器与反应器](#34-执行器与反应器)
  - [四、Send与Sync](#四send与sync)
    - [4.1 Send](#41-send)
    - [4.2 Sync](#42-sync)
    - [4.3 Send/Sync关系](#43-sendsync关系)
  - [五、内存模型](#五内存模型)
    - [5.1 Happens-Before](#51-happens-before)
    - [5.2 内存排序](#52-内存排序)
  - [六、与所有权的关系](#六与所有权的关系)
  - [七、形式化保证](#七形式化保证)
    - [定理](#定理)
