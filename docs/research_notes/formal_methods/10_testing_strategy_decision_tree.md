...
- [Rust 测试策略决策树 {#rust-测试策略决策树}](#rust-测试策略决策树-rust-测试策略决策树)
  - [📑 目录 {#目录}](#-目录-目录)
  - [快速决策索引 {#快速决策索引}](#快速决策索引-快速决策索引)
  - [一、测试类型选择决策树 {#一测试类型选择决策树}](#一测试类型选择决策树-一测试类型选择决策树)
    - [1.1 单元测试 (Unit Tests) {#11-单元测试-unit-tests}](#11-单元测试-unit-tests-11-单元测试-unit-tests)
    - [1.2 集成测试 (Integration Tests) {#12-集成测试-integration-tests}](#12-集成测试-integration-tests-12-集成测试-integration-tests)
    - [1.3 文档测试 (Doc Tests) {#13-文档测试-doc-tests}](#13-文档测试-doc-tests-13-文档测试-doc-tests)
    - [1.4 基准测试 (Benchmarks) {#14-基准测试-benchmarks}](#14-基准测试-benchmarks-14-基准测试-benchmarks)
    - [1.5 模糊测试 (Fuzz Testing) {#15-模糊测试-fuzz-testing}](#15-模糊测试-fuzz-testing-15-模糊测试-fuzz-testing)
  ...
  - [三、测试策略维度 {#三测试策略维度}](#三测试策略维度-三测试策略维度)
    - [3.1 测试金字塔 {#31-测试金字塔}](#31-测试金字塔-31-测试金字塔)
    - [3.2 覆盖率目标 {#32-覆盖率目标}](#32-覆盖率目标-32-覆盖率目标)
    - [3.3 CI 集成策略 {#33-ci-集成策略}](#33-ci-集成策略-33-ci-集成策略)
    - [3.4 性能回归防护 {#34-性能回归防护}](#34-性能回归防护-34-性能回归防护)
  - [四、最佳实践 {#四最佳实践}](#四最佳实践-四最佳实践)
    - [4.1 测试组织结构 {#41-测试组织结构}](#41-测试组织结构-41-测试组织结构)
    - [4.2 测试数据管理 {#42-测试数据管理}](#42-测试数据管理-42-测试数据管理)
    - [4.3 异步测试模式 {#43-异步测试模式}](#43-异步测试模式-43-异步测试模式)
    - [4.4 测试文档化 {#44-测试文档化}](#44-测试文档化-44-测试文档化)
  - [五、决策流程图 {#五决策流程图}](#五决策流程图-五决策流程图)
  - [六、快速参考卡片 {#六快速参考卡片}](#六快速参考卡片-六快速参考卡片)
    - [6.1 常用命令 {#61-常用命令}](#61-常用命令-61-常用命令)
    - [6.2 常用属性 {#62-常用属性}](#62-常用属性-62-常用属性)
  - [七、推荐配置模板 {#七推荐配置模板}](#七推荐配置模板-七推荐配置模板)
    - [7.1 Cargo.toml 测试配置 {#71-cargotoml-测试配置}](#71-cargotoml-测试配置-71-cargotoml-测试配置)
    - [7.2 测试环境配置 {#72-测试环境配置}](#72-测试环境配置-72-测试环境配置)
  - [八、参考资源 {#八参考资源}](#八参考资源-八参考资源)
