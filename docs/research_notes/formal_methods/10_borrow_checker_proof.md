...
- [借用检查器证明](#借用检查器证明)
  ...
  - [与 Aeneas 对比](#与-aeneas-对比)
    ...
    - [borrow\_generated\_from 与借用有效性](#borrow_generated_from-与借用有效性)
      - [Aeneas: borrow\_generated\_from](#aeneas-borrow_generated_from)
...
## 🆕 最新别名模型与操作语义（Tree Borrows / RustSEM / RustBelt / Oxide）
>
...
- 根据 [send_sync_formalization](../../../archive/research_notes_2026_06_25/formal_methods/10_send_sync_formalization.md) 定理 SEND-T1：$\text{Send}(T) \to \text{SafeToTransferAcrossThreads}(T)$
...
- 根据 [send_sync_formalization](../../../archive/research_notes_2026_06_25/formal_methods/10_send_sync_formalization.md) 定理 SEND-T1 和 SYNC-T1
- `Send` 保证跨线程转移安全
- `Sync` 保证跨线程共享安全
...
与 [type_system_foundations](../../../archive/research_notes_2026_06_25/type_theory/10_type_system_foundations.md) Def DEREF-NULL1 衔接。
