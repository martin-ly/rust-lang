...
| [borrow_checker_proof](10_borrow_checker_proof.md) | ✅ 规则 5–8 | ✅ 与 ownership/lifetime/Send | ✅ 数据竞争定义、理论 | ✅ T1, T2 | ✅ 双重可变借用（Mutable Borrow）、悬垂 | ✅ 同上 |
| lifetime_formalization | ✅ LF1–LF2, Def 1.4, $\ell \subseteq \text{lft}$ | ✅ 与 borrow、型变 | ✅ 区域类型、NLL | ✅ LF-T1–T3 | ✅ 返回局部引用（Reference）、存短命 | ✅ 矩阵/证明树 |
| [async_state_machine](10_async_state_machine.md) | ✅ Def 4.1–5.2（Future、Poll） | ✅ 与 Pin、Send/Sync | ✅ 状态机、并发安全（Concurrency Safety） | ✅ T6.1–T6.3, SPAWN-T1 | ✅ 非 Send 跨线程、未 Pin | ✅ 导图/矩阵/证明树/决策树 |
