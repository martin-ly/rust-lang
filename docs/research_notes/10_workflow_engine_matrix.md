...
- [工作流引擎能力矩阵 {#工作流引擎能力矩阵}](#工作流引擎能力矩阵-工作流引擎能力矩阵)
  - [📑 目录 {#目录}](#-目录-目录)
  - [一、概述 {#一概述}](#一概述-一概述)
  - [二、能力维度 {#二能力维度}](#二能力维度-二能力维度)
    - [2.1 维度分类 {#21-维度分类}](#21-维度分类-21-维度分类)
    - [2.2 维度层次 {#22-维度层次}](#22-维度层次-22-维度层次)
  - [三、核心能力矩阵 {#三核心能力矩阵}](#三核心能力矩阵-三核心能力矩阵)
    - [3.1 建模能力矩阵 {#31-建模能力矩阵}](#31-建模能力矩阵-31-建模能力矩阵)
    - [3.2 执行能力矩阵 {#32-执行能力矩阵}](#32-执行能力矩阵-32-执行能力矩阵)
    - [3.3 网关能力矩阵 {#33-网关能力矩阵}](#33-网关能力矩阵-33-网关能力矩阵)
  - [四、模式支持矩阵 {#四模式支持矩阵}](#四模式支持矩阵-四模式支持矩阵)
    - [4.1 BPMN 模式支持 {#41-bpmn-模式支持}](#41-bpmn-模式支持-41-bpmn-模式支持)
    - [4.2 高级模式支持 {#42-高级模式支持}](#42-高级模式支持-42-高级模式支持)
  - [五、事务能力矩阵 {#五事务能力矩阵}](#五事务能力矩阵-五事务能力矩阵)
    - [5.1 事务特性矩阵 {#51-事务特性矩阵}](#51-事务特性矩阵-51-事务特性矩阵)
    - [5.2 补偿能力矩阵 {#52-补偿能力矩阵}](#52-补偿能力矩阵-52-补偿能力矩阵)
    - [5.3 持久化矩阵 {#53-持久化矩阵}](#53-持久化矩阵-53-持久化矩阵)
  - [六、相关资源 {#六相关资源}](#六相关资源-六相关资源)
    - [6.1 内部文档 {#61-内部文档}](#61-内部文档-61-内部文档)
    - [6.2 工作流定义文档 {#62-工作流定义文档}](#62-工作流定义文档-62-工作流定义文档)
    - [6.3 能力评估框架 {#63-能力评估框架}](#63-能力评估框架-63-能力评估框架)
