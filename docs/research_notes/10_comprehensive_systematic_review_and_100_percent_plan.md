...
- [Rust Research Notes: 全面系统梳理与100%完成计划](#rust-research-notes-全面系统梳理与100完成计划)
  ...
  - [二、现状全面分析](#二现状全面分析)
    ...
    - [2.2 形式化论证覆盖度评估](#22-形式化论证覆盖度评估)
      - [2.2.1 formal\_methods 覆盖度](#221-formal_methods-覆盖度)
      - [2.2.2 type\_theory 覆盖度](#222-type_theory-覆盖度)
      - [2.2.3 software\_design\_theory 覆盖度](#223-software_design_theory-覆盖度)
