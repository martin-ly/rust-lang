...
**选型决策树（按需求选模式）**：见 [03_semantic_boundary_map §按需求反向查模式](../../../archive/deprecated_20260318/research_notes/software_design_theory/02_workflow_safe_complete_models/03_semantic_boundary_map.md#按需求反向查模式)（快速查找表 + 决策树精简）；本矩阵与彼处一一对应。
