...
枚举 + match 求值，由 [type_system_foundations](../../../type_theory/10_type_system_foundations.md) 穷尽匹配保证完备性。
...
以下示例已在 **Rust 1.96.0+ (Edition 2024)** 语义下校验，使用 `递归 enum 表达式树、trait Interpret` 等现代惯用法。
