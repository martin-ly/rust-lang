...
| 权威来源 | 对应章节 / 条款 | 与本模式关系 |
| :--- | :--- | :--- |
| Rust Design Patterns | [Structural Patterns – Flyweight](https://rust-unofficial.github.io/patterns/patterns/structural/flyweight.html) | Rust 惯用实现与模式定位 |
...
以下示例已在 **Rust 1.96.1+ (Edition 2024)** 语义下校验，使用 `Arc/Rc 共享内部状态、工厂缓存` 等现代惯用法。
