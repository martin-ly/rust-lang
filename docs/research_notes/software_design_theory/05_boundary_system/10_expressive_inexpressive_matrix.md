...
- [充分表达 vs 非充分表达边界矩阵 {#充分表达-vs-非充分表达边界矩阵}](#充分表达-vs-非充分表达边界矩阵-充分表达-vs-非充分表达边界矩阵)
  - [📑 目录 {#目录}](#-目录-目录)
  - [形式化定义与公理 {#形式化定义与公理}](#形式化定义与公理-形式化定义与公理)
  - [反例：违反表达边界 {#反例违反表达边界}](#反例违反表达边界-反例违反表达边界)
  - [定义（非形式化对照） {#定义非形式化对照}](#定义非形式化对照-定义非形式化对照)
  - [设计模式 × 表达边界 {#设计模式-表达边界}](#设计模式--表达边界-设计模式-表达边界)
    - [创建型（5） {#创建型5}](#创建型5-创建型5)
    - [结构型（7） {#结构型7}](#结构型7-结构型7)
    - [行为型（11） {#行为型11}](#行为型11-行为型11)
  - [执行模型 × 表达边界 {#执行模型-表达边界}](#执行模型--表达边界-执行模型-表达边界)
  - [近似表达详解 {#近似表达详解}](#近似表达详解-近似表达详解)
  - [等价表达示例 {#等价表达示例}](#等价表达示例-等价表达示例)
  - [不可表达边界说明 {#不可表达边界说明}](#不可表达边界说明-不可表达边界说明)
  - [从 OOP 迁移建议 {#从-oop-迁移建议}](#从-oop-迁移建议-从-oop-迁移建议)
  - [Adapter 等价表达示例 {#adapter-等价表达示例}](#adapter-等价表达示例-adapter-等价表达示例)
  - [Composite 等价表达示例 {#composite-等价表达示例}](#composite-等价表达示例-composite-等价表达示例)
  - [不可表达边界说明（扩展） {#不可表达边界说明扩展}](#不可表达边界说明扩展-不可表达边界说明扩展)
  - [场景化决策示例（层次推进） {#场景化决策示例层次推进}](#场景化决策示例层次推进-场景化决策示例层次推进)
