...
| 异步 | async T6.1–T6.3（状态一致性、并发安全、进度保证）、pin T1–T3、Send 边界 | [async_state_machine](../../formal_methods/10_async_state_machine.md)、[pin_self_referential](../../formal_methods/10_pin_self_referential.md) |
