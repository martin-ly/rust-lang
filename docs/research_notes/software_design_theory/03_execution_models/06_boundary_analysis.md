...
并发场景细分
├── 需 I/O 并发（网络、磁盘、定时器）？
│   └── 是 → async/await（tokio、async-std [已归档]）
...
| 机制 | 适用场景 | 形式化边界 | crate |
| :--- | :--- | :--- | :--- |
| **async** | I/O 并发、高连接数 | T6.1–T6.3、Send 约束 | tokio、async-std [已归档] |
...
*依据*：[HIERARCHICAL_MAPPING_AND_SUMMARY](../../../research_notes/10_hierarchical_mapping_and_summary.md) § 文档↔思维表征。
