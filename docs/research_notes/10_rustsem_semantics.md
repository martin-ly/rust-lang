...
| 域 | 定义 | 说明 |
|----|------|------|
| **Val** | 整数 ∪ 布尔 ∪ 引用 ∪ 闭包（Closures） | 可存储的值 |
| **Loc** | 地址空间 | 堆地址 |
...
- [CORE_THEOREMS_FULL_PROOFS](10_core_theorems_full_proofs.md) — 定理证明
