...
- [概念对比表汇编 {#概念对比表汇编}](#概念对比表汇编-概念对比表汇编)
  ...
  - [五、分布式模式对比 {#五分布式模式对比}](#五分布式模式对比-五分布式模式对比)
    - [Saga vs 2PC {#saga-vs-2pc}](#saga-vs-2pc-saga-vs-2pc)
    - [编排式 vs 编制式 Saga {#编排式-vs-编制式-saga}](#编排式-vs-编制式-saga-编排式-vs-编制式-saga)
    - [CQRS vs CRUD {#cqrs-vs-crud}](#cqrs-vs-crud-cqrs-vs-crud)
  - [六、工作流对比 {#六工作流对比}](#六工作流对比-六工作流对比)
    - [编排 vs 编制 {#编排-vs-编制}](#编排-vs-编制-编排-vs-编制)
    - [向后补偿 vs 向前补偿 {#向后补偿-vs-向前补偿}](#向后补偿-vs-向前补偿-向后补偿-vs-向前补偿)
...
| 特性 | &T (不可变借用（Immutable Borrow）) | &mut T (可变借用（Mutable Borrow）) |
| :--- | :--- | :--- |
| **读** | ✅ | ✅ |
| **写** | ❌ | ✅ |
| **数量** | 多个 | 只能一个 |
