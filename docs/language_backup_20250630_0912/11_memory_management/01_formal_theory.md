...
- [Rust 内存管理：形式化理论与哲学基础](#rust-内存管理形式化理论与哲学基础)
  - [目录](#目录)
  - [1. 引言](#1-引言)
    - [1.1 Rust 内存管理的理论视角](#11-rust-内存管理的理论视角)
    - [1.2 形式化定义](#12-形式化定义)
  - [2. 哲学基础](#2-哲学基础)
    - [2.1 资源本体论](#21-资源本体论)
    - [2.2 Rust 视角下的内存哲学](#22-rust-视角下的内存哲学)
  - [3. 数学理论](#3-数学理论)
    - [3.1 所有权与借用](#31-所有权与借用)
    - [3.2 生命周期](#32-生命周期)
    - [3.3 分配与释放](#33-分配与释放)
  - [4. 形式化模型](#4-形式化模型)
    - [4.1 所有权转移](#41-所有权转移)
