...
>
- [API 使用指南 {#api-使用指南}](#api-使用指南-api-使用指南)
  - [📑 目录 {#目录}](#-目录-目录)
  - [快速开始 {#快速开始}](#快速开始-快速开始)
    - [添加依赖 {#添加依赖}](#添加依赖-添加依赖)
    - [基本使用 {#基本使用}](#基本使用-基本使用)
  - [Crate API 概览 {#crate-api-概览}](#crate-api-概览-crate-api-概览)
    - [c01\_ownership\_borrow\_scope {#c01\_ownership\_borrow\_scope}](#c01_ownership_borrow_scope-c01_ownership_borrow_scope)
    - [c02\_type\_system {#c02\_type\_system}](#c02_type_system-c02_type_system)
    - [c04\_generic {#c04\_generic}](#c04_generic-c04_generic)
    - [c05\_threads {#c05\_threads}](#c05_threads-c05_threads)
    - [c06\_async {#c06\_async}](#c06_async-c06_async)
    - [c08\_algorithms {#c08\_algorithms}](#c08_algorithms-c08_algorithms)
  - [最佳实践 {#最佳实践}](#最佳实践-最佳实践)
    - [错误处理 {#错误处理}](#错误处理-错误处理)
    - [异步代码 {#异步代码}](#异步代码-异步代码)
    - [并发控制 {#并发控制}](#并发控制-并发控制)
