...
- [代码生成概览](#代码生成概览)
  - [Rust代码生成的特点](#rust代码生成的特点)
- [代码生成实现](#代码生成实现)
  - [1. 中间表示 (Intermediate Representation)](#1-中间表示-intermediate-representation)
    - [1.1 MIR (Mid-level IR)](#11-mir-mid-level-ir)
    - [1.2 LLVM IR 生成](#12-llvm-ir-生成)
  - [2. 目标代码生成 (Target Code Generation)](#2-目标代码生成-target-code-generation)
    - [2.1 x86-64 代码生成](#21-x86-64-代码生成)
- [总结](#总结)
