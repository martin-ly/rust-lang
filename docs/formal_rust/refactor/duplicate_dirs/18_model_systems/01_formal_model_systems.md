...
- [1. 模型系统基础理论](#1-模型系统基础理论)
  - [1.1 模型系统的数学定义](#11-模型系统的数学定义)
  - [1.2 状态机模型](#12-状态机模型)
- [2. 模型验证理论](#2-模型验证理论)
  - [2.1 模型检查](#21-模型检查)
  - [2.2 模型验证实现](#22-模型验证实现)
- [3. 模型抽象与简化](#3-模型抽象与简化)
  - [3.1 抽象理论](#31-抽象理论)
  - [3.2 模型简化算法](#32-模型简化算法)
- [4. 模型合成理论](#4-模型合成理论)
  - [4.1 模型组合](#41-模型组合)
  - [4.2 模型合成实现](#42-模型合成实现)
- [5. 形式化证明](#5-形式化证明)
  - [5.1 模型检查正确性证明](#51-模型检查正确性证明)
  - [5.2 抽象正确性证明](#52-抽象正确性证明)
  - [5.3 合成正确性证明](#53-合成正确性证明)
- [结论](#结论)
- [参考文献](#参考文献)
