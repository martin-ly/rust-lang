...
- [📅 文档信息](#文档信息)
- [1. 概述](#1-概述)
  - [1.1 模型检查理论基础](#11-模型检查理论基础)
  - [1.2 模型检查公理](#12-模型检查公理)
- [2. 状态空间理论](#2-状态空间理论)
  - [2.1 状态空间模型](#21-状态空间模型)
  - [2.2 状态空间探索](#22-状态空间探索)
- [3. 时态逻辑理论](#3-时态逻辑理论)
  - [3.1 线性时态逻辑 (LTL)](#31-线性时态逻辑-ltl)
  - [3.2 计算树逻辑 (CTL)](#32-计算树逻辑-ctl)
- [4. 自动机理论](#4-自动机理论)
  - [4.1 Büchi自动机](#41-büchi自动机)
  - [4.2 乘积自动机](#42-乘积自动机)
- [5. 模型检查算法](#5-模型检查算法)
  - [5.1 显式状态模型检查](#51-显式状态模型检查)
  - [5.2 符号模型检查](#52-符号模型检查)
- [6. 反例生成理论](#6-反例生成理论)
  - [6.1 反例结构体体体](#61-反例结构体体体)
  - [6.2 最小反例](#62-最小反例)
- [7. 抽象模型检查](#7-抽象模型检查)
  - [7.1 抽象模型](#71-抽象模型)
  - [7.2 反例引导抽象细化](#72-反例引导抽象细化)
- [8. 并发模型检查](#8-并发模型检查)
  - [8.1 并发系统模型](#81-并发系统模型)
  - [8.2 状态爆炸问题](#82-状态爆炸问题)
- [9. 实时模型检查](#9-实时模型检查)
  - [9.1 时间自动机](#91-时间自动机)
  - [9.2 区域图](#92-区域图)
- [10. 概率模型检查](#10-概率模型检查)
  - [10.1 马尔可夫链](#101-马尔可夫链)
  - [10.2 概率时态逻辑](#102-概率时态逻辑)
- [11. 参数化模型检查](#11-参数化模型检查)
  - [11.1 参数化系统](#111-参数化系统)
  - [11.2 归纳方法](#112-归纳方法)
- [12. 模型检查工具理论](#12-模型检查工具理论)
  - [12.1 工具架构](#121-工具架构)
  - [12.2 工具集成](#122-工具集成)
- [13. 模型检查应用](#13-模型检查应用)
  - [13.1 协议验证](#131-协议验证)
...
- [14. 模型检查优化](#14-模型检查优化)
  - [14.1 状态压缩](#141-状态压缩)
  - [14.2 并行模型检查](#142-并行模型检查)
- [15. 总结](#15-总结)
  - [15.1 模型检查完整性](#151-模型检查完整性)
