...
- [📅 文档信息](#文档信息)
- [1. 概述](#1-概述)
  - [1.1 静态分析理论基础](#11-静态分析理论基础)
  - [1.2 静态分析公理](#12-静态分析公理)
- [2. 抽象解释理论](#2-抽象解释理论)
  - [2.1 抽象域](#21-抽象域)
  - [2.2 伽罗瓦连接](#22-伽罗瓦连接)
- [3. 数据流分析理论](#3-数据流分析理论)
  - [3.1 数据流方程](#31-数据流方程)
  - [3.2 可达定义分析](#32-可达定义分析)
- [4. 控制流分析理论](#4-控制流分析理论)
  - [4.1 控制流图](#41-控制流图)
  - [4.2 支配关系](#42-支配关系)
- [5. 类型分析理论](#5-类型分析理论)
...
- [9. 安全分析理论](#9-安全分析理论)
  ...
  - [9.2 信息流分析](#92-信息流分析)
- [10. 性能分析理论](#10-性能分析理论)
  - [10.1 复杂度分析](#101-复杂度分析)
  - [10.2 瓶颈分析](#102-瓶颈分析)
- [11. 程序切片理论](#11-程序切片理论)
  - [11.1 程序切片](#111-程序切片)
  - [11.2 依赖分析](#112-依赖分析)
- [12. 抽象语法树分析](#12-抽象语法树分析)
  - [12.1 AST结构体体体](#121-ast结构体体体)
  - [12.2 AST遍历](#122-ast遍历)
- [13. 静态分析工具理论](#13-静态分析工具理论)
  - [13.1 工具架构](#131-工具架构)
  - [13.2 工具集成](#132-工具集成)
- [14. 静态分析优化](#14-静态分析优化)
  - [14.1 分析精度](#141-分析精度)
