...
泛型枚举允许枚举成员携带类型参数，广泛用于表达可选值、错误处理等场景。
Rust标准库中的`Option<T>`、`Result<T, E>`均为泛型枚举典范。
相关理论详见[泛型系统理论](../../04_generics/01_formal_generics_system.md)与[代数数据类型](../../02_type_system/02_fundamental_concepts.md#代数数据类型)。
