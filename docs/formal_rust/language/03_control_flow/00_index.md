...
| 异步控制流 | [模块 06: 异步/等待](../06_async_await/01_formal_async_system.md#异步控制流) | 06, 03 |
...
- **定义 3.2**: [模式匹配](02_pattern_matching_system.md#模式匹配定义) - 结构体化数据解构与条件控制的统一机制
...
- 证明方法：结构体归纳、状态移动归纳、自动化模型检验、反例生成。
