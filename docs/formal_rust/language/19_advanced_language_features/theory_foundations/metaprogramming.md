...
- [1. 编译期反射与代码生成](#1-编译期反射与代码生成)
- [1.1 宏系统形式化模型](#11-宏系统形式化模型)
- [1.2 卫生性与安全](#12-卫生性与安全)
- [1.3 编译期反射与类型安全](#13-编译期反射与类型安全)
- [3.1 宏卫生性定理](#31-宏卫生性定理)
- [3.2 元编程类型安全定理](#32-元编程类型安全定理)
- [2. 工程案例](#2-工程案例)
- [1.4 工程伪代码与类型推导](#14-工程伪代码与类型推导)
- [1.5 类型推导与反射安全链条](#15-类型推导与反射安全链条)
- [3. 批判性分析与未来值值值展望](#3-批判性分析与未来值值值展望)
