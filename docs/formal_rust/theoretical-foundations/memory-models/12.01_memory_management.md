...
fn main() {
    ...
    println!("借用计数: {}", unsafe { *ptr1.reference_count });
    
    drop(ptr1);
    println!("借用计数: {}", unsafe { *ptr2.reference_count });
...
fn main() {
    ...
    // 错误3: 内存泄漏
    // let mut list = Node::new(1);
    // list.next = Some(Box::new(list)); // 错误：循环借用
    
    // 错误4: 数据竞争
    // let mut data = vec![1, 2, 3];
    // let ref1 = &data;
    // let ref2 = &mut data; // 错误：同时存在可变和不可变借用
}
```
