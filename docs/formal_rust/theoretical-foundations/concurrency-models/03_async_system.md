...
- [Rust异步系统形式化理论](#rust异步系统形式化理论)
  ...
  - [3. 异步编程模型形式化理论](#3-异步编程模型形式化理论)
    ...
    - [3.3 异步状态机](#33-异步状态机)
  - [4. Future特质形式化理论](#4-future特质形式化理论)
...
本文档建立了Rust异步系统的形式化理论体系，包括异步编程模型、Future特质、异步运行时、异步I/O、异步流、异步任务调度和异步优化的数学定义、类型规则和安全性证明。
...
3. **Future特质理论**：建立了Future类型和Poll枚举的形式化理论
