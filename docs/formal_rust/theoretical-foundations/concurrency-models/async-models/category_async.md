...
- [Rust 异步编程与范畴论的形式化理论 {#异步编程范畴论}](#rust-异步编程与范畴论的形式化理论-异步编程范畴论)
  ...
  - [核心理论与形式化定义](#核心理论与形式化定义)
    - [1. 异步函数与 Future 的范畴论基础](#1-异步函数与-future-的范畴论基础)
      - [**定义 1.1 (异步范畴 AsyncCategory)**](#定义-11-异步范畴-asynccategory)
      - [**定义 1.2 (Future 函子)**](#定义-12-future-函子)
      - [**定义 1.3 (异步态射 AsyncMorphism)**](#定义-13-异步态射-asyncmorphism)
    - [2. 态射与函子的形式化定义](#2-态射与函子的形式化定义)
      - [**定义 2.1 (异步态射合成)**](#定义-21-异步态射合成)
      - [**定义 2.2 (异步函子变换)**](#定义-22-异步函子变换)
    - [3. 自然变换与异步组合](#3-自然变换与异步组合)
      - [**定义 3.1 (异步自然变换)**](#定义-31-异步自然变换)
  - [形式化公理与定理](#形式化公理与定理)
    - [1. 异步范畴的公理系统](#1-异步范畴的公理系统)
      - [**公理 1.1 (异步范畴存在性)**](#公理-11-异步范畴存在性)
      - [**公理 1.2 (Future 函子存在性)**](#公理-12-future-函子存在性)
      - [**公理 1.3 (异步态射合成结合律)**](#公理-13-异步态射合成结合律)
    - [2. Future 单子的形式化定理](#2-future-单子的形式化定理)
      - [**定理 2.1 (Future 单子性质)**](#定理-21-future-单子性质)
      - [**定理 2.2 (Future 函子保持异步性质)**](#定理-22-future-函子保持异步性质)
    - [3. 异步组合的安全性定理](#3-异步组合的安全性定理)
      - [**定理 3.1 (异步态射合成安全性)**](#定理-31-异步态射合成安全性)
  ...
  - [高级范畴论概念](#高级范畴论概念)
    - [1. 异步范畴的极限与余极限](#1-异步范畴的极限与余极限)
      - [**定义 4.1 (异步极限)**](#定义-41-异步极限)
      - [**定义 4.2 (异步余极限)**](#定义-42-异步余极限)
    - [2. 异步函子的伴随性](#2-异步函子的伴随性)
      - [**定义 4.3 (异步函子伴随)**](#定义-43-异步函子伴随)
    - [3. 异步单子的代数理论](#3-异步单子的代数理论)
      - [**定义 4.4 (异步单子代数)**](#定义-44-异步单子代数)
  - [形式化证明与安全性保证](#形式化证明与安全性保证)
    - [1. 异步范畴的完备性证明](#1-异步范畴的完备性证明)
      - [**定理 4.1 (异步范畴完备性)**](#定理-41-异步范畴完备性)
    - [2. 异步函子的伴随性证明](#2-异步函子的伴随性证明)
      - [**定理 4.2 (Future 函子伴随性)**](#定理-42-future-函子伴随性)
    - [3. 异步单子的代数完备性](#3-异步单子的代数完备性)
      - [**定理 4.3 (异步单子代数完备性)**](#定理-43-异步单子代数完备性)
