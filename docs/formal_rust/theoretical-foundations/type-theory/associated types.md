...
- [关联类型](#关联类型)
  - [📊 目录](#-目录)
  - [1. 什么是关联类型](#1-什么是关联类型)
  - [2. 关联类型在泛型编程中的优势](#2-关联类型在泛型编程中的优势)
    - [(1) 简化泛型接口](#1-简化泛型接口)
    - [(2) 表达类型之间的语义关系](#2-表达类型之间的语义关系)
    - [(3) 自动类型推导](#3-自动类型推导)
  - [3. 关联类型的示例和应用](#3-关联类型的示例和应用)
  - [4. 总结](#4-总结)
  - [1. 关联类型的概念](#1-关联类型的概念)
  - [2. 关联类型与泛型参数的比较](#2-关联类型与泛型参数的比较)
    - [2.1 使用泛型参数定义接口](#21-使用泛型参数定义接口)
    - [2.2 使用关联类型定义接口](#22-使用关联类型定义接口)
  - [3. 关联类型的实际应用示例](#3-关联类型的实际应用示例)
  - [4. 关联类型在 trait 中的扩展](#4-关联类型在-trait-中的扩展)
  - [5. 小结](#5-小结)
