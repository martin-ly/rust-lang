...
- [4.1 高阶类型](#41-高阶类型)
  ...
  - [4.1.4 Rust 中的类型构造器](#414-rust-中的类型构造器)
    - [4.1.4.1 Rust 中的一阶类型构造器](#4141-rust-中的一阶类型构造器)
    - [4.1.4.2 Rust 中的类型构造器限制](#4142-rust-中的类型构造器限制)
  - [4.1.5 在Rust 中模拟高阶类型](#415-在rust-中模拟高阶类型)
    - [4.1.5.1 使用特质和关联类型](#4151-使用特质和关联类型)
    - [4.1.5.2 高阶特质模式（HKT模式）](#4152-高阶特质模式hkt模式)
  ...
  - [4.1.7 高阶类型的限制与挑战](#417-高阶类型的限制与挑战)
    - [4.1.7.1 Rust 中的限制](#4171-rust-中的限制)
  ...
  - [4.1.9 未来展望](#419-未来展望)
    - [4.1.9.1 Rust 中的高阶类型提案](#4191-rust-中的高阶类型提案)
