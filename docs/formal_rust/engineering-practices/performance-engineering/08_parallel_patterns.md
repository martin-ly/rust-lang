...
- [概述](#概述)
- [1. 并行编程理论基础](#1-并行编程理论基础)
  - [1.1 并行性vs并发性](#11-并行性vs并发性)
  - [1.2 形式化语义](#12-形式化语义)
- [2. 工作窃取模式](#2-工作窃取模式)
  - [2.1 基本工作窃取](#21-基本工作窃取)
  - [2.2 自适应工作窃取](#22-自适应工作窃取)
- [3. 分治并行模式](#3-分治并行模式)
  - [3.1 并行归并排序](#31-并行归并排序)
  - [3.2 并行快速排序](#32-并行快速排序)
- [4. MapReduce模式](#4-mapreduce模式)
  - [4.1 基本MapReduce](#41-基本mapreduce)
  - [4.2 分组MapReduce](#42-分组mapreduce)
- [5. 流水线模式](#5-流水线模式)
  - [5.1 基本流水线](#51-基本流水线)
  - [5.2 异步流水线](#52-异步流水线)
- [6. 形式化证明](#6-形式化证明)
