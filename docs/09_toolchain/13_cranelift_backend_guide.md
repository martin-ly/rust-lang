...
>
- [Cranelift 后端实用指南 {#cranelift-后端实用指南}](#cranelift-后端实用指南-cranelift-后端实用指南)
  - [📑 目录 {#目录}](#-目录-目录)
  - [🚀 什么是 Cranelift {#什么是-cranelift}](#-什么是-cranelift-什么是-cranelift)
  - [⏱️ 为什么 Cranelift 重要 {#为什么-cranelift-重要}](#️-为什么-cranelift-重要-为什么-cranelift-重要)
  - [⚙️ 安装与配置 {#安装与配置}](#️-安装与配置-安装与配置)
    - [1. 安装组件 {#1-安装组件}](#1-安装组件-1-安装组件)
    - [2. 项目级配置 {#2-项目级配置}](#2-项目级配置-2-项目级配置)
    - [3. 单次编译 {#3-单次编译}](#3-单次编译-3-单次编译)
    - [4. 验证生效 {#4-验证生效}](#4-验证生效-4-验证生效)
  - [⚖️ LLVM vs Cranelift 对比 {#llvm-vs-cranelift-对比}](#️-llvm-vs-cranelift-对比-llvm-vs-cranelift-对比)
    - [设计哲学 {#设计哲学}](#设计哲学-设计哲学)
    - [支持平台 {#支持平台}](#支持平台-支持平台)
    - [优化级别 {#优化级别}](#优化级别-优化级别)
  - [📊 当前状态 {#当前状态}](#-当前状态-当前状态)
    - [Rust 2026 Project Goal 关联 {#rust-2026-project-goal-关联}](#rust-2026-project-goal-关联-rust-2026-project-goal-关联)
    - [已知限制 (2026-05) {#已知限制-2026-05}](#已知限制-2026-05-已知限制-2026-05)
  - [✅ 何时使用 vs 🚫 何时不使用 {#何时使用-vs-何时不使用}](#-何时使用-vs--何时不使用-何时使用-vs-何时不使用)
    - [✅ 推荐使用 Cranelift {#推荐使用-cranelift}](#-推荐使用-cranelift-推荐使用-cranelift)
    - [🚫 不推荐使用 Cranelift {#不推荐使用-cranelift}](#-不推荐使用-cranelift-不推荐使用-cranelift)
  - [🔧 实战配置模板 {#实战配置模板}](#-实战配置模板-实战配置模板)
    - [推荐 `.cargo/config.toml` {#推荐-cargoconfigtoml}](#推荐-cargoconfigtoml-推荐-cargoconfigtoml)
    - [快速切换脚本 {#快速切换脚本}](#快速切换脚本-快速切换脚本)
    - [Makefile 集成 {#makefile-集成}](#makefile-集成-makefile-集成)
  - [📖 参考文献 {#参考文献}](#-参考文献-参考文献)
  - [相关概念 {#相关概念}](#相关概念-相关概念)
