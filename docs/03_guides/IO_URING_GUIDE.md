...
- [io\_uring 高性能 I/O 指南](#io_uring-高性能-io-指南)
  ...
  - [核心概念](#核心概念)
    ...
    - [优势](#优势)
  - [决策树：何时使用 io\_uring？](#决策树何时使用-io_uring)
  - [Rust 生态](#rust-生态)
    - [主要 crate](#主要-crate)
    - [条件编译](#条件编译)
  - [代码示例](#代码示例)
...
**关键洞察**: io_uring 不仅是一个 API，更是 Linux 异步 I/O 的**范式转变** —— 从"就绪通知"到"完成通知"，从"每次 syscall"到"批量零拷贝"。
...
| Crate | 抽象层级 | 适用场景 | 成熟度 |
|:---|:---|:---|:---:|
| `io-uring` | 底层，直接映射内核 API | 自定义运行时、极致控制 | 🟢 稳定 |
| `tokio-uring` | 与 tokio 兼容的异步运行时 | 已有 tokio 应用迁移 | 🟡 活跃开发 |
| `glommio` | 线程 per core 运行时 | 存储系统、低延迟服务 | 🟡 活跃开发 |
