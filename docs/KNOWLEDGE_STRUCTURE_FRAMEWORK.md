...
决策图网已在 `crates/DECISION_GRAPH_NETWORK.md` 中详细定义，包含：
...
详见: [决策图网文档](../crates/DECISION_GRAPH_NETWORK.md)

### 4. 证明图网

证明图网已在 `crates/PROOF_GRAPH_NETWORK.md` 中详细定义，包含：
...
详见: [证明图网文档](../crates/PROOF_GRAPH_NETWORK.md)
