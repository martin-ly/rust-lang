...
| 特性 | Rust 1.54 之前 | Rust 1.54+ | Rust 1.90+ | Rust 1.91+ |
|------|---------------|-----------|-----------|------------|
| 增量编译 | 默认禁用 | **默认启用** ✅ | 默认启用 | 默认启用 (优化) |
| LTO | 支持 | 支持 | 支持 (改进) | 支持 (改进) |
| PGO | 支持 | 支持 | 支持 (改进) | 支持 (改进) |
| DWARF 5 | 实验性 | 实验性 | **稳定** ✅ | **稳定** ✅ |
| JIT 优化 | 基础支持 | 基础支持 | 基础支持 | **显著改进** ✅ |
| 内存分配 | 标准 | 标准 | 标准 | **优化** ✅ |
