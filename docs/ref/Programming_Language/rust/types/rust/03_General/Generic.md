...
- [泛型生命周期](#泛型生命周期)
- [类型系统](#类型系统)
  - [1. 标量类型 (Scalar Types)](#1-标量类型-scalar-types)
  - [2. 复合类型 (Composite Types)](#2-复合类型-composite-types)
  - [3. 复合类型 (Aggregate Types)](#3-复合类型-aggregate-types)
  - [4. 枚举 (Enums)](#4-枚举-enums)
  - [5. 智能指针 (Smart Pointers)](#5-智能指针-smart-pointers)
  - [6. 函数指针 (Function Pointers)](#6-函数指针-function-pointers)
  - [7. 切片 (Slices)](#7-切片-slices)
  - [8. 字符串 (Strings)](#8-字符串-strings)
  - [9. 选项和结果 (Option and Result)](#9-选项和结果-option-and-result)
  - [10. 特征 (Traits)](#10-特征-traits)
  - [11. 泛型 (Generics)](#11-泛型-generics)
  - [12. 生命周期 (Lifetimes)](#12-生命周期-lifetimes)
- [*泛型*](#泛型)
  - [泛型定义](#泛型定义)
  - [泛型与具体类型的关系](#泛型与具体类型的关系)
- [*Trait*](#trait)
