...
- [2. Rust 中 ad-hoc 多态的实现机制](#2-rust-中-ad-hoc-多态的实现机制)
  - [2.1 Trait 定义与实现](#21-trait-定义与实现)
    - [示例](#示例)
  - [2.2 静态分发与单态化](#22-静态分发与单态化)
  - [2.3 关联函数和方法调用](#23-关联函数和方法调用)
- [3. ad-hoc 多态的优势与设计思路](#3-ad-hoc-多态的优势与设计思路)
- [4. 思维导图示例](#4-思维导图示例)
- [5. 总结](#5-总结)
- [1. 实现原理与调度方式](#1-实现原理与调度方式)
  - [1.1 Rust 中的 ad-hoc 多态](#11-rust-中的-ad-hoc-多态)
  - [1.2 OOP 中的多态](#12-oop-中的多态)
- [2. 性能与安全性的对比](#2-性能与安全性的对比)
  - [2.1 性能考虑](#21-性能考虑)
  - [2.2 安全性与静态检查](#22-安全性与静态检查)
- [3. 设计理念与表达](#3-设计理念与表达)
  - [3.1 Rust 的 ad-hoc 多态](#31-rust-的-ad-hoc-多态)
  - [3.2 OOP 的多态](#32-oop-的多态)
- [4. 联系与共同点](#4-联系与共同点)
- [5. 思维导图示例](#5-思维导图示例)
- [6. 总结](#6-总结)
