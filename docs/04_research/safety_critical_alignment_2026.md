...
> **前置依赖**: [concept L5 安全边界](../../concept/05_comparative/04_safety_boundaries.md) · [docs Rust for Linux](../03_guides/RUST_FOR_LINUX_GUIDE.md)
...
> **覆盖版本**: Rust 1.95.0+ / FLS (Ferrocene Language Specification) 24.11 / Ferrocene 26.02.0
