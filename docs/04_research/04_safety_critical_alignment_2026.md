...
> **前置依赖**: [concept L5 安全边界](../../concept/05_comparative/03_domain_comparisons/04_safety_boundaries.md) · [docs Rust for Linux](04_rust_for_linux.md)
...
| Ferrocene 26.02.0 (ISO 26262 ASIL B + IEC 61508 SIL 2 for `core`) | 2026-03 | ✅ 已认证 | [`concept/04_formal/16_aerospace_certification_formal_methods.md`](../../concept/04_formal/04_model_checking/16_aerospace_certification_formal_methods.md) §3.2 |
...
| Normative unsafe docs | 2026 | 🟡 推进中 | 待与 `concept/03_advanced/02_unsafe/03_unsafe.md` 对齐 |
...
| 限制 | FLS 规则 | 项目对应文件 | 状态 |
|:---|:---|:---|:---:|
| **No `unsafe`** | FLS-C-0001 | `concept/03_advanced/02_unsafe/03_unsafe.md` | 🟡 需对齐 FLS 例外清单 |
| **No Panic** | FLS-C-0002 | `concept/02_intermediate/03_error_handling/04_error_handling.md` | 🟡 需补充 `panic_never` 策略 |
...
|:---|:---|:---|
| `concept/03_advanced/02_unsafe/03_unsafe.md` | unsafe 规范核心文档 | 补充 FLS/MISRA 安全注释模板 |
| `concept/02_intermediate/03_error_handling/04_error_handling.md` | No-Panic 策略 | 补充 `panic_never` 和 `panic_semihalt` 模式 |
...
- [ ] 为 `concept/03_advanced/02_unsafe/03_unsafe.md` 添加 FLS/MISRA Safety Comment 模板
