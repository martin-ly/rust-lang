...
>
> **EN**: Concurrent Index
> **Summary**: 并发设计模式 Concurrent Index. (stub/archive redirect)
> **分级**: [B]
> **Bloom 层级**: L5-L6
> **创建日期**: 2026-02-20
...
| 边界矩阵 | 并发安全（Concurrency Safety）边界 | [../../../12_research_notes/08_software_design_theory/01_design_patterns_formal/01_boundary_matrix.md](../../../12_research_notes/08_software_design_theory/01_design_patterns_formal/01_boundary_matrix.md) |
...
| 文档 | 描述 | 路径 |
| :--- | :--- | :--- |
| Send/Sync 形式化 | 线程安全形式化 | [../../../12_research_notes/02_formal_methods/12_send_sync_formalization.md](../../../12_research_notes/02_formal_methods/12_send_sync_formalization.md) |
