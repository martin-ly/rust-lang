...
> 内容已整合至： [06_toolchain/](../../09_toolchain/README.md)
...
| 借用（Borrowing）检查器证明 | 借用检查器形式化证明 | [../../12_research_notes/02_formal_methods/03_borrow_checker_proof.md](../../12_research_notes/02_formal_methods/03_borrow_checker_proof.md) |
...
| 文档 | 描述 | 路径 |
| :--- | :--- | :--- |
| 工具链文档 | 完整工具链指南 | [../../06_toolchain/](../../09_toolchain/README.md) |
...
| Rustdoc 高级 | 文档生成高级用法 | [../../09_toolchain/02_rustdoc_advanced.md](../../09_toolchain/02_rustdoc_advanced.md) |
...
| 性能基准 | 性能测试方法论 | [../../12_research_notes/09_experiments/05_performance_benchmarks.md](../../12_research_notes/09_experiments/05_performance_benchmarks.md) |
