...
> 内容已整合至： [toolchain/](../../../09_toolchain/README.md)

> **权威来源**: 本文件为 Rust 形式化工程体系专题入口；通用 Rust 概念解释请见对应 `concept/` 权威页：
>
> - [`concept/06_ecosystem/01_cargo/05_cargo_build_scripts.md`](../../../../concept/06_ecosystem/01_cargo/05_cargo_build_scripts.md)
...
| 编译器特性 | 编译器优化指南 | [../../../09_toolchain/01_compiler_features.md](../../../09_toolchain/01_compiler_features.md) |
