# 所有权系统理论 {#所有权系统理论}
>
> **EN**: Ownership System Index
> **Summary**: 所有权系统理论 Ownership System Index. (stub/archive redirect)
> **分级**: [B]
> **Bloom 层级**: L5-L6
> **创建日期**: 2026-02-20
...
> **状态**: ✅ 已完成
> 内容已整合至： [10_ownership_model.md](../../../12_research_notes/02_formal_methods/09_ownership_model.md)
...
| 文档 | 描述 | 路径 |
| :--- | :--- | :--- |
| 所有权（Ownership）模型 | 所有权系统的完整形式化模型 | [../../../12_research_notes/02_formal_methods/09_ownership_model.md](../../../12_research_notes/02_formal_methods/09_ownership_model.md) |
| 借用（Borrowing）检查器 | 借用检查的形式化证明 | [../../../12_research_notes/02_formal_methods/03_borrow_checker_proof.md](../../../12_research_notes/02_formal_methods/03_borrow_checker_proof.md) |
...
| 文档 | 描述 | 路径 |
| :--- | :--- | :--- |
| 所有权模型 | 所有权系统的完整形式化模型 | [../../../12_research_notes/02_formal_methods/09_ownership_model.md](../../../12_research_notes/02_formal_methods/09_ownership_model.md) |
| 借用检查器 | 借用检查的形式化证明 | [../../../12_research_notes/02_formal_methods/03_borrow_checker_proof.md](../../../12_research_notes/02_formal_methods/03_borrow_checker_proof.md) |
| 证明索引 | 所有权相关证明 | [../../../12_research_notes/03_formal_proofs/21_proof_index.md](../../../12_research_notes/03_formal_proofs/21_proof_index.md) |
| 工具指南 | 形式化验证工具 | [../../../12_research_notes/10_tutorials_and_guides/16_tools_guide.md](../../../12_research_notes/10_tutorials_and_guides/16_tools_guide.md) |
