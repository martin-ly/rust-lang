...
- [Rust 学习项目架构文档 {#rust-学习项目架构文档}](#rust-学习项目架构文档-rust-学习项目架构文档)
  - [目录 {#目录}](#目录-目录)
  - [项目概述 {#项目概述}](#项目概述-项目概述)
    - [设计原则 {#设计原则}](#设计原则-设计原则)
  - [架构总览 {#架构总览}](#架构总览-架构总览)
  - [Crate 关系图 {#crate-关系图}](#crate-关系图-crate-关系图)
    - [详细依赖关系 {#详细依赖关系}](#详细依赖关系-详细依赖关系)
    - [Crate 特性矩阵 {#crate-特性矩阵}](#crate-特性矩阵-crate-特性矩阵)
  - [模块依赖图 {#模块依赖图}](#模块依赖图-模块依赖图)
    - [内部模块结构 {#内部模块结构}](#内部模块结构-内部模块结构)
  - [数据流图 {#数据流图}](#数据流图-数据流图)
    - [学习路径数据流 {#学习路径数据流}](#学习路径数据流-学习路径数据流)
    - [运行时数据流（以异步模块为例） {#运行时数据流以异步模块为例}](#运行时数据流以异步模块为例-运行时数据流以异步模块为例)
  - [架构决策记录 {#架构决策记录}](#架构决策记录-架构决策记录)
    - [ADR-001: Workspace 结构 {#adr-001-workspace-结构}](#adr-001-workspace-结构-adr-001-workspace-结构)
    - [ADR-002: Common Crate {#adr-002-common-crate}](#adr-002-common-crate-adr-002-common-crate)
    - [ADR-003: 渐进式特性 {#adr-003-渐进式特性}](#adr-003-渐进式特性-adr-003-渐进式特性)
  - [技术栈 {#技术栈}](#技术栈-技术栈)
    - [核心运行时 {#核心运行时}](#核心运行时-核心运行时)
    - [序列化 {#序列化}](#序列化-序列化)
    - [网络 {#网络}](#网络-网络)
    - [日志与追踪 {#日志与追踪}](#日志与追踪-日志与追踪)
  - [参考资料 {#参考资料}](#参考资料-参考资料)
