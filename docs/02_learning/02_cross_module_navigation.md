...
│   ┌────────────────────────────────────────────────────────────────┐       │
│   │                    练习与巩固                                   │       │
│   │   crates/c01-03/exercises/  +  docs/05_practice/              │       │
│   └────────────────────────────────────────────────────────────────┘       │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
                                      │
...
|----------|--------------|------------|---------------|
| 所有权（Ownership） | c01_ownership/src/ | docs/02_learning/ | - |
| 类型系统（Type System） | c02_type_system/src/ | docs/04_thinking/matrices/ | - |
| 泛型（Generics） | c04_generic/src/ | docs/08_usage_guides/ | content/emerging/ |
| 并发 | c05_concurrency/src/ | docs/08_usage_guides/ | content/ecosystem/ |
...
| 生产部署 | - | docs/08_usage_guides/ | content/production/ |
...
```text
C01 → C04 → C11 → docs/12_research_notes/
                         ↓
                  content/academic/
```
...
| 资源 | 路径 | 描述 |
|------|------|------|
| 主索引 | [00_master_index.md](../00_meta/00_master_index.md) | 完整文档索引 |
| 学习路径 | [05_learning_path_planning.md](05_learning_path_planning.md) | 学习规划 |
| 快速参考 | [02_reference/quick_reference/README.md](../03_reference/quick_reference/README.md) | 速查手册 |
| 实践练习 | [03_practice/README.md](../05_practice/README.md) | 动手练习 |
| 思维表示 | [04_thinking/README.md](../07_thinking/README.md) | 思维导图/矩阵 |
| 实用指南 | 05_guides/10_best_practices.md | 最佳实践 |
| 前沿内容 | [../content/](../14_content) | 生产实践/学术 |
