...
> **最后更新**: 2026-05-06 (添加 Rust 1.95 支持)
...
| 指南 | 路径 | 说明 |
| :--- | :--- | :--- |
| **AI 辅助编程指南** | 已归档至 [`../archive/guides/AI_ASSISTED_RUST_PROGRAMMING_GUIDE_2026.md`](../archive/guides/AI_ASSISTED_RUST_PROGRAMMING_GUIDE_2026.md) | 提示词模板、RAG、工作流、1.95+ 特性 |
