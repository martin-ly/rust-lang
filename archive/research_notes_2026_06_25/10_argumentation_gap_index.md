...
*type_theory（整体）*：各子文档有 Def/Theorem；阶段 1–7 已补全；高/中优先级缺口已补全，见 [type_theory/00_completeness_gaps](../../archive/research_notes_2026_06_25/formal_methods/00_completeness_gaps.md)。

*formal_methods（整体）*：✅ 100% 完成；Phase 1–6 全部补全；含 RC/ARC/CELL/REFCELL/BOX、CHAN/MUTEX/RAW、UNSAFE、MATCH/FOR、EXTERN/CVARIADIC/QUERY、DROP/DEREF/REPR/CONST_MUT_STATIC、SPAWN；见 [formal_methods/00_completeness_gaps](../../archive/research_notes_2026_06_25/formal_methods/00_completeness_gaps.md)。
...
[CORE_THEOREMS_FULL_PROOFS](../../archive/research_notes_2026_06_25/10_core_theorems_full_proofs.md) L2 完整证明；
...
| 文档 | 用途 |
| :--- | :--- |
| [00_COMPREHENSIVE_SUMMARY](../../archive/research_notes_2026_06_25/10_00_comprehensive_summary.md) | **完整总结综合**：项目全貌、知识地图、论证脉络总览、各文档职责 |
...
| [HIERARCHICAL_MAPPING_AND_SUMMARY](../../archive/research_notes_2026_06_25/10_hierarchical_mapping_and_summary.md) | **层次化映射总结**：文档树、概念族↔文档↔Def/定理、文档↔思维表征、文档依赖 |
...
| [CORE_THEOREMS_FULL_PROOFS](../../archive/research_notes_2026_06_25/10_core_theorems_full_proofs.md) | **核心定理完整证明**：ownership T2、borrow T1、type T3（L2 级） |
