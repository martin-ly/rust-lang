...
- [IEC 61508 Rust实施指南](.#iec-61508-rust实施指南)
  - [📑 目录](.#-目录)
  - [概述](.#概述)
  - [IEC 61508结构概览](.#iec-61508结构概览)
  - [Part 3: 软件要求详解](.#part-3-软件要求详解)
    - [7.4.2 软件安全需求规范](.#742-软件安全需求规范)
      - [安全完整性等级(SIL)映射](.#安全完整性等级sil映射)
      - [Rust优势在IEC 61508中的体现](.#rust优势在iec-61508中的体现)
    - [7.4.3 软件安全验证](.#743-软件安全验证)
      - [验证方法表(Annex B)](.#验证方法表annex-b)
  - [Part 6: 软件开发和验证技术](.#part-6-软件开发和验证技术)
    - [Table A.1 - 设计和编码技术](.#table-a1---设计和编码技术)
    - [Table A.2 - 数据导向技术](.#table-a2---数据导向技术)
  - [Part 7: 技术和措施](.#part-7-技术和措施)
    - [系统性能力(SCL)评估](.#系统性能力scl评估)
    - [硬件容错要求](.#硬件容错要求)
  - [工业协议集成](.#工业协议集成)
    - [Modbus RTU/TCP](.#modbus-rtutcp)
    - [OPC UA](.#opc-ua)
  - [开发检查表](.#开发检查表)
    - [SIL 4项目完整检查表](.#sil-4项目完整检查表)
      - [需求阶段](.#需求阶段)
      - [设计阶段](.#设计阶段)
      - [实现阶段](.#实现阶段)
      - [验证阶段](.#验证阶段)
      - [认证阶段](.#认证阶段)
  - [*本文档应与IEC 61508标准原文配合使用。*](.#本文档应与iec-61508标准原文配合使用)
  - [相关概念](.#相关概念)
  - [权威来源索引](.#权威来源索引)
