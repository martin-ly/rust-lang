...
- [研究笔记示例 {#研究笔记示例}](#研究笔记示例-研究笔记示例)
  ...
  - [📋 说明 {#说明}](#-说明-说明)
  - [📝 完整示例 {#完整示例}](#-完整示例-完整示例)
  - [所有权模型形式化（示例） {#所有权模型形式化示例}](#所有权模型形式化示例-所有权模型形式化示例)
  - [🎯 研究目标 {#研究目标}](#-研究目标-研究目标)
    - [核心问题 {#核心问题}](#核心问题-核心问题)
    - [预期成果 {#预期成果}](#预期成果-预期成果)
  - [📚 理论基础 {#理论基础}](#-理论基础-理论基础)
  ...
  - [🔬 形式化定义 {#形式化定义}](#-形式化定义-形式化定义)
    - [1. 所有权转移 {#1-所有权转移}](#1-所有权转移-1-所有权转移)
    - [2. 借用规则 {#2-借用规则}](#2-借用规则-2-借用规则)
    - [3. 生命周期约束 {#3-生命周期约束}](#3-生命周期约束-3-生命周期约束)
  - [✅ 证明目标 {#证明目标}](#-证明目标-证明目标)
    - [待证明的性质 {#待证明的性质}](#待证明的性质-待证明的性质)
    - [证明方法 {#证明方法}](#证明方法-证明方法)
  - [💻 代码示例 {#代码示例}](#-代码示例-代码示例)
    - [示例 1: 所有权转移 {#示例-1-所有权转移}](#示例-1-所有权转移-示例-1-所有权转移)
    - [示例 2: 不可变借用 {#示例-2-不可变借用}](#示例-2-不可变借用-示例-2-不可变借用)
    - [示例 3: 可变借用 {#示例-3-可变借用}](#示例-3-可变借用-示例-3-可变借用)
    - [示例 4: 生命周期约束 {#示例-4-生命周期约束}](#示例-4-生命周期约束-示例-4-生命周期约束)
  - [📖 参考文献 {#参考文献}](#-参考文献-参考文献)
    - [学术论文 {#学术论文}](#学术论文-学术论文)
    - [官方文档 {#官方文档}](#官方文档-官方文档)
    - [相关代码 {#相关代码}](#相关代码-相关代码)
  ...
  - [🔄 研究进展 {#研究进展}](#-研究进展-研究进展)
    ...
    - [计划中 📋 {#计划中}](#计划中--计划中)
  - [💡 编写提示 {#编写提示}](#-编写提示-编写提示)
    - [1. 研究目标 {#1-研究目标}](#1-研究目标-1-研究目标)
    - [2. 理论基础 {#2-理论基础}](#2-理论基础-2-理论基础)
    - [3. 形式化定义 {#3-形式化定义}](#3-形式化定义-3-形式化定义)
    - [4. 代码示例 {#4-代码示例}](#4-代码示例-4-代码示例)
    - [5. 参考文献 {#5-参考文献}](#5-参考文献-5-参考文献)
    - [6. 研究进展 {#6-研究进展}](#6-研究进展-6-研究进展)
  - [🔗 相关资源 {#相关资源}](#-相关资源-相关资源)
    - [核心文档 {#核心文档}](#核心文档-核心文档)
    - [研究笔记 {#研究笔记}](#研究笔记-研究笔记)
...
**实质内容链接**：本示例的所有权、借用、生命周期形式化，在 [ownership_model](formal_methods/10_ownership_model.md)、[borrow_checker_proof](formal_methods/10_borrow_checker_proof.md)、lifetime_formalization 中有完整 Def/定理/证明；代码示例可对照 [PROOF_INDEX](10_proof_index.md) 追溯。
