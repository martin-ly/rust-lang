...
| **Iris 分离逻辑** | 机器可检查证明框架 | [coq_skeleton](../08_quality_audits/deprecated/coq_skeleton/README.md)（T-OW2 骨架，证明 Admitted） | 部分 |
...
| RustBelt 概念 | 本项目 | 差距 |
| :--- | :--- | :--- |
| 唯一所有者 | ownership T2、A-OW1、[coq_skeleton](../08_quality_audits/deprecated/coq_skeleton/README.md) | Coq 骨架已创建，证明待补全 |
...
2. **中期**：补全 [coq_skeleton](../08_quality_audits/deprecated/coq_skeleton/README.md) Admitted 证明；扩展 T-BR1/T-TY3 骨架（见 [COQ_ISABELLE_PROOF_SCAFFOLDING](10_coq_isabelle_proof_scaffolding.md)、[AENEAS_INTEGRATION_PLAN](10_aeneas_integration_plan.md)、[COQ_OF_RUST_INTEGRATION_PLAN](10_coq_of_rust_integration_plan.md)）
