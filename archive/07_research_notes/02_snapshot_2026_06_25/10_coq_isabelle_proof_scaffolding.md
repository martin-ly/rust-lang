...
- [Coq/Isabelle 证明脚手架 {#coqisabelle-证明脚手架}](#coqisabelle-证明脚手架-coqisabelle-证明脚手架)
  - [📑 目录 {#目录}](#-目录-目录)
  - [概述 {#概述}](#概述-概述)
  - [Coq 脚手架 {#coq-脚手架}](#coq-脚手架-coq-脚手架)
    - [所有权模型 {#所有权模型}](#所有权模型-所有权模型)
    - [借用规则 {#借用规则}](#借用规则-借用规则)
  - [Isabelle 脚手架 {#isabelle-脚手架}](#isabelle-脚手架-isabelle-脚手架)
    - [类型系统 {#类型系统}](#类型系统-类型系统)
  - [证明策略 {#证明策略}](#证明策略-证明策略)
    - [所有权证明策略 {#所有权证明策略}](#所有权证明策略-所有权证明策略)
    - [借用检查策略 {#借用检查策略}](#借用检查策略-借用检查策略)
