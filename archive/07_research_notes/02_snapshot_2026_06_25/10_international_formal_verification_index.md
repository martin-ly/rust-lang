...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **RustBelt** | MPI-SWS (Jung et al.) | 2018 | 所有权、借用、MIR 级 | Iris (Coq) | ownership_model, borrow_checker_proof, [coq_skeleton](../08_quality_audits/deprecated/coq_skeleton/README.md)（T-OW2/BR1/TY3 骨架） |
...
- **差距**: 无 Iris 分离逻辑形式化；无 MIR 级建模；**Coq 骨架已创建**（[coq_skeleton/OWNERSHIP_UNIQUENESS.v](../08_quality_audits/deprecated/coq_skeleton/OWNERSHIP_UNIQUENESS.v)），证明 Admitted 待补全
