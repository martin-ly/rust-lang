# Rust 自定义类型设计准则：算法设计视角

## 目录

- [Rust 自定义类型设计准则：算法设计视角](#rust-自定义类型设计准则算法设计视角)
  - [目录](#目录)
  - [1. 算法的表达与抽象](#1-算法的表达与抽象)
    - [1.1 特征作为算法抽象](#11-特征作为算法抽象)
    - [1.2 泛型算法设计](#12-泛型算法设计)
  - [2. 算法策略模式](#2-算法策略模式)
    - [2.1 策略模式实现](#21-策略模式实现)
    - [2.2 编译时策略选择](#22-编译时策略选择)
  - [3. 算法性能优化](#3-算法性能优化)
    - [3.1 类型系统编码的性能优化](#31-类型系统编码的性能优化)
    - [3.2 零成本抽象的算法实现](#32-零成本抽象的算法实现)
  - [4. 状态机和算法表示](#4-状态机和算法表示)
    - [4.1 类型状态模式](#41-类型状态模式)
    - [4.2 编译时有限状态机](#42-编译时有限状态机)
  - [5. 递归算法与不变量](#5-递归算法与不变量)
    - [5.1 递归算法的类型安全表达](#51-递归算法的类型安全表达)
    - [5.2 代数数据类型表达算法数据结构](#52-代数数据类型表达算法数据结构)
  - [6. 迭代器和适配器模式](#6-迭代器和适配器模式)
    - [6.1 迭代器抽象与组合](#61-迭代器抽象与组合)
    - [6.2 惰性求值算法](#62-惰性求值算法)
  - [7. 并行算法设计](#7-并行算法设计)
    - [7.1 类型安全的并行算法分解](#71-类型安全的并行算法分解)
    - [7.2 分而治之算法模式](#72-分而治之算法模式)
  - [8. 概率和随机化算法](#8-概率和随机化算法)
    - [8.1 随机化算法的抽象](#81-随机化算法的抽象)
    - [8.2 蒙特卡洛算法框架](#82-蒙特卡洛算法框架)
  - [9. 优化算法与搜索](#9-优化算法与搜索)
    - [9.1 通用优化器框架](#91-通用优化器框架)
    - [9.2 启发式搜索算法](#92-启发式搜索算法)
  - [10. 总结：算法设计的关键准则](#10-总结算法设计的关键准则)
