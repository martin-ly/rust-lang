...
|--------|----------|----------|------|----------|
| P0 | Using Structs to Structure Related Data | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | The `match` Control Flow Construct | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Control Scope and Privacy with Modules | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Paths for Referring to an Item in the Module Tree | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Separating Modules into Different Files | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Defining Shared Behavior with Traits | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Installing Binaries with `cargo install` | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Extending Cargo with Custom Commands | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Using Trait Objects to Abstract over Shared Behavior | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Behavior not considered unsafe | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Macro follow-set ambiguity formal specification | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Limits of Lifetimes | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Lifetime Elision | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Unbounded Lifetimes | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Higher-Rank Trait Bounds | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Splitting Borrows | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Ownership Based Resource Management | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | First Steps with Cargo | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Why Cargo Exists | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Cargo Home | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Cargo Targets | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | Cargo Commands | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | cargo help | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | cargo version | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | cargo bench | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | cargo check | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | cargo clean | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | cargo fetch | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | cargo fmt | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
| P0 | cargo run | concept/01_foundation/ 或 concept/03_advanced/ | 权威来源链接 | 完成 1 篇概念文档 + 1 个 crates/ 可运行示例（如适用） |
