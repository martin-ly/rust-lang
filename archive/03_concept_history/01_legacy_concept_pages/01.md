...
> **EN**: Archive Entry
> **Summary**: Archived concept entry placeholder.
> **内容分级**: [综述级]
> **Rust 版本**: 1.96.0+ (Edition 2024)
> **受众**: [进阶]
> **权威来源**: 本文件为 `concept/` 权威页。
> **归档声明**: 本文件为 Rust 核心开源库形式化评估原始长文，内容已结构化重组至 `06_ecosystem/44_formal_ecosystem_tower.md`（L6 生态层规范体系）。本文件保留为原始参考。
>
...
> **L0 编译器层**：所有权（Ownership）/生命周期（Lifetimes）/并发安全（Concurrency Safety）（已完成，所有库受益）
...
### 测验 1：《01.md》是一份归档文件。归档文件在知识体系中有什么作用？（理解层）

**题目**: 《01.md》是一份归档文件。归档文件在知识体系中有什么作用？
