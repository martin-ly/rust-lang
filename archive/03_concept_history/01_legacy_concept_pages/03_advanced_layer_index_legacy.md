> **Summary**:
>
> Advanced Layer Index Legacy. Core Rust concept.
> **内容分级**: [综述级]
...
- [L3 高级概念层索引（Advanced Layer Index）](#l3-高级概念层索引advanced-layer-index)
  ...
  - [嵌入式测验（Embedded Quiz）](#嵌入式测验embedded-quiz)
    - [测验 1：《L3 高级概念层索引（Advanced Layer Index）》是一份归档文件。归档文件在知识体系中有什么作用？（理解层）](#测验-1l3-高级概念层索引advanced-layer-index是一份归档文件归档文件在知识体系中有什么作用理解层)
...
### 测验 1：《L3 高级概念层索引（Advanced Layer Index）》是一份归档文件。归档文件在知识体系中有什么作用？（理解层）

**题目**: 《L3 高级概念层索引（Advanced Layer Index）》是一份归档文件。归档文件在知识体系中有什么作用？
