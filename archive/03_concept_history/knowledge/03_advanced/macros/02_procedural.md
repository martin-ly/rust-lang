...
> [来源: Rust Reference — Procedural Macros / 2025; RFC 1566 / 2016; 核心设计决策: 三种过程宏类型（Derive / Attribute / Function-like）分别在编译期的不同阶段介入，操作 `TokenStream` 而非 AST 节点; proc-macro2 提供独立于编译器的 Token 表示以支持测试]。
> 与 `macro_rules!` 相比，过程宏具有无限的表达能力，但开发和调试更复杂。
>
> **⏱️ 预计学习时间**: 75-100 分钟
> **📚 难度级别**: ⭐⭐⭐⭐⭐ 专家级
> **权威来源**:
