...
- [`concept/04_formal/03_ownership_formal.md`](../../../../concept/04_formal/01_ownership_logic/03_ownership_formal.md)：所有权规则、线性类型与内存安全定理的完整形式化。
- [`concept/04_formal/28_borrow_checking_decidability.md`](../../../../concept/04_formal/01_ownership_logic/28_borrow_checking_decidability.md)：借用检查的可判定性、NLL、Polonius 与 region inference 的复杂度边界。
