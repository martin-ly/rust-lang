...
|------|----------|--------|----------|----------|------|
| 1 | 05_async_programming_usage_guide.md | 1.93 | ✅ | ✅ | **深度整合完成** |
...
- isqrt 最佳实践
- [几何算法示例](../../../../docs/05_guides/05_cross_module_integration_examples.md)

#### 🔄 并发编程

- [HashMap 新 API](../../../../docs/05_guides/05_threads_concurrency_usage_guide.md)
- if let guards 指南

#### ⚡ 异步编程

- [async Fn trait 改进](../../../../docs/05_guides/05_async_programming_usage_guide.md)
