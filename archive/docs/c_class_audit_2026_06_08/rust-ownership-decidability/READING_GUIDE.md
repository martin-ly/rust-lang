...
- [阅读指南：如何理解这份形式化工作](#阅读指南如何理解这份形式化工作)
  - [📑 目录](#-目录)
  - [一、读者分类与推荐路径](#一读者分类与推荐路径)
    - [1.1 类型 A：Rust 开发者（想理解理论基础）](#11-类型-arust-开发者想理解理论基础)
    - [1.2 类型 B：编程语言研究者（想了解技术细节）](#12-类型-b编程语言研究者想了解技术细节)
    - [1.3 类型 C：学生和初学者（想学习形式化方法）](#13-类型-c学生和初学者想学习形式化方法)
    - [1.4 类型 D：贡献者（想完善这份形式化）](#14-类型-d贡献者想完善这份形式化)
  - [二、文档速查表](#二文档速查表)
    - [2.1 按主题查找](#21-按主题查找)
    - [2.2 按问题查找](#22-按问题查找)
    - [2.3 Coq 文件导航](#23-coq-文件导航)
  - [三、学习检查清单](#三学习检查清单)
    - [3.1 基础理解（必会）](#31-基础理解必会)
    - [3.2 中级理解（推荐）](#32-中级理解推荐)
    - [3.3 高级理解（可选）](#33-高级理解可选)
  - [四、常见问题 FAQ](#四常见问题-faq)
    - [Q1：我需要学 Coq 才能理解这份形式化吗？](#q1我需要学-coq-才能理解这份形式化吗)
    - [Q2：这份形式化是完整的吗？](#q2这份形式化是完整的吗)
    - [Q3：这份形式化能证明我的 Rust 程序安全吗？](#q3这份形式化能证明我的-rust-程序安全吗)
    - [Q4：与 Rust 实际编译器的关系是什么？](#q4与-rust-实际编译器的关系是什么)
    - [Q5：如何为这份形式化做贡献？](#q5如何为这份形式化做贡献)
  - [五、进阶阅读建议](#五进阶阅读建议)
    - [5.1 相关论文](#51-相关论文)
    - [5.2 相关教材](#52-相关教材)
    - [5.3 在线资源](#53-在线资源)
