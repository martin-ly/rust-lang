...
<a id="️-rust-193-行为变更影响性能矩阵补充-️-rust-193-行为变更影响性能矩阵补充"></a>
...
> 详见 [FORMAL_PROOF_SYSTEM_GUIDE](../../../research_notes_2026_06_25/10_formal_proof_system_guide.md)。
...
> 详见 [LANGUAGE_SEMANTICS_EXPRESSIVENESS](../../../research_notes_2026_06_25/10_language_semantics_expressiveness.md)。
...
> 用于梳理「为何如此设计」的理由与完整论证。详见 [DESIGN_MECHANISM_RATIONALE](../../../research_notes_2026_06_25/10_design_mechanism_rationale.md)。
...
> 五模型 × 三维边界。详见 [06_boundary_analysis](../../../research_notes_2026_06_25/software_design_theory/03_execution_models/06_boundary_analysis.md)。
...
> 23 模式 × 三维边界。详见 [04_boundary_matrix](../../../research_notes_2026_06_25/software_design_theory/01_design_patterns_formal/04_boundary_matrix.md)。
...
- [验证工具对比矩阵](../../../research_notes_2026_06_25/10_verification_tools_matrix.md) - Kani/Prusti/Miri 等工具对比
- [全局统一系统化框架](../../../research_notes_2026_06_25/10_unified_systematic_framework.md) - 全景思维导图、多维矩阵、全链路图、反例总索引
- [构造性语义与表达能力边界](../../../research_notes_2026_06_25/10_language_semantics_expressiveness.md) - 操作/指称/公理语义、表达能力边界论证
- [全面系统化梳理总览](../../../research_notes_2026_06_25/10_comprehensive_systematic_overview.md) - 全局一致性、语义归纳、概念族谱、论证缺口追踪
- [形式化论证系统梳理指南](../../../research_notes_2026_06_25/10_formal_proof_system_guide.md) - 论证缺口分析、概念-公理-定理映射
- [知识结构框架](../../../../docs/07_project/07_knowledge_structure_framework.md) - 完整知识结构体系
- [决策图网](../../../../docs/04_thinking/04_decision_graph_network.md) - 技术选型决策支持
- [证明图网](../../../../docs/04_thinking/04_proof_graph_network.md) - 形式化证明结构
- 最佳实践指南 - 开发最佳实践
