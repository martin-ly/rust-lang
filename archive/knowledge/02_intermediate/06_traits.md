...
- [Trait - 定义共享行为](#trait---定义共享行为)
  ...
  - [🧠 核心概念](#-核心概念)
    ...
    - [模块 6: 反例集](#模块-6-反例集)
      - [反例 1: 违反孤儿规则（Orphan Rules）](#反例-1-违反孤儿规则orphan-rules)
      - [反例 2: 尝试对非对象安全 trait 使用 `dyn Trait`](#反例-2-尝试对非对象安全-trait-使用-dyn-trait)
      - [反例 3: 冲突实现（Overlapping Implementations）](#反例-3-冲突实现overlapping-implementations)
  - [🗺️ 模块 7: 思维表征套件](#️-模块-7-思维表征套件)
    - [表征 A: Trait 使用场景决策矩阵](#表征-a-trait-使用场景决策矩阵)
    - [表征 B: 对象安全性检查决策树](#表征-b-对象安全性检查决策树)
    - [表征 C: vtable 内存布局图](#表征-c-vtable-内存布局图)
  ...
  - [⚖️ 模块 9: 设计权衡分析](#️-模块-9-设计权衡分析)
    - [9.1 为什么 Rust 选择了 trait 而非继承？](#91-为什么-rust-选择了-trait-而非继承)
    - [9.2 该设计的成本](#92-该设计的成本)
    - [9.3 什么场景下 trait 是次优的？](#93-什么场景下-trait-是次优的)
...
> **Bloom 层级**: 理解
> **📌 简介**:
> Trait 是 Rust 的类型接口系统，但它远比传统 OOP 的接口强大：它支持泛型关联类型、默认实现、条件实现、以及编译期多态（单态化）。
> Trait 是 Rust 实现"零成本抽象"的核心机制。
>
> **⏱️ 预计学习时间**: 90-120 分钟
> **📚 难度级别**: ⭐⭐⭐⭐ 高级
> **权威来源**:
> [The Rust Programming Language — Ch10](https://doc.rust-lang.org/book/ch10-00-generics.html),
> [Rust Reference — Traits](https://doc.rust-lang.org/reference/items/traits.html),
> [RFC 255: Trait Objects](https://rust-lang.github.io/rfcs/0255-object-safety.html),
> [RFC 1023: Rebalancing Coherence](https://rust-lang.github.io/rfcs/1023-rebalancing-coherence.html),
> [Wadler & Blott, "How to Make ad-hoc Polymorphism Less ad-hoc" (POPL 1989)](https://dl.acm.org/doi/10.1145/75277.75283)
>
