...
>
- [Reborrow Trait 的完整形式化语义](#reborrow-trait-的完整形式化语义)
  - [📑 目录](#-目录)
  - [1. 引言](#1-引言)
    - [1.1 什么是 Reborrow](#11-什么是-reborrow)
  - [2. 语法定义](#2-语法定义)
    - [2.1 Reborrow 操作的语法](#21-reborrow-操作的语法)
    - [2.2 类型语法扩展](#22-类型语法扩展)
  - [3. 操作语义](#3-操作语义)
    - [3.1 大步操作语义 (Big-Step Semantics)](#31-大步操作语义-big-step-semantics)
    - [3.2 小步操作语义 (Small-Step Semantics)](#32-小步操作语义-small-step-semantics)
    - [3.3 存储语义](#33-存储语义)
  - [4. 类型规则](#4-类型规则)
    - [4.1 Reborrow 类型推导规则](#41-reborrow-类型推导规则)
    - [4.2 生命周期包含关系](#42-生命周期包含关系)
    - [4.3 借用检查规则](#43-借用检查规则)
    - [4.4 多重 Reborrow 规则](#44-多重-reborrow-规则)
  - [5. 形式化定义](#5-形式化定义)
    - [5.1 Reborrow 关系的数学定义](#51-reborrow-关系的数学定义)
    - [5.2 引用有效性](#52-引用有效性)
    - [5.3 生命周期包含](#53-生命周期包含)
    - [5.4 借用兼容性](#54-借用兼容性)
  - [6. 安全定理](#6-安全定理)
    - [6.1 Reborrow 保持性定理](#61-reborrow-保持性定理)
    - [6.2 生命周期安全性定理](#62-生命周期安全性定理)
    - [6.3 别名安全定理](#63-别名安全定理)
    - [6.4 引用唯一性定理](#64-引用唯一性定理)
  - [7. Rust 代码示例](#7-rust-代码示例)
    - [7.1 基本 Reborrow 示例](#71-基本-reborrow-示例)
    - [7.2 函数参数中的 Reborrow](#72-函数参数中的-reborrow)
    - [7.3 嵌套 Reborrow](#73-嵌套-reborrow)
    - [7.4 模式匹配中的 Reborrow](#74-模式匹配中的-reborrow)
    - [7.5 生命周期标注示例](#75-生命周期标注示例)
    - [7.6 泛型中的 Reborrow](#76-泛型中的-reborrow)
  - [8. 与其他特性的交互](#8-与其他特性的交互)
    - [8.1 与 Auto Trait 的交互](#81-与-auto-trait-的交互)
    - [8.2 与 impl Trait 的交互](#82-与-impl-trait-的交互)
    - [8.3 与闭包捕获的交互](#83-与闭包捕获的交互)
    - [8.4 与 Pin 的交互](#84-与-pin-的交互)
  - [9. 实现细节](#9-实现细节)
    - [9.1 编译器中的 Reborrow](#91-编译器中的-reborrow)
    - [9.2 MIR 表示](#92-mir-表示)
  - [10. 总结](#10-总结)
  - [相关概念](#相关概念)
  - [权威来源索引](#权威来源索引)
