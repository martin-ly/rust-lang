...
>
- [CoerceShared Trait 的完整形式化语义](#coerceshared-trait-的完整形式化语义)
  - [📑 目录](#-目录)
  - [1. 引言](#1-引言)
    - [1.1 什么是 CoerceShared](#11-什么是-coerceshared)
    - [1.2 安全边界](#12-安全边界)
  - [2. 语法定义](#2-语法定义)
    - [2.1 强制转换表达式](#21-强制转换表达式)
    - [2.2 强制转换类型语法](#22-强制转换类型语法)
  - [3. 操作语义](#3-操作语义)
    - [3.1 大步操作语义](#31-大步操作语义)
    - [3.2 小步操作语义](#32-小步操作语义)
    - [3.3 强制转换有效性](#33-强制转换有效性)
  - [4. 类型规则](#4-类型规则)
    - [4.1 子类型关系](#41-子类型关系)
    - [4.2 引用强制规则](#42-引用强制规则)
    - [4.3 Box 强制规则](#43-box-强制规则)
    - [4.4 数组到切片强制](#44-数组到切片强制)
    - [4.5 函数指针强制](#45-函数指针强制)
  - [5. 形式化定义](#5-形式化定义)
    - [5.1 CoerceShared 关系](#51-coerceshared-关系)
    - [5.2 强制转换闭包](#52-强制转换闭包)
    - [5.3 安全强制转换](#53-安全强制转换)
    - [5.4 类型一致性](#54-类型一致性)
  - [6. 安全定理](#6-安全定理)
    - [6.1 安全强制保持性](#61-安全强制保持性)
    - [6.2 不安全强制定理](#62-不安全强制定理)
    - [6.3 强制转换组合性](#63-强制转换组合性)
    - [6.4 引用转换的别名安全](#64-引用转换的别名安全)
  - [7. Rust 代码示例](#7-rust-代码示例)
    - [7.1 基本强制转换](#71-基本强制转换)
    - [7.2 Box 到引用强制](#72-box-到引用强制)
    - [7.3 数组到切片强制](#73-数组到切片强制)
    - [7.4 引用到裸指针转换 (unsafe)](#74-引用到裸指针转换-unsafe)
    - [7.5 函数指针强制](#75-函数指针强制)
    - [7.6 自定义类型的强制转换](#76-自定义类型的强制转换)
    - [7.7 生命周期强制](#77-生命周期强制)
    - [7.8 复合强制](#78-复合强制)
  - [8. 安全边界分析](#8-安全边界分析)
    - [8.1 Safe Coercions 总结](#81-safe-coercions-总结)
    - [8.2 为什么某些转换是 Unsafe](#82-为什么某些转换是-unsafe)
    - [8.3 Unsize 强制](#83-unsize-强制)
  - [9. 与其他特性的交互](#9-与其他特性的交互)
    - [9.1 与泛型的交互](#91-与泛型的交互)
    - [9.2 与生命周期子类型的交互](#92-与生命周期子类型的交互)
    - [9.3 与模式匹配的交互](#93-与模式匹配的交互)
  - [10. 实现考虑](#10-实现考虑)
    - [10.1 编译器实现](#101-编译器实现)
    - [10.2 强制转换点](#102-强制转换点)
  - [11. 总结](#11-总结)
  - [理解这些规则对于编写安全和高效的 Rust 代码至关重要](#理解这些规则对于编写安全和高效的-rust-代码至关重要)
  - [相关概念](#相关概念)
  - [权威来源索引](#权威来源索引)
