...
- [一、基本概念定义](#一基本概念定义)
  ...
  - [1.2 特征与方法](#12-特征与方法)
- [二、概念之间的关系](#二概念之间的关系)
  - [2.1 引用与借用的关系](#21-引用与借用的关系)
  - [2.2 可变性与引用的关系](#22-可变性与引用的关系)
  - [2.3 `ref` 与 `&` 的关系](#23-ref-与-的关系)
  - [2.4 `Borrow` 与 `AsRef` 的关系](#24-borrow-与-asref-的关系)
  - [2.5 `to_owned` 与 `clone` 的关系](#25-to_owned-与-clone-的关系)
- [三、多层级引用与解引用](#三多层级引用与解引用)
  - [3.1 引用的层级关系](#31-引用的层级关系)
  - [3.2 自动解引用与方法调用](#32-自动解引用与方法调用)
  - [3.3 多层级可变引用](#33-多层级可变引用)
- [四、等价关系与推理](#四等价关系与推理)
  - [4.1 模式匹配中的 `ref` 与 `&` 等价关系](#41-模式匹配中的-ref-与-等价关系)
  - [4.2 多层解引用的等价关系](#42-多层解引用的等价关系)
...
- [六、复杂示例与分析](#六复杂示例与分析)
  - [6.1 多层级引用与可变性](#61-多层级引用与可变性)
  - [6.2 自引用结构体与生命周期](#62-自引用结构体与生命周期)
...
- [七、等价关系的形式化证明](#七等价关系的形式化证明)
  ...
  - [7.2 多层解引用的等价性证明](#72-多层解引用的等价性证明)
  - [7.3 借用方法的等价性证明](#73-借用方法的等价性证明)
- [八、总结与最佳实践](#八总结与最佳实践)
  - [8.1 引用与借用的关键概念](#81-引用与借用的关键概念)
  - [8.2 多层级引用的最佳实践](#82-多层级引用的最佳实践)
