...
- [C++ 中的复制语义和移动语义](#c-中的复制语义和移动语义)
- [Rust 中的所有权和移动语义](#rust-中的所有权和移动语义)
- [C++中的Copy、Clone、Moving语义](#c中的copyclonemoving语义)
- [Rust中的Copy、Clone、Moving语义](#rust中的copyclonemoving语义)
- [对比](#对比)
  - [C++中的Move语义](#c中的move语义)
    - [定义](#定义)
  - [联系和解释](#联系和解释)
  - [Rust中的Move语义](#rust中的move语义)
  - [Rust中的Copy语义](#rust中的copy语义)
- [类型系统中的变体性：C++ 与 Rust 对比](#类型系统中的变体性c-与-rust-对比)
  - [一、基本概念定义](#一基本概念定义)
...
- [二、C++ 中的变体性](#二c-中的变体性)
  ...
  - [3. 逆变](#3-逆变)
  - [4. 不变性](#4-不变性)
- [三、Rust 中的变体性](#三rust-中的变体性)
  - [1. rust可变性](#1-rust可变性)
  - [2. rust协变](#2-rust协变)
  - [3. rust逆变](#3-rust逆变)
  - [4. rust不变性](#4-rust不变性)
- [四、C++ 与 Rust 对比](#四c-与-rust-对比)
  - [1. 可变性对比](#1-可变性对比)
  - [2. 协变对比](#2-协变对比)
  - [3. 逆变对比](#3-逆变对比)
  - [4. 不变性对比](#4-不变性对比)
...
- [六、总结](#六总结)
  - [C++ 变体性特点](#c-变体性特点)
  - [Rust 变体性特点](#rust-变体性特点)
  - [核心差异](#核心差异)
- [1. Rust 支持的编程范式](#1-rust-支持的编程范式)
  - [1.1 面向过程编程](#11-面向过程编程)
  - [1.2 函数式编程](#12-函数式编程)
  - [1.3 面向对象编程（OOP）](#13-面向对象编程oop)
  - [1.4 泛型编程](#14-泛型编程)
  - [1.5 并发编程](#15-并发编程)
- [2. Rust 的思维模式](#2-rust-的思维模式)
  - [2.1 安全第一](#21-安全第一)
  - [2.2 零成本抽象](#22-零成本抽象)
  - [2.3 函数式思维](#23-函数式思维)
  - [2.4 组合优先与模块化](#24-组合优先与模块化)
  - [2.5 并发安全](#25-并发安全)
- [3. 思维导图](#3-思维导图)
- [4. 总结](#4-总结)
