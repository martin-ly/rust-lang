...
> **文档定位**: 介绍关联类型的概念和使用方法，以及与泛型参数的对比  
> **先修知识**: [Trait约束](./03_trait_bounds.md)  
> **相关文档**: [高级主题](./05_advanced_topics.md) | [主索引](./00_MASTER_INDEX.md)

## 📊 目录

- [04. 关联类型 (Associated Types)](#04-关联类型-associated-types)
  - [📊 目录](#-目录)
  - [📋 本文内容](#-本文内容)
