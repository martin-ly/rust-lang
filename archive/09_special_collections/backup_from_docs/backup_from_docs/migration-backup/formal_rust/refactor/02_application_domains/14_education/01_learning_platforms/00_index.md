...
- **[01_course_management/00_index.md](01_course_management/00_index.md)** - 课程管理语义
  - 课程结构语义
  - 内容管理语义
  - 进度跟踪语义
  - 课程优化语义
...
- **[02_learning_tracking/00_index.md](02_learning_tracking/00_index.md)** - 学习跟踪语义
  - 学习行为语义
  - 学习进度语义
  - 学习效果语义
  - 跟踪优化语义
...
- **[03_assessment_system/00_index.md](03_assessment_system/00_index.md)** - 评估系统语义
  - 评估算法语义
  - 评估策略语义
  - 评估验证语义
  - 评估优化语义
...
- **[04_collaborative_learning/00_index.md](04_collaborative_learning/00_index.md)** - 协作学习语义
  - 协作策略语义
  - 协作验证语义
  - 协作监控语义
  - 协作优化语义
...
- **[在线教育](../02_online_education/00_index.md)** - 在线教育应用
- **[智能辅导](../03_intelligent_tutoring/00_index.md)** - 智能辅导应用
- **[教育分析](../04_educational_analytics/00_index.md)** - 教育分析应用
