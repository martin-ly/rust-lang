...
- **[01_algorithms/00_index.md](01_algorithms/00_index.md)** - 算法语义
  - 监督学习语义
  - 无监督学习语义
  - 强化学习语义
  - 深度学习语义
...
- **[02_models/00_index.md](02_models/00_index.md)** - 模型语义
  - 模型结构语义
  - 模型参数语义
  - 模型优化语义
  - 模型验证语义
...
- **[03_training/00_index.md](03_training/00_index.md)** - 训练语义
  - 训练策略语义
  - 训练优化语义
  - 训练监控语义
  - 训练验证语义
...
- **[04_inference/00_index.md](04_inference/00_index.md)** - 推理语义
  - 推理算法语义
  - 推理优化语义
  - 推理验证语义
  - 推理部署语义
...
- **[自然语言处理](../03_nlp/00_index.md)** - 自然语言处理应用
