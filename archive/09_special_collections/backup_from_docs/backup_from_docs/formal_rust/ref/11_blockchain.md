...
- [1. 区块链协议的形式化](#1-区块链协议的形式化)
  - [1.1 区块结构与链式数据模型](#11-区块结构与链式数据模型)
- [2. 智能合约的理论基础](#2-智能合约的理论基础)
- [3. 密码学原语的形式化](#3-密码学原语的形式化)
- [4. Rust 区块链工程案例](#4-rust-区块链工程案例)
- [5. 理论贡献与方法论总结](#5-理论贡献与方法论总结)
  - [推进计划与断点快照](#推进计划与断点快照)
- [7. 交叉专题与纵深扩展](#7-交叉专题与纵深扩展)
  - [7.1 交叉专题：区块链与分布式/安全/IoT](#71-交叉专题区块链与分布式安全iot)
  - [7.2 纵深扩展：智能合约自动验证与安全分析](#72-纵深扩展智能合约自动验证与安全分析)
