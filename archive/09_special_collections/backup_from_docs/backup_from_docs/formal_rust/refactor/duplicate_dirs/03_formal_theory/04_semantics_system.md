...
- [1. 语义学基础](#1-语义学基础)
  - [1.1 语义学分类](#11-语义学分类)
    - [定义 1.1.1 (语义学)](#定义-111-语义学)
    - [语义学三大分支](#语义学三大分支)
  - [1.2 语义域](#12-语义域)
    - [定义 1.2.1 (语义域)](#定义-121-语义域)
    - [定义 1.2.2 (完全偏序)](#定义-122-完全偏序)
- [2. 操作语义](#2-操作语义)
  - [2.1 小步操作语义](#21-小步操作语义)
    - [定义 2.1.1 (小步操作语义)](#定义-211-小步操作语义)
    - [定义 2.1.2 (配置)](#定义-212-配置)
    - [小步语义规则](#小步语义规则)
  - [2.2 大步操作语义](#22-大步操作语义)
    - [定义 2.2.1 (大步操作语义)](#定义-221-大步操作语义)
    - [大步语义规则](#大步语义规则)
  - [2.3 Rust操作语义](#23-rust操作语义)
    - [定义 2.3.1 (Rust配置)](#定义-231-rust配置)
    - [Rust操作语义规则](#rust操作语义规则)
- [3. 指称语义](#3-指称语义)
  - [3.1 指称语义基础](#31-指称语义基础)
    - [定义 3.1.1 (指称语义)](#定义-311-指称语义)
    - [定义 3.1.2 (语义函数)](#定义-312-语义函数)
  - [3.2 语义函数定义](#32-语义函数定义)
    - [定义 3.2.1 (数值语义)](#定义-321-数值语义)
    - [定义 3.2.2 (变量语义)](#定义-322-变量语义)
    - [定义 3.2.3 (函数应用语义)](#定义-323-函数应用语义)
    - [定义 3.2.4 (条件表达式语义)](#定义-324-条件表达式语义)
  - [3.3 Rust指称语义](#33-rust指称语义)
    - [定义 3.3.1 (Rust语义函数)](#定义-331-rust语义函数)
    - [Rust语义规则](#rust语义规则)
- [4. 公理语义](#4-公理语义)
  - [4.1 霍尔逻辑](#41-霍尔逻辑)
    - [定义 4.1.1 (霍尔三元组)](#定义-411-霍尔三元组)
    - [霍尔逻辑公理](#霍尔逻辑公理)
  - [4.2 分离霍尔逻辑](#42-分离霍尔逻辑)
    - [定义 4.2.1 (分离霍尔逻辑)](#定义-421-分离霍尔逻辑)
    - [分离霍尔逻辑公理](#分离霍尔逻辑公理)
  - [4.3 Rust公理语义](#43-rust公理语义)
    - [定义 4.3.1 (Rust霍尔逻辑)](#定义-431-rust霍尔逻辑)
    - [Rust公理规则](#rust公理规则)
- [5. 语义等价性](#5-语义等价性)
  - [5.1 语义等价定义](#51-语义等价定义)
    - [定义 5.1.1 (语义等价)](#定义-511-语义等价)
    - [定义 5.1.2 (上下文等价)](#定义-512-上下文等价)
  - [5.2 等价性证明](#52-等价性证明)
    - [定理 5.2.1 (β等价)](#定理-521-β等价)
    - [定理 5.2.2 (η等价)](#定理-522-η等价)
- [6. 语义正确性](#6-语义正确性)
  - [6.1 正确性定义](#61-正确性定义)
    - [定义 6.1.1 (语义正确性)](#定义-611-语义正确性)
    - [定义 6.1.2 (完全正确性)](#定义-612-完全正确性)
  - [6.2 正确性证明](#62-正确性证明)
    - [定理 6.2.1 (霍尔逻辑正确性)](#定理-621-霍尔逻辑正确性)
    - [定理 6.2.2 (Rust语义正确性)](#定理-622-rust语义正确性)
- [7. 实践应用](#7-实践应用)
  - [7.1 Rust代码示例](#71-rust代码示例)
  - [7.2 语义验证工具](#72-语义验证工具)
- [8. 总结](#8-总结)
