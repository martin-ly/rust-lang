...
- [Pinning与Unsafe基础](#pinning与unsafe基础)
  - [📊 目录](#-目录)
  - [概述](#概述)
  - [Pin的理论基础](#pin的理论基础)
    - [1. 移动语义与自引用](#1-移动语义与自引用)
    - [2. Pin的解决方案](#2-pin的解决方案)
  - [Pin的API设计](#pin的api设计)
    - [1. Pin类型定义](#1-pin类型定义)
    - [2. Pin的安全保证](#2-pin的安全保证)
  - [Unpin Trait](#unpin-trait)
    - [1. Unpin的定义](#1-unpin的定义)
    - [2. Unpin的语义](#2-unpin的语义)
    - [3. 常见类型的Unpin实现](#3-常见类型的unpin实现)
  - [自借用结构](#自借用结构)
    - [1. 自借用的定义](#1-自借用的定义)
    - [2. 自借用的安全问题](#2-自借用的安全问题)
    - [3. 使用Pin解决自借用问题](#3-使用pin解决自借用问题)
  - [Future中的Pin使用](#future中的pin使用)
    - [1. Future Trait中的Pin](#1-future-trait中的pin)
    - [2. 为什么Future需要Pin](#2-为什么future需要pin)
    - [3. 手动实现Future](#3-手动实现future)
  - [Unsafe代码模式](#unsafe代码模式)
    - [1. 安全的unsafe使用](#1-安全的unsafe使用)
    - [2. 不安全的模式](#2-不安全的模式)
    - [3. 安全抽象](#3-安全抽象)
  - [形式化验证](#形式化验证)
    - [1. Pin的不变性](#1-pin的不变性)
