...
- [常量泛型类型检查算法和类型检查器实现](#常量泛型类型检查算法和类型检查器实现)
  - [📊 目录](#-目录)
  - [执行摘要](#执行摘要)
    - [核心目标](#核心目标)
  - [1. 常量泛型类型检查算法](#1-常量泛型类型检查算法)
    - [1.1 核心检查算法](#11-核心检查算法)
    - [1.2 常量参数检查](#12-常量参数检查)
  - [2. 常量表达式类型检查](#2-常量表达式类型检查)
    - [2.1 表达式类型检查](#21-表达式类型检查)
    - [2.2 操作符类型检查](#22-操作符类型检查)
  - [3. 常量泛型错误诊断系统](#3-常量泛型错误诊断系统)
    - [3.1 错误分类和诊断](#31-错误分类和诊断)
    - [3.2 修复建议生成](#32-修复建议生成)
  - [4. 常量泛型性能优化](#4-常量泛型性能优化)
    - [4.1 类型检查优化](#41-类型检查优化)
    - [4.2 表达式优化和缓存](#42-表达式优化和缓存)
  - [5. 实现示例](#5-实现示例)
    - [5.1 常量泛型类型检查示例](#51-常量泛型类型检查示例)
    - [5.2 常量表达式检查示例](#52-常量表达式检查示例)
  - [6. 验收标准](#6-验收标准)
