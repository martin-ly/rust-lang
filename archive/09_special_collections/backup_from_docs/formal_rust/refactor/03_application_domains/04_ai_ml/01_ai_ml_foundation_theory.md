...
- [📅 文档信息](#文档信息)
- [文档概述](#文档概述)
- [1. 机器学习基础理论](#1-机器学习基础理论)
  - [1.1 机器学习数学定义](#11-机器学习数学定义)
  - [1.2 Rust机器学习类型系统](#12-rust机器学习类型系统)
- [2. 神经网络理论](#2-神经网络理论)
  - [2.1 神经网络数学定义](#21-神经网络数学定义)
  - [2.2 Rust神经网络实现](#22-rust神经网络实现)
- [3. 深度学习理论](#3-深度学习理论)
  - [3.1 深度学习架构](#31-深度学习架构)
...
- [5. 损失函数理论](#5-损失函数理论)
  ...
  - [5.2 分类损失](#52-分类损失)
- [6. 正则化理论](#6-正则化理论)
  - [6.1 L1/L2正则化](#61-l1l2正则化)
  - [6.2 Dropout正则化](#62-dropout正则化)
- [7. 模型评估理论](#7-模型评估理论)
  - [7.1 评估指标](#71-评估指标)
  - [7.2 交叉验证](#72-交叉验证)
- [8. 特征工程理论](#8-特征工程理论)
