...
- [04 移动语义与部分移动](#04-移动语义与部分移动)
  - [📊 目录](#-目录)
  - [概述](#概述)
  - [理论基础](#理论基础)
  - [核心机制](#核心机制)
    - [1. 移动语义（Move）](#1-移动语义move)
    - [2. Copy类型与按值复制](#2-copy类型与按值复制)
    - [3. 部分移动（结构体字段）](#3-部分移动结构体字段)
    - [4. Drop特质与资源释放](#4-drop特质与资源释放)
  - [批判性分析](#批判性分析)
  - [FAQ](#faq)
  - [交叉借用](#交叉借用)
  - [总结](#总结)
...
- Drop特质自动释放资源，减少内存泄漏风险，但需避免循环借用
