...
- [核心概念](#核心概念)
  ...
  - [共识机制 (Consensus Mechanism)](#共识机制-consensus-mechanism)
  - [智能合约 (Smart Contract)](#智能合约-smart-contract)
...
- [共识算法](#共识算法)
  ...
  - [委托权益证明 (Delegated Proof of Stake, DPoS)](#委托权益证明-delegated-proof-of-stake-dpos)
- [密码学原语](#密码学原语)
  - [哈希函数 (Hash Function)](#哈希函数-hash-function)
  - [数字签名 (Digital Signature)](#数字签名-digital-signature)
  - [零知识证明 (Zero-Knowledge Proof)](#零知识证明-zero-knowledge-proof)
  - [同态加密 (Homomorphic Encryption)](#同态加密-homomorphic-encryption)
- [网络协议](#网络协议)
  - [P2P网络 (Peer-to-Peer Network)](#p2p网络-peer-to-peer-network)
  - [节点发现 (Node Discovery)](#节点发现-node-discovery)
  - [区块传播 (Block Propagation)](#区块传播-block-propagation)
  - [网络分区 (Network Partition)](#网络分区-network-partition)
- [应用协议](#应用协议)
  - [DeFi协议 (Decentralized Finance)](#defi协议-decentralized-finance)
  ...
  - [跨链协议 (Cross-Chain Protocol)](#跨链协议-cross-chain-protocol)
- [安全机制](#安全机制)
  - [双重支付攻击 (Double Spending Attack)](#双重支付攻击-double-spending-attack)
  - [51%攻击 (51% Attack)](#51攻击-51-attack)
  - [重入攻击 (Reentrancy Attack)](#重入攻击-reentrancy-attack)
  - [闪电贷攻击 (Flash Loan Attack)](#闪电贷攻击-flash-loan-attack)
- [数据结构体体体](#数据结构体体体)
  - [默克尔树 (Merkle Tree)](#默克尔树-merkle-tree)
  - [UTXO模型 (Unspent Transaction Output)](#utxo模型-unspent-transaction-output)
  - [账户模型 (Account Model)](#账户模型-account-model)
  - [状态树 (State Tree)](#状态树-state-tree)
- [虚拟机](#虚拟机)
  - [以太坊虚拟机 (Ethereum Virtual Machine, EVM)](#以太坊虚拟机-ethereum-virtual-machine-evm)
  - [WebAssembly虚拟机 (WASM VM)](#webassembly虚拟机-wasm-vm)
  - [Gas机制 (Gas Mechanism)](#gas机制-gas-mechanism)
- [扩容技术](#扩容技术)
  - [分片 (Sharding)](#分片-sharding)
  - [二层网络 (Layer 2)](#二层网络-layer-2)
  - [侧链 (Sidechain)](#侧链-sidechain)
  - [状态通道 (State Channel)](#状态通道-state-channel)
- [隐私技术](#隐私技术)
  - [环签名 (Ring Signature)](#环签名-ring-signature)
  - [混币技术 (Coin Mixing)](#混币技术-coin-mixing)
  - [机密交易 (Confidential Transactions)](#机密交易-confidential-transactions)
  - [同态加密1 (Homomorphic Encryption)](#同态加密1-homomorphic-encryption)
- [治理机制](#治理机制)
  - [链上治理 (On-Chain Governance)](#链上治理-on-chain-governance)
  - [代币投票 (Token Voting)](#代币投票-token-voting)
  - [委托投票 (Delegated Voting)](#委托投票-delegated-voting)
  - [时间锁定 (Time Lock)](#时间锁定-time-lock)
