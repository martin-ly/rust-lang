...
- [Rust所有权系统统一理论](#rust所有权系统统一理论)
  ...
  - [1. 理论基础](#1-理论基础)
    - [1.1 数学基础](#11-数学基础)
      ...
      - [所有权关系](#所有权关系)
      - [核心公理](#核心公理)
    - [1.2 线性逻辑基础](#12-线性逻辑基础)
      - [线性合取 $\\otimes$](#线性合取-otimes)
      - [线性蕴含 $\\multimap$](#线性蕴含-multimap)
    - [1.3 分离逻辑基础](#13-分离逻辑基础)
      - [分离合取 $\*$](#分离合取-)
  - [2. 所有权规则](#2-所有权规则)
    - [2.1 基本规则](#21-基本规则)
      - [规则1: 唯一性](#规则1-唯一性)
