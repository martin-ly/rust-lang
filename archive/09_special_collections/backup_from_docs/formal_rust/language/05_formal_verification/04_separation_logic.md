...
- [04 分离逻辑应用](#04-分离逻辑应用)
  - [目录](#目录)
  - [章节简介](#章节简介)
  - [1. 分离逻辑理论基础](#1-分离逻辑理论基础)
  - [2. 内存分离与帧规则](#2-内存分离与帧规则)
  - [3. Rust内存安全的分离逻辑建模](#3-rust内存安全的分离逻辑建模)
  - [4. 形式化推理与代码示例](#4-形式化推理与代码示例)
  - [5. 工程意义与工具应用](#5-工程意义与工具应用)
  - [6. 参考文献](#6-参考文献)

## 章节简介

本章系统梳理分离逻辑在Rust内存安全与资源管理中的理论基础、形式化定义、核心定理与证明思路，涵盖分离合取、帧规则、局部推理、所有权与借用的分离逻辑建模。
通过形式化推理、代码示例与工程意义分析，帮助读者掌握Rust内存安全的可机械化验证基础。
