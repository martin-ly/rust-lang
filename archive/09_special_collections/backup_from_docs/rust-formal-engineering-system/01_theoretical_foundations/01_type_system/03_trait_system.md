...
- [03 Trait系统形式化理论](#03-trait系统形式化理论)
  ...
  - [4. Trait实现](#4-trait实现)
    - [4.0 对象安全与动态分发（版本对齐说明） {#object-safety-dyn-dispatch-alignment}](#40-对象安全与动态分发版本对齐说明-object-safety-dyn-dispatch-alignment)
    - [4.1 基本实现](#41-基本实现)
    - [4.2 泛型实现](#42-泛型实现)
    - [4.3 条件实现](#43-条件实现)
    - [4.4 实现检查](#44-实现检查)
  ...
  - [10. 参考文献](#10-参考文献)
    ...
    - [10.2 技术文档](#102-技术文档)
    - [10.3 在线资源](#103-在线资源)
  - [版本对齐说明（对象安全、动态分发与强制）](#版本对齐说明对象安全动态分发与强制)
  - [附：索引锚点与导航](#附索引锚点与导航)
    - [对象安全 {#对象安全}](#对象安全-对象安全)
    - [动态分发 {#动态分发}](#动态分发-动态分发)
...
### 4.0 对象安全与动态分发（版本对齐说明） {#object-safety-dyn-dispatch-alignment}
