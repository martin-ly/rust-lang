...
- [06 所有权与借用系统定理证明](#06-所有权与借用系统定理证明)
  ...
  - [5. 生命周期定理](#5-生命周期定理)
    ...
    - [生命周期包含关系 {#生命周期包含关系}](#生命周期包含关系-生命周期包含关系)
  - [6. 内存安全定理](#6-内存安全定理)
...
- [内存安全保证](../23_security_verification/01_formal_security_model.md#内存安全保证)
- [并发安全](../05_concurrency/01_formal_concurrency_model.md#并发安全)
- [引用类型系统](../02_type_system/01_formal_type_system.md#引用规则)
...
- [异步生命周期](../06_async_await/01_formal_async_system.md#异步生命周期)
- [内存安全保证](../23_security_verification/01_formal_security_model.md#内存安全保证)
