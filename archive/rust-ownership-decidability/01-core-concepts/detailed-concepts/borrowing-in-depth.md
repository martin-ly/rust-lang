...
## 目录
>
> **来源: [Rust Reference](https://doc.rust-lang.org/reference/)** · **来源: [Wikipedia - Rust (programming language)](https://en.wikipedia.org/wiki/Rust_(programming_language))** · **来源: [Rustonomicon](https://doc.rust-lang.org/nomicon/)** · **来源: [The Rust Programming Language](https://doc.rust-lang.org/book/)** · **来源: [Rust RFCs](https://github.com/rust-lang/rfcs)** · **来源: [Rust Standard Library](https://doc.rust-lang.org/std/)** · **来源: [Wikipedia - Borrowing (computer science)](https://en.wikipedia.org/wiki/Borrowing_(computer_science))** · **来源: [Wikipedia - Alias Analysis](https://en.wikipedia.org/wiki/Alias_Analysis)** · **[来源: ACM - Borrow Checker Algorithms]** · **[来源: IEEE - Static Analysis for Memory Safety]**
...
- [借用深入分析](.#借用深入分析)
  ...
  - [8. 高级借用模式](.#8-高级借用模式)
    ...
    - [8.5 闭包与借用](.#85-闭包与借用)
  - [总结](.#总结)
<a id="继续学习-lifetimes-masterymd"></a>
