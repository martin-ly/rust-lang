...
- [形式化定义框架](.#形式化定义框架)
  ...
  - [6. 效果系统](.#6-效果系统)
    ...
    - [6.2 效果规则](.#62-效果规则)
  - [7. 并发形式化](.#7-并发形式化)
    - [7.1 Send与Sync定义](.#71-send与sync定义)
    - [7.2 并发安全性](.#72-并发安全性)
  - [8. 异步形式化](.#8-异步形式化)
    - [8.1 Future语义](.#81-future语义)
    - [8.2 async/await语义](.#82-asyncawait语义)
  - [9. 验证条件](.#9-验证条件)
    - [9.1 程序验证](.#91-程序验证)
    - [9.2 不变式](.#92-不变式)
<a id="状态--形式化定义框架-100-完成"></a>
  - [**状态**: ✅ 形式化定义框架 100% 完成](.#状态--形式化定义框架-100-完成)
  - [相关概念](.#相关概念)
  - [权威来源索引](.#权威来源索引)
