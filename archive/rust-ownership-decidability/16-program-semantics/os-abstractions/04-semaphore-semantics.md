...
- [信号量的形式化语义](#信号量的形式化语义)
  - [📑 目录](#-目录)
  - [1. 引言](#1-引言)
  - [2. 信号量的基本形式化模型](#2-信号量的基本形式化模型)
    - [2.1 核心定义](#21-核心定义)
    - [2.2 操作的形式化定义](#22-操作的形式化定义)
    - [2.3 状态转换图](#23-状态转换图)
  - [3. 计数信号量的语义](#3-计数信号量的语义)
    - [3.1 一般计数信号量](#31-一般计数信号量)
    - [3.2 Rust 代码示例](#32-rust-代码示例)
    - [3.3 使用 tokio::sync::Semaphore](#33-使用-tokiosyncsemaphore)
  - [4. 二进制信号量（互斥锁）](#4-二进制信号量互斥锁)
    - [4.1 二进制信号量的形式化](#41-二进制信号量的形式化)
    - [4.2 与互斥锁的比较](#42-与互斥锁的比较)
    - [4.3 Rust 代码示例](#43-rust-代码示例)
  - [5. 生产者-消费者模式的形式化](#5-生产者-消费者模式的形式化)
    - [5.1 有界缓冲区的形式化定义](#51-有界缓冲区的形式化定义)
    - [5.2 操作语义](#52-操作语义)
    - [5.3 Rust 代码实现](#53-rust-代码实现)
  - [6. 多资源管理的形式化](#6-多资源管理的形式化)
    - [6.1 资源池的形式化](#61-资源池的形式化)
    - [6.2 Rust 实现](#62-rust-实现)
  - [7. 信号量的高级模式](#7-信号量的高级模式)
    - [7.1 读写信号量](#71-读写信号量)
    - [7.2 屏障信号量](#72-屏障信号量)
  - [8. 综合安全论证](#8-综合安全论证)
    - [8.1 信号量的正确性定理](#81-信号量的正确性定理)
    - [8.2 不变式总结](#82-不变式总结)
  - [9. 总结](#9-总结)
<a id="这些形式化定义确保了-rust-程序在使用信号量进行并发控制时的正确性和安全性"></a>
  - [这些形式化定义确保了 Rust 程序在使用信号量进行并发控制时的正确性和安全性](#这些形式化定义确保了-rust-程序在使用信号量进行并发控制时的正确性和安全性)
  - [相关概念](#相关概念)
  - [权威来源索引](#权威来源索引)
  - [权威来源索引](#权威来源索引-1)
