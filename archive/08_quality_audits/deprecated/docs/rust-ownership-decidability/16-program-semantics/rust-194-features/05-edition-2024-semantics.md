...
>
> [归档级]
> **说明**: 本文档为历史研究材料，最新内容请参阅 [concept/07_future/23_rust_edition_guide.md](../../../../../../concept/07_future/01_edition_roadmap/23_rust_edition_guide.md)
...
> **说明**: 本文档为历史研究材料，最新 Edition 2024 内容请参阅 [knowledge/06_ecosystem/02_edition_2024.md](../../../../knowledge/06_ecosystem/02_edition_2024.md) 与 [concept/07_future/19_rust_edition_preview.md](../../../../../../concept/07_future/01_edition_roadmap/19_rust_edition_preview.md)

---

> **[主轨引用]**: 教学视角参见 [concept/07_future/19_rust_edition_preview.md](../../../../../../concept/07_future/01_edition_roadmap/19_rust_edition_preview.md)。本文档侧重形式化语义分析（操作语义、类型规则、安全定理）。
...
- [Rust 2024 Edition 的新借用规则语义](#rust-2024-edition-的新借用规则语义)
  ...
  - [2. 语法定义](#2-语法定义)
    - [2.1 扩展的借用表达式](#21-扩展的借用表达式)
    - [2.2 闭包捕获模式](#22-闭包捕获模式)
    - [2.3 新的模式语法](#23-新的模式语法)
  - [3. 操作语义](#3-操作语义)
    - [3.1 精确借用规则](#31-精确借用规则)
    - [3.2 改进的闭包捕获](#32-改进的闭包捕获)
    - [3.3 临时生命周期扩展](#33-临时生命周期扩展)
  - [4. 类型规则](#4-类型规则)
    - [4.1 精确借用类型规则](#41-精确借用类型规则)
    - [4.2 闭包捕获规则](#42-闭包捕获规则)
    - [4.3 模式匹配改进](#43-模式匹配改进)
    - [4.4 借用检查改进](#44-借用检查改进)
  - [5. 形式化定义](#5-形式化定义)
    - [5.1 借用区域](#51-借用区域)
    - [5.2 精确捕获集](#52-精确捕获集)
    - [5.3 借用冲突检测](#53-借用冲突检测)
    - [5.4 生命周期区域](#54-生命周期区域)
  - [6. 安全定理](#6-安全定理)
    - [6.1 精确借用安全](#61-精确借用安全)
    - [6.2 闭包捕获安全](#62-闭包捕获安全)
    - [6.3 临时生命周期安全](#63-临时生命周期安全)
    - [6.4 与 2021 Edition 的兼容性](#64-与-2021-edition-的兼容性)
  - [7. Rust 代码示例](#7-rust-代码示例)
    - [7.1 精确字段借用](#71-精确字段借用)
    - [7.2 改进的闭包捕获](#72-改进的闭包捕获)
    - [7.3 临时生命周期扩展](#73-临时生命周期扩展)
    - [7.4 改进的匹配模式](#74-改进的匹配模式)
    - [7.5 非词法生命周期改进](#75-非词法生命周期改进)
    - [7.6 与泛型的交互](#76-与泛型的交互)
  - [8. 2021 vs 2024 Edition 对比](#8-2021-vs-2024-edition-对比)
    - [8.1 借用检查器差异](#81-借用检查器差异)
    - [8.2 临时生命周期差异](#82-临时生命周期差异)
    - [8.3 版本迁移指南](#83-版本迁移指南)
  - [9. 形式化差异分析](#9-形式化差异分析)
    - [9.1 借用图差异](#91-借用图差异)
    - [9.2 区域推断差异](#92-区域推断差异)
    - [9.3 闭包捕获差异](#93-闭包捕获差异)
  - [10. 实现细节](#10-实现细节)
    - [10.1 编译器变化](#101-编译器变化)
    - [10.2 MIR 表示变化](#102-mir-表示变化)
  - [11. 总结](#11-总结)
    - [11.1 关键改进](#111-关键改进)
    - [11.2 向后兼容性](#112-向后兼容性)
    - [11.3 最佳实践](#113-最佳实践)
  - [这些改进使 Rust 在保持内存安全的同时，提供了更好的开发者体验](#这些改进使-rust-在保持内存安全的同时提供了更好的开发者体验)
  - [相关概念](#相关概念)
  - [权威来源索引](#权威来源索引)
