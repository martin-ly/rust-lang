...
|-------------|---------------------------|------|
| 所有权形式化 (`01-core-concepts/`) | [`formal_methods/10_ownership_model.md`](../../../../docs/research_notes/formal_methods/10_ownership_model.md) | 本知识库更深入、更系统 |
| 借用检查器证明 (`formal-foundations/proofs/`) | [`formal_methods/10_borrow_checker_proof.md`](../../../../docs/research_notes/formal_methods/10_borrow_checker_proof.md) | 本知识库包含完整 Coq 证明 |
| 类型理论 (`01-core-concepts/`) | [`type_theory/`](../../../research_notes_2026_06_25/type_theory) | `research_notes/` 侧更侧重类型系统基础理论 |
| 设计模式形式化 (`11-design-patterns/`) | [`software_design_theory/01_design_patterns_formal/`](../../../research_notes_2026_06_25/software_design_theory/01_design_patterns_formal) | 两者互补，本知识库侧重 Rust 特定模式 |
| 并发形式化 (`12-concurrency-patterns/`) | [`formal_methods/10_async_state_machine.md`](../../../research_notes_2026_06_25/formal_methods/10_async_state_machine.md) | 本知识库涵盖更多并发模型 |
