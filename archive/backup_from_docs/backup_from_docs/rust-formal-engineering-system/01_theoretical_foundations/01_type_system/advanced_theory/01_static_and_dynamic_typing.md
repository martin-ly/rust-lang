...
- [4.1 静态与动态类型的形式化比较 - Formal Comparison of Static and Dynamic Typing](#41-静态与动态类型的形式化比较---formal-comparison-of-static-and-dynamic-typing)
  - [📊 目录](#-目录)
  ...
  - [静态类型特性（版本对齐说明） - Static Typing Features (Version-aligned)](#静态类型特性版本对齐说明---static-typing-features-version-aligned)
  ...
  - [动态类型特性（版本对齐说明） - Dynamic Typing Features (Version-aligned)](#动态类型特性版本对齐说明---dynamic-typing-features-version-aligned)
  ...
  - [工程实践案例（版本对齐说明） - Engineering Practice Cases (Version-aligned)](#工程实践案例版本对齐说明---engineering-practice-cases-version-aligned)
  ...
  - [总结 - Summary](#总结---summary)
    ...
    - [Rust 的平衡 - Rust Balance (Version-aligned)](#rust-的平衡---rust-balance-version-aligned)
  - [附：索引锚点与导航 - Index Anchors and Navigation](#附索引锚点与导航---index-anchors-and-navigation)
    ...
    - [特性锚点 - Feature Anchors (Version-aligned)](#特性锚点---feature-anchors-version-aligned)
