...
- [1. 设计理念与核心概念](#1-设计理念与核心概念)
- [2. 使用到的主要开源库](#2-使用到的主要开源库)
- [3. 系统组成](#3-系统组成)
  - [3.1 网络与 I/O 层](#31-网络与-io-层)
  - [3.2 业务逻辑层](#32-业务逻辑层)
  - [3.3 数据处理与通信层](#33-数据处理与通信层)
  - [3.4 可观测性与监控层](#34-可观测性与监控层)
- [4. 总结](#4-总结)
- [Pingora 模块划分与源代码分析](#pingora-模块划分与源代码分析)
- [1. 整体架构概述](#1-整体架构概述)
- [2. 模块划分详情](#2-模块划分详情)
  - [2.1 核心入口模块](#21-核心入口模块)
  - [2.2 网络与 I/O 层](#22-网络与-io-层)
  - [2.3 协议解析层](#23-协议解析层)
  - [2.4 业务处理层](#24-业务处理层)
  - [2.5 数据存储层](#25-数据存储层)
  - [2.6 可观测性与监控层](#26-可观测性与监控层)
  - [2.7 配置及工具模块](#27-配置及工具模块)
- [3. 总结](#3-总结)
