...
- [1. 基本概念](#1-基本概念)
  - [1.1 **Send Trait**](#11-send-trait)
  - [1.2 **Sync Trait**](#12-sync-trait)
- [2. 编译器如何处理 Send 和 Sync](#2-编译器如何处理-send-和-sync)
  - [2.1 自动实现（Auto Trait）](#21-自动实现auto-trait)
  - [2.2 编译器生成的代码](#22-编译器生成的代码)
- [3. 总结](#3-总结)
- [thread-safe](#thread-safe)
  ...
  - [2. -编译器如何处理 Send 和 Sync](#2-编译器如何处理-send-和-sync)
    ...
    - [2.2 -编译器生成的代码](#22-编译器生成的代码)
  - [3. -总结](#3-总结)
- [thread-safe type](#thread-safe-type)
  - [1. 不同访问方式下的情况](#1-不同访问方式下的情况)
    - [1.1 不可变共享（&T）](#11-不可变共享t)
    - [1.2 可变共享（&mut T）](#12-可变共享mut-t)
    - [1.3 跨线程修改：使用同步原语和原子类型](#13-跨线程修改使用同步原语和原子类型)
  - [2. 总结](#2-总结)
