...
- [1. 含义](#1-含义)
- [2. 举例](#2-举例)
  - [2.1 旧的 RPIT 用法](#21-旧的-rpit-用法)
  - [2.2 Rust 2024 的新用法](#22-rust-2024-的新用法)
  - [3. 应用](#3-应用)
    - [3.1 简化异步编程](#31-简化异步编程)
    - [3.2 简化泛型函数](#32-简化泛型函数)
    - [3.3 提高代码可读性](#33-提高代码可读性)
  - [4. 迁移指南](#4-迁移指南)
    - [4.1 使用 `cargo fix` 自动迁移](#41-使用-cargo-fix-自动迁移)
    - [4.2 手动迁移](#42-手动迁移)
  - [总结](#总结)
  - [Rust 2024 对异步编程的具体影响](#rust-2024-对异步编程的具体影响)
    - [1. **异步闭包（Async Closures）**](#1-异步闭包async-closures)
    - [2. **改进的错误处理**](#2-改进的错误处理)
    - [3. **`AsyncFn` 特性**](#3-asyncfn-特性)
    - [4. **`Future` 和 `IntoFuture` 到标准库 Prelude**](#4-future-和-intofuture-到标准库-prelude)
    - [5. **改进的生命周期捕获规则**](#5-改进的生命周期捕获规则)
- [*总结*](#总结)
