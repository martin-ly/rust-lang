...
- [区域与效应系统 (Region and Effect Systems)](#区域与效应系统-region-and-effect-systems)
  - [📊 目录](#-目录)
  - [1. 核心概念](#1-核心概念)
  - [2. 形式化定义](#2-形式化定义)
    - [2.1. 区域 (Region)](#21-区域-region)
    - [2.2. 效应 (Effect)](#22-效应-effect)
    - [2.3. 效应系统 (Effect System)](#23-效应系统-effect-system)
  - [3. 与 Rust 核心理论的关联](#3-与-rust-核心理论的关联)
    - [3.1. 与线性/仿射类型的关系](#31-与线性仿射类型的关系)
    - [3.2. 与分离逻辑的关系](#32-与分离逻辑的关系)
  - [4. Rust 中的实现与示例](#4-rust-中的实现与示例)
    - [示例: 模拟 I/O 效应系统](#示例-模拟-io-效应系统)
