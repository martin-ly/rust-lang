...
- [优化器概览](#优化器概览)
  - [Rust优化器的特点](#rust优化器的特点)
- [优化器实现](#优化器实现)
  - [1. 常量折叠 (Constant Folding)](#1-常量折叠-constant-folding)
    - [1.1 常量折叠优化器](#11-常量折叠优化器)
  - [2. 死代码消除 (Dead Code Elimination)](#2-死代码消除-dead-code-elimination)
    - [2.1 死代码消除优化器](#21-死代码消除优化器)
  - [3. 内联优化 (Inlining)](#3-内联优化-inlining)
    - [3.1 内联优化器](#31-内联优化器)
  - [4. 循环优化 (Loop Optimization)](#4-循环优化-loop-optimization)
    - [4.1 循环优化器](#41-循环优化器)
- [总结](#总结)
