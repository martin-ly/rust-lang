...
- [宏系统概览](#宏系统概览)
  - [Rust宏系统的特点](#rust宏系统的特点)
- [宏系统理论](#宏系统理论)
  - [1. 声明宏 (Declarative Macros)](#1-声明宏-declarative-macros)
    - [1.1 宏规则系统](#11-宏规则系统)
    - [1.2 宏示例实现](#12-宏示例实现)
  - [2. 过程宏 (Procedural Macros)](#2-过程宏-procedural-macros)
    - [2.1 过程宏类型系统](#21-过程宏类型系统)
    - [2.2 过程宏示例实现](#22-过程宏示例实现)
  - [3. 宏卫生性 (Macro Hygiene)](#3-宏卫生性-macro-hygiene)
    - [3.1 卫生算法](#31-卫生算法)
  - [4. 宏编译时计算 (Compile-time Computation)](#4-宏编译时计算-compile-time-computation)
    - [4.1 编译时表达式求值](#41-编译时表达式求值)
- [总结](#总结)
