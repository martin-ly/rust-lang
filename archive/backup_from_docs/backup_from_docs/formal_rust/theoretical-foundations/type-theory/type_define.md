...
- [Rust 自定义类型设计的核心准则与最佳实践](#rust-自定义类型设计的核心准则与最佳实践)
  ...
  - [6. 特质实现准则](#6-特质实现准则)
    - [6.1 遵循特质约定](#61-遵循特质约定)
    - [6.2 考虑特质边界](#62-考虑特质边界)
...
**准则**：
    为类型实现适当的标准特质，如 `Debug`、`Clone`、`PartialEq` 等，这有助于提高类型的可用性。
...
2. **正确使用生命周期**：为借用提供适当的生命周期标注
3. **实现标准特质**：为类型实现合适的标准特质
4. **提供构造函数**：提供清晰的构造方法
