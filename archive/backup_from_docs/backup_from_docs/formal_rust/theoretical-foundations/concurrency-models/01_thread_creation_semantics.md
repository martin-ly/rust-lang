...
**交叉借用**: [1.4.3 生命周期语义](../../01_foundation_semantics/04_ownership_system_semantics/03_lifetime_semantics.md), [3.2.1 Future语义](../02_async_programming_semantics/01_future_semantics.md)
...
- [3.1.1 Rust线程创建语义模型深度分析](#311-rust线程创建语义模型深度分析)
  ...
  - [3.1.1.5 相关借用与扩展阅读](#3115-相关借用与扩展阅读)
    - [3.1.1.5.1 内部交叉借用](#31151-内部交叉借用)
...
- [rayon](https://crates.io/crates/rayon) - 并发处理库
