...
- [Rust2024异步函数编程](#rust2024异步函数编程)
  ...
  - [2. 高级特质组合](#2-高级特质组合)
    - [与泛型结合](#与泛型结合)
    - [与生命周期结合](#与生命周期结合)
    - [与 trait bounds 结合](#与-trait-bounds-结合)
  - [3. 异步编程模式](#3-异步编程模式)
    - [异步流处理](#异步流处理)
    - [并发控制](#并发控制)
  - [4. 函数式编程模式](#4-函数式编程模式)
  ...
  - [6. 资源管理模式](#6-资源管理模式)
    ...
    - [异步资源管理](#异步资源管理)
  - [7. 最佳实践建议](#7-最佳实践建议)
  - [8. 与 Tokio 等异步库的兼容性](#8-与-tokio-等异步库的兼容性)
    - [匹配与兼容](#匹配与兼容)
    - [潜在的错误使用](#潜在的错误使用)


在 Rust 2024 版本中，`gen`、`yield` 和 `next` 关键字为生成器和异步编程引入了新的特质。
以下是对这些关键字的定义、解释和使用说明，以及它们与其他语言特质的组合方式、编程建议，
...
通过这些特质和建议，Rust 2024 的生成器功能可以帮助开发者编写更高效、可读性更高的代码，特别是在需要处理复杂数据流和异步操作的场景中。
