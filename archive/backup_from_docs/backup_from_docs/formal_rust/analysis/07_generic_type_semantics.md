...
- [1.1.7 Rust泛型类型系统语义深度分析](#117-rust泛型类型系统语义深度分析)
  - [目录](#目录)
  - [1.1.7.1 泛型类型系统理论基础](#1171-泛型类型系统理论基础)
    - [1.1.7.1.1 泛型trait与类型推断](#11711-泛型trait与类型推断)
    - [1.1.7.1.2 泛型类型与内存布局](#11712-泛型类型与内存布局)
  - [相关文档推荐](#相关文档推荐)
  - [知识网络节点](#知识网络节点)
  - [自动化验证脚本](#自动化验证脚本)
  - [工程案例](#工程案例)
