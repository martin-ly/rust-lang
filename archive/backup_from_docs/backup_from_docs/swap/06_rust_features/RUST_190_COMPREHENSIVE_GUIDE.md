...
本文档是 Rust 1.90 版本所有权和借用系统的全面指南，从基础概念到高级技巧，系统地介绍了 Rust 的所有权模型、借用机制、生命周期系统、智能指针、并发安全等核心特性。

## 学习目标

- 理解 Rust 所有权的三个核心规则
- 掌握借用系统和生命周期
- 学习智能指针的使用（Box、Rc、RefCell）
- 理解并发安全和内存管理
- 掌握最佳实践和常见问题解决

## 目录 / Table of Contents

- [Rust 1.90 所有权和借用系统全面指南 / Rust 1.90 Ownership and Borrowing System Comprehensive Guide](#rust-190-所有权和借用系统全面指南--rust-190-ownership-and-borrowing-system-comprehensive-guide)
  - [内容概述](#内容概述)
  - [学习目标](#学习目标)
  - [目录 / Table of Contents](#目录--table-of-contents)
  - [概述 / Overview](#概述--overview)
    - [主要改进 / Main Improvements](#主要改进--main-improvements)
  - [基础概念 / Basic Concepts](#基础概念--basic-concepts)
    - [所有权规则 / Ownership Rules](#所有权规则--ownership-rules)
    - [借用概念 / Borrowing Concepts](#借用概念--borrowing-concepts)
  - [所有权系统 / Ownership System](#所有权系统--ownership-system)
    - [移动语义 / Move Semantics](#移动语义--move-semantics)
    - [所有权转移 / Ownership Transfer](#所有权转移--ownership-transfer)
  - [借用系统 / Borrowing System](#借用系统--borrowing-system)
    - [不可变借用 / Immutable Borrowing](#不可变借用--immutable-borrowing)
    - [可变借用 / Mutable Borrowing](#可变借用--mutable-borrowing)
    - [借用规则 / Borrowing Rules](#借用规则--borrowing-rules)
  - [生命周期系统 / Lifetime System](#生命周期系统--lifetime-system)
    - [生命周期注解 / Lifetime Annotations](#生命周期注解--lifetime-annotations)
    - [结构体生命周期 / Struct Lifetimes](#结构体生命周期--struct-lifetimes)
    - [生命周期省略 / Lifetime Elision](#生命周期省略--lifetime-elision)
  - [作用域管理 / Scope Management](#作用域管理--scope-management)
    - [基本作用域 / Basic Scope](#基本作用域--basic-scope)
    - [嵌套作用域 / Nested Scope](#嵌套作用域--nested-scope)
  - [智能指针 / Smart Pointers](#智能指针--smart-pointers)
    - [`Box<T>` - 堆分配 / `Box<T>` - Heap Allocation](#boxt---堆分配--boxt---heap-allocation)
    - [`Rc<T>` - 引用计数 / `Rc<T>` - Reference Counting](#rct---引用计数--rct---reference-counting)
    - [`RefCell<T>`- 内部可变性 / `RefCell<T>` - Interior Mutability](#refcellt--内部可变性--refcellt---interior-mutability)
  - [并发安全 / Concurrency Safety](#并发安全--concurrency-safety)
    - [线程 / Threads](#线程--threads)
    - [消息传递 / Message Passing](#消息传递--message-passing)
    - [共享状态 / Shared State](#共享状态--shared-state)
  ...
  - [错误处理 / Error Handling](#错误处理--error-handling)
    - [`Option<T>` / `Option<T>`](#optiont--optiont)
    - [Result\<T, E\> / Result\<T, E\>](#resultt-e--resultt-e)
  - [性能优化 / Performance Optimization](#性能优化--performance-optimization)
    - [内联优化 / Inline Optimization](#内联优化--inline-optimization)
    - [分支预测优化 / Branch Prediction Optimization](#分支预测优化--branch-prediction-optimization)
  - [最佳实践 / Best Practices](#最佳实践--best-practices)
    - [1. 最小化可变性 / Minimize Mutability](#1-最小化可变性--minimize-mutability)
    - [2. 优先使用借用 / Prefer Borrowing](#2-优先使用借用--prefer-borrowing)
    - [3. 合理使用生命周期 / Use Lifetimes Appropriately](#3-合理使用生命周期--use-lifetimes-appropriately)
  - [常见问题 / Common Issues](#常见问题--common-issues)
    - [1. 借用检查器错误 / Borrow Checker Errors](#1-借用检查器错误--borrow-checker-errors)
    - [2. 生命周期错误 / Lifetime Errors](#2-生命周期错误--lifetime-errors)
  - [高级技巧 / Advanced Techniques](#高级技巧--advanced-techniques)
    - [1. 所有权模式 / Ownership Patterns](#1-所有权模式--ownership-patterns)
    - [2. 高级借用技巧 / Advanced Borrowing Techniques](#2-高级借用技巧--advanced-borrowing-techniques)
    - [3. 智能指针组合 / Smart Pointer Combinations](#3-智能指针组合--smart-pointer-combinations)
  - [总结 / Summary](#总结--summary)
    - [关键要点 / Key Takeaways](#关键要点--key-takeaways)
