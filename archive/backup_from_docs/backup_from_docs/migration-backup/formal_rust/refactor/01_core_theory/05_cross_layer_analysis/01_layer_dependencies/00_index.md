...
- **[01_dependency_relations/00_index.md](01_dependency_relations/00_index.md)** - 依赖关系语义
  - 直接依赖语义
  - 间接依赖语义
  - 传递依赖语义
  - 依赖强度语义
...
- **[02_dependency_propagation/00_index.md](02_dependency_propagation/00_index.md)** - 依赖传播语义
  - 依赖传播路径语义
  - 依赖传播速度语义
  - 依赖传播影响语义
  - 依赖传播控制语义
...
- **[03_cycle_detection/00_index.md](03_cycle_detection/00_index.md)** - 循环依赖检测语义
  - 循环检测算法语义
  - 循环分析语义
  - 循环解决语义
  - 循环预防语义
...
- **[04_dependency_optimization/00_index.md](04_dependency_optimization/00_index.md)** - 依赖优化语义
  - 依赖简化语义
  - 依赖重构语义
  - 依赖缓存语义
  - 依赖并行化语义
