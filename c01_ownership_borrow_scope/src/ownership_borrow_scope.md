# Ownership and Borrow Scope

## 目录

- [Ownership and Borrow Scope](#ownership-and-borrow-scope)
  - [目录](#目录)
  - [1 从范畴论的视角来看-生命周期、所有权和借用](#1-从范畴论的视角来看-生命周期所有权和借用)
    ...
    - [1.5 **范畴论视角**](#15-范畴论视角)
    - [1.6 **总结**](#16-总结)
  - [2 从范畴论的视角来看-变量的赋值、传参和返回等操作](#2-从范畴论的视角来看-变量的赋值传参和返回等操作)
    - [2.1 **变量的赋值**](#21-变量的赋值)
    - [2.2 **传参**](#22-传参)
    - [2.3 **返回值**](#23-返回值)
    ...
    - [2.5 **范畴论视角**](#25-范畴论视角)
    - [2.6 **总结**](#26-总结)
  - [3 从范畴论的视角来综合思考和信息论的角度](#3-从范畴论的视角来综合思考和信息论的角度)
  ...
  - [4 可变引用的排他性](#4-可变引用的排他性)
    ...
    - [4.3 **排他性与内存安全**](#43-排他性与内存安全)
      ...
      - [4.3.4 **生命周期的管理**](#434-生命周期的管理)
      - [4.3.4 **总结**](#434-总结)

## 1 从范畴论的视角来看-生命周期、所有权和借用

从范畴论的视角来看，Rust中的生命周期、所有权和借用确实可以被视为类型组合、解构和类型构造的上下文模型的约束。
