...
>
> **相关概念**: [Select](../../../concept/03_advanced/01_async/02_async.md)
> **Bloom 层级**: 理解
...
- [rust-lang/rust#131038](https://github.com/rust-lang/rust/pull/131038) [Rust Core Team / 2025](https://www.rust-lang.org/)
...
- [`if let` Guards on Match Arms（Rust 1.95.0）](../control_flow/01_if_let_guards.md)
- [Rust 2024 Edition `let chains` 深度专题](../control_flow/02_let_chains.md)
- [声明宏深入 (Declarative Macros)](../../03_advanced/macros/01_declarative.md)
- [过程宏深入 (Procedural Macros)](../../03_advanced/macros/02_procedural.md)
