...
| 版本 | 预计发布 | 关键特性 | 准备状态 |
|------|---------|---------|----------|
| 1.96.0 | 2026-05-28 | `assert_matches!`, `core::range`, `NonZero` 迭代等 | 📦 历史版本（已升级到 1.96.1） |
| 1.96.1 | 2026-07-04 | 1.96 系列最新 patch，安全修复与稳定性改进 | ✅ Stable |
| 1.97.0 | 2026-07 | nightly / beta 候选 | ⏳ 等待 stable |
