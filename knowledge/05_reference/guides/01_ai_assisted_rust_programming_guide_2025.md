...
> **EN**: Ai Assisted Rust Programming Guide 2025
> **Summary**: AI 辅助 Rust 编程指南 Ai Assisted Rust Programming Guide 2025. (stub/archive redirect)
> **Bloom 层级**: 理解
> **最后更新**: 2026-05-19 (更新 Rust 1.95+ 特性)
> **Rust 版本**: 1.96.1+
...
- **错误码上下文**: 遇到编译错误时，附带 [ERROR_CODE_MAPPING](../../../docs/02_reference/02_error_code_mapping.md) 中对应文档
...
| **遇到错误** | 粘贴错误码 + [ERROR_CODE_MAPPING](../../../docs/02_reference/02_error_code_mapping.md) 对应文档 | Claude/GPT |
...
2. **版本一致**: 明确指定 Rust 1.96.1+ 和 Edition 2024
