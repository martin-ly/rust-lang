...
|-------------|---------|-------------------|
| **Unsafe Rust** | `../../03_advanced/unsafe/unsafe_rust.md` | [编码规范](09_reference/13_rust_safety_critical_coding_guidelines.md)、[安全审计](09_reference/15_security_audit_guide.md) |
| **Send/Sync 与线程** | `../../03_advanced/concurrency/threads.md` | [编码规范](09_reference/13_rust_safety_critical_coding_guidelines.md) |
| **原子操作与内存序** | `../../03_advanced/concurrency/atomics.md` | [编码规范](09_reference/13_rust_safety_critical_coding_guidelines.md) |
| **同步原语** | `../../03_advanced/concurrency/synchronization.md` | [编码规范](09_reference/13_rust_safety_critical_coding_guidelines.md) |
| **FFI 与 C 互操作** | `../../03_advanced/unsafe/ffi.md` | [FFI 集成指南](09_reference/07_ffi_integration_guide.md) |
| **Tree Borrows / Miri** | `../miri/tree_borrows.md` | [形式化验证实战](04_axiomatic_reasoning/01_formal_verification_practical_guide.md) |
| **编译器内部** | `../compiler_internals.md` | [工具链配置](09_reference/17_toolchain_setup_guide.md) |
| **Unsafe 代码审计** | `../unsafe_audit.md` | [安全审计指南](09_reference/15_security_audit_guide.md) |
| **类型驱动正确性** | `../../03_advanced/type_driven_correctness.md` | [形式化验证实战](04_axiomatic_reasoning/01_formal_verification_practical_guide.md) |
...
| `RUST_194_195_FEATURES_DEEP_DIVE.md` | Rust 1.94/1.95/1.96 特性深度解析 | ~15KB |
