...
- [Tree Borrows 权威指南 / Tree Borrows Authoritative Guide](02_tree_borrows_authoritative_guide.md)
...
- [形式化验证工具链 (concept)](../../../concept/04_formal/04_model_checking/05_verification_toolchain.md) — 2025–2026 工具链演进：AI × 形式化验证
