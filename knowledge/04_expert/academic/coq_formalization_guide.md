...
- [Tree Borrows 权威指南 / Tree Borrows Authoritative Guide](tree_borrows_authoritative_guide.md)
- [Rust 形式化语义](../../03_advanced/type_driven_correctness.md)
- [Miri 使用指南](../miri/README.md)
...
- [形式化验证工具链 (concept)](../../../concept/04_formal/05_verification_toolchain.md) — 2025–2026 工具链演进：AI × 形式化验证
