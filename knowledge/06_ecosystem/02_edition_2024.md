...
## 自 concept/07_future/19_rust_edition_preview.md 合并的补充内容

> **合并说明**: `concept/07_future/19_rust_edition_preview.md` 为 Rust 2024 Edition 的短预览 stub，
> 其独特价值在于嵌入式测验与认知路径。以下内容合并自该文件（2026-05-31 nightly 跟踪版本）。
...
## 自 docs/05_guides/06_rust_2024_edition_migration_guide.md 合并的补充内容

> **合并说明**: 以下内容来自 `docs/05_guides/06_rust_2024_edition_migration_guide.md`（2026-05-29 最后更新），
> 聚焦 Edition 2024 迁移实操：迁移前准备、分步迁移策略、六大核心变更详解、决策树、边界测试等。
