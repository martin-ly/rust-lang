...
> **相关概念**: [自我评估](../../concept/00_meta/04_navigation/self_assessment.md)
> **从入门到精通的完整路径**
> **总预计时间**: 200-400 小时
...
| 主题 | 文档 | 时间 | 目标 |
|------|------|------|------|
| 安装配置 | [02_installation.md](02_installation.md) | 1h | 搭建环境 |
| Hello World | [01_hello_world.md](01_hello_world.md) | 2h | 理解项目结构 |
| 设计哲学 | [04_rust_philosophy.md](04_rust_philosophy.md) | 2h | 理解核心理念 |
| Cargo 基础 | [../06_ecosystem/cargo_basics.md](../06_ecosystem/01_cargo_basics.md) | 2h | 包管理 |
