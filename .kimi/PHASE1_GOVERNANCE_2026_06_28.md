...
- [ ] 创建 `.kimi/archive/`（如不存在）
- [ ] 将以下历史计划/检查清单文件移入 `.kimi/archive/`，并保留原文件名：
...
- [ ] 更新 `BCD_TRACK_STATUS_2026_06_28.md` 中的提交记录与链接（若引用被归档文件）
- [ ] 提交变更
...
- [ ] 将 `docs/archive/` 下所有内容迁移到 `archive/docs/`
- [ ] 将 `docs/rust-ownership-decidability/` 迁移到 `archive/rust-ownership-decidability/`
- [ ] 更新仍引用这些路径的内部链接（优先修复 `docs/`、`concept/`、`knowledge/` 中的活跃链接）
- [ ] 在迁移后的 archive 目录顶层添加 `README.md` 说明归档政策
- [ ] 提交变更
