...
| 创建发布日探测脚本 | 2026-06-28 | `scripts/probe_rust_197_apis.rs` |
...
- [x] 完成剩余结构债务清理（BorrowSanitizer 重叠文件）
...
- [ ] 复查 `crates/c08_algorithms/src/rust_197_features.rs` 注释准确性
- [ ] 检查 Rust 1.97 beta 最新动态（releases.rs / rust-lang/rust 标签）
- [ ] 若 `retain_back` 状态明确，提前更新 fallback 注释

### 2026-06-30（周二）— 发布前第 9 天

- [ ] 预检 `docs/06_toolchain/` 目录，确认 1.97 稳定特性文档迁移目标位置
- [ ] 准备 `CHANGELOG.md [3.1.0]` 1.97 特性条目草稿

### 2026-07-01（周三）— 发布前第 8 天

- [ ] 复查 `concept/07_future/rust_1_97_preview.md` 中所有标记
- [ ] 确认术语表 `concept/00_meta/terminology_glossary.md` 中 1.97 术语状态
...
- [ ] 周报更新 `.kimi/WEEKLY_PROGRESS_2026_07_05.md`
