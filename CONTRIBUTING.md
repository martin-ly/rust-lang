...
| 阶段 | 建议行动 | 适合人群 |
| :--- | :--- | :--- || **入门贡献** | 修正文档错别字、更新过时链接、补充速查卡反例 | 刚学完 C01–C03 |
| **模块贡献** | 为某模块（如 C05、C08）补充示例、完善 FAQ | 已掌握对应模块 |
| **形式化贡献** | 在 [research_notes](./docs/research_notes/README.md) 补充证明、形式化分析 | 有形式化/类型论背景 |
| **维护贡献** | 认领模块维护、参与版本发布追踪（[RUST_RELEASE_TRACKING_CHECKLIST](./docs/07_project/RUST_RELEASE_TRACKING_CHECKLIST.md)） | 长期使用者 |

**Good First Issue**：优先选择标注「文档」「示例」「链接修复」的 Issue，适合首次贡献。
